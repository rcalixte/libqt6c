...
QSize* QFontMetrics_Size3(const QFontMetrics* self, int flags, libqt_string str, int tabstops);
QSize* QFontMetrics_Size4(const QFontMetrics* self, int flags, libqt_string str, int tabstops, int* tabarray);
libqt_string QFontMetrics_ElidedText4(const QFontMetrics* self, libqt_string text, int mode, int width, int flags);
...
QSizeF* QFontMetricsF_Size4(const QFontMetricsF* self, int flags, libqt_string str, int tabstops, int* tabarray);
libqt_string QFontMetricsF_ElidedText4(const QFontMetricsF* self, libqt_string text, int mode, double width, int flags);
