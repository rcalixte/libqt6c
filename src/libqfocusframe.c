...
bool q_focusframe_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_focusframe_as_q_paint_device(self));
}

int32_t q_focusframe_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_focusframe_as_q_paint_device(self));
}

int32_t q_focusframe_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_focusframe_as_q_paint_device(self));
}

int32_t q_focusframe_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_focusframe_as_q_paint_device(self));
}

int32_t q_focusframe_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_focusframe_as_q_paint_device(self));
}

int32_t q_focusframe_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_focusframe_as_q_paint_device(self));
}

int32_t q_focusframe_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_focusframe_as_q_paint_device(self));
}

double q_focusframe_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_focusframe_as_q_paint_device(self));
}

double q_focusframe_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_focusframe_as_q_paint_device(self));
}

int32_t q_focusframe_color_count(void* self) {
    return QPaintDevice_ColorCount(q_focusframe_as_q_paint_device(self));
}

int32_t q_focusframe_depth(void* self) {
    return QPaintDevice_Depth(q_focusframe_as_q_paint_device(self));
}
