...
const char** q_scrollbar_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_scrollbar_dynamic_property_names\n");
        abort();
    }
...
bool q_scrollbar_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_scrollbar_as_q_paint_device(self));
}

int32_t q_scrollbar_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_scrollbar_as_q_paint_device(self));
}

int32_t q_scrollbar_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_scrollbar_as_q_paint_device(self));
}

int32_t q_scrollbar_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_scrollbar_as_q_paint_device(self));
}

int32_t q_scrollbar_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_scrollbar_as_q_paint_device(self));
}

int32_t q_scrollbar_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_scrollbar_as_q_paint_device(self));
}

int32_t q_scrollbar_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_scrollbar_as_q_paint_device(self));
}

double q_scrollbar_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_scrollbar_as_q_paint_device(self));
}

double q_scrollbar_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_scrollbar_as_q_paint_device(self));
}

int32_t q_scrollbar_color_count(void* self) {
    return QPaintDevice_ColorCount(q_scrollbar_as_q_paint_device(self));
}

int32_t q_scrollbar_depth(void* self) {
    return QPaintDevice_Depth(q_scrollbar_as_q_paint_device(self));
}
