#pragma once
#ifndef SRCC_LIBQOPENGLFUNCTIONS_HPP
#define SRCC_LIBQOPENGLFUNCTIONS_HPP
...
void QOpenGLFunctions_GlDrawElements(QOpenGLFunctions* self, uint32_t mode, int32_t count, uint32_t type, const void* indices);
...
void QOpenGLFunctions_GlReadPixels(QOpenGLFunctions* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, void* pixels);
...
void QOpenGLFunctions_GlTexImage2D(QOpenGLFunctions* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, const void* pixels);
...
void QOpenGLFunctions_GlTexSubImage2D(QOpenGLFunctions* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels);
...
uint32_t QOpenGLFunctions_GlCreateShader(QOpenGLFunctions* self, uint32_t type);
...
void QOpenGLFunctions_GlVertexAttribPointer(QOpenGLFunctions* self, uint32_t indx, int32_t size, uint32_t type, unsigned char normalized, int32_t stride, const void* ptr);
