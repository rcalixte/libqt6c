#pragma once
#ifndef WEBENGINE_LIBQWEBENGINEDOWNLOADREQUEST_H
#define WEBENGINE_LIBQWEBENGINEDOWNLOADREQUEST_H
...
///
int32_t q_webenginedownloadrequest_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_webenginedownloadrequest_start_timer23(void* self, int64_t time, int32_t timerType);
