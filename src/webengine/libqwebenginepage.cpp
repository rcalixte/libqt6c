...
void QWebEnginePage_ToHtml(const QWebEnginePage* self, intptr_t resultCallback) {
    auto resultCallback_func = [resultCallback](const QString& funcparam1_fp) -> void {
        ...
        char* funcparam1_str = static_cast<char*>(malloc(funcparam1_str_len + 1));
        memcpy(funcparam1_str, funcparam1_b.data(), funcparam1_str_len);
        funcparam1_str[funcparam1_str_len] = '\0';
...
// Base class handler implementation
QWebEnginePage* QWebEnginePage_SuperCreateWindow(QWebEnginePage* self, int type) {
    auto* vqwebenginepage = dynamic_cast<VirtualQWebEnginePage*>(self);
    if (vqwebenginepage && vqwebenginepage->isVirtualQWebEnginePage) {
...
// Base class handler implementation
bool QWebEnginePage_SuperAcceptNavigationRequest(QWebEnginePage* self, const QUrl* url, int type, bool isMainFrame) {
    auto* vqwebenginepage = dynamic_cast<VirtualQWebEnginePage*>(self);
    if (vqwebenginepage && vqwebenginepage->isVirtualQWebEnginePage) {
