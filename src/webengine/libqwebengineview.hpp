#pragma once
#ifndef SRC_WEBENGINEC_LIBQWEBENGINEVIEW_HPP
#define SRC_WEBENGINEC_LIBQWEBENGINEVIEW_HPP
...
QWebEngineView* QWebEngineView_SuperCreateWindow(QWebEngineView* self, int type);
