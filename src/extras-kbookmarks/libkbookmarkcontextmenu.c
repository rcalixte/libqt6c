...
const char** k_bookmarkcontextmenu_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_bookmarkcontextmenu_dynamic_property_names\n");
        abort();
    }
...
bool k_bookmarkcontextmenu_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_bookmarkcontextmenu_as_q_paint_device(self));
}

int32_t k_bookmarkcontextmenu_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_bookmarkcontextmenu_as_q_paint_device(self));
}

int32_t k_bookmarkcontextmenu_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_bookmarkcontextmenu_as_q_paint_device(self));
}

int32_t k_bookmarkcontextmenu_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_bookmarkcontextmenu_as_q_paint_device(self));
}

int32_t k_bookmarkcontextmenu_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_bookmarkcontextmenu_as_q_paint_device(self));
}

int32_t k_bookmarkcontextmenu_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_bookmarkcontextmenu_as_q_paint_device(self));
}

int32_t k_bookmarkcontextmenu_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_bookmarkcontextmenu_as_q_paint_device(self));
}

double k_bookmarkcontextmenu_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_bookmarkcontextmenu_as_q_paint_device(self));
}

double k_bookmarkcontextmenu_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_bookmarkcontextmenu_as_q_paint_device(self));
}

int32_t k_bookmarkcontextmenu_color_count(void* self) {
    return QPaintDevice_ColorCount(k_bookmarkcontextmenu_as_q_paint_device(self));
}

int32_t k_bookmarkcontextmenu_depth(void* self) {
    return QPaintDevice_Depth(k_bookmarkcontextmenu_as_q_paint_device(self));
}
