#pragma once
#ifndef EXTRAS_KBOOKMARKS_LIBKBOOKMARKACTION_H
#define EXTRAS_KBOOKMARKS_LIBKBOOKMARKACTION_H
...
///
/// @param self KBookmarkAction*
/// @param callback void* func(KBookmarkAction* self, const char* param1)
///
