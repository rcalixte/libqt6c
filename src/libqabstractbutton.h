...
///
/// ``` QAbstractButton* self, libqt_list /* of QAction* */ actions ```
...
///
/// ``` QAbstractButton* self, QAction* before, libqt_list /* of QAction* */ actions ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#childAt)
///
/// ``` QAbstractButton* self, QPointF* p ```
QWidget* q_abstractbutton_child_at_with_q_point_f(void* self, void* p);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
///
/// ``` QAbstractButton* self, enum Qt__TimerId id ```
void q_abstractbutton_kill_timer_with_id(void* self, int64_t id);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
///
/// ``` QAbstractButton* self, QThread* thread, Disambiguated_t* param2 ```
...
/// Wrapper to allow calling virtual or protected method
///
/// ``` QAbstractButton* self, enum QPaintDevice__PaintDeviceMetric metricA, enum QPaintDevice__PaintDeviceMetric metricB ```
...
/// Wrapper to allow overriding base class virtual or protected method
///
/// ``` QAbstractButton* self, double (*slot)(QAbstractButton*, enum QPaintDevice__PaintDeviceMetric, enum QPaintDevice__PaintDeviceMetric) ```
