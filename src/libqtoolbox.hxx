...
class VirtualQToolBox final : public QToolBox {
  ...
  public:
    ...
    friend bool QToolBox_NativeEvent(QToolBox* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QToolBox_QBaseNativeEvent(QToolBox* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QToolBox_ConnectNotify(QToolBox* self, QMetaMethod* signal);
    friend void QToolBox_QBaseConnectNotify(QToolBox* self, QMetaMethod* signal);
    friend void QToolBox_DisconnectNotify(QToolBox* self, QMetaMethod* signal);
    friend void QToolBox_QBaseDisconnectNotify(QToolBox* self, QMetaMethod* signal);
    ...
    friend bool QToolBox_IsSignalConnected(const QToolBox* self, QMetaMethod* signal);
    friend bool QToolBox_QBaseIsSignalConnected(const QToolBox* self, QMetaMethod* signal);
};
