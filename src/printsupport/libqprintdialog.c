...
const char** q_printdialog_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_printdialog_dynamic_property_names\n");
        abort();
    }
...
bool q_printdialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_printdialog_as_q_paint_device(self));
}

int32_t q_printdialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_printdialog_as_q_paint_device(self));
}

int32_t q_printdialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_printdialog_as_q_paint_device(self));
}

int32_t q_printdialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_printdialog_as_q_paint_device(self));
}

int32_t q_printdialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_printdialog_as_q_paint_device(self));
}

int32_t q_printdialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_printdialog_as_q_paint_device(self));
}

int32_t q_printdialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_printdialog_as_q_paint_device(self));
}

double q_printdialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_printdialog_as_q_paint_device(self));
}

double q_printdialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_printdialog_as_q_paint_device(self));
}

int32_t q_printdialog_color_count(void* self) {
    return QPaintDevice_ColorCount(q_printdialog_as_q_paint_device(self));
}

int32_t q_printdialog_depth(void* self) {
    return QPaintDevice_Depth(q_printdialog_as_q_paint_device(self));
}
