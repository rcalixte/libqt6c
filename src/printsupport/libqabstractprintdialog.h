#pragma once
#ifndef SRC_PRINTSUPPORT_QT6C_LIBQABSTRACTPRINTDIALOG_H
#define SRC_PRINTSUPPORT_QT6C_LIBQABSTRACTPRINTDIALOG_H
...
/// [Upstream resources](https://doc.qt.io/qt-6/qabstractprintdialog.html)
...
///
/// @param self QAbstractPrintDialog*
/// @param callback void* func(QAbstractPrintDialog* self, const char* param1)
///
...
///
void q_abstractprintdialog_grab_gesture(void* self, int32_t type);
...
/// @param type enum Qt__GestureType
///
void q_abstractprintdialog_ungrab_gesture(void* self, int32_t type);
...
///
void q_abstractprintdialog_set_parent2(void* self, void* parent, int32_t f);
...
///
libqt_list q_abstractprintdialog_actions(void* self);
...
///
void q_abstractprintdialog_set_window_flags(void* self, int32_t type);
...
///
void q_abstractprintdialog_set_window_flag(void* self, int32_t param1);
...
/// @param type flag of enum Qt__WindowType
///
void q_abstractprintdialog_override_window_flags(void* self, int32_t type);
...
///
void q_abstractprintdialog_set_input_method_hints(void* self, int32_t hints);
...
///
void q_abstractprintdialog_grab_gesture2(void* self, int32_t type, int32_t flags);
...
/// @param on bool
///
void q_abstractprintdialog_set_window_flag2(void* self, int32_t param1, bool on);
...
///
QWidget* q_abstractprintdialog_create_window_container3(void* window, void* parent, int32_t flags);
...
///
int32_t q_abstractprintdialog_start_timer2(void* self, int64_t time);
...
///
libqt_list q_abstractprintdialog_children(void* self);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_abstractprintdialog_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
/// @param self QAbstractPrintDialog*
/// @param callback bool func(QAbstractPrintDialog* self, libqt_string eventType, void* message, intptr_t* result)
///
