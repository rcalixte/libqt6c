...
class VirtualQScrollArea final : public QScrollArea {
  ...
  public:
    ...
    friend bool QScrollArea_NativeEvent(QScrollArea* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QScrollArea_QBaseNativeEvent(QScrollArea* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QScrollArea_ConnectNotify(QScrollArea* self, QMetaMethod* signal);
    friend void QScrollArea_QBaseConnectNotify(QScrollArea* self, QMetaMethod* signal);
    friend void QScrollArea_DisconnectNotify(QScrollArea* self, QMetaMethod* signal);
    friend void QScrollArea_QBaseDisconnectNotify(QScrollArea* self, QMetaMethod* signal);
    ...
    friend bool QScrollArea_IsSignalConnected(const QScrollArea* self, QMetaMethod* signal);
    friend bool QScrollArea_QBaseIsSignalConnected(const QScrollArea* self, QMetaMethod* signal);
};
