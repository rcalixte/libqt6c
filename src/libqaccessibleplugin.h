#pragma once
#ifndef LIBQACCESSIBLEPLUGIN_H
#define LIBQACCESSIBLEPLUGIN_H
...
///
/// @param self QAccessiblePlugin*
/// @param callback void* func(QAccessiblePlugin* self, const char* param1)
///
...
///
int32_t q_accessibleplugin_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_accessibleplugin_start_timer23(void* self, int64_t time, int32_t timerType);
