...
void KLocalizedQmlContext_Connect_TranslationDomainChanged(KLocalizedQmlContext* self, intptr_t slot) {
    ...
    KLocalizedQmlContext::connect(self, &KLocalizedQmlContext::translationDomainChanged, [self, slotFunc](const QString& translationDomain) {
        ...
        char* translationDomain_str = static_cast<char*>(malloc(translationDomain_str_len + 1));
        memcpy(translationDomain_str, translationDomain_b.data(), translationDomain_str_len);
        translationDomain_str[translationDomain_str_len] = '\0';
...
KLocalizedQmlContext* KLocalization_SetupLocalizedContext(QQmlEngine* engine) {
    return KLocalization::setupLocalizedContext(engine);
}
