#pragma once
#ifndef EXTRAS_KI18N_LIBKLOCALIZEDQMLCONTEXT_H
#define EXTRAS_KI18N_LIBKLOCALIZEDQMLCONTEXT_H
...
///
/// @param self KLocalizedQmlContext*
/// @param callback void* func(KLocalizedQmlContext* self, const char* param1)
///
...
/// @param param1 const char*
///
void* k_localizedqmlcontext_super_metacast(void* self, const char* param1);
...
/// @param param3 void*
///
int32_t k_localizedqmlcontext_super_metacall(void* self, int32_t param1, int param2, void* param3);
...
/// @param event QEvent*
///
bool k_localizedqmlcontext_super_event_filter(void* self, void* watched, void* event);
...
///
void k_localizedqmlcontext_set_object_name(void* self, const char* name);
...
///
int32_t k_localizedqmlcontext_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_localizedqmlcontext_start_timer23(void* self, int64_t time, int32_t timerType);
...
/// @param event QEvent*
///
bool k_localizedqmlcontext_super_event(void* self, void* event);
...
/// @param event QTimerEvent*
///
void k_localizedqmlcontext_super_timer_event(void* self, void* event);
...
/// @param event QChildEvent*
///
void k_localizedqmlcontext_super_child_event(void* self, void* event);
...
/// @param event QEvent*
///
void k_localizedqmlcontext_super_custom_event(void* self, void* event);
...
///
KLocalizedQmlContext* k_localization_setup_localized_context(void* engine);
#endif
