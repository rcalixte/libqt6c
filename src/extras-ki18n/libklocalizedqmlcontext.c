...
const QMetaObject* k_localizedqmlcontext_super_meta_object(void* self) {
    return KLocalizedQmlContext_SuperMetaObject((KLocalizedQmlContext*)self);
}
...
void* k_localizedqmlcontext_super_metacast(void* self, const char* param1) {
    return KLocalizedQmlContext_SuperMetacast((KLocalizedQmlContext*)self, param1);
}
...
int32_t k_localizedqmlcontext_super_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KLocalizedQmlContext_SuperMetacall((KLocalizedQmlContext*)self, param1, param2, param3);
}
...
bool k_localizedqmlcontext_super_event(void* self, void* event) {
    return KLocalizedQmlContext_SuperEvent((KLocalizedQmlContext*)self, (QEvent*)event);
}
...
void k_localizedqmlcontext_super_timer_event(void* self, void* event) {
    KLocalizedQmlContext_SuperTimerEvent((KLocalizedQmlContext*)self, (QTimerEvent*)event);
}
...
void k_localizedqmlcontext_super_child_event(void* self, void* event) {
    KLocalizedQmlContext_SuperChildEvent((KLocalizedQmlContext*)self, (QChildEvent*)event);
}
...
void k_localizedqmlcontext_super_custom_event(void* self, void* event) {
    KLocalizedQmlContext_SuperCustomEvent((KLocalizedQmlContext*)self, (QEvent*)event);
}
...
void k_localizedqmlcontext_super_connect_notify(void* self, void* signal) {
    KLocalizedQmlContext_SuperConnectNotify((KLocalizedQmlContext*)self, (QMetaMethod*)signal);
}
...
void k_localizedqmlcontext_super_disconnect_notify(void* self, void* signal) {
    KLocalizedQmlContext_SuperDisconnectNotify((KLocalizedQmlContext*)self, (QMetaMethod*)signal);
}
...
QObject* k_localizedqmlcontext_super_sender(void* self) {
    return KLocalizedQmlContext_SuperSender((KLocalizedQmlContext*)self);
}
...
int32_t k_localizedqmlcontext_super_sender_signal_index(void* self) {
    return KLocalizedQmlContext_SuperSenderSignalIndex((KLocalizedQmlContext*)self);
}
...
int32_t k_localizedqmlcontext_super_receivers(void* self, const char* signal) {
    return KLocalizedQmlContext_SuperReceivers((KLocalizedQmlContext*)self, signal);
}
...
bool k_localizedqmlcontext_super_is_signal_connected(void* self, void* signal) {
    return KLocalizedQmlContext_SuperIsSignalConnected((KLocalizedQmlContext*)self, (QMetaMethod*)signal);
}
...
KLocalizedQmlContext* k_localization_setup_localized_context(void* engine) {
    return KLocalization_SetupLocalizedContext((QQmlEngine*)engine);
}
