#pragma once
#ifndef LIBQOBJECT_HPP
#define LIBQOBJECT_HPP
...
void qobject_h_QFindChildrenHelper(const QObject* parent, const char* name, const QMetaObject* mo, libqt_list /* of void* */ list, int options);
...
QObject* qobject_h_QFindChildHelper(const QObject* parent, const char* name, const QMetaObject* mo, int options);
...
QMetaObject__Connection* QObject_Connect52(const QObject* sender, const QMetaMethod* signal, const QObject* receiver, const QMetaMethod* method, int type);
QMetaObject__Connection* QObject_Connect4(const QObject* self, const QObject* sender, const char* signal, const char* member, int type);
