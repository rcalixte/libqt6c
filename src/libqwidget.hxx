...
class VirtualQWidget final : public QWidget {
  ...
  public:
    ...
    friend bool QWidget_NativeEvent(QWidget* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QWidget_QBaseNativeEvent(QWidget* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QWidget_ConnectNotify(QWidget* self, QMetaMethod* signal);
    friend void QWidget_QBaseConnectNotify(QWidget* self, QMetaMethod* signal);
    friend void QWidget_DisconnectNotify(QWidget* self, QMetaMethod* signal);
    friend void QWidget_QBaseDisconnectNotify(QWidget* self, QMetaMethod* signal);
    ...
    friend bool QWidget_IsSignalConnected(const QWidget* self, QMetaMethod* signal);
    friend bool QWidget_QBaseIsSignalConnected(const QWidget* self, QMetaMethod* signal);
};
