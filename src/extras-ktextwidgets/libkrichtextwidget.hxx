  ...
  public:
    ...
    virtual bool shouldBlockBeSpellChecked(const QString& block) const override {
        if (krichtextwidget_shouldblockbespellchecked_isbase) {
            ...
            char* block_str = static_cast<char*>(malloc(block_str_len + 1));
            memcpy(block_str, block_b.data(), block_str_len);
            block_str[block_str_len] = '\0';
    ...
    virtual QVariant loadResource(int type, const QUrl& name) override {
        if (krichtextwidget_loadresource_isbase) {
            ...
            return KRichTextWidget::loadResource(type, name);
