...
const char** k_pluralhandlingspinbox_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_pluralhandlingspinbox_dynamic_property_names\n");
        abort();
    }
...
bool k_pluralhandlingspinbox_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_pluralhandlingspinbox_as_q_paint_device(self));
}

int32_t k_pluralhandlingspinbox_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_pluralhandlingspinbox_as_q_paint_device(self));
}

int32_t k_pluralhandlingspinbox_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_pluralhandlingspinbox_as_q_paint_device(self));
}

int32_t k_pluralhandlingspinbox_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_pluralhandlingspinbox_as_q_paint_device(self));
}

int32_t k_pluralhandlingspinbox_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_pluralhandlingspinbox_as_q_paint_device(self));
}

int32_t k_pluralhandlingspinbox_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_pluralhandlingspinbox_as_q_paint_device(self));
}

int32_t k_pluralhandlingspinbox_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_pluralhandlingspinbox_as_q_paint_device(self));
}

double k_pluralhandlingspinbox_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_pluralhandlingspinbox_as_q_paint_device(self));
}

double k_pluralhandlingspinbox_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_pluralhandlingspinbox_as_q_paint_device(self));
}

int32_t k_pluralhandlingspinbox_color_count(void* self) {
    return QPaintDevice_ColorCount(k_pluralhandlingspinbox_as_q_paint_device(self));
}

int32_t k_pluralhandlingspinbox_depth(void* self) {
    return QPaintDevice_Depth(k_pluralhandlingspinbox_as_q_paint_device(self));
}
