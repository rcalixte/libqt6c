...
const char** q_object_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_object_dynamic_property_names");
        abort();
    }
