#pragma once
#ifndef SRC_EXTRAS_KPARTS_QT6C_LIBSTATUSBAREXTENSION_H
#define SRC_EXTRAS_KPARTS_QT6C_LIBSTATUSBAREXTENSION_H
...
/// https://api.kde.org/kparts-statusbarextension.html

/// k_parts__statusbarextension_new constructs a new KParts::StatusBarExtension object.
///
/// @param parent KParts__Part*
KParts__StatusBarExtension* k_parts__statusbarextension_new(void* parent);

/// k_parts__statusbarextension_new2 constructs a new KParts::StatusBarExtension object.
///
...
/// [Qt documentation](https://api.kde.org/kparts-statusbarextension.html#addStatusBarItem)
///
/// @param self KParts__StatusBarExtension*
...
/// [Qt documentation](https://api.kde.org/kparts-statusbarextension.html#removeStatusBarItem)
///
/// @param self KParts__StatusBarExtension*
/// @param widget QWidget*
void k_parts__statusbarextension_remove_status_bar_item(void* self, void* widget);

/// [Qt documentation](https://api.kde.org/kparts-statusbarextension.html#statusBar)
///
/// @param self KParts__StatusBarExtension*
QStatusBar* k_parts__statusbarextension_status_bar(void* self);

/// [Qt documentation](https://api.kde.org/kparts-statusbarextension.html#setStatusBar)
///
/// @param self KParts__StatusBarExtension*
/// @param status QStatusBar*
void k_parts__statusbarextension_set_status_bar(void* self, void* status);

/// [Qt documentation](https://api.kde.org/kparts-statusbarextension.html#childObject)
///
/// @param obj QObject*
KParts__StatusBarExtension* k_parts__statusbarextension_child_object(void* obj);

/// [Qt documentation](https://api.kde.org/kparts-statusbarextension.html#eventFilter)
///
/// @param self KParts__StatusBarExtension*
...
///
/// @param self KParts__StatusBarExtension*
/// @param callback void func(KParts__StatusBarExtension* self)
...
///
/// @param self KParts__StatusBarExtension*
/// @param callback void func(KParts__StatusBarExtension* self, QObject* param1)
...
///
/// @param self KParts__StatusBarExtension*
/// @param callback bool func(KParts__StatusBarExtension* self, QEvent* event)
...
///
/// @param self KParts__StatusBarExtension*
/// @param callback void func(KParts__StatusBarExtension* self, QTimerEvent* event)
...
///
/// @param self KParts__StatusBarExtension*
/// @param callback void func(KParts__StatusBarExtension* self, QChildEvent* event)
...
///
/// @param self KParts__StatusBarExtension*
/// @param callback void func(KParts__StatusBarExtension* self, QEvent* event)
...
///
/// @param self KParts__StatusBarExtension*
/// @param callback void func(KParts__StatusBarExtension* self, const char* objectName)
