  ...
  public:
    ...
    QWidget* hostContainer(const QString& containerName) {
        if (kparts__part_hostcontainer_isbase) {
            ...
            char* containerName_str = static_cast<char*>(malloc(containerName_str_len + 1));
            memcpy(containerName_str, containerName_b.data(), containerName_str_len);
            containerName_str[containerName_str_len] = '\0';
