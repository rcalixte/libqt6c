...
void* k_parts__readwritepart_super_metacast(void* self, const char* param1) {
    return KParts__ReadWritePart_SuperMetacast((KParts__ReadWritePart*)self, param1);
}
...
int32_t k_parts__readwritepart_super_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KParts__ReadWritePart_SuperMetacall((KParts__ReadWritePart*)self, param1, param2, param3);
}
...
bool k_parts__readwritepart_super_query_close(void* self) {
    return KParts__ReadWritePart_SuperQueryClose((KParts__ReadWritePart*)self);
}
...
bool k_parts__readwritepart_super_close_url(void* self) {
    return KParts__ReadWritePart_SuperCloseUrl((KParts__ReadWritePart*)self);
}
...
void k_parts__readwritepart_super_set_modified(void* self, bool modified) {
    KParts__ReadWritePart_SuperSetModified((KParts__ReadWritePart*)self, modified);
}
...
bool k_parts__readwritepart_super_save(void* self) {
    return KParts__ReadWritePart_SuperSave((KParts__ReadWritePart*)self);
}
...
bool k_parts__readwritepart_super_save_to_url(void* self) {
    return KParts__ReadWritePart_SuperSaveToUrl((KParts__ReadWritePart*)self);
}
...
void k_parts__readwritepart_super_gui_activate_event(void* self, void* event) {
    KParts__ReadWritePart_SuperGuiActivateEvent((KParts__ReadWritePart*)self, (KParts__GUIActivateEvent*)event);
}
...
void k_parts__readwritepart_super_set_manager(void* self, void* manager) {
    KParts__ReadWritePart_SuperSetManager((KParts__ReadWritePart*)self, (KParts__PartManager*)manager);
}
...
void k_parts__readwritepart_super_set_widget(void* self, void* widget) {
    KParts__ReadWritePart_SuperSetWidget((KParts__ReadWritePart*)self, (QWidget*)widget);
}
...
void k_parts__readwritepart_super_custom_event(void* self, void* event) {
    KParts__ReadWritePart_SuperCustomEvent((KParts__ReadWritePart*)self, (QEvent*)event);
}
...
void k_parts__readwritepart_super_part_activate_event(void* self, void* event) {
    KParts__ReadWritePart_SuperPartActivateEvent((KParts__ReadWritePart*)self, (KParts__PartActivateEvent*)event);
}
...
bool k_parts__readwritepart_super_event(void* self, void* event) {
    return KParts__ReadWritePart_SuperEvent((KParts__ReadWritePart*)self, (QEvent*)event);
}
...
bool k_parts__readwritepart_super_event_filter(void* self, void* watched, void* event) {
    return KParts__ReadWritePart_SuperEventFilter((KParts__ReadWritePart*)self, (QObject*)watched, (QEvent*)event);
}
...
void k_parts__readwritepart_super_timer_event(void* self, void* event) {
    KParts__ReadWritePart_SuperTimerEvent((KParts__ReadWritePart*)self, (QTimerEvent*)event);
}
...
void k_parts__readwritepart_super_child_event(void* self, void* event) {
    KParts__ReadWritePart_SuperChildEvent((KParts__ReadWritePart*)self, (QChildEvent*)event);
}
...
void k_parts__readwritepart_super_set_component_name(void* self, const char* componentName, const char* componentDisplayName) {
    KParts__ReadWritePart_SuperSetComponentName((KParts__ReadWritePart*)self, qstring(componentName), qstring(componentDisplayName));
}
...
void k_parts__readwritepart_super_set_x_m_l_file(void* self, const char* file, bool merge, bool setXMLDoc) {
    KParts__ReadWritePart_SuperSetXMLFile((KParts__ReadWritePart*)self, qstring(file), merge, setXMLDoc);
}
...
void k_parts__readwritepart_super_set_local_x_m_l_file(void* self, const char* file) {
    KParts__ReadWritePart_SuperSetLocalXMLFile((KParts__ReadWritePart*)self, qstring(file));
}
...
void k_parts__readwritepart_super_set_x_m_l(void* self, const char* document, bool merge) {
    KParts__ReadWritePart_SuperSetXML((KParts__ReadWritePart*)self, qstring(document), merge);
}
...
void k_parts__readwritepart_super_state_changed(void* self, const char* newstate, int32_t reverse) {
    KParts__ReadWritePart_SuperStateChanged((KParts__ReadWritePart*)self, qstring(newstate), reverse);
}
