  ...
  public:
    ...
    void setLocalFilePath(const QString& localFilePath) {
        if (kparts__readwritepart_setlocalfilepath_isbase) {
            ...
            char* localFilePath_str = static_cast<char*>(malloc(localFilePath_str_len + 1));
            memcpy(localFilePath_str, localFilePath_b.data(), localFilePath_str_len);
            localFilePath_str[localFilePath_str_len] = '\0';
