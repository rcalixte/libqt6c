...
///
/// @param self KParts__ListingFilterExtension*
/// @param callback void* func(KParts__ListingFilterExtension* self, const char* param1)
///
...
///
void k_parts__listingfilterextension_set_object_name(void* self, const char* name);
