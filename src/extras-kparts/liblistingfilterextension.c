...
int32_t k_parts__listingfilterextension_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KParts__ListingFilterExtension_Metacall((KParts__ListingFilterExtension*)self, param1, param2, param3);
}
...
const char* k_parts__listingfilterextension_tr(const char* s) {
    libqt_string _str = KParts__ListingFilterExtension_Tr(s);
...
KParts__ListingFilterExtension* k_parts__listingfilterextension_child_object(void* obj) {
    return KParts__ListingFilterExtension_ChildObject((QObject*)obj);
}
...
void k_parts__listingfilterextension_set_filter(void* self, int32_t mode, void* filter) {
    KParts__ListingFilterExtension_SetFilter((KParts__ListingFilterExtension*)self, mode, (QVariant*)filter);
}
...
const char* k_parts__listingfilterextension_tr2(const char* s, const char* c) {
    libqt_string _str = KParts__ListingFilterExtension_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_parts__listingfilterextension_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KParts__ListingFilterExtension_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_parts__listingfilterextension_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_parts__listingfilterextension_dynamic_property_names");
        abort();
    }
...
void k_parts__listingfilterextension_on_event(void* self, bool (*callback)(void*, void*)) {
    KParts__ListingFilterExtension_OnEvent((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    KParts__ListingFilterExtension_OnEventFilter((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_timer_event(void* self, void (*callback)(void*, void*)) {
    KParts__ListingFilterExtension_OnTimerEvent((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_child_event(void* self, void (*callback)(void*, void*)) {
    KParts__ListingFilterExtension_OnChildEvent((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_custom_event(void* self, void (*callback)(void*, void*)) {
    KParts__ListingFilterExtension_OnCustomEvent((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_connect_notify(void* self, void (*callback)(void*, void*)) {
    KParts__ListingFilterExtension_OnConnectNotify((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_disconnect_notify(void* self, void (*callback)(void*, void*)) {
    KParts__ListingFilterExtension_OnDisconnectNotify((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_sender(void* self, QObject* (*callback)()) {
    KParts__ListingFilterExtension_OnSender((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_sender_signal_index(void* self, int32_t (*callback)()) {
    KParts__ListingFilterExtension_OnSenderSignalIndex((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_receivers(void* self, int32_t (*callback)(void*, const char*)) {
    KParts__ListingFilterExtension_OnReceivers((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_on_is_signal_connected(void* self, bool (*callback)(void*, void*)) {
    KParts__ListingFilterExtension_OnIsSignalConnected((KParts__ListingFilterExtension*)self, (intptr_t)callback);
}
...
void k_parts__listingfilterextension_delete(void* self) {
    KParts__ListingFilterExtension_Delete((KParts__ListingFilterExtension*)(self));
}
