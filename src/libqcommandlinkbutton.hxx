...
class VirtualQCommandLinkButton final : public QCommandLinkButton {
  ...
  public:
    ...
    friend bool QCommandLinkButton_HitButton(const QCommandLinkButton* self, QPoint* pos);
    friend bool QCommandLinkButton_QBaseHitButton(const QCommandLinkButton* self, QPoint* pos);
    ...
    friend bool QCommandLinkButton_NativeEvent(QCommandLinkButton* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QCommandLinkButton_QBaseNativeEvent(QCommandLinkButton* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QCommandLinkButton_ConnectNotify(QCommandLinkButton* self, QMetaMethod* signal);
    friend void QCommandLinkButton_QBaseConnectNotify(QCommandLinkButton* self, QMetaMethod* signal);
    friend void QCommandLinkButton_DisconnectNotify(QCommandLinkButton* self, QMetaMethod* signal);
    friend void QCommandLinkButton_QBaseDisconnectNotify(QCommandLinkButton* self, QMetaMethod* signal);
    ...
    friend bool QCommandLinkButton_IsSignalConnected(const QCommandLinkButton* self, QMetaMethod* signal);
    friend bool QCommandLinkButton_QBaseIsSignalConnected(const QCommandLinkButton* self, QMetaMethod* signal);
};
