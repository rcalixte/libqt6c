...
class VirtualQFileDialog final : public QFileDialog {
  ...
  public:
    ...
    friend bool QFileDialog_NativeEvent(QFileDialog* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QFileDialog_QBaseNativeEvent(QFileDialog* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QFileDialog_ConnectNotify(QFileDialog* self, QMetaMethod* signal);
    friend void QFileDialog_QBaseConnectNotify(QFileDialog* self, QMetaMethod* signal);
    friend void QFileDialog_DisconnectNotify(QFileDialog* self, QMetaMethod* signal);
    friend void QFileDialog_QBaseDisconnectNotify(QFileDialog* self, QMetaMethod* signal);
    ...
    friend bool QFileDialog_IsSignalConnected(const QFileDialog* self, QMetaMethod* signal);
    friend bool QFileDialog_QBaseIsSignalConnected(const QFileDialog* self, QMetaMethod* signal);
};
