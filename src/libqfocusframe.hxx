...
class VirtualQFocusFrame final : public QFocusFrame {
  ...
  public:
    ...
    friend bool QFocusFrame_NativeEvent(QFocusFrame* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QFocusFrame_QBaseNativeEvent(QFocusFrame* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QFocusFrame_ConnectNotify(QFocusFrame* self, QMetaMethod* signal);
    friend void QFocusFrame_QBaseConnectNotify(QFocusFrame* self, QMetaMethod* signal);
    friend void QFocusFrame_DisconnectNotify(QFocusFrame* self, QMetaMethod* signal);
    friend void QFocusFrame_QBaseDisconnectNotify(QFocusFrame* self, QMetaMethod* signal);
    ...
    friend bool QFocusFrame_IsSignalConnected(const QFocusFrame* self, QMetaMethod* signal);
    friend bool QFocusFrame_QBaseIsSignalConnected(const QFocusFrame* self, QMetaMethod* signal);
};
