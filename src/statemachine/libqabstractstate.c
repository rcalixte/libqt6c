...
const QMetaObject* q_abstractstate_meta_object(void* self) {
    return QAbstractState_MetaObject((QAbstractState*)self);
}

void* q_abstractstate_metacast(void* self, const char* param1) {
    return QAbstractState_Metacast((QAbstractState*)self, param1);
}

int32_t q_abstractstate_metacall(void* self, int32_t param1, int param2, void* param3) {
    return QAbstractState_Metacall((QAbstractState*)self, param1, param2, param3);
}
...
libqt_list /* of QObject* */ q_abstractstate_children(void* self) {
...
const char** q_abstractstate_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_abstractstate_dynamic_property_names\n");
        abort();
    }
...
void q_abstractstate_delete(void* self) {
    QAbstractState_Delete((QAbstractState*)(self));
}
