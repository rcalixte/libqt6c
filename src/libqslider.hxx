...
class VirtualQSlider final : public QSlider {
  ...
  public:
    ...
    friend bool QSlider_NativeEvent(QSlider* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QSlider_QBaseNativeEvent(QSlider* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QSlider_ConnectNotify(QSlider* self, QMetaMethod* signal);
    friend void QSlider_QBaseConnectNotify(QSlider* self, QMetaMethod* signal);
    friend void QSlider_DisconnectNotify(QSlider* self, QMetaMethod* signal);
    friend void QSlider_QBaseDisconnectNotify(QSlider* self, QMetaMethod* signal);
    ...
    friend bool QSlider_IsSignalConnected(const QSlider* self, QMetaMethod* signal);
    friend bool QSlider_QBaseIsSignalConnected(const QSlider* self, QMetaMethod* signal);
};
