...
typedef enum {
    ...
    /// Workaround for duplicate enum value: KEY_DEAD_A
    QT_KEY_KEY_DEAD_A_2 = 16781952,
    /// Workaround for duplicate enum value: KEY_DEAD_A
    QT_KEY_KEY_DEAD_A_3 = 16781953,
    /// Workaround for duplicate enum value: KEY_DEAD_E
    QT_KEY_KEY_DEAD_E_4 = 16781954,
    /// Workaround for duplicate enum value: KEY_DEAD_E
    QT_KEY_KEY_DEAD_E_5 = 16781955,
    /// Workaround for duplicate enum value: KEY_DEAD_I
    QT_KEY_KEY_DEAD_I_6 = 16781956,
    /// Workaround for duplicate enum value: KEY_DEAD_I
    QT_KEY_KEY_DEAD_I_7 = 16781957,
    /// Workaround for duplicate enum value: KEY_DEAD_O
    QT_KEY_KEY_DEAD_O_8 = 16781958,
    /// Workaround for duplicate enum value: KEY_DEAD_O
    QT_KEY_KEY_DEAD_O_9 = 16781959,
    /// Workaround for duplicate enum value: KEY_DEAD_U
    QT_KEY_KEY_DEAD_U_0 = 16781960,
    /// Workaround for duplicate enum value: KEY_DEAD_U
    QT_KEY_KEY_DEAD_U_1 = 16781961,
