#pragma once
#ifndef SRC_EXTRAS_KITEMMODELSQT6C_LIBKMODELINDEXPROXYMAPPER_H
#define SRC_EXTRAS_KITEMMODELSQT6C_LIBKMODELINDEXPROXYMAPPER_H
...
/// [Qt documentation](https://api.kde.org/kmodelindexproxymapper.html#mapLeftToRight)
///
/// @param self KModelIndexProxyMapper*
/// @param index QModelIndex*
QModelIndex* k_modelindexproxymapper_map_left_to_right(void* self, void* index);

/// [Qt documentation](https://api.kde.org/kmodelindexproxymapper.html#mapRightToLeft)
///
/// @param self KModelIndexProxyMapper*
/// @param index QModelIndex*
QModelIndex* k_modelindexproxymapper_map_right_to_left(void* self, void* index);

/// [Qt documentation](https://api.kde.org/kmodelindexproxymapper.html#mapSelectionLeftToRight)
///
/// @param self KModelIndexProxyMapper*
/// @param selection QItemSelection*
QItemSelection* k_modelindexproxymapper_map_selection_left_to_right(void* self, void* selection);

/// [Qt documentation](https://api.kde.org/kmodelindexproxymapper.html#mapSelectionRightToLeft)
///
/// @param self KModelIndexProxyMapper*
/// @param selection QItemSelection*
QItemSelection* k_modelindexproxymapper_map_selection_right_to_left(void* self, void* selection);

/// [Qt documentation](https://api.kde.org/kmodelindexproxymapper.html#isConnected)
///
/// @param self KModelIndexProxyMapper*
bool k_modelindexproxymapper_is_connected(void* self);

/// [Qt documentation](https://api.kde.org/kmodelindexproxymapper.html#isConnectedChanged)
///
/// @param self KModelIndexProxyMapper*
...
/// [Qt documentation](https://api.kde.org/kmodelindexproxymapper.html#dtor.KModelIndexProxyMapper)
///
