...
const char* k_selectionproxymodel_tr(const char* s) {
    libqt_string _str = KSelectionProxyModel_Tr(s);
...
const char** k_selectionproxymodel_mime_types(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_selectionproxymodel_mime_types");
        abort();
    }
...
const char* k_selectionproxymodel_tr2(const char* s, const char* c) {
    libqt_string _str = KSelectionProxyModel_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_selectionproxymodel_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KSelectionProxyModel_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_selectionproxymodel_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_selectionproxymodel_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
libqt_map /* of int to QVariant* */ k_selectionproxymodel_item_data(void* self, void* index) {
    return KSelectionProxyModel_ItemData((KSelectionProxyModel*)self, (QModelIndex*)index);
}

libqt_map /* of int to QVariant* */ k_selectionproxymodel_qbase_item_data(void* self, void* index) {
    return KSelectionProxyModel_QBaseItemData((KSelectionProxyModel*)self, (QModelIndex*)index);
}
...
bool k_selectionproxymodel_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KSelectionProxyModel_SetItemData((KSelectionProxyModel*)self, (QModelIndex*)index, roles);
}

bool k_selectionproxymodel_qbase_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KSelectionProxyModel_QBaseSetItemData((KSelectionProxyModel*)self, (QModelIndex*)index, roles);
}
...
libqt_map /* of int to char* */ k_selectionproxymodel_role_names(void* self) {
    return KSelectionProxyModel_RoleNames((KSelectionProxyModel*)self);
}

libqt_map /* of int to char* */ k_selectionproxymodel_qbase_role_names(void* self) {
    return KSelectionProxyModel_QBaseRoleNames((KSelectionProxyModel*)self);
}
