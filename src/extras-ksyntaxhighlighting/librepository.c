...
const char** k_syntaxhighlighting__repository_custom_search_paths(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_syntaxhighlighting__repository_custom_search_paths");
        abort();
    }
...
QMetaObject__Connection* k_syntaxhighlighting__repository_connect(void* sender, void* signal, void* receiver, void* method) {
    return QObject_Connect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method);
}

QMetaObject__Connection* k_syntaxhighlighting__repository_connect2(void* self, void* sender, const char* signal, const char* member) {
    return QObject_Connect2((QObject*)self, (QObject*)sender, signal, member);
}

bool k_syntaxhighlighting__repository_disconnect(void* sender, void* signal, void* receiver, void* member) {
    return QObject_Disconnect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)member);
}

bool k_syntaxhighlighting__repository_disconnect2(void* param1) {
...
const char** k_syntaxhighlighting__repository_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_syntaxhighlighting__repository_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
bool k_syntaxhighlighting__repository_move_to_thread2(void* self, void* thread, void* param2) {
...
QMetaObject__Connection* k_syntaxhighlighting__repository_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type) {
