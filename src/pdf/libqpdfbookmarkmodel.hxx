...
class VirtualQPdfBookmarkModel final : public QPdfBookmarkModel {
  ...
  public:
    ...
    friend void QPdfBookmarkModel_ConnectNotify(QPdfBookmarkModel* self, QMetaMethod* signal);
    friend void QPdfBookmarkModel_QBaseConnectNotify(QPdfBookmarkModel* self, QMetaMethod* signal);
    friend void QPdfBookmarkModel_DisconnectNotify(QPdfBookmarkModel* self, QMetaMethod* signal);
    friend void QPdfBookmarkModel_QBaseDisconnectNotify(QPdfBookmarkModel* self, QMetaMethod* signal);
    ...
    friend void QPdfBookmarkModel_EncodeData(const QPdfBookmarkModel* self, libqt_list /* of QModelIndex* */ indexes, QDataStream* stream);
    friend void QPdfBookmarkModel_QBaseEncodeData(const QPdfBookmarkModel* self, libqt_list /* of QModelIndex* */ indexes, QDataStream* stream);
    friend bool QPdfBookmarkModel_DecodeData(QPdfBookmarkModel* self, int row, int column, QModelIndex* parent, QDataStream* stream);
    friend bool QPdfBookmarkModel_QBaseDecodeData(QPdfBookmarkModel* self, int row, int column, QModelIndex* parent, QDataStream* stream);
    friend void QPdfBookmarkModel_BeginInsertRows(QPdfBookmarkModel* self, QModelIndex* parent, int first, int last);
    friend void QPdfBookmarkModel_QBaseBeginInsertRows(QPdfBookmarkModel* self, QModelIndex* parent, int first, int last);
    ...
    friend void QPdfBookmarkModel_BeginRemoveRows(QPdfBookmarkModel* self, QModelIndex* parent, int first, int last);
    friend void QPdfBookmarkModel_QBaseBeginRemoveRows(QPdfBookmarkModel* self, QModelIndex* parent, int first, int last);
    ...
    friend bool QPdfBookmarkModel_BeginMoveRows(QPdfBookmarkModel* self, QModelIndex* sourceParent, int sourceFirst, int sourceLast, QModelIndex* destinationParent, int destinationRow);
    friend bool QPdfBookmarkModel_QBaseBeginMoveRows(QPdfBookmarkModel* self, QModelIndex* sourceParent, int sourceFirst, int sourceLast, QModelIndex* destinationParent, int destinationRow);
    ...
    friend void QPdfBookmarkModel_BeginInsertColumns(QPdfBookmarkModel* self, QModelIndex* parent, int first, int last);
    friend void QPdfBookmarkModel_QBaseBeginInsertColumns(QPdfBookmarkModel* self, QModelIndex* parent, int first, int last);
    ...
    friend void QPdfBookmarkModel_BeginRemoveColumns(QPdfBookmarkModel* self, QModelIndex* parent, int first, int last);
    friend void QPdfBookmarkModel_QBaseBeginRemoveColumns(QPdfBookmarkModel* self, QModelIndex* parent, int first, int last);
    ...
    friend bool QPdfBookmarkModel_BeginMoveColumns(QPdfBookmarkModel* self, QModelIndex* sourceParent, int sourceFirst, int sourceLast, QModelIndex* destinationParent, int destinationColumn);
    friend bool QPdfBookmarkModel_QBaseBeginMoveColumns(QPdfBookmarkModel* self, QModelIndex* sourceParent, int sourceFirst, int sourceLast, QModelIndex* destinationParent, int destinationColumn);
    ...
    friend void QPdfBookmarkModel_ChangePersistentIndex(QPdfBookmarkModel* self, QModelIndex* from, QModelIndex* to);
    friend void QPdfBookmarkModel_QBaseChangePersistentIndex(QPdfBookmarkModel* self, QModelIndex* from, QModelIndex* to);
    friend void QPdfBookmarkModel_ChangePersistentIndexList(QPdfBookmarkModel* self, libqt_list /* of QModelIndex* */ from, libqt_list /* of QModelIndex* */ to);
    friend void QPdfBookmarkModel_QBaseChangePersistentIndexList(QPdfBookmarkModel* self, libqt_list /* of QModelIndex* */ from, libqt_list /* of QModelIndex* */ to);
    ...
    friend bool QPdfBookmarkModel_IsSignalConnected(const QPdfBookmarkModel* self, QMetaMethod* signal);
    friend bool QPdfBookmarkModel_QBaseIsSignalConnected(const QPdfBookmarkModel* self, QMetaMethod* signal);
};
