...
class VirtualQPdfView final : public QPdfView {
  ...
  public:
    ...
    friend bool QPdfView_NativeEvent(QPdfView* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QPdfView_QBaseNativeEvent(QPdfView* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QPdfView_ConnectNotify(QPdfView* self, QMetaMethod* signal);
    friend void QPdfView_QBaseConnectNotify(QPdfView* self, QMetaMethod* signal);
    friend void QPdfView_DisconnectNotify(QPdfView* self, QMetaMethod* signal);
    friend void QPdfView_QBaseDisconnectNotify(QPdfView* self, QMetaMethod* signal);
    ...
    friend bool QPdfView_IsSignalConnected(const QPdfView* self, QMetaMethod* signal);
    friend bool QPdfView_QBaseIsSignalConnected(const QPdfView* self, QMetaMethod* signal);
};
