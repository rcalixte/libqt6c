...
void q_pdfpageselector_set_focus2(void* self, int64_t reason) {
...
void q_pdfpageselector_kill_timer2(void* self, int64_t id) {
...
int32_t q_pdfpageselector_start_timer22(void* self, int interval, int64_t timerType) {
