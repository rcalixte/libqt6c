...
bool q_pdfpagerenderer_disconnect_with_q_meta_object_connection(void* param1);
...
int32_t q_pdfpagerenderer_start_timer2(void* self, int interval, int64_t timerType);
