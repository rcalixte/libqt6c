...
void q_pdfpagerenderer_on_metacall(void* self, int32_t (*callback)(void*, int64_t, int, void*)) {
...
void q_pdfpagerenderer_on_render_mode_changed(void* self, void (*callback)(void*, int64_t)) {
