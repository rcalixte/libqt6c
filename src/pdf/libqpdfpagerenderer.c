...
const QMetaObject* q_pdfpagerenderer_super_meta_object(void* self) {
    return QPdfPageRenderer_SuperMetaObject((QPdfPageRenderer*)self);
}
...
void q_pdfpagerenderer_on_metacast(void* self, void* (*callback)(void*, const char*)) {
    QPdfPageRenderer_OnMetacast((QPdfPageRenderer*)self, (intptr_t)callback);
}

void* q_pdfpagerenderer_super_metacast(void* self, const char* param1) {
    return QPdfPageRenderer_SuperMetacast((QPdfPageRenderer*)self, param1);
}
...
void q_pdfpagerenderer_on_metacall(void* self, int32_t (*callback)(void*, int32_t, int, void*)) {
    QPdfPageRenderer_OnMetacall((QPdfPageRenderer*)self, (intptr_t)callback);
}

int32_t q_pdfpagerenderer_super_metacall(void* self, int32_t param1, int param2, void* param3) {
    return QPdfPageRenderer_SuperMetacall((QPdfPageRenderer*)self, param1, param2, param3);
}
...
void q_pdfpagerenderer_on_document_changed(void* self, void (*callback)(void*, void*)) {
    QPdfPageRenderer_Connect_DocumentChanged((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
void q_pdfpagerenderer_on_render_mode_changed(void* self, void (*callback)(void*, int32_t)) {
    QPdfPageRenderer_Connect_RenderModeChanged((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
void q_pdfpagerenderer_on_page_rendered(void* self, void (*callback)(void*, int, void*, void*, void*, uint64_t)) {
    QPdfPageRenderer_Connect_PageRendered((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
void q_pdfpagerenderer_set_object_name(void* self, const char* name) {
...
int32_t q_pdfpagerenderer_start_timer2(void* self, int64_t time) {
...
QMetaObject__Connection* q_pdfpagerenderer_connect(void* sender, const char* signal, void* receiver, const char* member) {
    return QObject_Connect((QObject*)sender, signal, (QObject*)receiver, member);
}

QMetaObject__Connection* q_pdfpagerenderer_connect2(void* sender, void* signal, void* receiver, void* method) {
    return QObject_Connect2((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method);
}

QMetaObject__Connection* q_pdfpagerenderer_connect3(void* self, void* sender, const char* signal, const char* member) {
    return QObject_Connect3((QObject*)self, (QObject*)sender, signal, member);
}

bool q_pdfpagerenderer_disconnect(void* sender, const char* signal, void* receiver, const char* member) {
    return QObject_Disconnect((QObject*)sender, signal, (QObject*)receiver, member);
}

bool q_pdfpagerenderer_disconnect2(void* sender, void* signal, void* receiver, void* member) {
    return QObject_Disconnect2((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)member);
}

bool q_pdfpagerenderer_disconnect3(void* self) {
    return QObject_Disconnect3((QObject*)self);
}

bool q_pdfpagerenderer_disconnect4(void* self, void* receiver) {
    return QObject_Disconnect4((QObject*)self, (QObject*)receiver);
}

bool q_pdfpagerenderer_disconnect5(void* param1) {
...
const char** q_pdfpagerenderer_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_pdfpagerenderer_dynamic_property_names\n");
        abort();
    }
...
int32_t q_pdfpagerenderer_start_timer23(void* self, int64_t time, int32_t timerType) {
    return QObject_StartTimer23((QObject*)self, time, timerType);
}

QMetaObject__Connection* q_pdfpagerenderer_connect5(void* sender, const char* signal, void* receiver, const char* member, int32_t param5) {
    return QObject_Connect5((QObject*)sender, signal, (QObject*)receiver, member, param5);
}

QMetaObject__Connection* q_pdfpagerenderer_connect52(void* sender, void* signal, void* receiver, void* method, int32_t type) {
...
bool q_pdfpagerenderer_disconnect1(void* self, const char* signal) {
    return QObject_Disconnect1((QObject*)self, signal);
}

bool q_pdfpagerenderer_disconnect22(void* self, const char* signal, void* receiver) {
    return QObject_Disconnect22((QObject*)self, signal, (QObject*)receiver);
}

bool q_pdfpagerenderer_disconnect32(void* self, const char* signal, void* receiver, const char* member) {
    return QObject_Disconnect32((QObject*)self, signal, (QObject*)receiver, member);
}

bool q_pdfpagerenderer_disconnect23(void* self, void* receiver, const char* member) {
...
bool q_pdfpagerenderer_super_event(void* self, void* event) {
    return QPdfPageRenderer_SuperEvent((QPdfPageRenderer*)self, (QEvent*)event);
}

void q_pdfpagerenderer_on_event(void* self, bool (*callback)(void*, void*)) {
    QPdfPageRenderer_OnEvent((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
bool q_pdfpagerenderer_super_event_filter(void* self, void* watched, void* event) {
    return QPdfPageRenderer_SuperEventFilter((QPdfPageRenderer*)self, (QObject*)watched, (QEvent*)event);
}

void q_pdfpagerenderer_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    QPdfPageRenderer_OnEventFilter((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
void q_pdfpagerenderer_super_timer_event(void* self, void* event) {
    QPdfPageRenderer_SuperTimerEvent((QPdfPageRenderer*)self, (QTimerEvent*)event);
}

void q_pdfpagerenderer_on_timer_event(void* self, void (*callback)(void*, void*)) {
    QPdfPageRenderer_OnTimerEvent((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
void q_pdfpagerenderer_super_child_event(void* self, void* event) {
    QPdfPageRenderer_SuperChildEvent((QPdfPageRenderer*)self, (QChildEvent*)event);
}

void q_pdfpagerenderer_on_child_event(void* self, void (*callback)(void*, void*)) {
    QPdfPageRenderer_OnChildEvent((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
void q_pdfpagerenderer_super_custom_event(void* self, void* event) {
    QPdfPageRenderer_SuperCustomEvent((QPdfPageRenderer*)self, (QEvent*)event);
}

void q_pdfpagerenderer_on_custom_event(void* self, void (*callback)(void*, void*)) {
    QPdfPageRenderer_OnCustomEvent((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
void q_pdfpagerenderer_super_connect_notify(void* self, void* signal) {
    QPdfPageRenderer_SuperConnectNotify((QPdfPageRenderer*)self, (QMetaMethod*)signal);
}

void q_pdfpagerenderer_on_connect_notify(void* self, void (*callback)(void*, void*)) {
    QPdfPageRenderer_OnConnectNotify((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
void q_pdfpagerenderer_super_disconnect_notify(void* self, void* signal) {
    QPdfPageRenderer_SuperDisconnectNotify((QPdfPageRenderer*)self, (QMetaMethod*)signal);
}

void q_pdfpagerenderer_on_disconnect_notify(void* self, void (*callback)(void*, void*)) {
    QPdfPageRenderer_OnDisconnectNotify((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
QObject* q_pdfpagerenderer_super_sender(void* self) {
    return QPdfPageRenderer_SuperSender((QPdfPageRenderer*)self);
}

void q_pdfpagerenderer_on_sender(void* self, QObject* (*callback)()) {
    QPdfPageRenderer_OnSender((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
int32_t q_pdfpagerenderer_super_sender_signal_index(void* self) {
    return QPdfPageRenderer_SuperSenderSignalIndex((QPdfPageRenderer*)self);
}

void q_pdfpagerenderer_on_sender_signal_index(void* self, int32_t (*callback)()) {
    QPdfPageRenderer_OnSenderSignalIndex((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
int32_t q_pdfpagerenderer_super_receivers(void* self, const char* signal) {
    return QPdfPageRenderer_SuperReceivers((QPdfPageRenderer*)self, signal);
}

void q_pdfpagerenderer_on_receivers(void* self, int32_t (*callback)(void*, const char*)) {
    QPdfPageRenderer_OnReceivers((QPdfPageRenderer*)self, (intptr_t)callback);
}
...
bool q_pdfpagerenderer_super_is_signal_connected(void* self, void* signal) {
    return QPdfPageRenderer_SuperIsSignalConnected((QPdfPageRenderer*)self, (QMetaMethod*)signal);
}

void q_pdfpagerenderer_on_is_signal_connected(void* self, bool (*callback)(void*, void*)) {
    QPdfPageRenderer_OnIsSignalConnected((QPdfPageRenderer*)self, (intptr_t)callback);
}
