...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
///
/// ``` QTextList* self, enum Qt__TimerId id ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QTextList* self, void (*slot)(QTextList*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
///
/// ``` QTextList* self, QThread* thread, Disambiguated_t* param2 ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QTextList* self, void (*slot)(QTextList*, QObject*) ```
...
///
/// ``` QTextList* self, void (*slot)(QTextList*, const char*) ```
