...
bool q_maskgenerator_seed(void* self) {
    return QMaskGenerator_Seed((QMaskGenerator*)self);
}
...
uint32_t q_maskgenerator_next_mask(void* self) {
    return QMaskGenerator_NextMask((QMaskGenerator*)self);
}
...
libqt_list /* of QObject* */ q_maskgenerator_children(void* self) {
...
const char** q_maskgenerator_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_maskgenerator_dynamic_property_names\n");
        abort();
    }
...
void q_maskgenerator_on_metacast(void* self, void* (*callback)(void*, const char*)) {
    QMaskGenerator_OnMetacast((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_metacall(void* self, int32_t (*callback)(void*, int32_t, int, void*)) {
    QMaskGenerator_OnMetacall((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_event(void* self, bool (*callback)(void*, void*)) {
    QMaskGenerator_OnEvent((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    QMaskGenerator_OnEventFilter((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_timer_event(void* self, void (*callback)(void*, void*)) {
    QMaskGenerator_OnTimerEvent((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_child_event(void* self, void (*callback)(void*, void*)) {
    QMaskGenerator_OnChildEvent((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_custom_event(void* self, void (*callback)(void*, void*)) {
    QMaskGenerator_OnCustomEvent((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_connect_notify(void* self, void (*callback)(void*, void*)) {
    QMaskGenerator_OnConnectNotify((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_disconnect_notify(void* self, void (*callback)(void*, void*)) {
    QMaskGenerator_OnDisconnectNotify((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_sender(void* self, QObject* (*callback)()) {
    QMaskGenerator_OnSender((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_sender_signal_index(void* self, int32_t (*callback)()) {
    QMaskGenerator_OnSenderSignalIndex((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_receivers(void* self, int32_t (*callback)(void*, const char*)) {
    QMaskGenerator_OnReceivers((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_on_is_signal_connected(void* self, bool (*callback)(void*, void*)) {
    QMaskGenerator_OnIsSignalConnected((QMaskGenerator*)self, (intptr_t)callback);
}
...
void q_maskgenerator_delete(void* self) {
    QMaskGenerator_Delete((QMaskGenerator*)(self));
}
