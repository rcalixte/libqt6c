...
class VirtualQGraphicsView final : public QGraphicsView {
  ...
  public:
    ...
    friend void QGraphicsView_DrawBackground(QGraphicsView* self, QPainter* painter, QRectF* rect);
    friend void QGraphicsView_QBaseDrawBackground(QGraphicsView* self, QPainter* painter, QRectF* rect);
    friend void QGraphicsView_DrawForeground(QGraphicsView* self, QPainter* painter, QRectF* rect);
    friend void QGraphicsView_QBaseDrawForeground(QGraphicsView* self, QPainter* painter, QRectF* rect);
    ...
    friend bool QGraphicsView_NativeEvent(QGraphicsView* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QGraphicsView_QBaseNativeEvent(QGraphicsView* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QGraphicsView_ConnectNotify(QGraphicsView* self, QMetaMethod* signal);
    friend void QGraphicsView_QBaseConnectNotify(QGraphicsView* self, QMetaMethod* signal);
    friend void QGraphicsView_DisconnectNotify(QGraphicsView* self, QMetaMethod* signal);
    friend void QGraphicsView_QBaseDisconnectNotify(QGraphicsView* self, QMetaMethod* signal);
    ...
    friend bool QGraphicsView_IsSignalConnected(const QGraphicsView* self, QMetaMethod* signal);
    friend bool QGraphicsView_QBaseIsSignalConnected(const QGraphicsView* self, QMetaMethod* signal);
};
