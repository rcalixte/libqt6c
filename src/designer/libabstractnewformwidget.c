...
void q_designernewformwidgetinterface_add_actions(void* self, libqt_list /* of QAction* */ actions) {
    QWidget_AddActions((QWidget*)self, actions);
}

void q_designernewformwidgetinterface_insert_actions(void* self, void* before, libqt_list /* of QAction* */ actions) {
...
bool q_designernewformwidgetinterface_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_designernewformwidgetinterface_as_q_paint_device(self));
}

int32_t q_designernewformwidgetinterface_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_designernewformwidgetinterface_as_q_paint_device(self));
}

int32_t q_designernewformwidgetinterface_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_designernewformwidgetinterface_as_q_paint_device(self));
}

int32_t q_designernewformwidgetinterface_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_designernewformwidgetinterface_as_q_paint_device(self));
}

int32_t q_designernewformwidgetinterface_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_designernewformwidgetinterface_as_q_paint_device(self));
}

int32_t q_designernewformwidgetinterface_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_designernewformwidgetinterface_as_q_paint_device(self));
}

int32_t q_designernewformwidgetinterface_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_designernewformwidgetinterface_as_q_paint_device(self));
}

double q_designernewformwidgetinterface_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_designernewformwidgetinterface_as_q_paint_device(self));
}

double q_designernewformwidgetinterface_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_designernewformwidgetinterface_as_q_paint_device(self));
}

int32_t q_designernewformwidgetinterface_color_count(void* self) {
    return QPaintDevice_ColorCount(q_designernewformwidgetinterface_as_q_paint_device(self));
}

int32_t q_designernewformwidgetinterface_depth(void* self) {
    return QPaintDevice_Depth(q_designernewformwidgetinterface_as_q_paint_device(self));
}
