  ...
  public:
    ...
    virtual void setToolTip(const QString& toolTip) override {
        if (qdesignerwidgetdatabaseiteminterface_settooltip_callback != nullptr) {
            ...
            char* toolTip_str = static_cast<char*>(malloc(toolTip_str_len + 1));
            memcpy(toolTip_str, toolTip_b.data(), toolTip_str_len);
            toolTip_str[toolTip_str_len] = '\0';
    ...
    virtual void setWhatsThis(const QString& whatsThis) override {
        if (qdesignerwidgetdatabaseiteminterface_setwhatsthis_callback != nullptr) {
            ...
            char* whatsThis_str = static_cast<char*>(malloc(whatsThis_str_len + 1));
            memcpy(whatsThis_str, whatsThis_b.data(), whatsThis_str_len);
            whatsThis_str[whatsThis_str_len] = '\0';
    ...
    virtual void setIncludeFile(const QString& includeFile) override {
        if (qdesignerwidgetdatabaseiteminterface_setincludefile_callback != nullptr) {
            ...
            char* includeFile_str = static_cast<char*>(malloc(includeFile_str_len + 1));
            memcpy(includeFile_str, includeFile_b.data(), includeFile_str_len);
            includeFile_str[includeFile_str_len] = '\0';
    ...
    virtual QList<QVariant> defaultPropertyValues() const override {
        if (qdesignerwidgetdatabaseiteminterface_defaultpropertyvalues_callback != nullptr) {
            ...
            QVariant** callback_ret_arr = static_cast<QVariant**>(callback_ret.data.ptr);
