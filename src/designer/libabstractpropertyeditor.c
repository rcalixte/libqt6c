...
QWidget* q_designerpropertyeditorinterface_find(uintptr_t param1) {
...
bool q_designerpropertyeditorinterface_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

int32_t q_designerpropertyeditorinterface_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

int32_t q_designerpropertyeditorinterface_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

int32_t q_designerpropertyeditorinterface_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

int32_t q_designerpropertyeditorinterface_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

int32_t q_designerpropertyeditorinterface_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

int32_t q_designerpropertyeditorinterface_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

double q_designerpropertyeditorinterface_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

double q_designerpropertyeditorinterface_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

int32_t q_designerpropertyeditorinterface_color_count(void* self) {
    return QPaintDevice_ColorCount(q_designerpropertyeditorinterface_as_q_paint_device(self));
}

int32_t q_designerpropertyeditorinterface_depth(void* self) {
    return QPaintDevice_Depth(q_designerpropertyeditorinterface_as_q_paint_device(self));
}
