  ...
  public:
    ...
    virtual void setFileName(const QString& file_name) override {
        if (qdesignerwidgetboxinterface_setfilename_callback != nullptr) {
            ...
            char* file_name_str = static_cast<char*>(malloc(file_name_str_len + 1));
            memcpy(file_name_str, file_name_b.data(), file_name_str_len);
            file_name_str[file_name_str_len] = '\0';
