...
const char** q_designermetadatabaseinterface_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_designermetadatabaseinterface_dynamic_property_names");
        abort();
    }
...
bool q_designermetadatabaseinterface_move_to_thread2(void* self, void* thread, void* param2) {
