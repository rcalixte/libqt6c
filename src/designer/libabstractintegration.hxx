  ...
  public:
    ...
    virtual void setHeaderSuffix(const QString& headerSuffix) override {
        if (qdesignerintegrationinterface_setheadersuffix_callback != nullptr) {
            ...
            char* headerSuffix_str = static_cast<char*>(malloc(headerSuffix_str_len + 1));
            memcpy(headerSuffix_str, headerSuffix_b.data(), headerSuffix_str_len);
            headerSuffix_str[headerSuffix_str_len] = '\0';
