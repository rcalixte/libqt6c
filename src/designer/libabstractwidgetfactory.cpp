...
QLayout* QDesignerWidgetFactoryInterface_CreateLayout(const QDesignerWidgetFactoryInterface* self, QWidget* widget, QLayout* layout, int type) {
    auto* vqdesignerwidgetfactoryinterface = dynamic_cast<const VirtualQDesignerWidgetFactoryInterface*>(self);
    if (vqdesignerwidgetfactoryinterface && vqdesignerwidgetfactoryinterface->isVirtualQDesignerWidgetFactoryInterface) {
        return vqdesignerwidgetfactoryinterface->createLayout(widget, layout, static_cast<int>(type));
    } else {
        return ((VirtualQDesignerWidgetFactoryInterface*)self)->createLayout(widget, layout, static_cast<int>(type));
    }
}
