#pragma once
#ifndef SRC_DESIGNERC_LIBABSTRACTWIDGETFACTORY_HPP
#define SRC_DESIGNERC_LIBABSTRACTWIDGETFACTORY_HPP
...
QLayout* QDesignerWidgetFactoryInterface_QBaseCreateLayout(const QDesignerWidgetFactoryInterface* self, QWidget* widget, QLayout* layout, int type);
