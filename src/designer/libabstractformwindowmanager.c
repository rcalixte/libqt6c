...
QMetaObject__Connection* q_designerformwindowmanagerinterface_connect(void* sender, void* signal, void* receiver, void* method) {
    return QObject_Connect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method);
}

QMetaObject__Connection* q_designerformwindowmanagerinterface_connect2(void* self, void* sender, const char* signal, const char* member) {
    return QObject_Connect2((QObject*)self, (QObject*)sender, signal, member);
}

bool q_designerformwindowmanagerinterface_disconnect(void* sender, void* signal, void* receiver, void* member) {
    return QObject_Disconnect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)member);
}

bool q_designerformwindowmanagerinterface_disconnect2(void* param1) {
...
const char** q_designerformwindowmanagerinterface_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_designerformwindowmanagerinterface_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* q_designerformwindowmanagerinterface_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type) {
