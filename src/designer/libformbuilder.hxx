  ...
  public:
    ...
    virtual QWidget* createWidget(const QString& widgetName, QWidget* parentWidget, const QString& name) override {
        if (qformbuilder_createwidget_isbase) {
            ...
            char* widgetName_str = static_cast<char*>(malloc(widgetName_str_len + 1));
            memcpy(widgetName_str, widgetName_b.data(), widgetName_str_len);
            widgetName_str[widgetName_str_len] = '\0';
    ...
    virtual QLayout* createLayout(const QString& layoutName, QObject* parent, const QString& name) override {
        if (qformbuilder_createlayout_isbase) {
            ...
            char* layoutName_str = static_cast<char*>(malloc(layoutName_str_len + 1));
            memcpy(layoutName_str, layoutName_b.data(), layoutName_str_len);
            layoutName_str[layoutName_str_len] = '\0';
    ...
    virtual bool checkProperty(QObject* obj, const QString& prop) const override {
        if (qformbuilder_checkproperty_isbase) {
            ...
            char* prop_str = static_cast<char*>(malloc(prop_str_len + 1));
            memcpy(prop_str, prop_b.data(), prop_str_len);
            prop_str[prop_str_len] = '\0';
