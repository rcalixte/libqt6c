...
bool q_pushbutton_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_pushbutton_as_q_paint_device(self));
}

int32_t q_pushbutton_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_pushbutton_as_q_paint_device(self));
}

int32_t q_pushbutton_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_pushbutton_as_q_paint_device(self));
}

int32_t q_pushbutton_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_pushbutton_as_q_paint_device(self));
}

int32_t q_pushbutton_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_pushbutton_as_q_paint_device(self));
}

int32_t q_pushbutton_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_pushbutton_as_q_paint_device(self));
}

int32_t q_pushbutton_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_pushbutton_as_q_paint_device(self));
}

double q_pushbutton_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_pushbutton_as_q_paint_device(self));
}

double q_pushbutton_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_pushbutton_as_q_paint_device(self));
}

int32_t q_pushbutton_color_count(void* self) {
    return QPaintDevice_ColorCount(q_pushbutton_as_q_paint_device(self));
}

int32_t q_pushbutton_depth(void* self) {
    return QPaintDevice_Depth(q_pushbutton_as_q_paint_device(self));
}
