...
void q_statusbar_grab_gesture(void* self, int32_t type) {
    QWidget_GrabGesture((QWidget*)self, type);
}

void q_statusbar_ungrab_gesture(void* self, int32_t type) {
...
void q_statusbar_set_parent2(void* self, void* parent, int32_t f) {
...
void q_statusbar_set_window_flags(void* self, int32_t type) {
...
void q_statusbar_set_window_flag(void* self, int32_t param1) {
    QWidget_SetWindowFlag((QWidget*)self, param1);
}

void q_statusbar_override_window_flags(void* self, int32_t type) {
...
QWidget* q_statusbar_find(uintptr_t param1) {
...
void q_statusbar_set_input_method_hints(void* self, int32_t hints) {
...
void q_statusbar_grab_gesture2(void* self, int32_t type, int32_t flags) {
...
void q_statusbar_set_window_flag2(void* self, int32_t param1, bool on) {
...
QWidget* q_statusbar_create_window_container3(void* window, void* parent, int32_t flags) {
...
int32_t q_statusbar_start_timer2(void* self, int64_t time) {
...
const char** q_statusbar_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_statusbar_dynamic_property_names\n");
        abort();
    }
...
int32_t q_statusbar_start_timer23(void* self, int64_t time, int32_t timerType) {
...
bool q_statusbar_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_statusbar_as_q_paint_device(self));
}

int32_t q_statusbar_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_statusbar_as_q_paint_device(self));
}

int32_t q_statusbar_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_statusbar_as_q_paint_device(self));
}

int32_t q_statusbar_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_statusbar_as_q_paint_device(self));
}

int32_t q_statusbar_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_statusbar_as_q_paint_device(self));
}

int32_t q_statusbar_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_statusbar_as_q_paint_device(self));
}

int32_t q_statusbar_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_statusbar_as_q_paint_device(self));
}

double q_statusbar_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_statusbar_as_q_paint_device(self));
}

double q_statusbar_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_statusbar_as_q_paint_device(self));
}

int32_t q_statusbar_color_count(void* self) {
    return QPaintDevice_ColorCount(q_statusbar_as_q_paint_device(self));
}

int32_t q_statusbar_depth(void* self) {
    return QPaintDevice_Depth(q_statusbar_as_q_paint_device(self));
}
