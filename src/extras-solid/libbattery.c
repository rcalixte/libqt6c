...
int32_t k_solid__battery_device_interface_type() {
    return Solid__Battery_DeviceInterfaceType();
}

bool k_solid__battery_is_present(void* self) {
    return Solid__Battery_IsPresent((Solid__Battery*)self);
}

int32_t k_solid__battery_type(void* self) {
    return Solid__Battery_Type((Solid__Battery*)self);
}

int32_t k_solid__battery_charge_percent(void* self) {
    return Solid__Battery_ChargePercent((Solid__Battery*)self);
}

int32_t k_solid__battery_capacity(void* self) {
    return Solid__Battery_Capacity((Solid__Battery*)self);
}

int32_t k_solid__battery_cycle_count(void* self) {
    return Solid__Battery_CycleCount((Solid__Battery*)self);
}

bool k_solid__battery_is_rechargeable(void* self) {
    return Solid__Battery_IsRechargeable((Solid__Battery*)self);
}

bool k_solid__battery_is_power_supply(void* self) {
    return Solid__Battery_IsPowerSupply((Solid__Battery*)self);
}

int32_t k_solid__battery_charge_state(void* self) {
    return Solid__Battery_ChargeState((Solid__Battery*)self);
}

long long k_solid__battery_time_to_empty(void* self) {
    return Solid__Battery_TimeToEmpty((Solid__Battery*)self);
}

long long k_solid__battery_time_to_full(void* self) {
    return Solid__Battery_TimeToFull((Solid__Battery*)self);
}

int32_t k_solid__battery_technology(void* self) {
    return Solid__Battery_Technology((Solid__Battery*)self);
}

double k_solid__battery_energy(void* self) {
    return Solid__Battery_Energy((Solid__Battery*)self);
}

double k_solid__battery_energy_full(void* self) {
    return Solid__Battery_EnergyFull((Solid__Battery*)self);
}

double k_solid__battery_energy_full_design(void* self) {
    return Solid__Battery_EnergyFullDesign((Solid__Battery*)self);
}

double k_solid__battery_energy_rate(void* self) {
    return Solid__Battery_EnergyRate((Solid__Battery*)self);
}

double k_solid__battery_voltage(void* self) {
    return Solid__Battery_Voltage((Solid__Battery*)self);
}

double k_solid__battery_temperature(void* self) {
    return Solid__Battery_Temperature((Solid__Battery*)self);
}

const char* k_solid__battery_serial(void* self) {
    libqt_string _str = Solid__Battery_Serial((Solid__Battery*)self);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_solid__battery_charge_state_changed2(void* self, int newState, const char* udi) {
    Solid__Battery_ChargeStateChanged2((Solid__Battery*)self, newState, qstring(udi));
}

void k_solid__battery_on_charge_state_changed2(void* self, void (*callback)(void*, int, const char*)) {
    Solid__Battery_Connect_ChargeStateChanged2((Solid__Battery*)self, (intptr_t)callback);
}
...
int32_t k_solid__battery_start_timer2(void* self, int64_t time) {
...
const char** k_solid__battery_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_solid__battery_dynamic_property_names\n");
        abort();
    }
...
int32_t k_solid__battery_start_timer23(void* self, int64_t time, int32_t timerType) {
...
void k_solid__battery_delete(void* self) {
    Solid__Battery_Delete((Solid__Battery*)(self));
}
