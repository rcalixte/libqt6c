...
const QMetaObject* k_solid__deviceinterface_meta_object(void* self) {
    return Solid__DeviceInterface_MetaObject((Solid__DeviceInterface*)self);
}

void* k_solid__deviceinterface_metacast(void* self, const char* param1) {
    return Solid__DeviceInterface_Metacast((Solid__DeviceInterface*)self, param1);
}

int32_t k_solid__deviceinterface_metacall(void* self, int32_t param1, int param2, void* param3) {
    return Solid__DeviceInterface_Metacall((Solid__DeviceInterface*)self, param1, param2, param3);
}

const char* k_solid__deviceinterface_tr(const char* s) {
    libqt_string _str = Solid__DeviceInterface_Tr(s);
...
const char* k_solid__deviceinterface_tr2(const char* s, const char* c) {
    libqt_string _str = Solid__DeviceInterface_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_solid__deviceinterface_tr3(const char* s, const char* c, int n) {
    libqt_string _str = Solid__DeviceInterface_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_solid__deviceinterface_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_solid__deviceinterface_dynamic_property_names");
        abort();
    }
...
void k_solid__deviceinterface_delete(void* self) {
    Solid__DeviceInterface_Delete((Solid__DeviceInterface*)(self));
}
