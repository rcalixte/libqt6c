...
#include "libportablemediaplayer.hpp"
#include "libportablemediaplayer.h"

const QMetaObject* k_solid__portablemediaplayer_meta_object(void* self) {
    return Solid__PortableMediaPlayer_MetaObject((Solid__PortableMediaPlayer*)self);
}

void* k_solid__portablemediaplayer_metacast(void* self, const char* param1) {
    return Solid__PortableMediaPlayer_Metacast((Solid__PortableMediaPlayer*)self, param1);
}

int32_t k_solid__portablemediaplayer_metacall(void* self, int32_t param1, int param2, void* param3) {
    return Solid__PortableMediaPlayer_Metacall((Solid__PortableMediaPlayer*)self, param1, param2, param3);
}

const char* k_solid__portablemediaplayer_tr(const char* s) {
    libqt_string _str = Solid__PortableMediaPlayer_Tr(s);
...
int32_t k_solid__portablemediaplayer_device_interface_type() {
    return Solid__PortableMediaPlayer_DeviceInterfaceType();
}

const char** k_solid__portablemediaplayer_supported_protocols(void* self) {
    libqt_list _arr = Solid__PortableMediaPlayer_SupportedProtocols((Solid__PortableMediaPlayer*)self);
    const libqt_string* _qstr = (libqt_string*)_arr.data.ptr;
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_solid__portablemediaplayer_supported_protocols");
        abort();
    }
...
const char** k_solid__portablemediaplayer_supported_drivers(void* self) {
    libqt_list _arr = Solid__PortableMediaPlayer_SupportedDrivers((Solid__PortableMediaPlayer*)self);
    const libqt_string* _qstr = (libqt_string*)_arr.data.ptr;
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_solid__portablemediaplayer_supported_drivers");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QVariant* k_solid__portablemediaplayer_driver_handle(void* self, const char* driver) {
    return Solid__PortableMediaPlayer_DriverHandle((Solid__PortableMediaPlayer*)self, qstring(driver));
}

const char* k_solid__portablemediaplayer_tr2(const char* s, const char* c) {
    libqt_string _str = Solid__PortableMediaPlayer_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_solid__portablemediaplayer_tr3(const char* s, const char* c, int n) {
    libqt_string _str = Solid__PortableMediaPlayer_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_solid__portablemediaplayer_supported_drivers1(void* self, const char* protocol) {
    libqt_list _arr = Solid__PortableMediaPlayer_SupportedDrivers1((Solid__PortableMediaPlayer*)self, qstring(protocol));
    const libqt_string* _qstr = (libqt_string*)_arr.data.ptr;
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_solid__portablemediaplayer_supported_drivers1");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char* k_solid__portablemediaplayer_type_to_string(int32_t typeVal) {
...
int32_t k_solid__portablemediaplayer_string_to_type(const char* typeVal) {
    return Solid__DeviceInterface_StringToType(qstring(typeVal));
}

const char* k_solid__portablemediaplayer_type_description(int32_t typeVal) {
...
const char** k_solid__portablemediaplayer_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_solid__portablemediaplayer_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QMetaObject__Connection* k_solid__portablemediaplayer_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_solid__portablemediaplayer_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
void k_solid__portablemediaplayer_delete(void* self) {
    Solid__PortableMediaPlayer_Delete((Solid__PortableMediaPlayer*)(self));
}
