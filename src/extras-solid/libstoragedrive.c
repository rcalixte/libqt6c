...
const QMetaObject* k_solid__storagedrive_meta_object(void* self) {
    return Solid__StorageDrive_MetaObject((Solid__StorageDrive*)self);
}

void* k_solid__storagedrive_metacast(void* self, const char* param1) {
    return Solid__StorageDrive_Metacast((Solid__StorageDrive*)self, param1);
}

int32_t k_solid__storagedrive_metacall(void* self, int32_t param1, int param2, void* param3) {
    return Solid__StorageDrive_Metacall((Solid__StorageDrive*)self, param1, param2, param3);
}

const char* k_solid__storagedrive_tr(const char* s) {
    libqt_string _str = Solid__StorageDrive_Tr(s);
...
int32_t k_solid__storagedrive_device_interface_type() {
    return Solid__StorageDrive_DeviceInterfaceType();
}
...
const char* k_solid__storagedrive_tr2(const char* s, const char* c) {
    libqt_string _str = Solid__StorageDrive_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_solid__storagedrive_tr3(const char* s, const char* c, int n) {
    libqt_string _str = Solid__StorageDrive_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_solid__storagedrive_type_to_string(int32_t typeVal) {
...
int32_t k_solid__storagedrive_string_to_type(const char* typeVal) {
    return Solid__DeviceInterface_StringToType(qstring(typeVal));
}

const char* k_solid__storagedrive_type_description(int32_t typeVal) {
...
const char** k_solid__storagedrive_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_solid__storagedrive_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_solid__storagedrive_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_solid__storagedrive_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
void k_solid__storagedrive_delete(void* self) {
    Solid__StorageDrive_Delete((Solid__StorageDrive*)(self));
}
