...
void Solid__OpticalDrive_EjectDone(Solid__OpticalDrive* self, int error, QVariant* errorData, const libqt_string udi) {
    QString udi_QString = QString::fromUtf8(udi.data, udi.len);
    self->ejectDone(static_cast<Solid::ErrorType>(error), *errorData, udi_QString);
}
...
void Solid__OpticalDrive_Connect_EjectDone(Solid__OpticalDrive* self, intptr_t slot) {
    ...
    Solid::OpticalDrive::connect(self, &Solid::OpticalDrive::ejectDone, [self, slotFunc](Solid::ErrorType error, QVariant errorData, const QString& udi) {
