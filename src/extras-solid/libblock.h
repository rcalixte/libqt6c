#pragma once
#ifndef SRC_EXTRAS_SOLIDQT6C_LIBBLOCK_H
#define SRC_EXTRAS_SOLIDQT6C_LIBBLOCK_H
...
/// [Qt documentation](https://api.kde.org/solid-block.html#deviceInterfaceType)
///
///
/// @return enum Solid__DeviceInterface__Type
int32_t k_solid__block_device_interface_type();

/// [Qt documentation](https://api.kde.org/solid-block.html#deviceMajor)
///
/// @param self Solid__Block*
int32_t k_solid__block_device_major(void* self);

/// [Qt documentation](https://api.kde.org/solid-block.html#deviceMinor)
///
/// @param self Solid__Block*
int32_t k_solid__block_device_minor(void* self);

/// [Qt documentation](https://api.kde.org/solid-block.html#device)
///
/// Caller is responsible for freeing the returned memory
///
/// @param self Solid__Block*
