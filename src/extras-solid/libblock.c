...
int32_t k_solid__block_device_interface_type() {
    return Solid__Block_DeviceInterfaceType();
}

int32_t k_solid__block_device_major(void* self) {
    return Solid__Block_DeviceMajor((Solid__Block*)self);
}

int32_t k_solid__block_device_minor(void* self) {
    return Solid__Block_DeviceMinor((Solid__Block*)self);
}

const char* k_solid__block_device(void* self) {
    libqt_string _str = Solid__Block_Device((Solid__Block*)self);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_solid__block_tr2(const char* s, const char* c) {
    libqt_string _str = Solid__Block_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_solid__block_tr3(const char* s, const char* c, int n) {
    libqt_string _str = Solid__Block_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_solid__block_type_to_string(int32_t typeVal) {
...
int32_t k_solid__block_string_to_type(const char* typeVal) {
    return Solid__DeviceInterface_StringToType(qstring(typeVal));
}

const char* k_solid__block_type_description(int32_t typeVal) {
...
const char** k_solid__block_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_solid__block_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_solid__block_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_solid__block_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
void k_solid__block_delete(void* self) {
    Solid__Block_Delete((Solid__Block*)(self));
}
