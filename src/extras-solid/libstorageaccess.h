#pragma once
#ifndef EXTRAS_SOLID_LIBSTORAGEACCESS_H
#define EXTRAS_SOLID_LIBSTORAGEACCESS_H
...
///
int32_t k_solid__storageaccess_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_solid__storageaccess_start_timer23(void* self, int64_t time, int32_t timerType);
