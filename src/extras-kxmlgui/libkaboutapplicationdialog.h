#pragma once
#ifndef EXTRAS_KXMLGUI_LIBKABOUTAPPLICATIONDIALOG_H
#define EXTRAS_KXMLGUI_LIBKABOUTAPPLICATIONDIALOG_H
...
///
/// @param self KAboutApplicationDialog*
/// @param callback bool func(KAboutApplicationDialog* self, libqt_string eventType, void* message, intptr_t* result)
///
