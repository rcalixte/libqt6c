...
const char* k_toggletoolbaraction_tr(const char* s) {
    libqt_string _str = KToggleToolBarAction_Tr(s);
...
const char* k_toggletoolbaraction_tr2(const char* s, const char* c) {
    libqt_string _str = KToggleToolBarAction_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_toggletoolbaraction_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KToggleToolBarAction_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_toggletoolbaraction_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_toggletoolbaraction_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_toggletoolbaraction_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_toggletoolbaraction_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
