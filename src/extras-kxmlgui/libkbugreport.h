#pragma once
#ifndef SRC_EXTRAS_KXMLGUI_QT6C_LIBKBUGREPORT_H
#define SRC_EXTRAS_KXMLGUI_QT6C_LIBKBUGREPORT_H
...
///
/// @param self KBugReport*
/// @param callback void* func(KBugReport* self, const char* param1)
///
...
///
/// @param self KBugReport*
/// @param callback bool func(KBugReport* self, libqt_string eventType, void* message, intptr_t* result)
///
