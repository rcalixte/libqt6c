...
void k_shortcutwidget_on_shortcut_changed(void* self, void (*callback)(void*, libqt_list /* of QKeySequence* */)) {
...
bool k_shortcutwidget_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_shortcutwidget_as_q_paint_device(self));
}

int32_t k_shortcutwidget_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_shortcutwidget_as_q_paint_device(self));
}

int32_t k_shortcutwidget_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_shortcutwidget_as_q_paint_device(self));
}

int32_t k_shortcutwidget_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_shortcutwidget_as_q_paint_device(self));
}

int32_t k_shortcutwidget_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_shortcutwidget_as_q_paint_device(self));
}

int32_t k_shortcutwidget_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_shortcutwidget_as_q_paint_device(self));
}

int32_t k_shortcutwidget_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_shortcutwidget_as_q_paint_device(self));
}

double k_shortcutwidget_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_shortcutwidget_as_q_paint_device(self));
}

double k_shortcutwidget_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_shortcutwidget_as_q_paint_device(self));
}

int32_t k_shortcutwidget_color_count(void* self) {
    return QPaintDevice_ColorCount(k_shortcutwidget_as_q_paint_device(self));
}

int32_t k_shortcutwidget_depth(void* self) {
    return QPaintDevice_Depth(k_shortcutwidget_as_q_paint_device(self));
}
