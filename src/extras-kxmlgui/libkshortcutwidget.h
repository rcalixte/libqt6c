#pragma once
#ifndef SRC_EXTRAS_KXMLGUIQT6C_LIBKSHORTCUTWIDGET_H
#define SRC_EXTRAS_KXMLGUIQT6C_LIBKSHORTCUTWIDGET_H
...
void k_shortcutwidget_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KShortcutWidget*
/// @param typeVal enum Qt__GestureType
void k_shortcutwidget_ungrab_gesture(void* self, int64_t typeVal);
...
void k_shortcutwidget_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KShortcutWidget*
/// @param typeVal flag of enum Qt__WindowType
void k_shortcutwidget_override_window_flags(void* self, int64_t typeVal);
...
void k_shortcutwidget_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_shortcutwidget_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_shortcutwidget_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
