#pragma once
#ifndef EXTRAS_KXMLGUI_LIBKACTIONCOLLECTION_H
#define EXTRAS_KXMLGUI_LIBKACTIONCOLLECTION_H
...
///
int32_t k_actioncollection_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_actioncollection_start_timer23(void* self, int64_t time, int32_t timerType);
