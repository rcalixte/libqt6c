...
const char* k_xmlguiclient_find_most_recent_x_m_l_file(const char* files[], const char* doc) {
    ...
    if (files_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_xmlguiclient_find_most_recent_x_m_l_file");
        abort();
    }
...
const char** k_xmlguiclient__statechange_actions_to_enable(void* self) {
    ...
    if (actionsToEnable_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_xmlguiclient__statechange_actions_to_enable");
        abort();
    }
...
void k_xmlguiclient__statechange_set_actions_to_enable(void* self, const char* actionsToEnable[]) {
    ...
    if (actionsToEnable_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_xmlguiclient__statechange_set_actions_to_enable");
        abort();
    }
...
const char** k_xmlguiclient__statechange_actions_to_disable(void* self) {
    ...
    if (actionsToDisable_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_xmlguiclient__statechange_actions_to_disable");
        abort();
    }
...
void k_xmlguiclient__statechange_set_actions_to_disable(void* self, const char* actionsToDisable[]) {
    ...
    if (actionsToDisable_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_xmlguiclient__statechange_set_actions_to_disable");
        abort();
    }
