...
const char* k_aboutapplicationdialog_tr(const char* s) {
    libqt_string _str = KAboutApplicationDialog_Tr(s);
...
const char* k_aboutapplicationdialog_tr2(const char* s, const char* c) {
    libqt_string _str = KAboutApplicationDialog_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_aboutapplicationdialog_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KAboutApplicationDialog_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_aboutapplicationdialog_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_aboutapplicationdialog_ungrab_gesture(void* self, int64_t typeVal) {
...
void k_aboutapplicationdialog_set_window_flags(void* self, int64_t typeVal) {
...
void k_aboutapplicationdialog_override_window_flags(void* self, int64_t typeVal) {
...
void k_aboutapplicationdialog_grab_gesture2(void* self, int64_t typeVal, int32_t flags) {
...
const char** k_aboutapplicationdialog_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_aboutapplicationdialog_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_aboutapplicationdialog_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_aboutapplicationdialog_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
