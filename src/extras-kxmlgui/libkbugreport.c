...
void k_bugreport_grab_gesture(void* self, int32_t type) {
    QWidget_GrabGesture((QWidget*)self, type);
}

void k_bugreport_ungrab_gesture(void* self, int32_t type) {
...
bool k_bugreport_restore_geometry(void* self, char* geometry) {
...
void k_bugreport_set_parent2(void* self, void* parent, int32_t f) {
...
void k_bugreport_add_actions(void* self, libqt_list /* of QAction* */ actions) {
    QWidget_AddActions((QWidget*)self, actions);
}

void k_bugreport_insert_actions(void* self, void* before, libqt_list /* of QAction* */ actions) {
...
void k_bugreport_set_window_flags(void* self, int32_t type) {
...
void k_bugreport_set_window_flag(void* self, int32_t param1) {
    QWidget_SetWindowFlag((QWidget*)self, param1);
}

void k_bugreport_override_window_flags(void* self, int32_t type) {
...
QWidget* k_bugreport_find(uintptr_t param1) {
...
void k_bugreport_set_input_method_hints(void* self, int32_t hints) {
...
void k_bugreport_grab_gesture2(void* self, int32_t type, int32_t flags) {
...
void k_bugreport_set_window_flag2(void* self, int32_t param1, bool on) {
...
QWidget* k_bugreport_create_window_container3(void* window, void* parent, int32_t flags) {
...
void k_bugreport_set_object_name(void* self, const char* name) {
...
int32_t k_bugreport_start_timer2(void* self, int64_t time) {
...
const char** k_bugreport_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_bugreport_dynamic_property_names\n");
        abort();
    }
...
int32_t k_bugreport_start_timer23(void* self, int64_t time, int32_t timerType) {
...
bool k_bugreport_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_bugreport_as_q_paint_device(self));
}

int32_t k_bugreport_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_bugreport_as_q_paint_device(self));
}

int32_t k_bugreport_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_bugreport_as_q_paint_device(self));
}

int32_t k_bugreport_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_bugreport_as_q_paint_device(self));
}

int32_t k_bugreport_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_bugreport_as_q_paint_device(self));
}

int32_t k_bugreport_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_bugreport_as_q_paint_device(self));
}

int32_t k_bugreport_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_bugreport_as_q_paint_device(self));
}

double k_bugreport_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_bugreport_as_q_paint_device(self));
}

double k_bugreport_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_bugreport_as_q_paint_device(self));
}

int32_t k_bugreport_color_count(void* self) {
    return QPaintDevice_ColorCount(k_bugreport_as_q_paint_device(self));
}

int32_t k_bugreport_depth(void* self) {
    return QPaintDevice_Depth(k_bugreport_as_q_paint_device(self));
}
