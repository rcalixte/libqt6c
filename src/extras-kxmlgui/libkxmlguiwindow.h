#pragma once
#ifndef SRC_EXTRAS_KXMLGUIQT6C_LIBKXMLGUIWINDOW_H
#define SRC_EXTRAS_KXMLGUIQT6C_LIBKXMLGUIWINDOW_H
...
void k_xmlguiwindow_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KXmlGuiWindow*
/// @param typeVal enum Qt__GestureType
void k_xmlguiwindow_ungrab_gesture(void* self, int64_t typeVal);
...
void k_xmlguiwindow_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KXmlGuiWindow*
/// @param typeVal flag of enum Qt__WindowType
void k_xmlguiwindow_override_window_flags(void* self, int64_t typeVal);
...
void k_xmlguiwindow_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_xmlguiwindow_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_xmlguiwindow_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
const char* k_xmlguiwindow_find_most_recent_x_m_l_file(const char* files[], const char* doc);
