...
QQmlComponent* QQmlComponent_New7(QQmlEngine* engine, const char* uri, const char* typeName) {
    return new VirtualQQmlComponent(engine, QAnyStringView(uri), QAnyStringView(typeName));
}

QQmlComponent* QQmlComponent_New8(QQmlEngine* engine, const char* uri, const char* typeName, int mode) {
    return new VirtualQQmlComponent(engine, QAnyStringView(uri), QAnyStringView(typeName), static_cast<QQmlComponent::CompilationMode>(mode));
}
...
QQmlComponent* QQmlComponent_New15(QQmlEngine* engine, const char* uri, const char* typeName, QObject* parent) {
    return new VirtualQQmlComponent(engine, QAnyStringView(uri), QAnyStringView(typeName), parent);
}

QQmlComponent* QQmlComponent_New16(QQmlEngine* engine, const char* uri, const char* typeName, int mode, QObject* parent) {
    return new VirtualQQmlComponent(engine, QAnyStringView(uri), QAnyStringView(typeName), static_cast<QQmlComponent::CompilationMode>(mode), parent);
}
...
void QQmlComponent_LoadFromModule(QQmlComponent* self, const char* uri, const char* typeName) {
    self->loadFromModule(QAnyStringView(uri), QAnyStringView(typeName));
}
...
void QQmlComponent_LoadFromModule3(QQmlComponent* self, const char* uri, const char* typeName, int mode) {
    self->loadFromModule(QAnyStringView(uri), QAnyStringView(typeName), static_cast<QQmlComponent::CompilationMode>(mode));
}
