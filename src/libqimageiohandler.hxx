...
class VirtualQImageIOPlugin final : public QImageIOPlugin {
  ...
  public:
    ...
    friend void QImageIOPlugin_ConnectNotify(QImageIOPlugin* self, QMetaMethod* signal);
    friend void QImageIOPlugin_QBaseConnectNotify(QImageIOPlugin* self, QMetaMethod* signal);
    friend void QImageIOPlugin_DisconnectNotify(QImageIOPlugin* self, QMetaMethod* signal);
    friend void QImageIOPlugin_QBaseDisconnectNotify(QImageIOPlugin* self, QMetaMethod* signal);
    ...
    friend bool QImageIOPlugin_IsSignalConnected(const QImageIOPlugin* self, QMetaMethod* signal);
    friend bool QImageIOPlugin_QBaseIsSignalConnected(const QImageIOPlugin* self, QMetaMethod* signal);
};
