...
void QOpenGLFunctions_4_2_Compatibility_GlGetTexImage(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, int32_t level, uint32_t format, uint32_t type, void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlReadPixels(QOpenGLFunctions_4_2_Compatibility* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlTexImage2D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlTexImage1D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlTexSubImage2D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlTexSubImage1D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, int32_t level, int32_t xoffset, int32_t width, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawElements(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, int32_t count, uint32_t type, const void* indices) {
...
void QOpenGLFunctions_4_2_Compatibility_GlTexSubImage3D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlTexImage3D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t depth, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawRangeElements(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMultiDrawElements(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, const int32_t* count, uint32_t type, const void** indices, int32_t drawcount) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribPointer(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, int32_t size, uint32_t type, unsigned char normalized, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlShaderSource(QOpenGLFunctions_4_2_Compatibility* self, uint32_t shader, int32_t count, const char** stringVal, const int32_t* length) {
...
int32_t QOpenGLFunctions_4_2_Compatibility_GlGetUniformLocation(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, const char* name) {
    return self->glGetUniformLocation(static_cast<GLuint>(program), static_cast<const GLchar*>(name));
}

void QOpenGLFunctions_4_2_Compatibility_GlGetShaderSource(QOpenGLFunctions_4_2_Compatibility* self, uint32_t shader, int32_t bufSize, int32_t* length, char* source) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetShaderInfoLog(QOpenGLFunctions_4_2_Compatibility* self, uint32_t shader, int32_t bufSize, int32_t* length, char* infoLog) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetProgramInfoLog(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, int32_t bufSize, int32_t* length, char* infoLog) {
...
int32_t QOpenGLFunctions_4_2_Compatibility_GlGetAttribLocation(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, const char* name) {
...
uint32_t QOpenGLFunctions_4_2_Compatibility_GlCreateShader(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type) {
...
void QOpenGLFunctions_4_2_Compatibility_GlBindAttribLocation(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t index, const char* name) {
...
int32_t QOpenGLFunctions_4_2_Compatibility_GlGetFragDataLocation(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, const char* name) {
    return self->glGetFragDataLocation(static_cast<GLuint>(program), static_cast<const GLchar*>(name));
}

void QOpenGLFunctions_4_2_Compatibility_GlBindFragDataLocation(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t color, const char* name) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribIPointer(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlTransformFeedbackVaryings(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetActiveUniformBlockName(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t uniformBlockIndex, int32_t bufSize, int32_t* length, char* uniformBlockName) {
...
uint32_t QOpenGLFunctions_4_2_Compatibility_GlGetUniformBlockIndex(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, const char* uniformBlockName) {
    return self->glGetUniformBlockIndex(static_cast<GLuint>(program), static_cast<const GLchar*>(uniformBlockName));
}

void QOpenGLFunctions_4_2_Compatibility_GlGetActiveUniformName(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t uniformIndex, int32_t bufSize, int32_t* length, char* uniformName) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetUniformIndices(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawElementsInstanced(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMultiDrawElementsBaseVertex(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, const int32_t* count, uint32_t type, const void** indices, int32_t drawcount, const int32_t* basevertex) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawElementsInstancedBaseVertex(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, int32_t basevertex) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawRangeElementsBaseVertex(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices, int32_t basevertex) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawElementsBaseVertex(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t basevertex) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribP4uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribP4ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribP3uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribP3ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribP2uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribP2ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribP1uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribP1ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value) {
...
void QOpenGLFunctions_4_2_Compatibility_GlSecondaryColorP3uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* color) {
    self->glSecondaryColorP3uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(color));
}

void QOpenGLFunctions_4_2_Compatibility_GlSecondaryColorP3ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t color) {
    self->glSecondaryColorP3ui(static_cast<GLenum>(type), static_cast<GLuint>(color));
}

void QOpenGLFunctions_4_2_Compatibility_GlColorP4uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* color) {
    self->glColorP4uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(color));
}

void QOpenGLFunctions_4_2_Compatibility_GlColorP4ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t color) {
    self->glColorP4ui(static_cast<GLenum>(type), static_cast<GLuint>(color));
}

void QOpenGLFunctions_4_2_Compatibility_GlColorP3uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* color) {
    self->glColorP3uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(color));
}

void QOpenGLFunctions_4_2_Compatibility_GlColorP3ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t color) {
    self->glColorP3ui(static_cast<GLenum>(type), static_cast<GLuint>(color));
}

void QOpenGLFunctions_4_2_Compatibility_GlNormalP3uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* coords) {
    self->glNormalP3uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlNormalP3ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t coords) {
    self->glNormalP3ui(static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlMultiTexCoordP4uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t texture, uint32_t type, const uint32_t* coords) {
    self->glMultiTexCoordP4uiv(static_cast<GLenum>(texture), static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlMultiTexCoordP4ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t texture, uint32_t type, uint32_t coords) {
    self->glMultiTexCoordP4ui(static_cast<GLenum>(texture), static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlMultiTexCoordP3uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t texture, uint32_t type, const uint32_t* coords) {
    self->glMultiTexCoordP3uiv(static_cast<GLenum>(texture), static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlMultiTexCoordP3ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t texture, uint32_t type, uint32_t coords) {
    self->glMultiTexCoordP3ui(static_cast<GLenum>(texture), static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlMultiTexCoordP2uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t texture, uint32_t type, const uint32_t* coords) {
    self->glMultiTexCoordP2uiv(static_cast<GLenum>(texture), static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlMultiTexCoordP2ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t texture, uint32_t type, uint32_t coords) {
    self->glMultiTexCoordP2ui(static_cast<GLenum>(texture), static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlMultiTexCoordP1uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t texture, uint32_t type, const uint32_t* coords) {
    self->glMultiTexCoordP1uiv(static_cast<GLenum>(texture), static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlMultiTexCoordP1ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t texture, uint32_t type, uint32_t coords) {
    self->glMultiTexCoordP1ui(static_cast<GLenum>(texture), static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordP4uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* coords) {
    self->glTexCoordP4uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordP4ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t coords) {
    self->glTexCoordP4ui(static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordP3uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* coords) {
    self->glTexCoordP3uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordP3ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t coords) {
    self->glTexCoordP3ui(static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordP2uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* coords) {
    self->glTexCoordP2uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordP2ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t coords) {
    self->glTexCoordP2ui(static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordP1uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* coords) {
    self->glTexCoordP1uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordP1ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t coords) {
    self->glTexCoordP1ui(static_cast<GLenum>(type), static_cast<GLuint>(coords));
}

void QOpenGLFunctions_4_2_Compatibility_GlVertexP4uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* value) {
    self->glVertexP4uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(value));
}

void QOpenGLFunctions_4_2_Compatibility_GlVertexP4ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t value) {
    self->glVertexP4ui(static_cast<GLenum>(type), static_cast<GLuint>(value));
}

void QOpenGLFunctions_4_2_Compatibility_GlVertexP3uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* value) {
    self->glVertexP3uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(value));
}

void QOpenGLFunctions_4_2_Compatibility_GlVertexP3ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t value) {
    self->glVertexP3ui(static_cast<GLenum>(type), static_cast<GLuint>(value));
}

void QOpenGLFunctions_4_2_Compatibility_GlVertexP2uiv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, const uint32_t* value) {
    self->glVertexP2uiv(static_cast<GLenum>(type), static_cast<const GLuint*>(value));
}

void QOpenGLFunctions_4_2_Compatibility_GlVertexP2ui(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, uint32_t value) {
...
int32_t QOpenGLFunctions_4_2_Compatibility_GlGetFragDataIndex(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, const char* name) {
    return self->glGetFragDataIndex(static_cast<GLuint>(program), static_cast<const GLchar*>(name));
}

void QOpenGLFunctions_4_2_Compatibility_GlBindFragDataLocationIndexed(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t colorNumber, uint32_t index, const char* name) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetActiveSubroutineName(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t shadertype, uint32_t index, int32_t bufsize, int32_t* length, char* name) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetActiveSubroutineUniformName(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t shadertype, uint32_t index, int32_t bufsize, int32_t* length, char* name) {
...
uint32_t QOpenGLFunctions_4_2_Compatibility_GlGetSubroutineIndex(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t shadertype, const char* name) {
    return self->glGetSubroutineIndex(static_cast<GLuint>(program), static_cast<GLenum>(shadertype), static_cast<const GLchar*>(name));
}

int32_t QOpenGLFunctions_4_2_Compatibility_GlGetSubroutineUniformLocation(QOpenGLFunctions_4_2_Compatibility* self, uint32_t program, uint32_t shadertype, const char* name) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawElementsIndirect(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, uint32_t type, const void* indirect) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexAttribLPointer(QOpenGLFunctions_4_2_Compatibility* self, uint32_t index, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetProgramPipelineInfoLog(QOpenGLFunctions_4_2_Compatibility* self, uint32_t pipeline, int32_t bufSize, int32_t* length, char* infoLog) {
...
uint32_t QOpenGLFunctions_4_2_Compatibility_GlCreateShaderProgramv(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, int32_t count, const char** strings) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawElementsInstancedBaseVertexBaseInstance(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, int32_t basevertex, uint32_t baseinstance) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawElementsInstancedBaseInstance(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, uint32_t baseinstance) {
...
void QOpenGLFunctions_4_2_Compatibility_GlDrawPixels(QOpenGLFunctions_4_2_Compatibility* self, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_2_Compatibility_GlCopyPixels(QOpenGLFunctions_4_2_Compatibility* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t type) {
...
void QOpenGLFunctions_4_2_Compatibility_GlEvalMesh2(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, int32_t i1, int32_t i2, int32_t j1, int32_t j2) {
...
void QOpenGLFunctions_4_2_Compatibility_GlEvalMesh1(QOpenGLFunctions_4_2_Compatibility* self, uint32_t mode, int32_t i1, int32_t i2) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMapGrid2f(QOpenGLFunctions_4_2_Compatibility* self, int32_t un, float u1, float u2, int32_t vn, float v1, float v2) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMapGrid2d(QOpenGLFunctions_4_2_Compatibility* self, int32_t un, double u1, double u2, int32_t vn, double v1, double v2) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMapGrid1f(QOpenGLFunctions_4_2_Compatibility* self, int32_t un, float u1, float u2) {
    self->glMapGrid1f(static_cast<GLint>(un), static_cast<GLfloat>(u1), static_cast<GLfloat>(u2));
}

void QOpenGLFunctions_4_2_Compatibility_GlMapGrid1d(QOpenGLFunctions_4_2_Compatibility* self, int32_t un, double u1, double u2) {
    self->glMapGrid1d(static_cast<GLint>(un), static_cast<GLdouble>(u1), static_cast<GLdouble>(u2));
}

void QOpenGLFunctions_4_2_Compatibility_GlMap2f(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, float u1, float u2, int32_t ustride, int32_t uorder, float v1, float v2, int32_t vstride, int32_t vorder, const float* points) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMap2d(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, double u1, double u2, int32_t ustride, int32_t uorder, double v1, double v2, int32_t vstride, int32_t vorder, const double* points) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMap1f(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, float u1, float u2, int32_t stride, int32_t order, const float* points) {
...
void QOpenGLFunctions_4_2_Compatibility_GlMap1d(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, double u1, double u2, int32_t stride, int32_t order, const double* points) {
...
void QOpenGLFunctions_4_2_Compatibility_GlFeedbackBuffer(QOpenGLFunctions_4_2_Compatibility* self, int32_t size, uint32_t type, float* buffer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlCallLists(QOpenGLFunctions_4_2_Compatibility* self, int32_t n, uint32_t type, const void* lists) {
...
void QOpenGLFunctions_4_2_Compatibility_GlVertexPointer(QOpenGLFunctions_4_2_Compatibility* self, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
    self->glVertexPointer(static_cast<GLint>(size), static_cast<GLenum>(type), static_cast<GLsizei>(stride), pointer);
}

void QOpenGLFunctions_4_2_Compatibility_GlTexCoordPointer(QOpenGLFunctions_4_2_Compatibility* self, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
    self->glTexCoordPointer(static_cast<GLint>(size), static_cast<GLenum>(type), static_cast<GLsizei>(stride), pointer);
}

void QOpenGLFunctions_4_2_Compatibility_GlNormalPointer(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlIndexPointer(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlColorPointer(QOpenGLFunctions_4_2_Compatibility* self, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetMinmax(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, unsigned char reset, uint32_t format, uint32_t type, void* values) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetHistogram(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, unsigned char reset, uint32_t format, uint32_t type, void* values) {
...
void QOpenGLFunctions_4_2_Compatibility_GlSeparableFilter2D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, uint32_t internalformat, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* row, const void* column) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetSeparableFilter(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, uint32_t format, uint32_t type, void* row, void* column, void* span) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetConvolutionFilter(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, uint32_t format, uint32_t type, void* image) {
...
void QOpenGLFunctions_4_2_Compatibility_GlConvolutionFilter2D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, uint32_t internalformat, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* image) {
...
void QOpenGLFunctions_4_2_Compatibility_GlConvolutionFilter1D(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, uint32_t internalformat, int32_t width, uint32_t format, uint32_t type, const void* image) {
...
void QOpenGLFunctions_4_2_Compatibility_GlColorSubTable(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, int32_t start, int32_t count, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_4_2_Compatibility_GlGetColorTable(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, uint32_t format, uint32_t type, void* table) {
...
void QOpenGLFunctions_4_2_Compatibility_GlColorTable(QOpenGLFunctions_4_2_Compatibility* self, uint32_t target, uint32_t internalformat, int32_t width, uint32_t format, uint32_t type, const void* table) {
...
void QOpenGLFunctions_4_2_Compatibility_GlSecondaryColorPointer(QOpenGLFunctions_4_2_Compatibility* self, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_2_Compatibility_GlFogCoordPointer(QOpenGLFunctions_4_2_Compatibility* self, uint32_t type, int32_t stride, const void* pointer) {
