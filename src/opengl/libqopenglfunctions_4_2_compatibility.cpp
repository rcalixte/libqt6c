...
void QOpenGLFunctions_4_2_Compatibility_GlShaderSource(QOpenGLFunctions_4_2_Compatibility* self, uint32_t shader, int32_t count, const char** string, const int32_t* length) {
