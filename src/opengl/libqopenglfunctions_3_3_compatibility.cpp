...
bool QOpenGLFunctions_3_3_Compatibility_InitializeOpenGLFunctions(QOpenGLFunctions_3_3_Compatibility* self) {
    ...
    if (vqopenglfunctions_3_3_compatibility && vqopenglfunctions_3_3_compatibility->isVirtualQOpenGLFunctions_3_3_Compatibility) {
        ...
        return ((VirtualQOpenGLFunctions_3_3_Compatibility*)self)->initializeOpenGLFunctions();
    }
}
...
void QOpenGLFunctions_3_3_Compatibility_GlShaderSource(QOpenGLFunctions_3_3_Compatibility* self, uint32_t shader, int32_t count, const char** stringVal, const int32_t* length) {
