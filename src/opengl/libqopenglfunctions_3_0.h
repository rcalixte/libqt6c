#pragma once
#ifndef SRC_OPENGL_QT6C_LIBQOPENGLFUNCTIONS_3_0_H
#define SRC_OPENGL_QT6C_LIBQOPENGLFUNCTIONS_3_0_H
...
/// q_openglfunctions_3_0_new constructs a new QOpenGLFunctions_3_0 object.
///
...
/// @warning DEPRECATED: Use `q_openglfunctions_3_0_super_initialize_open_g_l_functions` instead
///
#define q_openglfunctions_3_0_qbase_initialize_open_g_l_functions q_openglfunctions_3_0_super_initialize_open_g_l_functions
...
/// @param self QOpenGLFunctions_3_0*
///
bool q_openglfunctions_3_0_super_initialize_open_g_l_functions(void* self);
...
///
void q_openglfunctions_3_0_gl_shader_source(void* self, uint32_t shader, int32_t count, const char** string, int32_t* length);
...
///
void q_openglfunctions_3_0_gl_get_pixel_mapusv(void* self, uint32_t map, uint16_t* values);
...
///
void q_openglfunctions_3_0_gl_get_pixel_mapuiv(void* self, uint32_t map, uint32_t* values);
...
/// @param values float*
///
void q_openglfunctions_3_0_gl_get_pixel_mapfv(void* self, uint32_t map, float* values);
...
/// @param values uint16_t*
///
void q_openglfunctions_3_0_gl_pixel_mapusv(void* self, uint32_t map, int32_t mapsize, uint16_t* values);
...
/// @param values uint32_t*
///
void q_openglfunctions_3_0_gl_pixel_mapuiv(void* self, uint32_t map, int32_t mapsize, uint32_t* values);
...
/// @param values float*
///
void q_openglfunctions_3_0_gl_pixel_mapfv(void* self, uint32_t map, int32_t mapsize, float* values);
...
/// @warning DEPRECATED: Use `q_openglfunctions_3_0_super_is_initialized` instead
///
#define q_openglfunctions_3_0_qbase_is_initialized q_openglfunctions_3_0_super_is_initialized
...
/// @warning DEPRECATED: Use `q_openglfunctions_3_0_super_set_owning_context` instead
///
#define q_openglfunctions_3_0_qbase_set_owning_context q_openglfunctions_3_0_super_set_owning_context
...
/// @warning DEPRECATED: Use `q_openglfunctions_3_0_super_owning_context` instead
///
#define q_openglfunctions_3_0_qbase_owning_context q_openglfunctions_3_0_super_owning_context
