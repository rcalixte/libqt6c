...
bool q_openglfunctions_3_3_core_super_initialize_open_g_l_functions(void* self) {
    return QOpenGLFunctions_3_3_Core_SuperInitializeOpenGLFunctions((QOpenGLFunctions_3_3_Core*)self);
}
...
void q_openglfunctions_3_3_core_gl_multi_draw_elements(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount) {
    QOpenGLFunctions_3_3_Core_GlMultiDrawElements((QOpenGLFunctions_3_3_Core*)self, mode, count, type, indices, drawcount);
}
...
void q_openglfunctions_3_3_core_gl_get_buffer_pointerv(void* self, uint32_t target, uint32_t pname, void* params) {
    QOpenGLFunctions_3_3_Core_GlGetBufferPointerv((QOpenGLFunctions_3_3_Core*)self, target, pname, params);
}
...
void q_openglfunctions_3_3_core_gl_shader_source(void* self, uint32_t shader, int32_t count, const char** string, int32_t* length) {
    QOpenGLFunctions_3_3_Core_GlShaderSource((QOpenGLFunctions_3_3_Core*)self, shader, count, string, length);
}
...
void q_openglfunctions_3_3_core_gl_get_vertex_attrib_pointerv(void* self, uint32_t index, uint32_t pname, void* pointer) {
    QOpenGLFunctions_3_3_Core_GlGetVertexAttribPointerv((QOpenGLFunctions_3_3_Core*)self, index, pname, pointer);
}
...
void q_openglfunctions_3_3_core_gl_transform_feedback_varyings(void* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode) {
    QOpenGLFunctions_3_3_Core_GlTransformFeedbackVaryings((QOpenGLFunctions_3_3_Core*)self, program, count, varyings, bufferMode);
}
...
void q_openglfunctions_3_3_core_gl_get_uniform_indices(void* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices) {
    QOpenGLFunctions_3_3_Core_GlGetUniformIndices((QOpenGLFunctions_3_3_Core*)self, program, uniformCount, uniformNames, uniformIndices);
}
...
void q_openglfunctions_3_3_core_gl_multi_draw_elements_base_vertex(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount, int32_t* basevertex) {
    QOpenGLFunctions_3_3_Core_GlMultiDrawElementsBaseVertex((QOpenGLFunctions_3_3_Core*)self, mode, count, type, indices, drawcount, basevertex);
}
...
bool q_openglfunctions_3_3_core_super_is_initialized(void* self) {
    return QOpenGLFunctions_3_3_Core_SuperIsInitialized((QOpenGLFunctions_3_3_Core*)self);
}
...
void q_openglfunctions_3_3_core_super_set_owning_context(void* self, void* context) {
    QOpenGLFunctions_3_3_Core_SuperSetOwningContext((QOpenGLFunctions_3_3_Core*)self, (QOpenGLContext*)context);
}
...
QOpenGLContext* q_openglfunctions_3_3_core_super_owning_context(void* self) {
    return QOpenGLFunctions_3_3_Core_SuperOwningContext((QOpenGLFunctions_3_3_Core*)self);
}
