...
void q_openglfunctions_3_3_core_gl_get_buffer_sub_data(void* self, uint32_t target, int64_t offset, int64_t size, void* data) {
    QOpenGLFunctions_3_3_Core_GlGetBufferSubData((QOpenGLFunctions_3_3_Core*)self, target, offset, size, data);
}

void q_openglfunctions_3_3_core_gl_buffer_sub_data(void* self, uint32_t target, int64_t offset, int64_t size, void* data) {
    QOpenGLFunctions_3_3_Core_GlBufferSubData((QOpenGLFunctions_3_3_Core*)self, target, offset, size, data);
}

void q_openglfunctions_3_3_core_gl_buffer_data(void* self, uint32_t target, int64_t size, void* data, uint32_t usage) {
...
void q_openglfunctions_3_3_core_gl_flush_mapped_buffer_range(void* self, uint32_t target, int64_t offset, int64_t length) {
    QOpenGLFunctions_3_3_Core_GlFlushMappedBufferRange((QOpenGLFunctions_3_3_Core*)self, target, offset, length);
}

void* q_openglfunctions_3_3_core_gl_map_buffer_range(void* self, uint32_t target, int64_t offset, int64_t length, uint32_t access) {
...
void q_openglfunctions_3_3_core_gl_bind_buffer_range(void* self, uint32_t target, uint32_t index, uint32_t buffer, int64_t offset, int64_t size) {
...
void q_openglfunctions_3_3_core_gl_copy_buffer_sub_data(void* self, uint32_t readTarget, uint32_t writeTarget, int64_t readOffset, int64_t writeOffset, int64_t size) {
