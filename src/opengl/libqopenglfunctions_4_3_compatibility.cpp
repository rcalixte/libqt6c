...
void QOpenGLFunctions_4_3_Compatibility_GlClearBufferSubData(QOpenGLFunctions_4_3_Compatibility* self, uint32_t target, uint32_t internalformat, int64_t offset, int64_t size, uint32_t format, uint32_t type, const void* data) {
