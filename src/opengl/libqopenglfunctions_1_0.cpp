...
void QOpenGLFunctions_1_0_GlGetTexImage(QOpenGLFunctions_1_0* self, uint32_t target, int32_t level, uint32_t format, uint32_t type, void* pixels) {
...
void QOpenGLFunctions_1_0_GlReadPixels(QOpenGLFunctions_1_0* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, void* pixels) {
...
void QOpenGLFunctions_1_0_GlTexImage2D(QOpenGLFunctions_1_0* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_0_GlTexImage1D(QOpenGLFunctions_1_0* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_0_GlGetPixelMapusv(QOpenGLFunctions_1_0* self, uint32_t map, uint16_t* values) {
    self->glGetPixelMapusv(static_cast<GLenum>(map), static_cast<GLushort*>(values));
}

void QOpenGLFunctions_1_0_GlGetPixelMapuiv(QOpenGLFunctions_1_0* self, uint32_t map, uint32_t* values) {
    self->glGetPixelMapuiv(static_cast<GLenum>(map), static_cast<GLuint*>(values));
}

void QOpenGLFunctions_1_0_GlGetPixelMapfv(QOpenGLFunctions_1_0* self, uint32_t map, float* values) {
...
void QOpenGLFunctions_1_0_GlDrawPixels(QOpenGLFunctions_1_0* self, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_0_GlCopyPixels(QOpenGLFunctions_1_0* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t type) {
...
void QOpenGLFunctions_1_0_GlPixelMapusv(QOpenGLFunctions_1_0* self, uint32_t map, int32_t mapsize, const uint16_t* values) {
    self->glPixelMapusv(static_cast<GLenum>(map), static_cast<GLint>(mapsize), static_cast<const GLushort*>(values));
}

void QOpenGLFunctions_1_0_GlPixelMapuiv(QOpenGLFunctions_1_0* self, uint32_t map, int32_t mapsize, const uint32_t* values) {
    self->glPixelMapuiv(static_cast<GLenum>(map), static_cast<GLint>(mapsize), static_cast<const GLuint*>(values));
}

void QOpenGLFunctions_1_0_GlPixelMapfv(QOpenGLFunctions_1_0* self, uint32_t map, int32_t mapsize, const float* values) {
...
void QOpenGLFunctions_1_0_GlEvalMesh2(QOpenGLFunctions_1_0* self, uint32_t mode, int32_t i1, int32_t i2, int32_t j1, int32_t j2) {
...
void QOpenGLFunctions_1_0_GlEvalMesh1(QOpenGLFunctions_1_0* self, uint32_t mode, int32_t i1, int32_t i2) {
...
void QOpenGLFunctions_1_0_GlMapGrid2f(QOpenGLFunctions_1_0* self, int32_t un, float u1, float u2, int32_t vn, float v1, float v2) {
...
void QOpenGLFunctions_1_0_GlMapGrid2d(QOpenGLFunctions_1_0* self, int32_t un, double u1, double u2, int32_t vn, double v1, double v2) {
...
void QOpenGLFunctions_1_0_GlMapGrid1f(QOpenGLFunctions_1_0* self, int32_t un, float u1, float u2) {
    self->glMapGrid1f(static_cast<GLint>(un), static_cast<GLfloat>(u1), static_cast<GLfloat>(u2));
}

void QOpenGLFunctions_1_0_GlMapGrid1d(QOpenGLFunctions_1_0* self, int32_t un, double u1, double u2) {
    self->glMapGrid1d(static_cast<GLint>(un), static_cast<GLdouble>(u1), static_cast<GLdouble>(u2));
}

void QOpenGLFunctions_1_0_GlMap2f(QOpenGLFunctions_1_0* self, uint32_t target, float u1, float u2, int32_t ustride, int32_t uorder, float v1, float v2, int32_t vstride, int32_t vorder, const float* points) {
...
void QOpenGLFunctions_1_0_GlMap2d(QOpenGLFunctions_1_0* self, uint32_t target, double u1, double u2, int32_t ustride, int32_t uorder, double v1, double v2, int32_t vstride, int32_t vorder, const double* points) {
...
void QOpenGLFunctions_1_0_GlMap1f(QOpenGLFunctions_1_0* self, uint32_t target, float u1, float u2, int32_t stride, int32_t order, const float* points) {
...
void QOpenGLFunctions_1_0_GlMap1d(QOpenGLFunctions_1_0* self, uint32_t target, double u1, double u2, int32_t stride, int32_t order, const double* points) {
...
void QOpenGLFunctions_1_0_GlFeedbackBuffer(QOpenGLFunctions_1_0* self, int32_t size, uint32_t type, float* buffer) {
...
void QOpenGLFunctions_1_0_GlCallLists(QOpenGLFunctions_1_0* self, int32_t n, uint32_t type, const void* lists) {
