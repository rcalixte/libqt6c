#pragma once
#ifndef SRC_OPENGLC_LIBQOPENGLFUNCTIONS_3_1_HPP
#define SRC_OPENGLC_LIBQOPENGLFUNCTIONS_3_1_HPP
...
void QOpenGLFunctions_3_1_GlGetTexImage(QOpenGLFunctions_3_1* self, uint32_t target, int32_t level, uint32_t format, uint32_t type, void* pixels);
...
void QOpenGLFunctions_3_1_GlReadPixels(QOpenGLFunctions_3_1* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, void* pixels);
...
void QOpenGLFunctions_3_1_GlTexImage2D(QOpenGLFunctions_3_1* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, const void* pixels);
void QOpenGLFunctions_3_1_GlTexImage1D(QOpenGLFunctions_3_1* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t border, uint32_t format, uint32_t type, const void* pixels);
...
void QOpenGLFunctions_3_1_GlTexSubImage2D(QOpenGLFunctions_3_1* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels);
void QOpenGLFunctions_3_1_GlTexSubImage1D(QOpenGLFunctions_3_1* self, uint32_t target, int32_t level, int32_t xoffset, int32_t width, uint32_t format, uint32_t type, const void* pixels);
...
void QOpenGLFunctions_3_1_GlDrawElements(QOpenGLFunctions_3_1* self, uint32_t mode, int32_t count, uint32_t type, const void* indices);
...
void QOpenGLFunctions_3_1_GlTexSubImage3D(QOpenGLFunctions_3_1* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, const void* pixels);
void QOpenGLFunctions_3_1_GlTexImage3D(QOpenGLFunctions_3_1* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t depth, int32_t border, uint32_t format, uint32_t type, const void* pixels);
void QOpenGLFunctions_3_1_GlDrawRangeElements(QOpenGLFunctions_3_1* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices);
...
void QOpenGLFunctions_3_1_GlMultiDrawElements(QOpenGLFunctions_3_1* self, uint32_t mode, const int32_t* count, uint32_t type, const void** indices, int32_t drawcount);
...
void QOpenGLFunctions_3_1_GlGetBufferSubData(QOpenGLFunctions_3_1* self, uint32_t target, intptr_t offset, intptr_t size, void* data);
void QOpenGLFunctions_3_1_GlBufferSubData(QOpenGLFunctions_3_1* self, uint32_t target, intptr_t offset, intptr_t size, const void* data);
void QOpenGLFunctions_3_1_GlBufferData(QOpenGLFunctions_3_1* self, uint32_t target, intptr_t size, const void* data, uint32_t usage);
...
void QOpenGLFunctions_3_1_GlVertexAttribPointer(QOpenGLFunctions_3_1* self, uint32_t index, int32_t size, uint32_t type, unsigned char normalized, int32_t stride, const void* pointer);
...
void QOpenGLFunctions_3_1_GlShaderSource(QOpenGLFunctions_3_1* self, uint32_t shader, int32_t count, const char** stringVal, const int32_t* length);
...
int32_t QOpenGLFunctions_3_1_GlGetUniformLocation(QOpenGLFunctions_3_1* self, uint32_t program, const char* name);
void QOpenGLFunctions_3_1_GlGetShaderSource(QOpenGLFunctions_3_1* self, uint32_t shader, int32_t bufSize, int32_t* length, char* source);
void QOpenGLFunctions_3_1_GlGetShaderInfoLog(QOpenGLFunctions_3_1* self, uint32_t shader, int32_t bufSize, int32_t* length, char* infoLog);
void QOpenGLFunctions_3_1_GlGetShaderiv(QOpenGLFunctions_3_1* self, uint32_t shader, uint32_t pname, int32_t* params);
void QOpenGLFunctions_3_1_GlGetProgramInfoLog(QOpenGLFunctions_3_1* self, uint32_t program, int32_t bufSize, int32_t* length, char* infoLog);
void QOpenGLFunctions_3_1_GlGetProgramiv(QOpenGLFunctions_3_1* self, uint32_t program, uint32_t pname, int32_t* params);
int32_t QOpenGLFunctions_3_1_GlGetAttribLocation(QOpenGLFunctions_3_1* self, uint32_t program, const char* name);
...
uint32_t QOpenGLFunctions_3_1_GlCreateShader(QOpenGLFunctions_3_1* self, uint32_t type);
...
void QOpenGLFunctions_3_1_GlBindAttribLocation(QOpenGLFunctions_3_1* self, uint32_t program, uint32_t index, const char* name);
...
void QOpenGLFunctions_3_1_GlFlushMappedBufferRange(QOpenGLFunctions_3_1* self, uint32_t target, intptr_t offset, intptr_t length);
void* QOpenGLFunctions_3_1_GlMapBufferRange(QOpenGLFunctions_3_1* self, uint32_t target, intptr_t offset, intptr_t length, uint32_t access);
...
int32_t QOpenGLFunctions_3_1_GlGetFragDataLocation(QOpenGLFunctions_3_1* self, uint32_t program, const char* name);
void QOpenGLFunctions_3_1_GlBindFragDataLocation(QOpenGLFunctions_3_1* self, uint32_t program, uint32_t color, const char* name);
...
void QOpenGLFunctions_3_1_GlVertexAttribIPointer(QOpenGLFunctions_3_1* self, uint32_t index, int32_t size, uint32_t type, int32_t stride, const void* pointer);
...
void QOpenGLFunctions_3_1_GlTransformFeedbackVaryings(QOpenGLFunctions_3_1* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode);
void QOpenGLFunctions_3_1_GlBindBufferBase(QOpenGLFunctions_3_1* self, uint32_t target, uint32_t index, uint32_t buffer);
void QOpenGLFunctions_3_1_GlBindBufferRange(QOpenGLFunctions_3_1* self, uint32_t target, uint32_t index, uint32_t buffer, intptr_t offset, intptr_t size);
...
void QOpenGLFunctions_3_1_GlCopyBufferSubData(QOpenGLFunctions_3_1* self, uint32_t readTarget, uint32_t writeTarget, intptr_t readOffset, intptr_t writeOffset, intptr_t size);
...
void QOpenGLFunctions_3_1_GlGetActiveUniformBlockName(QOpenGLFunctions_3_1* self, uint32_t program, uint32_t uniformBlockIndex, int32_t bufSize, int32_t* length, char* uniformBlockName);
...
uint32_t QOpenGLFunctions_3_1_GlGetUniformBlockIndex(QOpenGLFunctions_3_1* self, uint32_t program, const char* uniformBlockName);
void QOpenGLFunctions_3_1_GlGetActiveUniformName(QOpenGLFunctions_3_1* self, uint32_t program, uint32_t uniformIndex, int32_t bufSize, int32_t* length, char* uniformName);
...
void QOpenGLFunctions_3_1_GlGetUniformIndices(QOpenGLFunctions_3_1* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices);
...
void QOpenGLFunctions_3_1_GlDrawElementsInstanced(QOpenGLFunctions_3_1* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount);
