...
bool q_openglfunctions_1_4_super_initialize_open_g_l_functions(void* self) {
    return QOpenGLFunctions_1_4_SuperInitializeOpenGLFunctions((QOpenGLFunctions_1_4*)self);
}
...
void q_openglfunctions_1_4_gl_get_pixel_mapusv(void* self, uint32_t map, uint16_t* values) {
    QOpenGLFunctions_1_4_GlGetPixelMapusv((QOpenGLFunctions_1_4*)self, map, values);
}

void q_openglfunctions_1_4_gl_get_pixel_mapuiv(void* self, uint32_t map, uint32_t* values) {
    QOpenGLFunctions_1_4_GlGetPixelMapuiv((QOpenGLFunctions_1_4*)self, map, values);
}

void q_openglfunctions_1_4_gl_get_pixel_mapfv(void* self, uint32_t map, float* values) {
    QOpenGLFunctions_1_4_GlGetPixelMapfv((QOpenGLFunctions_1_4*)self, map, values);
}
...
void q_openglfunctions_1_4_gl_pixel_mapusv(void* self, uint32_t map, int32_t mapsize, uint16_t* values) {
    QOpenGLFunctions_1_4_GlPixelMapusv((QOpenGLFunctions_1_4*)self, map, mapsize, values);
}

void q_openglfunctions_1_4_gl_pixel_mapuiv(void* self, uint32_t map, int32_t mapsize, uint32_t* values) {
    QOpenGLFunctions_1_4_GlPixelMapuiv((QOpenGLFunctions_1_4*)self, map, mapsize, values);
}

void q_openglfunctions_1_4_gl_pixel_mapfv(void* self, uint32_t map, int32_t mapsize, float* values) {
    QOpenGLFunctions_1_4_GlPixelMapfv((QOpenGLFunctions_1_4*)self, map, mapsize, values);
}
