...
bool q_openglfunctions_1_1_qbase_initialize_open_g_l_functions(void* self) {
    return QOpenGLFunctions_1_1_QBaseInitializeOpenGLFunctions((QOpenGLFunctions_1_1*)self);
}
...
bool q_openglfunctions_1_1_qbase_is_initialized(void* self) {
    return QOpenGLFunctions_1_1_QBaseIsInitialized((QOpenGLFunctions_1_1*)self);
}
...
void q_openglfunctions_1_1_qbase_set_owning_context(void* self, void* context) {
    QOpenGLFunctions_1_1_QBaseSetOwningContext((QOpenGLFunctions_1_1*)self, (QOpenGLContext*)context);
}
...
QOpenGLContext* q_openglfunctions_1_1_qbase_owning_context(void* self) {
    return QOpenGLFunctions_1_1_QBaseOwningContext((QOpenGLFunctions_1_1*)self);
}
