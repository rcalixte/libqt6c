...
QOpenGLDebugMessage* QOpenGLDebugMessage_CreateApplicationMessage4(const libqt_string text, uint32_t id, int severity, int type) {
    QString text_QString = QString::fromUtf8(text.data, text.len);
    return new QOpenGLDebugMessage(QOpenGLDebugMessage::createApplicationMessage(text_QString, static_cast<GLuint>(id), static_cast<QOpenGLDebugMessage::Severity>(severity), static_cast<QOpenGLDebugMessage::Type>(type)));
}
...
QOpenGLDebugMessage* QOpenGLDebugMessage_CreateThirdPartyMessage4(const libqt_string text, uint32_t id, int severity, int type) {
    QString text_QString = QString::fromUtf8(text.data, text.len);
    return new QOpenGLDebugMessage(QOpenGLDebugMessage::createThirdPartyMessage(text_QString, static_cast<GLuint>(id), static_cast<QOpenGLDebugMessage::Severity>(severity), static_cast<QOpenGLDebugMessage::Type>(type)));
}
...
void QOpenGLDebugLogger_EnableMessages2(QOpenGLDebugLogger* self, const libqt_list /* of uint32_t */ ids) {
    ...
    uint32_t* ids_arr = static_cast<uint32_t*>(ids.data.uint32_ts);
