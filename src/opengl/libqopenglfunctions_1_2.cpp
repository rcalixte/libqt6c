...
void QOpenGLFunctions_1_2_GlGetTexImage(QOpenGLFunctions_1_2* self, uint32_t target, int32_t level, uint32_t format, uint32_t type, void* pixels) {
...
void QOpenGLFunctions_1_2_GlReadPixels(QOpenGLFunctions_1_2* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, void* pixels) {
...
void QOpenGLFunctions_1_2_GlTexImage2D(QOpenGLFunctions_1_2* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_2_GlTexImage1D(QOpenGLFunctions_1_2* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_2_GlTexSubImage2D(QOpenGLFunctions_1_2* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_2_GlTexSubImage1D(QOpenGLFunctions_1_2* self, uint32_t target, int32_t level, int32_t xoffset, int32_t width, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_2_GlDrawElements(QOpenGLFunctions_1_2* self, uint32_t mode, int32_t count, uint32_t type, const void* indices) {
...
void QOpenGLFunctions_1_2_GlTexSubImage3D(QOpenGLFunctions_1_2* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_2_GlTexImage3D(QOpenGLFunctions_1_2* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t depth, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_2_GlDrawRangeElements(QOpenGLFunctions_1_2* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices) {
...
void QOpenGLFunctions_1_2_GlGetPixelMapusv(QOpenGLFunctions_1_2* self, uint32_t map, uint16_t* values) {
    self->glGetPixelMapusv(static_cast<GLenum>(map), static_cast<GLushort*>(values));
}

void QOpenGLFunctions_1_2_GlGetPixelMapuiv(QOpenGLFunctions_1_2* self, uint32_t map, uint32_t* values) {
    self->glGetPixelMapuiv(static_cast<GLenum>(map), static_cast<GLuint*>(values));
}

void QOpenGLFunctions_1_2_GlGetPixelMapfv(QOpenGLFunctions_1_2* self, uint32_t map, float* values) {
...
void QOpenGLFunctions_1_2_GlDrawPixels(QOpenGLFunctions_1_2* self, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_1_2_GlCopyPixels(QOpenGLFunctions_1_2* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t type) {
...
void QOpenGLFunctions_1_2_GlPixelMapusv(QOpenGLFunctions_1_2* self, uint32_t map, int32_t mapsize, const uint16_t* values) {
    self->glPixelMapusv(static_cast<GLenum>(map), static_cast<GLint>(mapsize), static_cast<const GLushort*>(values));
}

void QOpenGLFunctions_1_2_GlPixelMapuiv(QOpenGLFunctions_1_2* self, uint32_t map, int32_t mapsize, const uint32_t* values) {
    self->glPixelMapuiv(static_cast<GLenum>(map), static_cast<GLint>(mapsize), static_cast<const GLuint*>(values));
}

void QOpenGLFunctions_1_2_GlPixelMapfv(QOpenGLFunctions_1_2* self, uint32_t map, int32_t mapsize, const float* values) {
...
void QOpenGLFunctions_1_2_GlEvalMesh2(QOpenGLFunctions_1_2* self, uint32_t mode, int32_t i1, int32_t i2, int32_t j1, int32_t j2) {
...
void QOpenGLFunctions_1_2_GlEvalMesh1(QOpenGLFunctions_1_2* self, uint32_t mode, int32_t i1, int32_t i2) {
...
void QOpenGLFunctions_1_2_GlMapGrid2f(QOpenGLFunctions_1_2* self, int32_t un, float u1, float u2, int32_t vn, float v1, float v2) {
...
void QOpenGLFunctions_1_2_GlMapGrid2d(QOpenGLFunctions_1_2* self, int32_t un, double u1, double u2, int32_t vn, double v1, double v2) {
...
void QOpenGLFunctions_1_2_GlMapGrid1f(QOpenGLFunctions_1_2* self, int32_t un, float u1, float u2) {
    self->glMapGrid1f(static_cast<GLint>(un), static_cast<GLfloat>(u1), static_cast<GLfloat>(u2));
}

void QOpenGLFunctions_1_2_GlMapGrid1d(QOpenGLFunctions_1_2* self, int32_t un, double u1, double u2) {
    self->glMapGrid1d(static_cast<GLint>(un), static_cast<GLdouble>(u1), static_cast<GLdouble>(u2));
}

void QOpenGLFunctions_1_2_GlMap2f(QOpenGLFunctions_1_2* self, uint32_t target, float u1, float u2, int32_t ustride, int32_t uorder, float v1, float v2, int32_t vstride, int32_t vorder, const float* points) {
...
void QOpenGLFunctions_1_2_GlMap2d(QOpenGLFunctions_1_2* self, uint32_t target, double u1, double u2, int32_t ustride, int32_t uorder, double v1, double v2, int32_t vstride, int32_t vorder, const double* points) {
...
void QOpenGLFunctions_1_2_GlMap1f(QOpenGLFunctions_1_2* self, uint32_t target, float u1, float u2, int32_t stride, int32_t order, const float* points) {
...
void QOpenGLFunctions_1_2_GlMap1d(QOpenGLFunctions_1_2* self, uint32_t target, double u1, double u2, int32_t stride, int32_t order, const double* points) {
...
void QOpenGLFunctions_1_2_GlFeedbackBuffer(QOpenGLFunctions_1_2* self, int32_t size, uint32_t type, float* buffer) {
...
void QOpenGLFunctions_1_2_GlCallLists(QOpenGLFunctions_1_2* self, int32_t n, uint32_t type, const void* lists) {
...
void QOpenGLFunctions_1_2_GlVertexPointer(QOpenGLFunctions_1_2* self, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
    self->glVertexPointer(static_cast<GLint>(size), static_cast<GLenum>(type), static_cast<GLsizei>(stride), pointer);
}

void QOpenGLFunctions_1_2_GlTexCoordPointer(QOpenGLFunctions_1_2* self, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
    self->glTexCoordPointer(static_cast<GLint>(size), static_cast<GLenum>(type), static_cast<GLsizei>(stride), pointer);
}

void QOpenGLFunctions_1_2_GlNormalPointer(QOpenGLFunctions_1_2* self, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_1_2_GlIndexPointer(QOpenGLFunctions_1_2* self, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_1_2_GlColorPointer(QOpenGLFunctions_1_2* self, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_1_2_GlGetMinmax(QOpenGLFunctions_1_2* self, uint32_t target, unsigned char reset, uint32_t format, uint32_t type, void* values) {
...
void QOpenGLFunctions_1_2_GlGetHistogram(QOpenGLFunctions_1_2* self, uint32_t target, unsigned char reset, uint32_t format, uint32_t type, void* values) {
...
void QOpenGLFunctions_1_2_GlSeparableFilter2D(QOpenGLFunctions_1_2* self, uint32_t target, uint32_t internalformat, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* row, const void* column) {
...
void QOpenGLFunctions_1_2_GlGetSeparableFilter(QOpenGLFunctions_1_2* self, uint32_t target, uint32_t format, uint32_t type, void* row, void* column, void* span) {
...
void QOpenGLFunctions_1_2_GlGetConvolutionFilter(QOpenGLFunctions_1_2* self, uint32_t target, uint32_t format, uint32_t type, void* image) {
...
void QOpenGLFunctions_1_2_GlConvolutionFilter2D(QOpenGLFunctions_1_2* self, uint32_t target, uint32_t internalformat, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* image) {
...
void QOpenGLFunctions_1_2_GlConvolutionFilter1D(QOpenGLFunctions_1_2* self, uint32_t target, uint32_t internalformat, int32_t width, uint32_t format, uint32_t type, const void* image) {
...
void QOpenGLFunctions_1_2_GlColorSubTable(QOpenGLFunctions_1_2* self, uint32_t target, int32_t start, int32_t count, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_1_2_GlGetColorTable(QOpenGLFunctions_1_2* self, uint32_t target, uint32_t format, uint32_t type, void* table) {
...
void QOpenGLFunctions_1_2_GlColorTable(QOpenGLFunctions_1_2* self, uint32_t target, uint32_t internalformat, int32_t width, uint32_t format, uint32_t type, const void* table) {
