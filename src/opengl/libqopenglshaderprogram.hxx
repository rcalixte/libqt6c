...
class VirtualQOpenGLShader final : public QOpenGLShader {
  ...
  public:
    VirtualQOpenGLShader(QOpenGLShader::ShaderType type) : QOpenGLShader(type) {};
    VirtualQOpenGLShader(QOpenGLShader::ShaderType type, QObject* parent) : QOpenGLShader(type, parent) {};
