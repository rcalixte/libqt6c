...
bool q_openglfunctions_2_1_super_initialize_open_g_l_functions(void* self) {
    return QOpenGLFunctions_2_1_SuperInitializeOpenGLFunctions((QOpenGLFunctions_2_1*)self);
}
...
void q_openglfunctions_2_1_gl_shader_source(void* self, uint32_t shader, int32_t count, const char** string, int32_t* length) {
    QOpenGLFunctions_2_1_GlShaderSource((QOpenGLFunctions_2_1*)self, shader, count, string, length);
}
...
void q_openglfunctions_2_1_gl_get_pixel_mapusv(void* self, uint32_t map, uint16_t* values) {
    QOpenGLFunctions_2_1_GlGetPixelMapusv((QOpenGLFunctions_2_1*)self, map, values);
}

void q_openglfunctions_2_1_gl_get_pixel_mapuiv(void* self, uint32_t map, uint32_t* values) {
    QOpenGLFunctions_2_1_GlGetPixelMapuiv((QOpenGLFunctions_2_1*)self, map, values);
}

void q_openglfunctions_2_1_gl_get_pixel_mapfv(void* self, uint32_t map, float* values) {
    QOpenGLFunctions_2_1_GlGetPixelMapfv((QOpenGLFunctions_2_1*)self, map, values);
}
...
void q_openglfunctions_2_1_gl_pixel_mapusv(void* self, uint32_t map, int32_t mapsize, uint16_t* values) {
    QOpenGLFunctions_2_1_GlPixelMapusv((QOpenGLFunctions_2_1*)self, map, mapsize, values);
}

void q_openglfunctions_2_1_gl_pixel_mapuiv(void* self, uint32_t map, int32_t mapsize, uint32_t* values) {
    QOpenGLFunctions_2_1_GlPixelMapuiv((QOpenGLFunctions_2_1*)self, map, mapsize, values);
}

void q_openglfunctions_2_1_gl_pixel_mapfv(void* self, uint32_t map, int32_t mapsize, float* values) {
    QOpenGLFunctions_2_1_GlPixelMapfv((QOpenGLFunctions_2_1*)self, map, mapsize, values);
}
...
bool q_openglfunctions_2_1_super_is_initialized(void* self) {
    return QOpenGLFunctions_2_1_SuperIsInitialized((QOpenGLFunctions_2_1*)self);
}
...
void q_openglfunctions_2_1_super_set_owning_context(void* self, void* context) {
    QOpenGLFunctions_2_1_SuperSetOwningContext((QOpenGLFunctions_2_1*)self, (QOpenGLContext*)context);
}
...
QOpenGLContext* q_openglfunctions_2_1_super_owning_context(void* self) {
    return QOpenGLFunctions_2_1_SuperOwningContext((QOpenGLFunctions_2_1*)self);
}
