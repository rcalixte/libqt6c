...
void QOpenGLFunctions_4_5_Core_GlClearBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t target, uint32_t internalformat, int64_t offset, int64_t size, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_4_5_Core_GlClearNamedBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, uint32_t internalformat, int64_t offset, int64_t size, uint32_t format, uint32_t type, const void* data) {
