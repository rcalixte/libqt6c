...
#include "libqopenglfunctions_4_5_core.hpp"
...
void QOpenGLFunctions_4_5_Core_GlGetTexImage(QOpenGLFunctions_4_5_Core* self, uint32_t target, int32_t level, uint32_t format, uint32_t type, void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlReadPixels(QOpenGLFunctions_4_5_Core* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTexImage2D(QOpenGLFunctions_4_5_Core* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTexImage1D(QOpenGLFunctions_4_5_Core* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTexSubImage2D(QOpenGLFunctions_4_5_Core* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTexSubImage1D(QOpenGLFunctions_4_5_Core* self, uint32_t target, int32_t level, int32_t xoffset, int32_t width, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlDrawElements(QOpenGLFunctions_4_5_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices) {
...
void QOpenGLFunctions_4_5_Core_GlTexSubImage3D(QOpenGLFunctions_4_5_Core* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTexImage3D(QOpenGLFunctions_4_5_Core* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t depth, int32_t border, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlDrawRangeElements(QOpenGLFunctions_4_5_Core* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices) {
...
void QOpenGLFunctions_4_5_Core_GlMultiDrawElements(QOpenGLFunctions_4_5_Core* self, uint32_t mode, const int32_t* count, uint32_t type, const void** indices, int32_t drawcount) {
...
void QOpenGLFunctions_4_5_Core_GlGetBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t target, intptr_t offset, intptr_t size, void* data) {
    self->glGetBufferSubData(static_cast<GLenum>(target), static_cast<GLintptr>(offset), static_cast<GLsizeiptr>(size), data);
}

void QOpenGLFunctions_4_5_Core_GlBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t target, intptr_t offset, intptr_t size, const void* data) {
    self->glBufferSubData(static_cast<GLenum>(target), static_cast<GLintptr>(offset), static_cast<GLsizeiptr>(size), data);
}

void QOpenGLFunctions_4_5_Core_GlBufferData(QOpenGLFunctions_4_5_Core* self, uint32_t target, intptr_t size, const void* data, uint32_t usage) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribPointer(QOpenGLFunctions_4_5_Core* self, uint32_t index, int32_t size, uint32_t type, unsigned char normalized, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_5_Core_GlShaderSource(QOpenGLFunctions_4_5_Core* self, uint32_t shader, int32_t count, const char** stringVal, const int32_t* length) {
...
int32_t QOpenGLFunctions_4_5_Core_GlGetUniformLocation(QOpenGLFunctions_4_5_Core* self, uint32_t program, const char* name) {
    return self->glGetUniformLocation(static_cast<GLuint>(program), static_cast<const GLchar*>(name));
}

void QOpenGLFunctions_4_5_Core_GlGetShaderSource(QOpenGLFunctions_4_5_Core* self, uint32_t shader, int32_t bufSize, int32_t* length, char* source) {
...
void QOpenGLFunctions_4_5_Core_GlGetShaderInfoLog(QOpenGLFunctions_4_5_Core* self, uint32_t shader, int32_t bufSize, int32_t* length, char* infoLog) {
...
void QOpenGLFunctions_4_5_Core_GlGetProgramInfoLog(QOpenGLFunctions_4_5_Core* self, uint32_t program, int32_t bufSize, int32_t* length, char* infoLog) {
...
int32_t QOpenGLFunctions_4_5_Core_GlGetAttribLocation(QOpenGLFunctions_4_5_Core* self, uint32_t program, const char* name) {
...
uint32_t QOpenGLFunctions_4_5_Core_GlCreateShader(QOpenGLFunctions_4_5_Core* self, uint32_t type) {
...
void QOpenGLFunctions_4_5_Core_GlBindAttribLocation(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t index, const char* name) {
...
void QOpenGLFunctions_4_5_Core_GlFlushMappedBufferRange(QOpenGLFunctions_4_5_Core* self, uint32_t target, intptr_t offset, intptr_t length) {
    self->glFlushMappedBufferRange(static_cast<GLenum>(target), static_cast<GLintptr>(offset), static_cast<GLsizeiptr>(length));
}

void* QOpenGLFunctions_4_5_Core_GlMapBufferRange(QOpenGLFunctions_4_5_Core* self, uint32_t target, intptr_t offset, intptr_t length, uint32_t access) {
...
int32_t QOpenGLFunctions_4_5_Core_GlGetFragDataLocation(QOpenGLFunctions_4_5_Core* self, uint32_t program, const char* name) {
    return self->glGetFragDataLocation(static_cast<GLuint>(program), static_cast<const GLchar*>(name));
}

void QOpenGLFunctions_4_5_Core_GlBindFragDataLocation(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t color, const char* name) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribIPointer(QOpenGLFunctions_4_5_Core* self, uint32_t index, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_5_Core_GlTransformFeedbackVaryings(QOpenGLFunctions_4_5_Core* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode) {
...
void QOpenGLFunctions_4_5_Core_GlBindBufferRange(QOpenGLFunctions_4_5_Core* self, uint32_t target, uint32_t index, uint32_t buffer, intptr_t offset, intptr_t size) {
...
void QOpenGLFunctions_4_5_Core_GlGetActiveUniformBlockName(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t uniformBlockIndex, int32_t bufSize, int32_t* length, char* uniformBlockName) {
...
uint32_t QOpenGLFunctions_4_5_Core_GlGetUniformBlockIndex(QOpenGLFunctions_4_5_Core* self, uint32_t program, const char* uniformBlockName) {
    return self->glGetUniformBlockIndex(static_cast<GLuint>(program), static_cast<const GLchar*>(uniformBlockName));
}

void QOpenGLFunctions_4_5_Core_GlGetActiveUniformName(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t uniformIndex, int32_t bufSize, int32_t* length, char* uniformName) {
...
void QOpenGLFunctions_4_5_Core_GlGetUniformIndices(QOpenGLFunctions_4_5_Core* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices) {
...
void QOpenGLFunctions_4_5_Core_GlCopyBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t readTarget, uint32_t writeTarget, intptr_t readOffset, intptr_t writeOffset, intptr_t size) {
...
void QOpenGLFunctions_4_5_Core_GlDrawElementsInstanced(QOpenGLFunctions_4_5_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount) {
...
void QOpenGLFunctions_4_5_Core_GlMultiDrawElementsBaseVertex(QOpenGLFunctions_4_5_Core* self, uint32_t mode, const int32_t* count, uint32_t type, const void** indices, int32_t drawcount, const int32_t* basevertex) {
...
void QOpenGLFunctions_4_5_Core_GlDrawElementsInstancedBaseVertex(QOpenGLFunctions_4_5_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, int32_t basevertex) {
...
void QOpenGLFunctions_4_5_Core_GlDrawRangeElementsBaseVertex(QOpenGLFunctions_4_5_Core* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices, int32_t basevertex) {
...
void QOpenGLFunctions_4_5_Core_GlDrawElementsBaseVertex(QOpenGLFunctions_4_5_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t basevertex) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribP4uiv(QOpenGLFunctions_4_5_Core* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribP4ui(QOpenGLFunctions_4_5_Core* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribP3uiv(QOpenGLFunctions_4_5_Core* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribP3ui(QOpenGLFunctions_4_5_Core* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribP2uiv(QOpenGLFunctions_4_5_Core* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribP2ui(QOpenGLFunctions_4_5_Core* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribP1uiv(QOpenGLFunctions_4_5_Core* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribP1ui(QOpenGLFunctions_4_5_Core* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value) {
...
int32_t QOpenGLFunctions_4_5_Core_GlGetFragDataIndex(QOpenGLFunctions_4_5_Core* self, uint32_t program, const char* name) {
    return self->glGetFragDataIndex(static_cast<GLuint>(program), static_cast<const GLchar*>(name));
}

void QOpenGLFunctions_4_5_Core_GlBindFragDataLocationIndexed(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t colorNumber, uint32_t index, const char* name) {
...
void QOpenGLFunctions_4_5_Core_GlGetActiveSubroutineName(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t shadertype, uint32_t index, int32_t bufsize, int32_t* length, char* name) {
...
void QOpenGLFunctions_4_5_Core_GlGetActiveSubroutineUniformName(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t shadertype, uint32_t index, int32_t bufsize, int32_t* length, char* name) {
...
uint32_t QOpenGLFunctions_4_5_Core_GlGetSubroutineIndex(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t shadertype, const char* name) {
    return self->glGetSubroutineIndex(static_cast<GLuint>(program), static_cast<GLenum>(shadertype), static_cast<const GLchar*>(name));
}

int32_t QOpenGLFunctions_4_5_Core_GlGetSubroutineUniformLocation(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t shadertype, const char* name) {
...
void QOpenGLFunctions_4_5_Core_GlDrawElementsIndirect(QOpenGLFunctions_4_5_Core* self, uint32_t mode, uint32_t type, const void* indirect) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribLPointer(QOpenGLFunctions_4_5_Core* self, uint32_t index, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
...
void QOpenGLFunctions_4_5_Core_GlGetProgramPipelineInfoLog(QOpenGLFunctions_4_5_Core* self, uint32_t pipeline, int32_t bufSize, int32_t* length, char* infoLog) {
...
uint32_t QOpenGLFunctions_4_5_Core_GlCreateShaderProgramv(QOpenGLFunctions_4_5_Core* self, uint32_t type, int32_t count, const char** strings) {
...
void QOpenGLFunctions_4_5_Core_GlDrawElementsInstancedBaseVertexBaseInstance(QOpenGLFunctions_4_5_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, int32_t basevertex, uint32_t baseinstance) {
...
void QOpenGLFunctions_4_5_Core_GlDrawElementsInstancedBaseInstance(QOpenGLFunctions_4_5_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, uint32_t baseinstance) {
...
void QOpenGLFunctions_4_5_Core_GlGetObjectPtrLabel(QOpenGLFunctions_4_5_Core* self, const void* ptr, int32_t bufSize, int32_t* length, char* label) {
    self->glGetObjectPtrLabel(ptr, static_cast<GLsizei>(bufSize), static_cast<GLsizei*>(length), static_cast<GLchar*>(label));
}

void QOpenGLFunctions_4_5_Core_GlObjectPtrLabel(QOpenGLFunctions_4_5_Core* self, const void* ptr, int32_t length, const char* label) {
    self->glObjectPtrLabel(ptr, static_cast<GLsizei>(length), static_cast<const GLchar*>(label));
}

void QOpenGLFunctions_4_5_Core_GlGetObjectLabel(QOpenGLFunctions_4_5_Core* self, uint32_t identifier, uint32_t name, int32_t bufSize, int32_t* length, char* label) {
...
void QOpenGLFunctions_4_5_Core_GlObjectLabel(QOpenGLFunctions_4_5_Core* self, uint32_t identifier, uint32_t name, int32_t length, const char* label) {
...
void QOpenGLFunctions_4_5_Core_GlPushDebugGroup(QOpenGLFunctions_4_5_Core* self, uint32_t source, uint32_t id, int32_t length, const char* message) {
...
void QOpenGLFunctions_4_5_Core_GlDebugMessageInsert(QOpenGLFunctions_4_5_Core* self, uint32_t source, uint32_t type, uint32_t id, uint32_t severity, int32_t length, const char* buf) {
...
void QOpenGLFunctions_4_5_Core_GlDebugMessageControl(QOpenGLFunctions_4_5_Core* self, uint32_t source, uint32_t type, uint32_t severity, int32_t count, const uint32_t* ids, unsigned char enabled) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribLFormat(QOpenGLFunctions_4_5_Core* self, uint32_t attribindex, int32_t size, uint32_t type, uint32_t relativeoffset) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribIFormat(QOpenGLFunctions_4_5_Core* self, uint32_t attribindex, int32_t size, uint32_t type, uint32_t relativeoffset) {
...
void QOpenGLFunctions_4_5_Core_GlVertexAttribFormat(QOpenGLFunctions_4_5_Core* self, uint32_t attribindex, int32_t size, uint32_t type, unsigned char normalized, uint32_t relativeoffset) {
...
void QOpenGLFunctions_4_5_Core_GlBindVertexBuffer(QOpenGLFunctions_4_5_Core* self, uint32_t bindingindex, uint32_t buffer, intptr_t offset, int32_t stride) {
...
void QOpenGLFunctions_4_5_Core_GlTexBufferRange(QOpenGLFunctions_4_5_Core* self, uint32_t target, uint32_t internalformat, uint32_t buffer, intptr_t offset, intptr_t size) {
...
int32_t QOpenGLFunctions_4_5_Core_GlGetProgramResourceLocationIndex(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t programInterface, const char* name) {
...
int32_t QOpenGLFunctions_4_5_Core_GlGetProgramResourceLocation(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t programInterface, const char* name) {
...
void QOpenGLFunctions_4_5_Core_GlGetProgramResourceName(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t programInterface, uint32_t index, int32_t bufSize, int32_t* length, char* name) {
...
uint32_t QOpenGLFunctions_4_5_Core_GlGetProgramResourceIndex(QOpenGLFunctions_4_5_Core* self, uint32_t program, uint32_t programInterface, const char* name) {
...
void QOpenGLFunctions_4_5_Core_GlMultiDrawElementsIndirect(QOpenGLFunctions_4_5_Core* self, uint32_t mode, uint32_t type, const void* indirect, int32_t drawcount, int32_t stride) {
...
void QOpenGLFunctions_4_5_Core_GlInvalidateBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, intptr_t offset, intptr_t length) {
...
void QOpenGLFunctions_4_5_Core_GlDispatchComputeIndirect(QOpenGLFunctions_4_5_Core* self, intptr_t indirect) {
...
void QOpenGLFunctions_4_5_Core_GlClearBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t target, uint32_t internalformat, intptr_t offset, intptr_t size, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_4_5_Core_GlClearBufferData(QOpenGLFunctions_4_5_Core* self, uint32_t target, uint32_t internalformat, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_4_5_Core_GlBindVertexBuffers(QOpenGLFunctions_4_5_Core* self, uint32_t first, int32_t count, const uint32_t* buffers, const intptr_t* offsets, const int32_t* strides) {
...
void QOpenGLFunctions_4_5_Core_GlBindBuffersRange(QOpenGLFunctions_4_5_Core* self, uint32_t target, uint32_t first, int32_t count, const uint32_t* buffers, const intptr_t* offsets, const intptr_t* sizes) {
...
void QOpenGLFunctions_4_5_Core_GlClearTexSubImage(QOpenGLFunctions_4_5_Core* self, uint32_t texture, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_4_5_Core_GlClearTexImage(QOpenGLFunctions_4_5_Core* self, uint32_t texture, int32_t level, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_4_5_Core_GlBufferStorage(QOpenGLFunctions_4_5_Core* self, uint32_t target, intptr_t size, const void* data, uint32_t flags) {
...
void QOpenGLFunctions_4_5_Core_GlReadnPixels(QOpenGLFunctions_4_5_Core* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, int32_t bufSize, void* data) {
...
void QOpenGLFunctions_4_5_Core_GlGetnTexImage(QOpenGLFunctions_4_5_Core* self, uint32_t target, int32_t level, uint32_t format, uint32_t type, int32_t bufSize, void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlGetTextureSubImage(QOpenGLFunctions_4_5_Core* self, uint32_t texture, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, int32_t bufSize, void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlVertexArrayAttribLFormat(QOpenGLFunctions_4_5_Core* self, uint32_t vaobj, uint32_t attribindex, int32_t size, uint32_t type, uint32_t relativeoffset) {
...
void QOpenGLFunctions_4_5_Core_GlVertexArrayAttribIFormat(QOpenGLFunctions_4_5_Core* self, uint32_t vaobj, uint32_t attribindex, int32_t size, uint32_t type, uint32_t relativeoffset) {
...
void QOpenGLFunctions_4_5_Core_GlVertexArrayAttribFormat(QOpenGLFunctions_4_5_Core* self, uint32_t vaobj, uint32_t attribindex, int32_t size, uint32_t type, unsigned char normalized, uint32_t relativeoffset) {
...
void QOpenGLFunctions_4_5_Core_GlVertexArrayVertexBuffers(QOpenGLFunctions_4_5_Core* self, uint32_t vaobj, uint32_t first, int32_t count, const uint32_t* buffers, const intptr_t* offsets, const int32_t* strides) {
...
void QOpenGLFunctions_4_5_Core_GlVertexArrayVertexBuffer(QOpenGLFunctions_4_5_Core* self, uint32_t vaobj, uint32_t bindingindex, uint32_t buffer, intptr_t offset, int32_t stride) {
...
void QOpenGLFunctions_4_5_Core_GlGetTextureImage(QOpenGLFunctions_4_5_Core* self, uint32_t texture, int32_t level, uint32_t format, uint32_t type, int32_t bufSize, void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTextureSubImage3D(QOpenGLFunctions_4_5_Core* self, uint32_t texture, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTextureSubImage2D(QOpenGLFunctions_4_5_Core* self, uint32_t texture, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTextureSubImage1D(QOpenGLFunctions_4_5_Core* self, uint32_t texture, int32_t level, int32_t xoffset, int32_t width, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLFunctions_4_5_Core_GlTextureBufferRange(QOpenGLFunctions_4_5_Core* self, uint32_t texture, uint32_t internalformat, uint32_t buffer, intptr_t offset, int32_t size) {
...
void QOpenGLFunctions_4_5_Core_GlGetNamedBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, intptr_t offset, intptr_t size, void* data) {
...
void QOpenGLFunctions_4_5_Core_GlFlushMappedNamedBufferRange(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, intptr_t offset, intptr_t length) {
...
void* QOpenGLFunctions_4_5_Core_GlMapNamedBufferRange(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, intptr_t offset, intptr_t length, uint32_t access) {
...
void QOpenGLFunctions_4_5_Core_GlClearNamedBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, uint32_t internalformat, intptr_t offset, intptr_t size, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_4_5_Core_GlClearNamedBufferData(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, uint32_t internalformat, uint32_t format, uint32_t type, const void* data) {
...
void QOpenGLFunctions_4_5_Core_GlCopyNamedBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t readBuffer, uint32_t writeBuffer, intptr_t readOffset, intptr_t writeOffset, intptr_t size) {
...
void QOpenGLFunctions_4_5_Core_GlNamedBufferSubData(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, intptr_t offset, intptr_t size, const void* data) {
    self->glNamedBufferSubData(static_cast<GLuint>(buffer), static_cast<GLintptr>(offset), static_cast<GLsizeiptr>(size), data);
}

void QOpenGLFunctions_4_5_Core_GlNamedBufferData(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, intptr_t size, const void* data, uint32_t usage) {
    self->glNamedBufferData(static_cast<GLuint>(buffer), static_cast<GLsizeiptr>(size), data, static_cast<GLenum>(usage));
}

void QOpenGLFunctions_4_5_Core_GlNamedBufferStorage(QOpenGLFunctions_4_5_Core* self, uint32_t buffer, intptr_t size, const void* data, uint32_t flags) {
...
void QOpenGLFunctions_4_5_Core_GlTransformFeedbackBufferRange(QOpenGLFunctions_4_5_Core* self, uint32_t xfb, uint32_t index, uint32_t buffer, intptr_t offset, intptr_t size) {
