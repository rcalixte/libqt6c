...
bool q_openglfunctions_4_3_compatibility_super_initialize_open_g_l_functions(void* self) {
    return QOpenGLFunctions_4_3_Compatibility_SuperInitializeOpenGLFunctions((QOpenGLFunctions_4_3_Compatibility*)self);
}
...
void q_openglfunctions_4_3_compatibility_gl_get_pointerv(void* self, uint32_t pname, void* params) {
    QOpenGLFunctions_4_3_Compatibility_GlGetPointerv((QOpenGLFunctions_4_3_Compatibility*)self, pname, params);
}
...
void q_openglfunctions_4_3_compatibility_gl_multi_draw_elements(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount) {
    QOpenGLFunctions_4_3_Compatibility_GlMultiDrawElements((QOpenGLFunctions_4_3_Compatibility*)self, mode, count, type, indices, drawcount);
}
...
void q_openglfunctions_4_3_compatibility_gl_get_buffer_pointerv(void* self, uint32_t target, uint32_t pname, void* params) {
    QOpenGLFunctions_4_3_Compatibility_GlGetBufferPointerv((QOpenGLFunctions_4_3_Compatibility*)self, target, pname, params);
}
...
void q_openglfunctions_4_3_compatibility_gl_shader_source(void* self, uint32_t shader, int32_t count, const char** string, int32_t* length) {
    QOpenGLFunctions_4_3_Compatibility_GlShaderSource((QOpenGLFunctions_4_3_Compatibility*)self, shader, count, string, length);
}
...
void q_openglfunctions_4_3_compatibility_gl_get_vertex_attrib_pointerv(void* self, uint32_t index, uint32_t pname, void* pointer) {
    QOpenGLFunctions_4_3_Compatibility_GlGetVertexAttribPointerv((QOpenGLFunctions_4_3_Compatibility*)self, index, pname, pointer);
}
...
void q_openglfunctions_4_3_compatibility_gl_transform_feedback_varyings(void* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode) {
    QOpenGLFunctions_4_3_Compatibility_GlTransformFeedbackVaryings((QOpenGLFunctions_4_3_Compatibility*)self, program, count, varyings, bufferMode);
}
...
void q_openglfunctions_4_3_compatibility_gl_get_uniform_indices(void* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices) {
    QOpenGLFunctions_4_3_Compatibility_GlGetUniformIndices((QOpenGLFunctions_4_3_Compatibility*)self, program, uniformCount, uniformNames, uniformIndices);
}
...
void q_openglfunctions_4_3_compatibility_gl_multi_draw_elements_base_vertex(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount, int32_t* basevertex) {
    QOpenGLFunctions_4_3_Compatibility_GlMultiDrawElementsBaseVertex((QOpenGLFunctions_4_3_Compatibility*)self, mode, count, type, indices, drawcount, basevertex);
}
...
uint32_t q_openglfunctions_4_3_compatibility_gl_create_shader_programv(void* self, uint32_t type, int32_t count, const char** strings) {
    return QOpenGLFunctions_4_3_Compatibility_GlCreateShaderProgramv((QOpenGLFunctions_4_3_Compatibility*)self, type, count, strings);
}
...
void q_openglfunctions_4_3_compatibility_gl_get_pixel_mapusv(void* self, uint32_t map, uint16_t* values) {
    QOpenGLFunctions_4_3_Compatibility_GlGetPixelMapusv((QOpenGLFunctions_4_3_Compatibility*)self, map, values);
}

void q_openglfunctions_4_3_compatibility_gl_get_pixel_mapuiv(void* self, uint32_t map, uint32_t* values) {
    QOpenGLFunctions_4_3_Compatibility_GlGetPixelMapuiv((QOpenGLFunctions_4_3_Compatibility*)self, map, values);
}

void q_openglfunctions_4_3_compatibility_gl_get_pixel_mapfv(void* self, uint32_t map, float* values) {
    QOpenGLFunctions_4_3_Compatibility_GlGetPixelMapfv((QOpenGLFunctions_4_3_Compatibility*)self, map, values);
}
...
void q_openglfunctions_4_3_compatibility_gl_pixel_mapusv(void* self, uint32_t map, int32_t mapsize, uint16_t* values) {
    QOpenGLFunctions_4_3_Compatibility_GlPixelMapusv((QOpenGLFunctions_4_3_Compatibility*)self, map, mapsize, values);
}

void q_openglfunctions_4_3_compatibility_gl_pixel_mapuiv(void* self, uint32_t map, int32_t mapsize, uint32_t* values) {
    QOpenGLFunctions_4_3_Compatibility_GlPixelMapuiv((QOpenGLFunctions_4_3_Compatibility*)self, map, mapsize, values);
}

void q_openglfunctions_4_3_compatibility_gl_pixel_mapfv(void* self, uint32_t map, int32_t mapsize, float* values) {
    QOpenGLFunctions_4_3_Compatibility_GlPixelMapfv((QOpenGLFunctions_4_3_Compatibility*)self, map, mapsize, values);
}
...
bool q_openglfunctions_4_3_compatibility_super_is_initialized(void* self) {
    return QOpenGLFunctions_4_3_Compatibility_SuperIsInitialized((QOpenGLFunctions_4_3_Compatibility*)self);
}
...
void q_openglfunctions_4_3_compatibility_super_set_owning_context(void* self, void* context) {
    QOpenGLFunctions_4_3_Compatibility_SuperSetOwningContext((QOpenGLFunctions_4_3_Compatibility*)self, (QOpenGLContext*)context);
}
...
QOpenGLContext* q_openglfunctions_4_3_compatibility_super_owning_context(void* self) {
    return QOpenGLFunctions_4_3_Compatibility_SuperOwningContext((QOpenGLFunctions_4_3_Compatibility*)self);
}
