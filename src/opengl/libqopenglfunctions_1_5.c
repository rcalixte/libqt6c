...
bool q_openglfunctions_1_5_super_initialize_open_g_l_functions(void* self) {
    return QOpenGLFunctions_1_5_SuperInitializeOpenGLFunctions((QOpenGLFunctions_1_5*)self);
}
...
void q_openglfunctions_1_5_gl_get_pointerv(void* self, uint32_t pname, void* params) {
    QOpenGLFunctions_1_5_GlGetPointerv((QOpenGLFunctions_1_5*)self, pname, params);
}
...
void q_openglfunctions_1_5_gl_multi_draw_elements(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount) {
    QOpenGLFunctions_1_5_GlMultiDrawElements((QOpenGLFunctions_1_5*)self, mode, count, type, indices, drawcount);
}
...
void q_openglfunctions_1_5_gl_get_buffer_pointerv(void* self, uint32_t target, uint32_t pname, void* params) {
    QOpenGLFunctions_1_5_GlGetBufferPointerv((QOpenGLFunctions_1_5*)self, target, pname, params);
}
...
void q_openglfunctions_1_5_gl_get_pixel_mapusv(void* self, uint32_t map, uint16_t* values) {
    QOpenGLFunctions_1_5_GlGetPixelMapusv((QOpenGLFunctions_1_5*)self, map, values);
}

void q_openglfunctions_1_5_gl_get_pixel_mapuiv(void* self, uint32_t map, uint32_t* values) {
    QOpenGLFunctions_1_5_GlGetPixelMapuiv((QOpenGLFunctions_1_5*)self, map, values);
}

void q_openglfunctions_1_5_gl_get_pixel_mapfv(void* self, uint32_t map, float* values) {
    QOpenGLFunctions_1_5_GlGetPixelMapfv((QOpenGLFunctions_1_5*)self, map, values);
}
...
void q_openglfunctions_1_5_gl_pixel_mapusv(void* self, uint32_t map, int32_t mapsize, uint16_t* values) {
    QOpenGLFunctions_1_5_GlPixelMapusv((QOpenGLFunctions_1_5*)self, map, mapsize, values);
}

void q_openglfunctions_1_5_gl_pixel_mapuiv(void* self, uint32_t map, int32_t mapsize, uint32_t* values) {
    QOpenGLFunctions_1_5_GlPixelMapuiv((QOpenGLFunctions_1_5*)self, map, mapsize, values);
}

void q_openglfunctions_1_5_gl_pixel_mapfv(void* self, uint32_t map, int32_t mapsize, float* values) {
    QOpenGLFunctions_1_5_GlPixelMapfv((QOpenGLFunctions_1_5*)self, map, mapsize, values);
}
...
bool q_openglfunctions_1_5_super_is_initialized(void* self) {
    return QOpenGLFunctions_1_5_SuperIsInitialized((QOpenGLFunctions_1_5*)self);
}
...
void q_openglfunctions_1_5_super_set_owning_context(void* self, void* context) {
    QOpenGLFunctions_1_5_SuperSetOwningContext((QOpenGLFunctions_1_5*)self, (QOpenGLContext*)context);
}
...
QOpenGLContext* q_openglfunctions_1_5_super_owning_context(void* self) {
    return QOpenGLFunctions_1_5_SuperOwningContext((QOpenGLFunctions_1_5*)self);
}
