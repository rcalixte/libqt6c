#pragma once
#ifndef SRC_OPENGL_QT6C_LIBQOPENGLFUNCTIONS_4_0_CORE_H
#define SRC_OPENGL_QT6C_LIBQOPENGLFUNCTIONS_4_0_CORE_H
...
///
void q_openglfunctions_4_0_core_gl_multi_draw_elements(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount);
...
/// @param params void*
///
void q_openglfunctions_4_0_core_gl_get_buffer_pointerv(void* self, uint32_t target, uint32_t pname, void* params);
...
///
void q_openglfunctions_4_0_core_gl_shader_source(void* self, uint32_t shader, int32_t count, const char** stringVal, int32_t* length);
...
/// @param pointer void*
///
void q_openglfunctions_4_0_core_gl_get_vertex_attrib_pointerv(void* self, uint32_t index, uint32_t pname, void* pointer);
...
///
void q_openglfunctions_4_0_core_gl_transform_feedback_varyings(void* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode);
...
/// @param uniformIndices uint32_t*
///
void q_openglfunctions_4_0_core_gl_get_uniform_indices(void* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices);
...
///
void q_openglfunctions_4_0_core_gl_multi_draw_elements_base_vertex(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount, int32_t* basevertex);
