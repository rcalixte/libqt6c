...
bool QOpenGLShaderProgram_AddShaderFromSourceCode(QOpenGLShaderProgram* self, int type, const char* source) {
    return self->addShaderFromSourceCode(static_cast<QOpenGLShader::ShaderType>(type), source);
}

bool QOpenGLShaderProgram_AddShaderFromSourceCode2(QOpenGLShaderProgram* self, int type, const libqt_string source) {
    QByteArray source_QByteArray(source.data, source.len);
    return self->addShaderFromSourceCode(static_cast<QOpenGLShader::ShaderType>(type), source_QByteArray);
}

bool QOpenGLShaderProgram_AddShaderFromSourceCode3(QOpenGLShaderProgram* self, int type, const libqt_string source) {
    QString source_QString = QString::fromUtf8(source.data, source.len);
    return self->addShaderFromSourceCode(static_cast<QOpenGLShader::ShaderType>(type), source_QString);
}

bool QOpenGLShaderProgram_AddShaderFromSourceFile(QOpenGLShaderProgram* self, int type, const libqt_string fileName) {
    QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
    return self->addShaderFromSourceFile(static_cast<QOpenGLShader::ShaderType>(type), fileName_QString);
}

bool QOpenGLShaderProgram_AddCacheableShaderFromSourceCode(QOpenGLShaderProgram* self, int type, const char* source) {
    return self->addCacheableShaderFromSourceCode(static_cast<QOpenGLShader::ShaderType>(type), source);
}

bool QOpenGLShaderProgram_AddCacheableShaderFromSourceCode2(QOpenGLShaderProgram* self, int type, const libqt_string source) {
    QByteArray source_QByteArray(source.data, source.len);
    return self->addCacheableShaderFromSourceCode(static_cast<QOpenGLShader::ShaderType>(type), source_QByteArray);
}

bool QOpenGLShaderProgram_AddCacheableShaderFromSourceCode3(QOpenGLShaderProgram* self, int type, const libqt_string source) {
    QString source_QString = QString::fromUtf8(source.data, source.len);
    return self->addCacheableShaderFromSourceCode(static_cast<QOpenGLShader::ShaderType>(type), source_QString);
}

bool QOpenGLShaderProgram_AddCacheableShaderFromSourceFile(QOpenGLShaderProgram* self, int type, const libqt_string fileName) {
    QString fileName_QString = QString::fromUtf8(fileName.data, fileName.len);
    return self->addCacheableShaderFromSourceFile(static_cast<QOpenGLShader::ShaderType>(type), fileName_QString);
}
...
void QOpenGLShaderProgram_SetDefaultOuterTessellationLevels(QOpenGLShaderProgram* self, const libqt_list /* of float */ levels) {
    ...
    float* levels_arr = static_cast<float*>(levels.data.floats);
...
void QOpenGLShaderProgram_SetAttributeArray5(QOpenGLShaderProgram* self, int location, uint32_t type, const void* values, int tupleSize) {
    self->setAttributeArray(static_cast<int>(location), static_cast<GLenum>(type), values, static_cast<int>(tupleSize));
}
...
void QOpenGLShaderProgram_SetAttributeArray10(QOpenGLShaderProgram* self, const char* name, uint32_t type, const void* values, int tupleSize) {
    self->setAttributeArray(name, static_cast<GLenum>(type), values, static_cast<int>(tupleSize));
}

void QOpenGLShaderProgram_SetAttributeBuffer(QOpenGLShaderProgram* self, int location, uint32_t type, int offset, int tupleSize) {
    self->setAttributeBuffer(static_cast<int>(location), static_cast<GLenum>(type), static_cast<int>(offset), static_cast<int>(tupleSize));
}

void QOpenGLShaderProgram_SetAttributeBuffer2(QOpenGLShaderProgram* self, const char* name, uint32_t type, int offset, int tupleSize) {
    self->setAttributeBuffer(name, static_cast<GLenum>(type), static_cast<int>(offset), static_cast<int>(tupleSize));
}
...
void QOpenGLShaderProgram_SetAttributeArray52(QOpenGLShaderProgram* self, int location, uint32_t type, const void* values, int tupleSize, int stride) {
    self->setAttributeArray(static_cast<int>(location), static_cast<GLenum>(type), values, static_cast<int>(tupleSize), static_cast<int>(stride));
}
...
void QOpenGLShaderProgram_SetAttributeArray53(QOpenGLShaderProgram* self, const char* name, uint32_t type, const void* values, int tupleSize, int stride) {
    self->setAttributeArray(name, static_cast<GLenum>(type), values, static_cast<int>(tupleSize), static_cast<int>(stride));
}

void QOpenGLShaderProgram_SetAttributeBuffer5(QOpenGLShaderProgram* self, int location, uint32_t type, int offset, int tupleSize, int stride) {
    self->setAttributeBuffer(static_cast<int>(location), static_cast<GLenum>(type), static_cast<int>(offset), static_cast<int>(tupleSize), static_cast<int>(stride));
}

void QOpenGLShaderProgram_SetAttributeBuffer52(QOpenGLShaderProgram* self, const char* name, uint32_t type, int offset, int tupleSize, int stride) {
    self->setAttributeBuffer(name, static_cast<GLenum>(type), static_cast<int>(offset), static_cast<int>(tupleSize), static_cast<int>(stride));
}
