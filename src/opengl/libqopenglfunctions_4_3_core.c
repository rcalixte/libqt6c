...
bool q_openglfunctions_4_3_core_super_initialize_open_g_l_functions(void* self) {
    return QOpenGLFunctions_4_3_Core_SuperInitializeOpenGLFunctions((QOpenGLFunctions_4_3_Core*)self);
}
...
void q_openglfunctions_4_3_core_gl_multi_draw_elements(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount) {
    QOpenGLFunctions_4_3_Core_GlMultiDrawElements((QOpenGLFunctions_4_3_Core*)self, mode, count, type, indices, drawcount);
}
...
void q_openglfunctions_4_3_core_gl_get_buffer_pointerv(void* self, uint32_t target, uint32_t pname, void* params) {
    QOpenGLFunctions_4_3_Core_GlGetBufferPointerv((QOpenGLFunctions_4_3_Core*)self, target, pname, params);
}
...
void q_openglfunctions_4_3_core_gl_get_vertex_attrib_pointerv(void* self, uint32_t index, uint32_t pname, void* pointer) {
    QOpenGLFunctions_4_3_Core_GlGetVertexAttribPointerv((QOpenGLFunctions_4_3_Core*)self, index, pname, pointer);
}
...
void q_openglfunctions_4_3_core_gl_transform_feedback_varyings(void* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode) {
    QOpenGLFunctions_4_3_Core_GlTransformFeedbackVaryings((QOpenGLFunctions_4_3_Core*)self, program, count, varyings, bufferMode);
}
...
void q_openglfunctions_4_3_core_gl_get_uniform_indices(void* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices) {
    QOpenGLFunctions_4_3_Core_GlGetUniformIndices((QOpenGLFunctions_4_3_Core*)self, program, uniformCount, uniformNames, uniformIndices);
}
...
void q_openglfunctions_4_3_core_gl_multi_draw_elements_base_vertex(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount, int32_t* basevertex) {
    QOpenGLFunctions_4_3_Core_GlMultiDrawElementsBaseVertex((QOpenGLFunctions_4_3_Core*)self, mode, count, type, indices, drawcount, basevertex);
}
...
uint32_t q_openglfunctions_4_3_core_gl_create_shader_programv(void* self, uint32_t type, int32_t count, const char** strings) {
    return QOpenGLFunctions_4_3_Core_GlCreateShaderProgramv((QOpenGLFunctions_4_3_Core*)self, type, count, strings);
}
