#pragma once
#ifndef SRC_OPENGLC_LIBQOPENGLFUNCTIONS_4_2_CORE_HPP
#define SRC_OPENGLC_LIBQOPENGLFUNCTIONS_4_2_CORE_HPP
...
void QOpenGLFunctions_4_2_Core_GlGetTexImage(QOpenGLFunctions_4_2_Core* self, uint32_t target, int32_t level, uint32_t format, uint32_t type, void* pixels);
...
void QOpenGLFunctions_4_2_Core_GlReadPixels(QOpenGLFunctions_4_2_Core* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, void* pixels);
...
void QOpenGLFunctions_4_2_Core_GlTexImage2D(QOpenGLFunctions_4_2_Core* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t border, uint32_t format, uint32_t type, const void* pixels);
void QOpenGLFunctions_4_2_Core_GlTexImage1D(QOpenGLFunctions_4_2_Core* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t border, uint32_t format, uint32_t type, const void* pixels);
...
void QOpenGLFunctions_4_2_Core_GlTexSubImage2D(QOpenGLFunctions_4_2_Core* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t width, int32_t height, uint32_t format, uint32_t type, const void* pixels);
void QOpenGLFunctions_4_2_Core_GlTexSubImage1D(QOpenGLFunctions_4_2_Core* self, uint32_t target, int32_t level, int32_t xoffset, int32_t width, uint32_t format, uint32_t type, const void* pixels);
...
void QOpenGLFunctions_4_2_Core_GlDrawElements(QOpenGLFunctions_4_2_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices);
...
void QOpenGLFunctions_4_2_Core_GlTexSubImage3D(QOpenGLFunctions_4_2_Core* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, const void* pixels);
void QOpenGLFunctions_4_2_Core_GlTexImage3D(QOpenGLFunctions_4_2_Core* self, uint32_t target, int32_t level, int32_t internalformat, int32_t width, int32_t height, int32_t depth, int32_t border, uint32_t format, uint32_t type, const void* pixels);
void QOpenGLFunctions_4_2_Core_GlDrawRangeElements(QOpenGLFunctions_4_2_Core* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices);
...
void QOpenGLFunctions_4_2_Core_GlMultiDrawElements(QOpenGLFunctions_4_2_Core* self, uint32_t mode, const int32_t* count, uint32_t type, const void** indices, int32_t drawcount);
...
void QOpenGLFunctions_4_2_Core_GlGetBufferSubData(QOpenGLFunctions_4_2_Core* self, uint32_t target, intptr_t offset, intptr_t size, void* data);
void QOpenGLFunctions_4_2_Core_GlBufferSubData(QOpenGLFunctions_4_2_Core* self, uint32_t target, intptr_t offset, intptr_t size, const void* data);
void QOpenGLFunctions_4_2_Core_GlBufferData(QOpenGLFunctions_4_2_Core* self, uint32_t target, intptr_t size, const void* data, uint32_t usage);
...
void QOpenGLFunctions_4_2_Core_GlVertexAttribPointer(QOpenGLFunctions_4_2_Core* self, uint32_t index, int32_t size, uint32_t type, unsigned char normalized, int32_t stride, const void* pointer);
...
void QOpenGLFunctions_4_2_Core_GlShaderSource(QOpenGLFunctions_4_2_Core* self, uint32_t shader, int32_t count, const char** stringVal, const int32_t* length);
...
int32_t QOpenGLFunctions_4_2_Core_GlGetUniformLocation(QOpenGLFunctions_4_2_Core* self, uint32_t program, const char* name);
void QOpenGLFunctions_4_2_Core_GlGetShaderSource(QOpenGLFunctions_4_2_Core* self, uint32_t shader, int32_t bufSize, int32_t* length, char* source);
void QOpenGLFunctions_4_2_Core_GlGetShaderInfoLog(QOpenGLFunctions_4_2_Core* self, uint32_t shader, int32_t bufSize, int32_t* length, char* infoLog);
...
void QOpenGLFunctions_4_2_Core_GlGetProgramInfoLog(QOpenGLFunctions_4_2_Core* self, uint32_t program, int32_t bufSize, int32_t* length, char* infoLog);
...
int32_t QOpenGLFunctions_4_2_Core_GlGetAttribLocation(QOpenGLFunctions_4_2_Core* self, uint32_t program, const char* name);
...
uint32_t QOpenGLFunctions_4_2_Core_GlCreateShader(QOpenGLFunctions_4_2_Core* self, uint32_t type);
...
void QOpenGLFunctions_4_2_Core_GlBindAttribLocation(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t index, const char* name);
...
void QOpenGLFunctions_4_2_Core_GlFlushMappedBufferRange(QOpenGLFunctions_4_2_Core* self, uint32_t target, intptr_t offset, intptr_t length);
void* QOpenGLFunctions_4_2_Core_GlMapBufferRange(QOpenGLFunctions_4_2_Core* self, uint32_t target, intptr_t offset, intptr_t length, uint32_t access);
...
int32_t QOpenGLFunctions_4_2_Core_GlGetFragDataLocation(QOpenGLFunctions_4_2_Core* self, uint32_t program, const char* name);
void QOpenGLFunctions_4_2_Core_GlBindFragDataLocation(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t color, const char* name);
...
void QOpenGLFunctions_4_2_Core_GlVertexAttribIPointer(QOpenGLFunctions_4_2_Core* self, uint32_t index, int32_t size, uint32_t type, int32_t stride, const void* pointer);
...
void QOpenGLFunctions_4_2_Core_GlTransformFeedbackVaryings(QOpenGLFunctions_4_2_Core* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode);
...
void QOpenGLFunctions_4_2_Core_GlBindBufferRange(QOpenGLFunctions_4_2_Core* self, uint32_t target, uint32_t index, uint32_t buffer, intptr_t offset, intptr_t size);
...
void QOpenGLFunctions_4_2_Core_GlCopyBufferSubData(QOpenGLFunctions_4_2_Core* self, uint32_t readTarget, uint32_t writeTarget, intptr_t readOffset, intptr_t writeOffset, intptr_t size);
...
void QOpenGLFunctions_4_2_Core_GlGetActiveUniformBlockName(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t uniformBlockIndex, int32_t bufSize, int32_t* length, char* uniformBlockName);
...
uint32_t QOpenGLFunctions_4_2_Core_GlGetUniformBlockIndex(QOpenGLFunctions_4_2_Core* self, uint32_t program, const char* uniformBlockName);
void QOpenGLFunctions_4_2_Core_GlGetActiveUniformName(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t uniformIndex, int32_t bufSize, int32_t* length, char* uniformName);
...
void QOpenGLFunctions_4_2_Core_GlGetUniformIndices(QOpenGLFunctions_4_2_Core* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices);
...
void QOpenGLFunctions_4_2_Core_GlDrawElementsInstanced(QOpenGLFunctions_4_2_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount);
...
void QOpenGLFunctions_4_2_Core_GlMultiDrawElementsBaseVertex(QOpenGLFunctions_4_2_Core* self, uint32_t mode, const int32_t* count, uint32_t type, const void** indices, int32_t drawcount, const int32_t* basevertex);
void QOpenGLFunctions_4_2_Core_GlDrawElementsInstancedBaseVertex(QOpenGLFunctions_4_2_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, int32_t basevertex);
void QOpenGLFunctions_4_2_Core_GlDrawRangeElementsBaseVertex(QOpenGLFunctions_4_2_Core* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices, int32_t basevertex);
void QOpenGLFunctions_4_2_Core_GlDrawElementsBaseVertex(QOpenGLFunctions_4_2_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t basevertex);
...
void QOpenGLFunctions_4_2_Core_GlVertexAttribP4uiv(QOpenGLFunctions_4_2_Core* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value);
void QOpenGLFunctions_4_2_Core_GlVertexAttribP4ui(QOpenGLFunctions_4_2_Core* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value);
void QOpenGLFunctions_4_2_Core_GlVertexAttribP3uiv(QOpenGLFunctions_4_2_Core* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value);
void QOpenGLFunctions_4_2_Core_GlVertexAttribP3ui(QOpenGLFunctions_4_2_Core* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value);
void QOpenGLFunctions_4_2_Core_GlVertexAttribP2uiv(QOpenGLFunctions_4_2_Core* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value);
void QOpenGLFunctions_4_2_Core_GlVertexAttribP2ui(QOpenGLFunctions_4_2_Core* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value);
void QOpenGLFunctions_4_2_Core_GlVertexAttribP1uiv(QOpenGLFunctions_4_2_Core* self, uint32_t index, uint32_t type, unsigned char normalized, const uint32_t* value);
void QOpenGLFunctions_4_2_Core_GlVertexAttribP1ui(QOpenGLFunctions_4_2_Core* self, uint32_t index, uint32_t type, unsigned char normalized, uint32_t value);
...
int32_t QOpenGLFunctions_4_2_Core_GlGetFragDataIndex(QOpenGLFunctions_4_2_Core* self, uint32_t program, const char* name);
void QOpenGLFunctions_4_2_Core_GlBindFragDataLocationIndexed(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t colorNumber, uint32_t index, const char* name);
...
void QOpenGLFunctions_4_2_Core_GlGetActiveSubroutineName(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t shadertype, uint32_t index, int32_t bufsize, int32_t* length, char* name);
void QOpenGLFunctions_4_2_Core_GlGetActiveSubroutineUniformName(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t shadertype, uint32_t index, int32_t bufsize, int32_t* length, char* name);
...
uint32_t QOpenGLFunctions_4_2_Core_GlGetSubroutineIndex(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t shadertype, const char* name);
int32_t QOpenGLFunctions_4_2_Core_GlGetSubroutineUniformLocation(QOpenGLFunctions_4_2_Core* self, uint32_t program, uint32_t shadertype, const char* name);
...
void QOpenGLFunctions_4_2_Core_GlDrawElementsIndirect(QOpenGLFunctions_4_2_Core* self, uint32_t mode, uint32_t type, const void* indirect);
...
void QOpenGLFunctions_4_2_Core_GlVertexAttribLPointer(QOpenGLFunctions_4_2_Core* self, uint32_t index, int32_t size, uint32_t type, int32_t stride, const void* pointer);
...
void QOpenGLFunctions_4_2_Core_GlGetProgramPipelineInfoLog(QOpenGLFunctions_4_2_Core* self, uint32_t pipeline, int32_t bufSize, int32_t* length, char* infoLog);
...
uint32_t QOpenGLFunctions_4_2_Core_GlCreateShaderProgramv(QOpenGLFunctions_4_2_Core* self, uint32_t type, int32_t count, const char** strings);
...
void QOpenGLFunctions_4_2_Core_GlDrawElementsInstancedBaseVertexBaseInstance(QOpenGLFunctions_4_2_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, int32_t basevertex, uint32_t baseinstance);
void QOpenGLFunctions_4_2_Core_GlDrawElementsInstancedBaseInstance(QOpenGLFunctions_4_2_Core* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, uint32_t baseinstance);
