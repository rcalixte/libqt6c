#pragma once
#ifndef SRC_EXTRAS_KTEXTEDITORC_LIBCODECOMPLETIONMODELCONTROLLERINTERFACE_HPP
#define SRC_EXTRAS_KTEXTEDITORC_LIBCODECOMPLETIONMODELCONTROLLERINTERFACE_HPP
