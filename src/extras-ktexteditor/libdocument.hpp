#pragma once
#ifndef SRC_EXTRAS_KTEXTEDITORC_LIBDOCUMENT_HPP
#define SRC_EXTRAS_KTEXTEDITORC_LIBDOCUMENT_HPP
...
void KTextEditor__Document_ReadSessionConfig(KTextEditor__Document* self, const KConfigGroup* config, const libqt_list /* set of const char* */ flags);
void KTextEditor__Document_WriteSessionConfig(KTextEditor__Document* self, KConfigGroup* config, const libqt_list /* set of const char* */ flags);
