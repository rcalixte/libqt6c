#pragma once
#ifndef EXTRAS_KTEXTEDITOR_LIBANNOTATIONINTERFACE_H
#define EXTRAS_KTEXTEDITOR_LIBANNOTATIONINTERFACE_H
...
///
void k_texteditor__annotationmodel_set_object_name(void* self, const char* name);
