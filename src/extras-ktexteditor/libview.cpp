...
void KTextEditor__View_SetCursorPositions(KTextEditor__View* self, const libqt_list /* of KTextEditor__Cursor* */ positions) {
    ...
    KTextEditor__Cursor** positions_arr = static_cast<KTextEditor__Cursor**>(positions.data.ptr);
...
void KTextEditor__View_SetSelections(KTextEditor__View* self, const libqt_list /* of KTextEditor__Range* */ ranges) {
    ...
    KTextEditor__Range** ranges_arr = static_cast<KTextEditor__Range**>(ranges.data.ptr);
...
void KTextEditor__View_ReadSessionConfig(KTextEditor__View* self, const KConfigGroup* config, const libqt_list /* set of const char* */ flags) {
...
void KTextEditor__View_WriteSessionConfig(KTextEditor__View* self, KConfigGroup* config, const libqt_list /* set of const char* */ flags) {
    // Convert libqt_list to QSet<>
    QSet<QString> flags_set;
    flags_set.reserve(flags.len);
    const char** flags_strarr = static_cast<const char**>(flags.data.ptr);
...
void KTextEditor__View_StartCompletion2(KTextEditor__View* self, const KTextEditor__Range* word, const libqt_list /* of KTextEditor__CodeCompletionModel* */ models, int invocationType) {
    ...
    KTextEditor__CodeCompletionModel** models_arr = static_cast<KTextEditor__CodeCompletionModel**>(models.data.ptr);
