...
class VirtualQRadioButton final : public QRadioButton {
  ...
  public:
    ...
    friend bool QRadioButton_HitButton(const QRadioButton* self, QPoint* param1);
    friend bool QRadioButton_QBaseHitButton(const QRadioButton* self, QPoint* param1);
    ...
    friend bool QRadioButton_NativeEvent(QRadioButton* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QRadioButton_QBaseNativeEvent(QRadioButton* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QRadioButton_ConnectNotify(QRadioButton* self, QMetaMethod* signal);
    friend void QRadioButton_QBaseConnectNotify(QRadioButton* self, QMetaMethod* signal);
    friend void QRadioButton_DisconnectNotify(QRadioButton* self, QMetaMethod* signal);
    friend void QRadioButton_QBaseDisconnectNotify(QRadioButton* self, QMetaMethod* signal);
    ...
    friend bool QRadioButton_IsSignalConnected(const QRadioButton* self, QMetaMethod* signal);
    friend bool QRadioButton_QBaseIsSignalConnected(const QRadioButton* self, QMetaMethod* signal);
};
