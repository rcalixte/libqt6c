...
class VirtualQQmlWebChannel final : public QQmlWebChannel {
  ...
  public:
    ...
    friend void QQmlWebChannel_ConnectNotify(QQmlWebChannel* self, QMetaMethod* signal);
    friend void QQmlWebChannel_QBaseConnectNotify(QQmlWebChannel* self, QMetaMethod* signal);
    friend void QQmlWebChannel_DisconnectNotify(QQmlWebChannel* self, QMetaMethod* signal);
    friend void QQmlWebChannel_QBaseDisconnectNotify(QQmlWebChannel* self, QMetaMethod* signal);
    ...
    friend bool QQmlWebChannel_IsSignalConnected(const QQmlWebChannel* self, QMetaMethod* signal);
    friend bool QQmlWebChannel_QBaseIsSignalConnected(const QQmlWebChannel* self, QMetaMethod* signal);
};
