...
QWidget* k_pagewidget_find(uintptr_t param1) {
...
bool k_pagewidget_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_pagewidget_as_q_paint_device(self));
}

int32_t k_pagewidget_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_pagewidget_as_q_paint_device(self));
}

int32_t k_pagewidget_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_pagewidget_as_q_paint_device(self));
}

int32_t k_pagewidget_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_pagewidget_as_q_paint_device(self));
}

int32_t k_pagewidget_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_pagewidget_as_q_paint_device(self));
}

int32_t k_pagewidget_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_pagewidget_as_q_paint_device(self));
}

int32_t k_pagewidget_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_pagewidget_as_q_paint_device(self));
}

double k_pagewidget_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_pagewidget_as_q_paint_device(self));
}

double k_pagewidget_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_pagewidget_as_q_paint_device(self));
}

int32_t k_pagewidget_color_count(void* self) {
    return QPaintDevice_ColorCount(k_pagewidget_as_q_paint_device(self));
}

int32_t k_pagewidget_depth(void* self) {
    return QPaintDevice_Depth(k_pagewidget_as_q_paint_device(self));
}
