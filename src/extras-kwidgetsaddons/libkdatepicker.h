#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKDATEPICKER_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKDATEPICKER_H
...
void k_datepicker_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KDatePicker*
/// @param typeVal enum Qt__GestureType
void k_datepicker_ungrab_gesture(void* self, int64_t typeVal);
...
int64_t k_datepicker_window_state(void* self);
...
void k_datepicker_set_window_state(void* self, int64_t state);
...
/// @param self KDatePicker*
/// @param state flag of enum Qt__WindowState
void k_datepicker_override_window_state(void* self, int64_t state);
...
void k_datepicker_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KDatePicker*
/// @param typeVal flag of enum Qt__WindowType
void k_datepicker_override_window_flags(void* self, int64_t typeVal);
...
void k_datepicker_render4(void* self, void* target, void* targetOffset, void* sourceRegion, int64_t renderFlags);
...
/// @param sourceRegion QRegion*
/// @param renderFlags flag of enum QWidget__RenderFlag
void k_datepicker_render42(void* self, void* painter, void* targetOffset, void* sourceRegion, int64_t renderFlags);
...
void k_datepicker_grab_gesture2(void* self, int64_t typeVal, int64_t flags);
...
QMetaObject__Connection* k_datepicker_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_datepicker_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
