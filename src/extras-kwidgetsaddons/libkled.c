...
const QMetaObject* k_led_super_meta_object(void* self) {
    return KLed_SuperMetaObject((KLed*)self);
}
...
void* k_led_super_metacast(void* self, const char* param1) {
    return KLed_SuperMetacast((KLed*)self, param1);
}
...
int32_t k_led_super_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KLed_SuperMetacall((KLed*)self, param1, param2, param3);
}
...
QSize* k_led_super_size_hint(void* self) {
    return KLed_SuperSizeHint((KLed*)self);
}
...
QSize* k_led_super_minimum_size_hint(void* self) {
    return KLed_SuperMinimumSizeHint((KLed*)self);
}
...
void k_led_super_paint_event(void* self, void* param1) {
    KLed_SuperPaintEvent((KLed*)self, (QPaintEvent*)param1);
}
...
void k_led_super_resize_event(void* self, void* param1) {
    KLed_SuperResizeEvent((KLed*)self, (QResizeEvent*)param1);
}
...
const char** k_led_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_led_dynamic_property_names\n");
        abort();
    }
...
bool k_led_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_led_as_q_paint_device(self));
}

int32_t k_led_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_led_as_q_paint_device(self));
}

int32_t k_led_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_led_as_q_paint_device(self));
}

int32_t k_led_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_led_as_q_paint_device(self));
}

int32_t k_led_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_led_as_q_paint_device(self));
}

int32_t k_led_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_led_as_q_paint_device(self));
}

int32_t k_led_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_led_as_q_paint_device(self));
}

double k_led_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_led_as_q_paint_device(self));
}

double k_led_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_led_as_q_paint_device(self));
}

int32_t k_led_color_count(void* self) {
    return QPaintDevice_ColorCount(k_led_as_q_paint_device(self));
}

int32_t k_led_depth(void* self) {
    return QPaintDevice_Depth(k_led_as_q_paint_device(self));
}
...
void k_led_super_set_visible(void* self, bool visible) {
    KLed_SuperSetVisible((KLed*)self, visible);
}
...
bool k_led_super_event(void* self, void* event) {
    return KLed_SuperEvent((KLed*)self, (QEvent*)event);
}
...
void k_led_super_mouse_press_event(void* self, void* event) {
    KLed_SuperMousePressEvent((KLed*)self, (QMouseEvent*)event);
}
...
void k_led_super_mouse_release_event(void* self, void* event) {
    KLed_SuperMouseReleaseEvent((KLed*)self, (QMouseEvent*)event);
}
...
void k_led_super_mouse_double_click_event(void* self, void* event) {
    KLed_SuperMouseDoubleClickEvent((KLed*)self, (QMouseEvent*)event);
}
...
void k_led_super_mouse_move_event(void* self, void* event) {
    KLed_SuperMouseMoveEvent((KLed*)self, (QMouseEvent*)event);
}
...
void k_led_super_wheel_event(void* self, void* event) {
    KLed_SuperWheelEvent((KLed*)self, (QWheelEvent*)event);
}
...
void k_led_super_key_press_event(void* self, void* event) {
    KLed_SuperKeyPressEvent((KLed*)self, (QKeyEvent*)event);
}
...
void k_led_super_key_release_event(void* self, void* event) {
    KLed_SuperKeyReleaseEvent((KLed*)self, (QKeyEvent*)event);
}
...
void k_led_super_focus_in_event(void* self, void* event) {
    KLed_SuperFocusInEvent((KLed*)self, (QFocusEvent*)event);
}
...
void k_led_super_focus_out_event(void* self, void* event) {
    KLed_SuperFocusOutEvent((KLed*)self, (QFocusEvent*)event);
}
...
void k_led_super_enter_event(void* self, void* event) {
    KLed_SuperEnterEvent((KLed*)self, (QEnterEvent*)event);
}
...
void k_led_super_leave_event(void* self, void* event) {
    KLed_SuperLeaveEvent((KLed*)self, (QEvent*)event);
}
...
void k_led_super_move_event(void* self, void* event) {
    KLed_SuperMoveEvent((KLed*)self, (QMoveEvent*)event);
}
...
void k_led_super_close_event(void* self, void* event) {
    KLed_SuperCloseEvent((KLed*)self, (QCloseEvent*)event);
}
...
void k_led_super_context_menu_event(void* self, void* event) {
    KLed_SuperContextMenuEvent((KLed*)self, (QContextMenuEvent*)event);
}
...
void k_led_super_tablet_event(void* self, void* event) {
    KLed_SuperTabletEvent((KLed*)self, (QTabletEvent*)event);
}
...
void k_led_super_action_event(void* self, void* event) {
    KLed_SuperActionEvent((KLed*)self, (QActionEvent*)event);
}
...
void k_led_super_drag_enter_event(void* self, void* event) {
    KLed_SuperDragEnterEvent((KLed*)self, (QDragEnterEvent*)event);
}
...
void k_led_super_drag_move_event(void* self, void* event) {
    KLed_SuperDragMoveEvent((KLed*)self, (QDragMoveEvent*)event);
}
...
void k_led_super_drag_leave_event(void* self, void* event) {
    KLed_SuperDragLeaveEvent((KLed*)self, (QDragLeaveEvent*)event);
}
...
void k_led_super_drop_event(void* self, void* event) {
    KLed_SuperDropEvent((KLed*)self, (QDropEvent*)event);
}
...
void k_led_super_show_event(void* self, void* event) {
    KLed_SuperShowEvent((KLed*)self, (QShowEvent*)event);
}
...
void k_led_super_hide_event(void* self, void* event) {
    KLed_SuperHideEvent((KLed*)self, (QHideEvent*)event);
}
...
bool k_led_super_native_event(void* self, char* eventType, void* message, intptr_t* result) {
    return KLed_SuperNativeEvent((KLed*)self, qstring(eventType), message, result);
}
...
void k_led_super_change_event(void* self, void* param1) {
    KLed_SuperChangeEvent((KLed*)self, (QEvent*)param1);
}
...
void k_led_super_input_method_event(void* self, void* param1) {
    KLed_SuperInputMethodEvent((KLed*)self, (QInputMethodEvent*)param1);
}
...
bool k_led_super_focus_next_prev_child(void* self, bool next) {
    return KLed_SuperFocusNextPrevChild((KLed*)self, next);
}
...
bool k_led_super_event_filter(void* self, void* watched, void* event) {
    return KLed_SuperEventFilter((KLed*)self, (QObject*)watched, (QEvent*)event);
}
...
void k_led_super_timer_event(void* self, void* event) {
    KLed_SuperTimerEvent((KLed*)self, (QTimerEvent*)event);
}
...
void k_led_super_child_event(void* self, void* event) {
    KLed_SuperChildEvent((KLed*)self, (QChildEvent*)event);
}
...
void k_led_super_custom_event(void* self, void* event) {
    KLed_SuperCustomEvent((KLed*)self, (QEvent*)event);
}
...
void k_led_super_connect_notify(void* self, void* signal) {
    KLed_SuperConnectNotify((KLed*)self, (QMetaMethod*)signal);
}
...
void k_led_super_disconnect_notify(void* self, void* signal) {
    KLed_SuperDisconnectNotify((KLed*)self, (QMetaMethod*)signal);
}
...
void k_led_super_update_micro_focus(void* self) {
    KLed_SuperUpdateMicroFocus((KLed*)self);
}
...
bool k_led_super_focus_next_child(void* self) {
    return KLed_SuperFocusNextChild((KLed*)self);
}
...
bool k_led_super_focus_previous_child(void* self) {
    return KLed_SuperFocusPreviousChild((KLed*)self);
}
...
QObject* k_led_super_sender(void* self) {
    return KLed_SuperSender((KLed*)self);
}
...
int32_t k_led_super_sender_signal_index(void* self) {
    return KLed_SuperSenderSignalIndex((KLed*)self);
}
...
int32_t k_led_super_receivers(void* self, const char* signal) {
    return KLed_SuperReceivers((KLed*)self, signal);
}
...
bool k_led_super_is_signal_connected(void* self, void* signal) {
    return KLed_SuperIsSignalConnected((KLed*)self, (QMetaMethod*)signal);
}
...
double k_led_super_get_decoded_metric_f(void* self, int32_t metricA, int32_t metricB) {
    return KLed_SuperGetDecodedMetricF((KLed*)self, metricA, metricB);
}
