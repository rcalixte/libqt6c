#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKRATINGPAINTER_H
#define SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKRATINGPAINTER_H
...
/// [Qt documentation](https://api.kde.org/kratingpainter.html#maxRating)
///
/// @param self KRatingPainter*
int32_t k_ratingpainter_max_rating(void* self);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#halfStepsEnabled)
///
/// @param self KRatingPainter*
bool k_ratingpainter_half_steps_enabled(void* self);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#alignment)
///
/// @param self KRatingPainter*
///
...
/// [Qt documentation](https://api.kde.org/kratingpainter.html#layoutDirection)
///
/// @param self KRatingPainter*
///
...
/// [Qt documentation](https://api.kde.org/kratingpainter.html#icon)
///
/// @param self KRatingPainter*
QIcon* k_ratingpainter_icon(void* self);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#isEnabled)
///
/// @param self KRatingPainter*
bool k_ratingpainter_is_enabled(void* self);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#customPixmap)
///
/// @param self KRatingPainter*
QPixmap* k_ratingpainter_custom_pixmap(void* self);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#spacing)
///
/// @param self KRatingPainter*
int32_t k_ratingpainter_spacing(void* self);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#setMaxRating)
///
/// @param self KRatingPainter*
/// @param max int
void k_ratingpainter_set_max_rating(void* self, int max);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#setHalfStepsEnabled)
///
/// @param self KRatingPainter*
/// @param enabled bool
void k_ratingpainter_set_half_steps_enabled(void* self, bool enabled);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#setAlignment)
///
/// @param self KRatingPainter*
/// @param align flag of enum Qt__AlignmentFlag
void k_ratingpainter_set_alignment(void* self, int32_t align);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#setLayoutDirection)
///
/// @param self KRatingPainter*
/// @param direction enum Qt__LayoutDirection
void k_ratingpainter_set_layout_direction(void* self, int32_t direction);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#setIcon)
///
/// @param self KRatingPainter*
/// @param icon QIcon*
void k_ratingpainter_set_icon(void* self, void* icon);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#setEnabled)
///
/// @param self KRatingPainter*
/// @param enabled bool
void k_ratingpainter_set_enabled(void* self, bool enabled);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#setCustomPixmap)
///
/// @param self KRatingPainter*
/// @param pixmap QPixmap*
void k_ratingpainter_set_custom_pixmap(void* self, void* pixmap);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#setSpacing)
///
/// @param self KRatingPainter*
/// @param spacing int
void k_ratingpainter_set_spacing(void* self, int spacing);

/// [Qt documentation](https://api.kde.org/kratingpainter.html#paint)
///
/// @param self KRatingPainter*
...
/// [Qt documentation](https://api.kde.org/kratingpainter.html#ratingFromPosition)
///
/// @param self KRatingPainter*
/// @param rect QRect*
/// @param pos QPoint*
...
/// [Qt documentation](https://api.kde.org/kratingpainter.html#paintRating)
///
/// @param p QPainter*
/// @param rect QRect*
/// @param align flag of enum Qt__AlignmentFlag
...
/// [Qt documentation](https://api.kde.org/kratingpainter.html#getRatingFromPosition)
///
/// @param rect QRect*
/// @param align flag of enum Qt__AlignmentFlag
/// @param direction enum Qt__LayoutDirection
...
/// [Qt documentation](https://api.kde.org/kratingpainter.html#dtor.KRatingPainter)
///
