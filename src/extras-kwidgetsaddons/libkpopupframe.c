...
bool k_popupframe_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_popupframe_as_q_paint_device(self));
}

int32_t k_popupframe_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_popupframe_as_q_paint_device(self));
}

int32_t k_popupframe_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_popupframe_as_q_paint_device(self));
}

int32_t k_popupframe_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_popupframe_as_q_paint_device(self));
}

int32_t k_popupframe_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_popupframe_as_q_paint_device(self));
}

int32_t k_popupframe_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_popupframe_as_q_paint_device(self));
}

int32_t k_popupframe_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_popupframe_as_q_paint_device(self));
}

double k_popupframe_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_popupframe_as_q_paint_device(self));
}

double k_popupframe_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_popupframe_as_q_paint_device(self));
}

int32_t k_popupframe_color_count(void* self) {
    return QPaintDevice_ColorCount(k_popupframe_as_q_paint_device(self));
}

int32_t k_popupframe_depth(void* self) {
    return QPaintDevice_Depth(k_popupframe_as_q_paint_device(self));
}
