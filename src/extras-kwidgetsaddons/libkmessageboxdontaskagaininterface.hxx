  ...
  public:
    ...
    virtual bool shouldBeShownTwoActions(const QString& dontShowAgainName, KMessageBox::ButtonCode& result) override {
        if (kmessageboxdontaskagaininterface_shouldbeshowntwoactions_callback != nullptr) {
            ...
            char* dontShowAgainName_str = static_cast<char*>(malloc(dontShowAgainName_str_len + 1));
            memcpy(dontShowAgainName_str, dontShowAgainName_b.data(), dontShowAgainName_str_len);
            dontShowAgainName_str[dontShowAgainName_str_len] = '\0';
