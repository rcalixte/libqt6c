#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSC_LIBKPIXMAPSEQUENCEOVERLAYPAINTER_HPP
#define SRC_EXTRAS_KWIDGETSADDONSC_LIBKPIXMAPSEQUENCEOVERLAYPAINTER_HPP
...
void KPixmapSequenceOverlayPainter_SetAlignment(KPixmapSequenceOverlayPainter* self, int align);
