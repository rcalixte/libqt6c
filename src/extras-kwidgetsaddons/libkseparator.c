...
bool k_separator_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_separator_as_q_paint_device(self));
}

int32_t k_separator_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_separator_as_q_paint_device(self));
}

int32_t k_separator_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_separator_as_q_paint_device(self));
}

int32_t k_separator_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_separator_as_q_paint_device(self));
}

int32_t k_separator_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_separator_as_q_paint_device(self));
}

int32_t k_separator_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_separator_as_q_paint_device(self));
}

int32_t k_separator_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_separator_as_q_paint_device(self));
}

double k_separator_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_separator_as_q_paint_device(self));
}

double k_separator_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_separator_as_q_paint_device(self));
}

int32_t k_separator_color_count(void* self) {
    return QPaintDevice_ColorCount(k_separator_as_q_paint_device(self));
}

int32_t k_separator_depth(void* self) {
    return QPaintDevice_Depth(k_separator_as_q_paint_device(self));
}
