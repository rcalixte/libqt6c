#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKPAGEVIEW_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKPAGEVIEW_H
...
///
/// @param self KPageView*
/// @param callback bool func(KPageView* self, const char* eventType, void* message, intptr_t* result)
