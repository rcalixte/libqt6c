...
void k_pixmapsequencewidget_set_object_name(void* self, const char* name) {
...
int32_t k_pixmapsequencewidget_start_timer2(void* self, int64_t time) {
...
const char** k_pixmapsequencewidget_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_pixmapsequencewidget_dynamic_property_names\n");
        abort();
    }
...
int32_t k_pixmapsequencewidget_start_timer23(void* self, int64_t time, int32_t timerType) {
...
bool k_pixmapsequencewidget_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_pixmapsequencewidget_as_q_paint_device(self));
}

int32_t k_pixmapsequencewidget_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_pixmapsequencewidget_as_q_paint_device(self));
}

int32_t k_pixmapsequencewidget_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_pixmapsequencewidget_as_q_paint_device(self));
}

int32_t k_pixmapsequencewidget_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_pixmapsequencewidget_as_q_paint_device(self));
}

int32_t k_pixmapsequencewidget_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_pixmapsequencewidget_as_q_paint_device(self));
}

int32_t k_pixmapsequencewidget_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_pixmapsequencewidget_as_q_paint_device(self));
}

int32_t k_pixmapsequencewidget_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_pixmapsequencewidget_as_q_paint_device(self));
}

double k_pixmapsequencewidget_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_pixmapsequencewidget_as_q_paint_device(self));
}

double k_pixmapsequencewidget_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_pixmapsequencewidget_as_q_paint_device(self));
}

int32_t k_pixmapsequencewidget_color_count(void* self) {
    return QPaintDevice_ColorCount(k_pixmapsequencewidget_as_q_paint_device(self));
}

int32_t k_pixmapsequencewidget_depth(void* self) {
    return QPaintDevice_Depth(k_pixmapsequencewidget_as_q_paint_device(self));
}
