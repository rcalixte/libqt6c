...
int32_t k_twofingerswipe_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KTwoFingerSwipe_Metacall((KTwoFingerSwipe*)self, param1, param2, param3);
}
...
const char* k_twofingerswipe_tr(const char* s) {
    libqt_string _str = KTwoFingerSwipe_Tr(s);
...
QPointF* k_twofingerswipe_pos(void* self) {
    return KTwoFingerSwipe_Pos((KTwoFingerSwipe*)self);
}

void k_twofingerswipe_set_pos(void* self, void* pos) {
    KTwoFingerSwipe_SetPos((KTwoFingerSwipe*)self, (QPointF*)pos);
}

QPointF* k_twofingerswipe_screen_pos(void* self) {
    return KTwoFingerSwipe_ScreenPos((KTwoFingerSwipe*)self);
}

void k_twofingerswipe_set_screen_pos(void* self, void* screenPos) {
    KTwoFingerSwipe_SetScreenPos((KTwoFingerSwipe*)self, (QPointF*)screenPos);
}

QPointF* k_twofingerswipe_scene_pos(void* self) {
    return KTwoFingerSwipe_ScenePos((KTwoFingerSwipe*)self);
}

void k_twofingerswipe_set_scene_pos(void* self, void* scenePos) {
    KTwoFingerSwipe_SetScenePos((KTwoFingerSwipe*)self, (QPointF*)scenePos);
}

double k_twofingerswipe_swipe_angle(void* self) {
    return KTwoFingerSwipe_SwipeAngle((KTwoFingerSwipe*)self);
}

void k_twofingerswipe_set_swipe_angle(void* self, double swipeAngle) {
    KTwoFingerSwipe_SetSwipeAngle((KTwoFingerSwipe*)self, swipeAngle);
}

const char* k_twofingerswipe_tr2(const char* s, const char* c) {
    libqt_string _str = KTwoFingerSwipe_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_twofingerswipe_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KTwoFingerSwipe_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_twofingerswipe_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_twofingerswipe_dynamic_property_names");
        abort();
    }
...
void k_twofingerswipe_on_event(void* self, bool (*callback)(void*, void*)) {
    KTwoFingerSwipe_OnEvent((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    KTwoFingerSwipe_OnEventFilter((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_timer_event(void* self, void (*callback)(void*, void*)) {
    KTwoFingerSwipe_OnTimerEvent((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_child_event(void* self, void (*callback)(void*, void*)) {
    KTwoFingerSwipe_OnChildEvent((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_custom_event(void* self, void (*callback)(void*, void*)) {
    KTwoFingerSwipe_OnCustomEvent((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_connect_notify(void* self, void (*callback)(void*, void*)) {
    KTwoFingerSwipe_OnConnectNotify((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_disconnect_notify(void* self, void (*callback)(void*, void*)) {
    KTwoFingerSwipe_OnDisconnectNotify((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_sender(void* self, QObject* (*callback)()) {
    KTwoFingerSwipe_OnSender((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_sender_signal_index(void* self, int32_t (*callback)()) {
    KTwoFingerSwipe_OnSenderSignalIndex((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_receivers(void* self, int32_t (*callback)(void*, const char*)) {
    KTwoFingerSwipe_OnReceivers((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_on_is_signal_connected(void* self, bool (*callback)(void*, void*)) {
    KTwoFingerSwipe_OnIsSignalConnected((KTwoFingerSwipe*)self, (intptr_t)callback);
}
...
void k_twofingerswipe_delete(void* self) {
    KTwoFingerSwipe_Delete((KTwoFingerSwipe*)(self));
}
...
QGesture* k_twofingerswiperecognizer_create(void* self, void* target) {
    return KTwoFingerSwipeRecognizer_Create((KTwoFingerSwipeRecognizer*)self, (QObject*)target);
}
...
int32_t k_twofingerswiperecognizer_max_swipe_time(void* self) {
    return KTwoFingerSwipeRecognizer_MaxSwipeTime((KTwoFingerSwipeRecognizer*)self);
}

void k_twofingerswiperecognizer_set_max_swipe_time(void* self, int i) {
    KTwoFingerSwipeRecognizer_SetMaxSwipeTime((KTwoFingerSwipeRecognizer*)self, i);
}

int32_t k_twofingerswiperecognizer_min_sswipe_distance(void* self) {
    return KTwoFingerSwipeRecognizer_MinSswipeDistance((KTwoFingerSwipeRecognizer*)self);
}
...
void k_twofingerswiperecognizer_on_reset(void* self, void (*callback)(void*, void*)) {
    KTwoFingerSwipeRecognizer_OnReset((KTwoFingerSwipeRecognizer*)self, (intptr_t)callback);
}

void k_twofingerswiperecognizer_delete(void* self) {
    KTwoFingerSwipeRecognizer_Delete((KTwoFingerSwipeRecognizer*)(self));
}
