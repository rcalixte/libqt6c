...
bool k_recentfilesmenu_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_recentfilesmenu_as_q_paint_device(self));
}

int32_t k_recentfilesmenu_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_recentfilesmenu_as_q_paint_device(self));
}

int32_t k_recentfilesmenu_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_recentfilesmenu_as_q_paint_device(self));
}

int32_t k_recentfilesmenu_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_recentfilesmenu_as_q_paint_device(self));
}

int32_t k_recentfilesmenu_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_recentfilesmenu_as_q_paint_device(self));
}

int32_t k_recentfilesmenu_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_recentfilesmenu_as_q_paint_device(self));
}

int32_t k_recentfilesmenu_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_recentfilesmenu_as_q_paint_device(self));
}

double k_recentfilesmenu_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_recentfilesmenu_as_q_paint_device(self));
}

double k_recentfilesmenu_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_recentfilesmenu_as_q_paint_device(self));
}

int32_t k_recentfilesmenu_color_count(void* self) {
    return QPaintDevice_ColorCount(k_recentfilesmenu_as_q_paint_device(self));
}

int32_t k_recentfilesmenu_depth(void* self) {
    return QPaintDevice_Depth(k_recentfilesmenu_as_q_paint_device(self));
}
