...
const char** k_actionselector_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_actionselector_dynamic_property_names\n");
        abort();
    }
...
bool k_actionselector_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_actionselector_as_q_paint_device(self));
}

int32_t k_actionselector_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_actionselector_as_q_paint_device(self));
}

int32_t k_actionselector_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_actionselector_as_q_paint_device(self));
}

int32_t k_actionselector_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_actionselector_as_q_paint_device(self));
}

int32_t k_actionselector_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_actionselector_as_q_paint_device(self));
}

int32_t k_actionselector_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_actionselector_as_q_paint_device(self));
}

int32_t k_actionselector_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_actionselector_as_q_paint_device(self));
}

double k_actionselector_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_actionselector_as_q_paint_device(self));
}

double k_actionselector_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_actionselector_as_q_paint_device(self));
}

int32_t k_actionselector_color_count(void* self) {
    return QPaintDevice_ColorCount(k_actionselector_as_q_paint_device(self));
}

int32_t k_actionselector_depth(void* self) {
    return QPaintDevice_Depth(k_actionselector_as_q_paint_device(self));
}
