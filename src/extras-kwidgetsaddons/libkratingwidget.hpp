#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSC_LIBKRATINGWIDGET_HPP
#define SRC_EXTRAS_KWIDGETSADDONSC_LIBKRATINGWIDGET_HPP
...
void KRatingWidget_SetAlignment(KRatingWidget* self, int align);
