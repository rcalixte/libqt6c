...
const char* k_colorcombo_tr(const char* s) {
    libqt_string _str = KColorCombo_Tr(s);
...
const char* k_colorcombo_tr2(const char* s, const char* c) {
    libqt_string _str = KColorCombo_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_colorcombo_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KColorCombo_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_colorcombo_add_items(void* self, const char* texts[]) {
    ...
    if (texts_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_colorcombo_add_items");
        abort();
    }
...
void k_colorcombo_insert_items(void* self, int index, const char* texts[]) {
    ...
    libqt_string* texts_qstr = (libqt_string*)malloc(texts_len * sizeof(libqt_string));
    if (texts_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_colorcombo_insert_items");
        abort();
    }
    for (size_t i = 0; i < texts_len; ++i) {
        texts_qstr[i] = qstring(texts[i]);
...
void k_colorcombo_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_colorcombo_ungrab_gesture(void* self, int64_t typeVal) {
...
void k_colorcombo_set_window_flags(void* self, int64_t typeVal) {
...
void k_colorcombo_override_window_flags(void* self, int64_t typeVal) {
...
const char** k_colorcombo_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_colorcombo_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_colorcombo_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_colorcombo_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
