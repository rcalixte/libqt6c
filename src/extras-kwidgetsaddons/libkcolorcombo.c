...
bool k_colorcombo_restore_geometry(void* self, char* geometry) {
...
QWidget* k_colorcombo_find(uintptr_t param1) {
...
void k_colorcombo_set_object_name(void* self, const char* name) {
...
bool k_colorcombo_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_colorcombo_as_q_paint_device(self));
}

int32_t k_colorcombo_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_colorcombo_as_q_paint_device(self));
}

int32_t k_colorcombo_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_colorcombo_as_q_paint_device(self));
}

int32_t k_colorcombo_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_colorcombo_as_q_paint_device(self));
}

int32_t k_colorcombo_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_colorcombo_as_q_paint_device(self));
}

int32_t k_colorcombo_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_colorcombo_as_q_paint_device(self));
}

int32_t k_colorcombo_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_colorcombo_as_q_paint_device(self));
}

double k_colorcombo_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_colorcombo_as_q_paint_device(self));
}

double k_colorcombo_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_colorcombo_as_q_paint_device(self));
}

int32_t k_colorcombo_color_count(void* self) {
    return QPaintDevice_ColorCount(k_colorcombo_as_q_paint_device(self));
}

int32_t k_colorcombo_depth(void* self) {
    return QPaintDevice_Depth(k_colorcombo_as_q_paint_device(self));
}
