...
const char** k_pixmapregionselectordialog_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_pixmapregionselectordialog_dynamic_property_names\n");
        abort();
    }
...
bool k_pixmapregionselectordialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_pixmapregionselectordialog_as_q_paint_device(self));
}

int32_t k_pixmapregionselectordialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_pixmapregionselectordialog_as_q_paint_device(self));
}

int32_t k_pixmapregionselectordialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_pixmapregionselectordialog_as_q_paint_device(self));
}

int32_t k_pixmapregionselectordialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_pixmapregionselectordialog_as_q_paint_device(self));
}

int32_t k_pixmapregionselectordialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_pixmapregionselectordialog_as_q_paint_device(self));
}

int32_t k_pixmapregionselectordialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_pixmapregionselectordialog_as_q_paint_device(self));
}

int32_t k_pixmapregionselectordialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_pixmapregionselectordialog_as_q_paint_device(self));
}

double k_pixmapregionselectordialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_pixmapregionselectordialog_as_q_paint_device(self));
}

double k_pixmapregionselectordialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_pixmapregionselectordialog_as_q_paint_device(self));
}

int32_t k_pixmapregionselectordialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_pixmapregionselectordialog_as_q_paint_device(self));
}

int32_t k_pixmapregionselectordialog_depth(void* self) {
    return QPaintDevice_Depth(k_pixmapregionselectordialog_as_q_paint_device(self));
}
