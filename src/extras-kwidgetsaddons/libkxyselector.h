#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKXYSELECTOR_H
#define SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKXYSELECTOR_H
...
/// [Upstream resources](https://api.kde.org/kxyselector.html#setValues)
///
/// @param self KXYSelector*
/// @param xPos int
/// @param yPos int
...
///
void k_xyselector_grab_gesture(void* self, int64_t type);
...
/// @param type enum Qt__GestureType
///
void k_xyselector_ungrab_gesture(void* self, int64_t type);
...
///
void k_xyselector_set_window_flags(void* self, int64_t type);
...
/// @param type flag of enum Qt__WindowType
///
void k_xyselector_override_window_flags(void* self, int64_t type);
...
///
void k_xyselector_grab_gesture2(void* self, int64_t type, int32_t flags);
...
///
QMetaObject__Connection* k_xyselector_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
