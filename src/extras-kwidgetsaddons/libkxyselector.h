#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKXYSELECTOR_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKXYSELECTOR_H
...
/// k_xyselector_new2 constructs a new KXYSelector object.
///
