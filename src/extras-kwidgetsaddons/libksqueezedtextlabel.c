...
void k_squeezedtextlabel_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_squeezedtextlabel_ungrab_gesture(void* self, int64_t typeVal) {
...
void k_squeezedtextlabel_set_window_flags(void* self, int64_t typeVal) {
...
void k_squeezedtextlabel_override_window_flags(void* self, int64_t typeVal) {
...
const char** k_squeezedtextlabel_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_squeezedtextlabel_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_squeezedtextlabel_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_squeezedtextlabel_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
