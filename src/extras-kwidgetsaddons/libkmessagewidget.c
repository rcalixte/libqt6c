...
const char* k_messagewidget_tr(const char* s) {
    libqt_string _str = KMessageWidget_Tr(s);
...
void k_messagewidget_set_message_type(void* self, int32_t typeVal) {
    KMessageWidget_SetMessageType((KMessageWidget*)self, typeVal);
}
...
const char* k_messagewidget_tr2(const char* s, const char* c) {
    libqt_string _str = KMessageWidget_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_messagewidget_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KMessageWidget_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_messagewidget_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_messagewidget_dynamic_property_names");
        abort();
    }
