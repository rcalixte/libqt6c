...
bool k_fontchooserdialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_fontchooserdialog_as_q_paint_device(self));
}

int32_t k_fontchooserdialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_fontchooserdialog_as_q_paint_device(self));
}

int32_t k_fontchooserdialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_fontchooserdialog_as_q_paint_device(self));
}

int32_t k_fontchooserdialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_fontchooserdialog_as_q_paint_device(self));
}

int32_t k_fontchooserdialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_fontchooserdialog_as_q_paint_device(self));
}

int32_t k_fontchooserdialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_fontchooserdialog_as_q_paint_device(self));
}

int32_t k_fontchooserdialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_fontchooserdialog_as_q_paint_device(self));
}

double k_fontchooserdialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_fontchooserdialog_as_q_paint_device(self));
}

double k_fontchooserdialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_fontchooserdialog_as_q_paint_device(self));
}

int32_t k_fontchooserdialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_fontchooserdialog_as_q_paint_device(self));
}

int32_t k_fontchooserdialog_depth(void* self) {
    return QPaintDevice_Depth(k_fontchooserdialog_as_q_paint_device(self));
}
