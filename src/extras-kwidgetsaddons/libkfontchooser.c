...
const char* k_fontchooser_tr(const char* s) {
    libqt_string _str = KFontChooser_Tr(s);
...
const char* k_fontchooser_tr2(const char* s, const char* c) {
    libqt_string _str = KFontChooser_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_fontchooser_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KFontChooser_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_fontchooser_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_fontchooser_ungrab_gesture(void* self, int64_t typeVal) {
...
void k_fontchooser_set_window_flags(void* self, int64_t typeVal) {
...
void k_fontchooser_override_window_flags(void* self, int64_t typeVal) {
...
QMetaObject__Connection* k_fontchooser_connect(void* sender, void* signal, void* receiver, void* method) {
    return QObject_Connect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method);
}

QMetaObject__Connection* k_fontchooser_connect2(void* self, void* sender, const char* signal, const char* member) {
    return QObject_Connect2((QObject*)self, (QObject*)sender, signal, member);
}

bool k_fontchooser_disconnect(void* sender, void* signal, void* receiver, void* member) {
    return QObject_Disconnect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)member);
}

bool k_fontchooser_disconnect2(void* param1) {
...
bool k_fontchooser_move_to_thread2(void* self, void* thread, void* param2) {
...
QMetaObject__Connection* k_fontchooser_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_fontchooser_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
