...
const char* k_datecombobox_tr(const char* s) {
    libqt_string _str = KDateComboBox_Tr(s);
...
libqt_map /* of QDate* to const char* */ k_datecombobox_date_map(void* self) {
    return KDateComboBox_DateMap((KDateComboBox*)self);
}
...
void k_datecombobox_set_date_map(void* self, libqt_map /* of QDate* to const char* */ dateMap) {
    KDateComboBox_SetDateMap((KDateComboBox*)self, dateMap);
}
...
const char* k_datecombobox_tr2(const char* s, const char* c) {
    libqt_string _str = KDateComboBox_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_datecombobox_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KDateComboBox_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_datecombobox_add_items(void* self, const char* texts[]) {
...
void k_datecombobox_insert_items(void* self, int index, const char* texts[]) {
    size_t texts_len = libqt_strv_length(texts);
    libqt_string* texts_qstr = (libqt_string*)malloc(texts_len * sizeof(libqt_string));
    if (texts_qstr == NULL) {
...
void k_datecombobox_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_datecombobox_ungrab_gesture(void* self, int64_t typeVal) {
...
void k_datecombobox_set_window_flags(void* self, int64_t typeVal) {
...
void k_datecombobox_override_window_flags(void* self, int64_t typeVal) {
...
QMetaObject__Connection* k_datecombobox_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_datecombobox_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
