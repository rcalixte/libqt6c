...
const char** k_pagewidgetitem_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_pagewidgetitem_dynamic_property_names");
        abort();
    }
...
void k_pagewidgetmodel_on_layout_changed1(void* self, void (*callback)(void*, QPersistentModelIndex**)) {
...
void k_pagewidgetmodel_on_layout_changed2(void* self, void (*callback)(void*, QPersistentModelIndex**, int32_t)) {
...
void k_pagewidgetmodel_on_layout_about_to_be_changed1(void* self, void (*callback)(void*, QPersistentModelIndex**)) {
...
void k_pagewidgetmodel_on_layout_about_to_be_changed2(void* self, void (*callback)(void*, QPersistentModelIndex**, int32_t)) {
...
const char** k_pagewidgetmodel_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_pagewidgetmodel_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
libqt_map /* of int to QVariant* */ k_pagewidgetmodel_item_data(void* self, void* index) {
    return KPageWidgetModel_ItemData((KPageWidgetModel*)self, (QModelIndex*)index);
}

libqt_map /* of int to QVariant* */ k_pagewidgetmodel_qbase_item_data(void* self, void* index) {
    return KPageWidgetModel_QBaseItemData((KPageWidgetModel*)self, (QModelIndex*)index);
}
...
bool k_pagewidgetmodel_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KPageWidgetModel_SetItemData((KPageWidgetModel*)self, (QModelIndex*)index, roles);
}

bool k_pagewidgetmodel_qbase_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KPageWidgetModel_QBaseSetItemData((KPageWidgetModel*)self, (QModelIndex*)index, roles);
}
...
const char** k_pagewidgetmodel_mime_types(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_pagewidgetmodel_mime_types");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
void k_pagewidgetmodel_on_mime_data(void* self, QMimeData* (*callback)(void*, QModelIndex**)) {
...
void k_pagewidgetmodel_on_match(void* self, QModelIndex** (*callback)(void*, void*, int, void*, int, int32_t)) {
...
libqt_map /* of int to char* */ k_pagewidgetmodel_role_names(void* self) {
    return KPageWidgetModel_RoleNames((KPageWidgetModel*)self);
}

libqt_map /* of int to char* */ k_pagewidgetmodel_qbase_role_names(void* self) {
    return KPageWidgetModel_QBaseRoleNames((KPageWidgetModel*)self);
}
...
void k_pagewidgetmodel_on_encode_data(void* self, void (*callback)(void*, QModelIndex**, void*)) {
...
void k_pagewidgetmodel_on_change_persistent_index_list(void* self, void (*callback)(void*, QModelIndex**, QModelIndex**)) {
...
void k_pagewidgetmodel_on_persistent_index_list(void* self, QModelIndex** (*callback)()) {
