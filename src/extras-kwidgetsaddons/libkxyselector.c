...
QWidget* k_xyselector_find(uintptr_t param1) {
...
bool k_xyselector_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_xyselector_as_q_paint_device(self));
}

int32_t k_xyselector_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_xyselector_as_q_paint_device(self));
}

int32_t k_xyselector_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_xyselector_as_q_paint_device(self));
}

int32_t k_xyselector_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_xyselector_as_q_paint_device(self));
}

int32_t k_xyselector_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_xyselector_as_q_paint_device(self));
}

int32_t k_xyselector_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_xyselector_as_q_paint_device(self));
}

int32_t k_xyselector_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_xyselector_as_q_paint_device(self));
}

double k_xyselector_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_xyselector_as_q_paint_device(self));
}

double k_xyselector_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_xyselector_as_q_paint_device(self));
}

int32_t k_xyselector_color_count(void* self) {
    return QPaintDevice_ColorCount(k_xyselector_as_q_paint_device(self));
}

int32_t k_xyselector_depth(void* self) {
    return QPaintDevice_Depth(k_xyselector_as_q_paint_device(self));
}
