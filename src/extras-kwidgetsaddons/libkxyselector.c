...
const char* k_xyselector_tr(const char* s) {
    libqt_string _str = KXYSelector_Tr(s);
...
const char* k_xyselector_tr2(const char* s, const char* c) {
    libqt_string _str = KXYSelector_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_xyselector_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KXYSelector_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_xyselector_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_xyselector_ungrab_gesture(void* self, int64_t typeVal) {
...
int64_t k_xyselector_window_state(void* self) {
    return QWidget_WindowState((QWidget*)self);
}

void k_xyselector_set_window_state(void* self, int64_t state) {
    QWidget_SetWindowState((QWidget*)self, state);
}

void k_xyselector_override_window_state(void* self, int64_t state) {
...
void k_xyselector_set_parent2(void* self, void* parent, int64_t f) {
...
void k_xyselector_add_actions(void* self, libqt_list actions) {
    QWidget_AddActions((QWidget*)self, actions);
}

void k_xyselector_insert_actions(void* self, void* before, libqt_list actions) {
...
void k_xyselector_set_window_flags(void* self, int64_t typeVal) {
    QWidget_SetWindowFlags((QWidget*)self, typeVal);
}

int64_t k_xyselector_window_flags(void* self) {
    return QWidget_WindowFlags((QWidget*)self);
}

void k_xyselector_set_window_flag(void* self, int64_t param1) {
    QWidget_SetWindowFlag((QWidget*)self, param1);
}

void k_xyselector_override_window_flags(void* self, int64_t typeVal) {
    QWidget_OverrideWindowFlags((QWidget*)self, typeVal);
}

int64_t k_xyselector_window_type(void* self) {
...
int64_t k_xyselector_input_method_hints(void* self) {
    return QWidget_InputMethodHints((QWidget*)self);
}

void k_xyselector_set_input_method_hints(void* self, int64_t hints) {
...
void k_xyselector_render4(void* self, void* target, void* targetOffset, void* sourceRegion, int64_t renderFlags) {
...
void k_xyselector_render42(void* self, void* painter, void* targetOffset, void* sourceRegion, int64_t renderFlags) {
...
void k_xyselector_grab_gesture2(void* self, int64_t typeVal, int64_t flags) {
...
void k_xyselector_set_window_flag2(void* self, int64_t param1, bool on) {
...
QWidget* k_xyselector_create_window_container3(void* window, void* parent, int64_t flags) {
...
QMetaObject__Connection* k_xyselector_connect(void* sender, void* signal, void* receiver, void* method) {
    return QObject_Connect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method);
}

QMetaObject__Connection* k_xyselector_connect2(void* self, void* sender, const char* signal, const char* member) {
    return QObject_Connect2((QObject*)self, (QObject*)sender, signal, member);
}

bool k_xyselector_disconnect(void* sender, void* signal, void* receiver, void* member) {
    return QObject_Disconnect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)member);
}

bool k_xyselector_disconnect2(void* param1) {
...
const char** k_xyselector_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_xyselector_dynamic_property_names");
        abort();
    }
...
bool k_xyselector_move_to_thread2(void* self, void* thread, void* param2) {
...
QMetaObject__Connection* k_xyselector_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_xyselector_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
QVariant* k_xyselector_input_method_query(void* self, int64_t param1) {
    return KXYSelector_InputMethodQuery((KXYSelector*)self, param1);
}

QVariant* k_xyselector_qbase_input_method_query(void* self, int64_t param1) {
