...
QMetaObject* KBusyIndicatorWidget_MetaObject(const KBusyIndicatorWidget* self) {
    auto* vkbusyindicatorwidget = dynamic_cast<const VirtualKBusyIndicatorWidget*>(self);
    if (vkbusyindicatorwidget && vkbusyindicatorwidget->isVirtualKBusyIndicatorWidget) {
        return (QMetaObject*)self->metaObject();
    } else {
        return (QMetaObject*)((VirtualKBusyIndicatorWidget*)self)->metaObject();
    }
}
...
void* KBusyIndicatorWidget_Metacast(KBusyIndicatorWidget* self, const char* param1) {
    ...
    if (vkbusyindicatorwidget && vkbusyindicatorwidget->isVirtualKBusyIndicatorWidget) {
        ...
        return ((VirtualKBusyIndicatorWidget*)self)->qt_metacast(param1);
    }
}
...
QMetaObject* KBusyIndicatorWidget_QBaseMetaObject(const KBusyIndicatorWidget* self) {
    ...
    if (vkbusyindicatorwidget && vkbusyindicatorwidget->isVirtualKBusyIndicatorWidget) {
        ...
        return (QMetaObject*)vkbusyindicatorwidget->metaObject();
    } else {
...
void* KBusyIndicatorWidget_QBaseMetacast(KBusyIndicatorWidget* self, const char* param1) {
    ...
    if (vkbusyindicatorwidget && vkbusyindicatorwidget->isVirtualKBusyIndicatorWidget) {
        ...
        return vkbusyindicatorwidget->qt_metacast(param1);
    } else {
