...
bool k_pageview_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_pageview_as_q_paint_device(self));
}

int32_t k_pageview_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_pageview_as_q_paint_device(self));
}

int32_t k_pageview_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_pageview_as_q_paint_device(self));
}

int32_t k_pageview_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_pageview_as_q_paint_device(self));
}

int32_t k_pageview_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_pageview_as_q_paint_device(self));
}

int32_t k_pageview_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_pageview_as_q_paint_device(self));
}

int32_t k_pageview_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_pageview_as_q_paint_device(self));
}

double k_pageview_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_pageview_as_q_paint_device(self));
}

double k_pageview_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_pageview_as_q_paint_device(self));
}

int32_t k_pageview_color_count(void* self) {
    return QPaintDevice_ColorCount(k_pageview_as_q_paint_device(self));
}

int32_t k_pageview_depth(void* self) {
    return QPaintDevice_Depth(k_pageview_as_q_paint_device(self));
}
