...
const char* k_tooltipwidget_tr(const char* s) {
    libqt_string _str = KToolTipWidget_Tr(s);
...
const char* k_tooltipwidget_tr2(const char* s, const char* c) {
    libqt_string _str = KToolTipWidget_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_tooltipwidget_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KToolTipWidget_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_tooltipwidget_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_tooltipwidget_ungrab_gesture(void* self, int64_t typeVal) {
...
int64_t k_tooltipwidget_window_state(void* self) {
    return QWidget_WindowState((QWidget*)self);
}

void k_tooltipwidget_set_window_state(void* self, int64_t state) {
    QWidget_SetWindowState((QWidget*)self, state);
}

void k_tooltipwidget_override_window_state(void* self, int64_t state) {
...
void k_tooltipwidget_set_window_flags(void* self, int64_t typeVal) {
...
void k_tooltipwidget_override_window_flags(void* self, int64_t typeVal) {
...
void k_tooltipwidget_render4(void* self, void* target, void* targetOffset, void* sourceRegion, int64_t renderFlags) {
...
void k_tooltipwidget_render42(void* self, void* painter, void* targetOffset, void* sourceRegion, int64_t renderFlags) {
...
void k_tooltipwidget_grab_gesture2(void* self, int64_t typeVal, int64_t flags) {
...
const char** k_tooltipwidget_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_tooltipwidget_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_tooltipwidget_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_tooltipwidget_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
