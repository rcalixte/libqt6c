...
QWidget* k_capacitybar_find(uintptr_t param1) {
...
bool k_capacitybar_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_capacitybar_as_q_paint_device(self));
}

int32_t k_capacitybar_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_capacitybar_as_q_paint_device(self));
}

int32_t k_capacitybar_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_capacitybar_as_q_paint_device(self));
}

int32_t k_capacitybar_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_capacitybar_as_q_paint_device(self));
}

int32_t k_capacitybar_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_capacitybar_as_q_paint_device(self));
}

int32_t k_capacitybar_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_capacitybar_as_q_paint_device(self));
}

int32_t k_capacitybar_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_capacitybar_as_q_paint_device(self));
}

double k_capacitybar_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_capacitybar_as_q_paint_device(self));
}

double k_capacitybar_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_capacitybar_as_q_paint_device(self));
}

int32_t k_capacitybar_color_count(void* self) {
    return QPaintDevice_ColorCount(k_capacitybar_as_q_paint_device(self));
}

int32_t k_capacitybar_depth(void* self) {
    return QPaintDevice_Depth(k_capacitybar_as_q_paint_device(self));
}
