...
const char* k_ratingwidget_tr(const char* s) {
    libqt_string _str = KRatingWidget_Tr(s);
...
const char* k_ratingwidget_tr2(const char* s, const char* c) {
    libqt_string _str = KRatingWidget_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_ratingwidget_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KRatingWidget_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_ratingwidget_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_ratingwidget_ungrab_gesture(void* self, int64_t typeVal) {
...
void k_ratingwidget_set_window_flags(void* self, int64_t typeVal) {
...
void k_ratingwidget_override_window_flags(void* self, int64_t typeVal) {
...
const char** k_ratingwidget_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_ratingwidget_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_ratingwidget_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_ratingwidget_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
