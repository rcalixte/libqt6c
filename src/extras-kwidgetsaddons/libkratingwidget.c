...
bool k_ratingwidget_restore_geometry(void* self, char* geometry) {
...
void k_ratingwidget_set_object_name(void* self, const char* name) {
...
bool k_ratingwidget_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_ratingwidget_as_q_paint_device(self));
}

int32_t k_ratingwidget_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_ratingwidget_as_q_paint_device(self));
}

int32_t k_ratingwidget_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_ratingwidget_as_q_paint_device(self));
}

int32_t k_ratingwidget_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_ratingwidget_as_q_paint_device(self));
}

int32_t k_ratingwidget_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_ratingwidget_as_q_paint_device(self));
}

int32_t k_ratingwidget_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_ratingwidget_as_q_paint_device(self));
}

int32_t k_ratingwidget_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_ratingwidget_as_q_paint_device(self));
}

double k_ratingwidget_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_ratingwidget_as_q_paint_device(self));
}

double k_ratingwidget_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_ratingwidget_as_q_paint_device(self));
}

int32_t k_ratingwidget_color_count(void* self) {
    return QPaintDevice_ColorCount(k_ratingwidget_as_q_paint_device(self));
}

int32_t k_ratingwidget_depth(void* self) {
    return QPaintDevice_Depth(k_ratingwidget_as_q_paint_device(self));
}
