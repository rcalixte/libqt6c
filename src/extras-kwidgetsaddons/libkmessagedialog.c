...
const char* k_messagedialog_tr(const char* s) {
    libqt_string _str = KMessageDialog_Tr(s);
...
void k_messagedialog_set_list_widget_items(void* self, const char* strlist[]) {
    ...
    if (strlist_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_messagedialog_set_list_widget_items");
        abort();
    }
...
const char* k_messagedialog_tr2(const char* s, const char* c) {
    libqt_string _str = KMessageDialog_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_messagedialog_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KMessageDialog_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_messagedialog_beep2(int32_t typeVal, const char* text) {
    KMessageDialog_Beep2(typeVal, qstring(text));
}

void k_messagedialog_beep3(int32_t typeVal, const char* text, void* dialog) {
    KMessageDialog_Beep3(typeVal, qstring(text), (QWidget*)dialog);
}
...
int64_t k_messagedialog_window_state(void* self) {
    return QWidget_WindowState((QWidget*)self);
}

void k_messagedialog_set_window_state(void* self, int64_t state) {
    QWidget_SetWindowState((QWidget*)self, state);
}

void k_messagedialog_override_window_state(void* self, int64_t state) {
...
void k_messagedialog_render4(void* self, void* target, void* targetOffset, void* sourceRegion, int64_t renderFlags) {
...
void k_messagedialog_render42(void* self, void* painter, void* targetOffset, void* sourceRegion, int64_t renderFlags) {
...
void k_messagedialog_grab_gesture2(void* self, int64_t typeVal, int64_t flags) {
...
const char** k_messagedialog_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_messagedialog_dynamic_property_names");
        abort();
    }
