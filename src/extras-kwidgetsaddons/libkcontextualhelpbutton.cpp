...
void KContextualHelpButton_Connect_ContextualHelpTextChanged(KContextualHelpButton* self, intptr_t slot) {
    ...
    KContextualHelpButton::connect(self, &KContextualHelpButton::contextualHelpTextChanged, [self, slotFunc](const QString& newContextualHelpText) {
        ...
        char* newContextualHelpText_str = static_cast<char*>(malloc(newContextualHelpText_str_len + 1));
        memcpy(newContextualHelpText_str, newContextualHelpText_b.data(), newContextualHelpText_str_len);
        newContextualHelpText_str[newContextualHelpText_str_len] = '\0';
