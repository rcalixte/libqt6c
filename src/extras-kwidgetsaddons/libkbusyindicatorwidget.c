...
const char** k_busyindicatorwidget_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_busyindicatorwidget_dynamic_property_names\n");
        abort();
    }
...
bool k_busyindicatorwidget_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_busyindicatorwidget_as_q_paint_device(self));
}

int32_t k_busyindicatorwidget_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_busyindicatorwidget_as_q_paint_device(self));
}

int32_t k_busyindicatorwidget_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_busyindicatorwidget_as_q_paint_device(self));
}

int32_t k_busyindicatorwidget_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_busyindicatorwidget_as_q_paint_device(self));
}

int32_t k_busyindicatorwidget_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_busyindicatorwidget_as_q_paint_device(self));
}

int32_t k_busyindicatorwidget_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_busyindicatorwidget_as_q_paint_device(self));
}

int32_t k_busyindicatorwidget_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_busyindicatorwidget_as_q_paint_device(self));
}

double k_busyindicatorwidget_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_busyindicatorwidget_as_q_paint_device(self));
}

double k_busyindicatorwidget_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_busyindicatorwidget_as_q_paint_device(self));
}

int32_t k_busyindicatorwidget_color_count(void* self) {
    return QPaintDevice_ColorCount(k_busyindicatorwidget_as_q_paint_device(self));
}

int32_t k_busyindicatorwidget_depth(void* self) {
    return QPaintDevice_Depth(k_busyindicatorwidget_as_q_paint_device(self));
}
