...
bool k_urllabel_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_urllabel_as_q_paint_device(self));
}

int32_t k_urllabel_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_urllabel_as_q_paint_device(self));
}

int32_t k_urllabel_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_urllabel_as_q_paint_device(self));
}

int32_t k_urllabel_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_urllabel_as_q_paint_device(self));
}

int32_t k_urllabel_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_urllabel_as_q_paint_device(self));
}

int32_t k_urllabel_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_urllabel_as_q_paint_device(self));
}

int32_t k_urllabel_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_urllabel_as_q_paint_device(self));
}

double k_urllabel_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_urllabel_as_q_paint_device(self));
}

double k_urllabel_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_urllabel_as_q_paint_device(self));
}

int32_t k_urllabel_color_count(void* self) {
    return QPaintDevice_ColorCount(k_urllabel_as_q_paint_device(self));
}

int32_t k_urllabel_depth(void* self) {
    return QPaintDevice_Depth(k_urllabel_as_q_paint_device(self));
}
