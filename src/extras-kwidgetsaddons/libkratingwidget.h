#pragma once
#ifndef EXTRAS_KWIDGETSADDONS_LIBKRATINGWIDGET_H
#define EXTRAS_KWIDGETSADDONS_LIBKRATINGWIDGET_H
...
/// Inherited from QWidget
///
/// Downcasts to a KRatingWidget object
///
...
///
/// @param self KRatingWidget*
/// @param callback bool func(KRatingWidget* self, libqt_string eventType, void* message, intptr_t* result)
///
