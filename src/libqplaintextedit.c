...
bool q_plaintextedit_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_plaintextedit_as_q_paint_device(self));
}

int32_t q_plaintextedit_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_plaintextedit_as_q_paint_device(self));
}

int32_t q_plaintextedit_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_plaintextedit_as_q_paint_device(self));
}

int32_t q_plaintextedit_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_plaintextedit_as_q_paint_device(self));
}

int32_t q_plaintextedit_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_plaintextedit_as_q_paint_device(self));
}

int32_t q_plaintextedit_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_plaintextedit_as_q_paint_device(self));
}

int32_t q_plaintextedit_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_plaintextedit_as_q_paint_device(self));
}

double q_plaintextedit_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_plaintextedit_as_q_paint_device(self));
}

double q_plaintextedit_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_plaintextedit_as_q_paint_device(self));
}

int32_t q_plaintextedit_color_count(void* self) {
    return QPaintDevice_ColorCount(q_plaintextedit_as_q_paint_device(self));
}

int32_t q_plaintextedit_depth(void* self) {
    return QPaintDevice_Depth(q_plaintextedit_as_q_paint_device(self));
}
