...
class VirtualQSqlTableModel final : public QSqlTableModel {
  ...
  public:
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        auto metaobject_cb = qsqltablemodel_metaobject_callback;
        if (metaobject_cb) {
    ...
    virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
        ...
        auto metacall_cb = qsqltablemodel_metacall_callback;
        if (metacall_cb) {
    ...
    virtual void setTable(const QString& tableName) override {
        ...
        auto settable_cb = qsqltablemodel_settable_callback;
        if (settable_cb) {
            ...
            char* tableName_str = static_cast<char*>(malloc(tableName_str_len + 1));
            memcpy(tableName_str, tableName_b.data(), tableName_str_len);
            tableName_str[tableName_str_len] = '\0';
    ...
    virtual Qt::ItemFlags flags(const QModelIndex& index) const override {
        ...
        auto flags_cb = qsqltablemodel_flags_callback;
        if (flags_cb) {
    ...
    virtual QVariant data(const QModelIndex& idx, int role) const override {
        ...
        auto data_cb = qsqltablemodel_data_callback;
        if (data_cb) {
    ...
    virtual bool setData(const QModelIndex& index, const QVariant& value, int role) override {
        ...
        auto setdata_cb = qsqltablemodel_setdata_callback;
        if (setdata_cb) {
            const QModelIndex& index_ret = index;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&index_ret);
    ...
    virtual bool clearItemData(const QModelIndex& index) override {
        ...
        auto clearitemdata_cb = qsqltablemodel_clearitemdata_callback;
        if (clearitemdata_cb) {
            const QModelIndex& index_ret = index;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&index_ret);
    ...
    virtual QVariant headerData(int section, Qt::Orientation orientation, int role) const override {
        ...
        auto headerdata_cb = qsqltablemodel_headerdata_callback;
        if (headerdata_cb) {
            int cbval1 = section;
    ...
    virtual void clear() override {
        ...
        auto clear_cb = qsqltablemodel_clear_callback;
        if (clear_cb) {
            clear_cb();
            return;
        }
    ...
    virtual void sort(int column, Qt::SortOrder order) override {
        ...
        auto sort_cb = qsqltablemodel_sort_callback;
        if (sort_cb) {
            int cbval1 = column;
    ...
    virtual void setSort(int column, Qt::SortOrder order) override {
        ...
        auto setsort_cb = qsqltablemodel_setsort_callback;
        if (setsort_cb) {
            int cbval1 = column;
            int cbval2 = static_cast<int>(order);
    ...
    virtual void setFilter(const QString& filter) override {
        ...
        auto setfilter_cb = qsqltablemodel_setfilter_callback;
        if (setfilter_cb) {
            const QString filter_ret = filter;
            // Convert QString from UTF-16 in C++ RAII memory to UTF-8 chars in manually-managed C memory
            QByteArray filter_b = filter_ret.toUtf8();
            auto filter_str_len = filter_b.length();
            char* filter_str = static_cast<char*>(malloc(filter_str_len + 1));
            memcpy(filter_str, filter_b.data(), filter_str_len);
    ...
    virtual int rowCount(const QModelIndex& parent) const override {
        ...
        auto rowcount_cb = qsqltablemodel_rowcount_callback;
        if (rowcount_cb) {
    ...
    virtual bool removeColumns(int column, int count, const QModelIndex& parent) override {
        ...
        auto removecolumns_cb = qsqltablemodel_removecolumns_callback;
        if (removecolumns_cb) {
            int cbval1 = column;
            int cbval2 = count;
            const QModelIndex& parent_ret = parent;
    ...
    virtual bool removeRows(int row, int count, const QModelIndex& parent) override {
        ...
        auto removerows_cb = qsqltablemodel_removerows_callback;
        if (removerows_cb) {
            int cbval1 = row;
            int cbval2 = count;
            const QModelIndex& parent_ret = parent;
    ...
    virtual bool insertRows(int row, int count, const QModelIndex& parent) override {
        ...
        auto insertrows_cb = qsqltablemodel_insertrows_callback;
        if (insertrows_cb) {
            int cbval1 = row;
            int cbval2 = count;
            const QModelIndex& parent_ret = parent;
    ...
    virtual bool select() override {
        ...
        auto select_cb = qsqltablemodel_select_callback;
        if (select_cb) {
    ...
    virtual bool submit() override {
        ...
        auto submit_cb = qsqltablemodel_submit_callback;
        if (submit_cb) {
    ...
    virtual void revert() override {
        ...
        auto revert_cb = qsqltablemodel_revert_callback;
        if (revert_cb) {
            revert_cb();
            return;
        }
    ...
    virtual bool updateRowInTable(int row, const QSqlRecord& values) override {
        ...
        auto updaterowintable_cb = qsqltablemodel_updaterowintable_callback;
    ...
    virtual bool insertRowIntoTable(const QSqlRecord& values) override {
        ...
        auto insertrowintotable_cb = qsqltablemodel_insertrowintotable_callback;
    ...
    virtual QString orderByClause() const override {
        ...
        auto orderbyclause_cb = qsqltablemodel_orderbyclause_callback;
        if (orderbyclause_cb) {
    ...
    virtual QString selectStatement() const override {
        ...
        auto selectstatement_cb = qsqltablemodel_selectstatement_callback;
    ...
    virtual QModelIndex indexInQuery(const QModelIndex& item) const override {
        ...
        auto indexinquery_cb = qsqltablemodel_indexinquery_callback;
        if (indexinquery_cb) {
    ...
    virtual int columnCount(const QModelIndex& parent) const override {
        ...
        auto columncount_cb = qsqltablemodel_columncount_callback;
        if (columncount_cb) {
            const QModelIndex& parent_ret = parent;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&parent_ret);
    ...
    virtual bool setHeaderData(int section, Qt::Orientation orientation, const QVariant& value, int role) override {
        ...
        auto setheaderdata_cb = qsqltablemodel_setheaderdata_callback;
        if (setheaderdata_cb) {
            int cbval1 = section;
            int cbval2 = static_cast<int>(orientation);
            const QVariant& value_ret = value;
    ...
    virtual bool insertColumns(int column, int count, const QModelIndex& parent) override {
        ...
        auto insertcolumns_cb = qsqltablemodel_insertcolumns_callback;
        if (insertcolumns_cb) {
            int cbval1 = column;
            int cbval2 = count;
            const QModelIndex& parent_ret = parent;
    ...
    virtual void fetchMore(const QModelIndex& parent) override {
        ...
        auto fetchmore_cb = qsqltablemodel_fetchmore_callback;
        if (fetchmore_cb) {
            const QModelIndex& parent_ret = parent;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&parent_ret);
    ...
    virtual bool canFetchMore(const QModelIndex& parent) const override {
        ...
        auto canfetchmore_cb = qsqltablemodel_canfetchmore_callback;
        if (canfetchmore_cb) {
            const QModelIndex& parent_ret = parent;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&parent_ret);
    ...
    virtual QHash<int, QByteArray> roleNames() const override {
        ...
        auto rolenames_cb = qsqltablemodel_rolenames_callback;
        if (rolenames_cb) {
    ...
    virtual void queryChange() override {
        ...
        auto querychange_cb = qsqltablemodel_querychange_callback;
        if (querychange_cb) {
            querychange_cb();
            return;
        }
    ...
    virtual QModelIndex index(int row, int column, const QModelIndex& parent) const override {
        ...
        auto index_cb = qsqltablemodel_index_callback;
        if (index_cb) {
            int cbval1 = row;
            int cbval2 = column;
            const QModelIndex& parent_ret = parent;
    ...
    virtual QModelIndex sibling(int row, int column, const QModelIndex& idx) const override {
        ...
        auto sibling_cb = qsqltablemodel_sibling_callback;
        if (sibling_cb) {
            int cbval1 = row;
            int cbval2 = column;
            const QModelIndex& idx_ret = idx;
    ...
    virtual bool dropMimeData(const QMimeData* data, Qt::DropAction action, int row, int column, const QModelIndex& parent) override {
        ...
        auto dropmimedata_cb = qsqltablemodel_dropmimedata_callback;
        if (dropmimedata_cb) {
    ...
    virtual QMap<int, QVariant> itemData(const QModelIndex& index) const override {
        ...
        auto itemdata_cb = qsqltablemodel_itemdata_callback;
        if (itemdata_cb) {
            const QModelIndex& index_ret = index;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&index_ret);
    ...
    virtual bool setItemData(const QModelIndex& index, const QMap<int, QVariant>& roles) override {
        ...
        auto setitemdata_cb = qsqltablemodel_setitemdata_callback;
        if (setitemdata_cb) {
            const QModelIndex& index_ret = index;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&index_ret);
    ...
    virtual QList<QString> mimeTypes() const override {
        ...
        auto mimetypes_cb = qsqltablemodel_mimetypes_callback;
        if (mimetypes_cb) {
    ...
    virtual QMimeData* mimeData(const QList<QModelIndex>& indexes) const override {
        ...
        auto mimedata_cb = qsqltablemodel_mimedata_callback;
        if (mimedata_cb) {
    ...
    virtual bool canDropMimeData(const QMimeData* data, Qt::DropAction action, int row, int column, const QModelIndex& parent) const override {
        ...
        auto candropmimedata_cb = qsqltablemodel_candropmimedata_callback;
    ...
    virtual Qt::DropActions supportedDropActions() const override {
        ...
        auto supporteddropactions_cb = qsqltablemodel_supporteddropactions_callback;
    ...
    virtual Qt::DropActions supportedDragActions() const override {
        ...
        auto supporteddragactions_cb = qsqltablemodel_supporteddragactions_callback;
    ...
    virtual bool moveRows(const QModelIndex& sourceParent, int sourceRow, int count, const QModelIndex& destinationParent, int destinationChild) override {
        ...
        auto moverows_cb = qsqltablemodel_moverows_callback;
        if (moverows_cb) {
    ...
    virtual bool moveColumns(const QModelIndex& sourceParent, int sourceColumn, int count, const QModelIndex& destinationParent, int destinationChild) override {
        ...
        auto movecolumns_cb = qsqltablemodel_movecolumns_callback;
        if (movecolumns_cb) {
            const QModelIndex& sourceParent_ret = sourceParent;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&sourceParent_ret);
    ...
    virtual QModelIndex buddy(const QModelIndex& index) const override {
        ...
        auto buddy_cb = qsqltablemodel_buddy_callback;
        if (buddy_cb) {
            const QModelIndex& index_ret = index;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&index_ret);
    ...
    virtual QList<QModelIndex> match(const QModelIndex& start, int role, const QVariant& value, int hits, Qt::MatchFlags flags) const override {
        ...
        auto match_cb = qsqltablemodel_match_callback;
        if (match_cb) {
    ...
    virtual QSize span(const QModelIndex& index) const override {
        ...
        auto span_cb = qsqltablemodel_span_callback;
        if (span_cb) {
            const QModelIndex& index_ret = index;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&index_ret);
    ...
    virtual void multiData(const QModelIndex& index, QModelRoleDataSpan roleDataSpan) const override {
        ...
        auto multidata_cb = qsqltablemodel_multidata_callback;
        if (multidata_cb) {
            const QModelIndex& index_ret = index;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&index_ret);
    ...
    virtual void resetInternalData() override {
        ...
        auto resetinternaldata_cb = qsqltablemodel_resetinternaldata_callback;
    ...
    virtual bool eventFilter(QObject* watched, QEvent* event) override {
        ...
        auto eventfilter_cb = qsqltablemodel_eventfilter_callback;
        if (eventfilter_cb) {
    ...
    virtual void connectNotify(const QMetaMethod& signal) override {
        ...
        auto connectnotify_cb = qsqltablemodel_connectnotify_callback;
        if (connectnotify_cb) {
    ...
    virtual void disconnectNotify(const QMetaMethod& signal) override {
        ...
        auto disconnectnotify_cb = qsqltablemodel_disconnectnotify_callback;
    ...
    void setPrimaryKey(const QSqlIndex& key) {
        ...
        auto setprimarykey_cb = qsqltablemodel_setprimarykey_callback;
        if (setprimarykey_cb) {
    ...
    void beginInsertRows(const QModelIndex& parent, int first, int last) {
        ...
        auto begininsertrows_cb = qsqltablemodel_begininsertrows_callback;
    ...
    void endInsertRows() {
        ...
        auto endinsertrows_cb = qsqltablemodel_endinsertrows_callback;
        if (endinsertrows_cb) {
            endinsertrows_cb();
            return;
        }
    ...
    void beginRemoveRows(const QModelIndex& parent, int first, int last) {
        ...
        auto beginremoverows_cb = qsqltablemodel_beginremoverows_callback;
    ...
    void endRemoveRows() {
        ...
        auto endremoverows_cb = qsqltablemodel_endremoverows_callback;
        if (endremoverows_cb) {
            endremoverows_cb();
            return;
        }
    ...
    void beginInsertColumns(const QModelIndex& parent, int first, int last) {
        ...
        auto begininsertcolumns_cb = qsqltablemodel_begininsertcolumns_callback;
    ...
    void endInsertColumns() {
        ...
        auto endinsertcolumns_cb = qsqltablemodel_endinsertcolumns_callback;
    ...
    void beginRemoveColumns(const QModelIndex& parent, int first, int last) {
        ...
        auto beginremovecolumns_cb = qsqltablemodel_beginremovecolumns_callback;
    ...
    void endRemoveColumns() {
        ...
        auto endremovecolumns_cb = qsqltablemodel_endremovecolumns_callback;
    ...
    void beginResetModel() {
        ...
        auto beginresetmodel_cb = qsqltablemodel_beginresetmodel_callback;
    ...
    void endResetModel() {
        ...
        auto endresetmodel_cb = qsqltablemodel_endresetmodel_callback;
        if (endresetmodel_cb) {
            endresetmodel_cb();
            return;
        }
    ...
    void setLastError(const QSqlError& error) {
        ...
        auto setlasterror_cb = qsqltablemodel_setlasterror_callback;
        if (setlasterror_cb) {
    ...
    QModelIndex createIndex(int row, int column) const {
        ...
        auto createindex_cb = qsqltablemodel_createindex_callback;
        if (createindex_cb) {
            int cbval1 = row;
            int cbval2 = column;
    ...
    void encodeData(const QList<QModelIndex>& indexes, QDataStream& stream) const {
        ...
        auto encodedata_cb = qsqltablemodel_encodedata_callback;
        if (encodedata_cb) {
            const QList<QModelIndex>& indexes_ret = indexes;
            // Convert QList<> from C++ memory to manually-managed C memory
            QModelIndex** indexes_arr = static_cast<QModelIndex**>(malloc(sizeof(QModelIndex*) * (indexes_ret.size())));
    ...
    bool decodeData(int row, int column, const QModelIndex& parent, QDataStream& stream) {
        ...
        auto decodedata_cb = qsqltablemodel_decodedata_callback;
        if (decodedata_cb) {
            int cbval1 = row;
            int cbval2 = column;
            const QModelIndex& parent_ret = parent;
    ...
    bool beginMoveRows(const QModelIndex& sourceParent, int sourceFirst, int sourceLast, const QModelIndex& destinationParent, int destinationRow) {
        ...
        auto beginmoverows_cb = qsqltablemodel_beginmoverows_callback;
        if (beginmoverows_cb) {
            const QModelIndex& sourceParent_ret = sourceParent;
            // Cast returned reference into pointer
            QModelIndex* cbval1 = const_cast<QModelIndex*>(&sourceParent_ret);
    ...
    void endMoveRows() {
        ...
        auto endmoverows_cb = qsqltablemodel_endmoverows_callback;
        if (endmoverows_cb) {
            endmoverows_cb();
            return;
        }
    ...
    bool beginMoveColumns(const QModelIndex& sourceParent, int sourceFirst, int sourceLast, const QModelIndex& destinationParent, int destinationColumn) {
        ...
        auto beginmovecolumns_cb = qsqltablemodel_beginmovecolumns_callback;
    ...
    void endMoveColumns() {
        ...
        auto endmovecolumns_cb = qsqltablemodel_endmovecolumns_callback;
    ...
    void changePersistentIndex(const QModelIndex& from, const QModelIndex& to) {
        ...
        auto changepersistentindex_cb = qsqltablemodel_changepersistentindex_callback;
    ...
    void changePersistentIndexList(const QList<QModelIndex>& from, const QList<QModelIndex>& to) {
        ...
        auto changepersistentindexlist_cb = qsqltablemodel_changepersistentindexlist_callback;
    ...
    QList<QModelIndex> persistentIndexList() const {
        ...
        auto persistentindexlist_cb = qsqltablemodel_persistentindexlist_callback;
    ...
    QObject* sender() const {
        ...
        auto sender_cb = qsqltablemodel_sender_callback;
        if (sender_cb) {
    ...
    int senderSignalIndex() const {
        ...
        auto sendersignalindex_cb = qsqltablemodel_sendersignalindex_callback;
    ...
    bool isSignalConnected(const QMetaMethod& signal) const {
        ...
        auto issignalconnected_cb = qsqltablemodel_issignalconnected_callback;
    ...
    friend void QSqlTableModel_SuperSetPrimaryKey(QSqlTableModel* self, const QSqlIndex* key);
    friend QSqlRecord* QSqlTableModel_PrimaryValues(const QSqlTableModel* self, int row);
    friend QSqlRecord* QSqlTableModel_SuperPrimaryValues(const QSqlTableModel* self, int row);
    friend void QSqlTableModel_BeginInsertRows(QSqlTableModel* self, const QModelIndex* parent, int first, int last);
    friend void QSqlTableModel_SuperBeginInsertRows(QSqlTableModel* self, const QModelIndex* parent, int first, int last);
    friend void QSqlTableModel_EndInsertRows(QSqlTableModel* self);
    friend void QSqlTableModel_SuperEndInsertRows(QSqlTableModel* self);
    friend void QSqlTableModel_BeginRemoveRows(QSqlTableModel* self, const QModelIndex* parent, int first, int last);
    friend void QSqlTableModel_SuperBeginRemoveRows(QSqlTableModel* self, const QModelIndex* parent, int first, int last);
    friend void QSqlTableModel_EndRemoveRows(QSqlTableModel* self);
    friend void QSqlTableModel_SuperEndRemoveRows(QSqlTableModel* self);
    friend void QSqlTableModel_BeginInsertColumns(QSqlTableModel* self, const QModelIndex* parent, int first, int last);
    friend void QSqlTableModel_SuperBeginInsertColumns(QSqlTableModel* self, const QModelIndex* parent, int first, int last);
    friend void QSqlTableModel_EndInsertColumns(QSqlTableModel* self);
    friend void QSqlTableModel_SuperEndInsertColumns(QSqlTableModel* self);
    friend void QSqlTableModel_BeginRemoveColumns(QSqlTableModel* self, const QModelIndex* parent, int first, int last);
    friend void QSqlTableModel_SuperBeginRemoveColumns(QSqlTableModel* self, const QModelIndex* parent, int first, int last);
    friend void QSqlTableModel_EndRemoveColumns(QSqlTableModel* self);
    friend void QSqlTableModel_SuperEndRemoveColumns(QSqlTableModel* self);
    friend void QSqlTableModel_BeginResetModel(QSqlTableModel* self);
    friend void QSqlTableModel_SuperBeginResetModel(QSqlTableModel* self);
    friend void QSqlTableModel_EndResetModel(QSqlTableModel* self);
    friend void QSqlTableModel_SuperEndResetModel(QSqlTableModel* self);
    friend void QSqlTableModel_SetLastError(QSqlTableModel* self, const QSqlError* error);
    friend void QSqlTableModel_SuperSetLastError(QSqlTableModel* self, const QSqlError* error);
    friend QModelIndex* QSqlTableModel_CreateIndex(const QSqlTableModel* self, int row, int column);
    friend QModelIndex* QSqlTableModel_SuperCreateIndex(const QSqlTableModel* self, int row, int column);
    ...
    friend void QSqlTableModel_SuperEncodeData(const QSqlTableModel* self, const libqt_list /* of QModelIndex* */ indexes, QDataStream* stream);
    friend bool QSqlTableModel_DecodeData(QSqlTableModel* self, int row, int column, const QModelIndex* parent, QDataStream* stream);
    friend bool QSqlTableModel_SuperDecodeData(QSqlTableModel* self, int row, int column, const QModelIndex* parent, QDataStream* stream);
    ...
    friend bool QSqlTableModel_SuperBeginMoveRows(QSqlTableModel* self, const QModelIndex* sourceParent, int sourceFirst, int sourceLast, const QModelIndex* destinationParent, int destinationRow);
    friend void QSqlTableModel_EndMoveRows(QSqlTableModel* self);
    friend void QSqlTableModel_SuperEndMoveRows(QSqlTableModel* self);
    ...
    friend bool QSqlTableModel_SuperBeginMoveColumns(QSqlTableModel* self, const QModelIndex* sourceParent, int sourceFirst, int sourceLast, const QModelIndex* destinationParent, int destinationColumn);
    friend void QSqlTableModel_EndMoveColumns(QSqlTableModel* self);
    friend void QSqlTableModel_SuperEndMoveColumns(QSqlTableModel* self);
    friend void QSqlTableModel_ChangePersistentIndex(QSqlTableModel* self, const QModelIndex* from, const QModelIndex* to);
    friend void QSqlTableModel_SuperChangePersistentIndex(QSqlTableModel* self, const QModelIndex* from, const QModelIndex* to);
    ...
    friend void QSqlTableModel_SuperChangePersistentIndexList(QSqlTableModel* self, const libqt_list /* of QModelIndex* */ from, const libqt_list /* of QModelIndex* */ to);
    friend libqt_list /* of QModelIndex* */ QSqlTableModel_PersistentIndexList(const QSqlTableModel* self);
    friend libqt_list /* of QModelIndex* */ QSqlTableModel_SuperPersistentIndexList(const QSqlTableModel* self);
    friend QObject* QSqlTableModel_Sender(const QSqlTableModel* self);
    friend QObject* QSqlTableModel_SuperSender(const QSqlTableModel* self);
    friend int QSqlTableModel_SenderSignalIndex(const QSqlTableModel* self);
    friend int QSqlTableModel_SuperSenderSignalIndex(const QSqlTableModel* self);
    friend int QSqlTableModel_Receivers(const QSqlTableModel* self, const char* signal);
    friend int QSqlTableModel_SuperReceivers(const QSqlTableModel* self, const char* signal);
    friend bool QSqlTableModel_IsSignalConnected(const QSqlTableModel* self, const QMetaMethod* signal);
    friend bool QSqlTableModel_SuperIsSignalConnected(const QSqlTableModel* self, const QMetaMethod* signal);
};
