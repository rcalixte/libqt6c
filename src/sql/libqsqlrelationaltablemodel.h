#pragma once
#ifndef SRC_SQLQT6C_LIBQSQLRELATIONALTABLEMODEL_H
#define SRC_SQLQT6C_LIBQSQLRELATIONALTABLEMODEL_H
...
QMetaObject__Connection* q_sqlrelationaltablemodel_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* q_sqlrelationaltablemodel_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
void q_sqlrelationaltablemodel_set_last_error(void* self, void* errorVal);
...
/// @param self QSqlRelationalTableModel*
/// @param errorVal QSqlError*
void q_sqlrelationaltablemodel_qbase_set_last_error(void* self, void* errorVal);
