#pragma once
#ifndef SQL_LIBQSQLTABLEMODEL_H
#define SQL_LIBQSQLTABLEMODEL_H
...
///
void q_sqltablemodel_set_object_name(void* self, const char* name);
...
///
int32_t q_sqltablemodel_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_sqltablemodel_start_timer23(void* self, int64_t time, int32_t timerType);
