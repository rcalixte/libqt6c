...
class VirtualQSqlQueryModel final : public QSqlQueryModel {
  ...
  public:
    ...
    friend void QSqlQueryModel_SetLastError(QSqlQueryModel* self, const QSqlError* error);
    friend void QSqlQueryModel_SuperSetLastError(QSqlQueryModel* self, const QSqlError* error);
