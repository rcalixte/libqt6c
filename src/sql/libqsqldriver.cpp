...
libqt_string QSqlDriver_EscapeIdentifier(const QSqlDriver* self, const libqt_string identifier, int type) {
    ...
    auto* vqsqldriver = dynamic_cast<const VirtualQSqlDriver*>(self);
    if (vqsqldriver && vqsqldriver->isVirtualQSqlDriver) {
        auto _ret = self->escapeIdentifier(identifier_QString, static_cast<QSqlDriver::IdentifierType>(type));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
        ...
        auto _ret = ((VirtualQSqlDriver*)self)->escapeIdentifier(identifier_QString, static_cast<QSqlDriver::IdentifierType>(type));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
...
libqt_string QSqlDriver_SqlStatement(const QSqlDriver* self, int type, const libqt_string tableName, const QSqlRecord* rec, bool preparedStatement) {
    ...
    auto* vqsqldriver = dynamic_cast<const VirtualQSqlDriver*>(self);
    if (vqsqldriver && vqsqldriver->isVirtualQSqlDriver) {
        auto _ret = self->sqlStatement(static_cast<QSqlDriver::StatementType>(type), tableName_QString, *rec, preparedStatement);
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
        ...
        auto _ret = ((VirtualQSqlDriver*)self)->sqlStatement(static_cast<QSqlDriver::StatementType>(type), tableName_QString, *rec, preparedStatement);
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
...
libqt_string QSqlDriver_StripDelimiters(const QSqlDriver* self, const libqt_string identifier, int type) {
    ...
    auto* vqsqldriver = dynamic_cast<const VirtualQSqlDriver*>(self);
    if (vqsqldriver && vqsqldriver->isVirtualQSqlDriver) {
        auto _ret = self->stripDelimiters(identifier_QString, static_cast<QSqlDriver::IdentifierType>(type));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
        ...
        auto _ret = ((VirtualQSqlDriver*)self)->stripDelimiters(identifier_QString, static_cast<QSqlDriver::IdentifierType>(type));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
...
// Base class handler implementation
libqt_string QSqlDriver_SuperEscapeIdentifier(const QSqlDriver* self, const libqt_string identifier, int type) {
    auto* vqsqldriver = const_cast<VirtualQSqlDriver*>(dynamic_cast<const VirtualQSqlDriver*>(self));
    QString identifier_QString = QString::fromUtf8(identifier.data, identifier.len);
    if (vqsqldriver && vqsqldriver->isVirtualQSqlDriver) {
        vqsqldriver->setQSqlDriver_EscapeIdentifier_IsBase(true);
        auto _ret = vqsqldriver->escapeIdentifier(identifier_QString, static_cast<QSqlDriver::IdentifierType>(type));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
        ...
        auto _ret = self->QSqlDriver::escapeIdentifier(identifier_QString, static_cast<QSqlDriver::IdentifierType>(type));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
...
// Base class handler implementation
libqt_string QSqlDriver_SuperSqlStatement(const QSqlDriver* self, int type, const libqt_string tableName, const QSqlRecord* rec, bool preparedStatement) {
    auto* vqsqldriver = const_cast<VirtualQSqlDriver*>(dynamic_cast<const VirtualQSqlDriver*>(self));
    QString tableName_QString = QString::fromUtf8(tableName.data, tableName.len);
    if (vqsqldriver && vqsqldriver->isVirtualQSqlDriver) {
        vqsqldriver->setQSqlDriver_SqlStatement_IsBase(true);
        auto _ret = vqsqldriver->sqlStatement(static_cast<QSqlDriver::StatementType>(type), tableName_QString, *rec, preparedStatement);
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
        ...
        auto _ret = self->QSqlDriver::sqlStatement(static_cast<QSqlDriver::StatementType>(type), tableName_QString, *rec, preparedStatement);
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
...
// Base class handler implementation
bool QSqlDriver_SuperIsIdentifierEscaped(const QSqlDriver* self, const libqt_string identifier, int type) {
    auto* vqsqldriver = const_cast<VirtualQSqlDriver*>(dynamic_cast<const VirtualQSqlDriver*>(self));
    QString identifier_QString = QString::fromUtf8(identifier.data, identifier.len);
    if (vqsqldriver && vqsqldriver->isVirtualQSqlDriver) {
...
// Base class handler implementation
libqt_string QSqlDriver_SuperStripDelimiters(const QSqlDriver* self, const libqt_string identifier, int type) {
    auto* vqsqldriver = const_cast<VirtualQSqlDriver*>(dynamic_cast<const VirtualQSqlDriver*>(self));
    QString identifier_QString = QString::fromUtf8(identifier.data, identifier.len);
    if (vqsqldriver && vqsqldriver->isVirtualQSqlDriver) {
        vqsqldriver->setQSqlDriver_StripDelimiters_IsBase(true);
        auto _ret = vqsqldriver->stripDelimiters(identifier_QString, static_cast<QSqlDriver::IdentifierType>(type));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
        ...
        auto _ret = self->QSqlDriver::stripDelimiters(identifier_QString, static_cast<QSqlDriver::IdentifierType>(type));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
...
// Base class handler implementation
int QSqlDriver_SuperMaximumIdentifierLength(const QSqlDriver* self, int type) {
    auto* vqsqldriver = const_cast<VirtualQSqlDriver*>(dynamic_cast<const VirtualQSqlDriver*>(self));
    if (vqsqldriver && vqsqldriver->isVirtualQSqlDriver) {
