...
/// @return libqt_map of int to char*
///
libqt_map q_sqlquerymodel_qbase_role_names(void* self);
...
///
/// @param self QSqlQueryModel*
/// @param callback void func(QSqlQueryModel* self, QModelIndex* topLeft, QModelIndex* bottomRight, int* )
///
...
///
QMetaObject__Connection* q_sqlquerymodel_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
/// @return libqt_map of int to QVariant*
///
libqt_map q_sqlquerymodel_qbase_item_data(void* self, void* index);
...
/// @param roles libqt_map of int to QVariant*
///
bool q_sqlquerymodel_qbase_set_item_data(void* self, void* index, libqt_map roles);
...
///
/// @param self QSqlQueryModel*
/// @param callback bool func(QSqlQueryModel* self, QModelIndex* index, libqt_map of int to QVariant*)
///
...
///
/// @param self QSqlQueryModel*
/// @param callback QMimeData* func(QSqlQueryModel* self, QModelIndex** indexes)
///
...
/// @return libqt_list of QModelIndex*
///
libqt_list q_sqlquerymodel_qbase_match(void* self, void* start, int role, void* value, int hits, int32_t flags);
...
///
/// @param self QSqlQueryModel*
/// @param callback QModelIndex** func(QSqlQueryModel* self, QModelIndex* start, int role, QVariant* value, int hits, flag of enum Qt__MatchFlag flags)
///
...
///
/// @param self QSqlQueryModel*
/// @param callback void func(QSqlQueryModel* self, QModelIndex** indexes, QDataStream* stream)
///
...
/// @return libqt_list of QModelIndex*
///
libqt_list q_sqlquerymodel_qbase_persistent_index_list(void* self);
