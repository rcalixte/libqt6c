...
class VirtualQMenuBar final : public QMenuBar {
  ...
  public:
    ...
    friend void QMenuBar_InitStyleOption(const QMenuBar* self, QStyleOptionMenuItem* option, QAction* action);
    friend void QMenuBar_QBaseInitStyleOption(const QMenuBar* self, QStyleOptionMenuItem* option, QAction* action);
    ...
    friend bool QMenuBar_NativeEvent(QMenuBar* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QMenuBar_QBaseNativeEvent(QMenuBar* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QMenuBar_ConnectNotify(QMenuBar* self, QMetaMethod* signal);
    friend void QMenuBar_QBaseConnectNotify(QMenuBar* self, QMetaMethod* signal);
    friend void QMenuBar_DisconnectNotify(QMenuBar* self, QMetaMethod* signal);
    friend void QMenuBar_QBaseDisconnectNotify(QMenuBar* self, QMetaMethod* signal);
    ...
    friend bool QMenuBar_IsSignalConnected(const QMenuBar* self, QMetaMethod* signal);
    friend bool QMenuBar_QBaseIsSignalConnected(const QMenuBar* self, QMetaMethod* signal);
};
