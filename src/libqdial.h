...
///
libqt_list q_dial_actions(void* self);
...
///
int32_t q_dial_window_flags(void* self);
...
///
int32_t q_dial_window_type(void* self);
...
///
int32_t q_dial_input_method_hints(void* self);
...
///
libqt_list q_dial_children(void* self);
...
///
void q_dial_on_input_method_query(void* self, QVariant* (*callback)(void*, int32_t));
