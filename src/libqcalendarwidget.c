...
bool q_calendarwidget_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_calendarwidget_as_q_paint_device(self));
}

int32_t q_calendarwidget_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_calendarwidget_as_q_paint_device(self));
}

int32_t q_calendarwidget_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_calendarwidget_as_q_paint_device(self));
}

int32_t q_calendarwidget_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_calendarwidget_as_q_paint_device(self));
}

int32_t q_calendarwidget_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_calendarwidget_as_q_paint_device(self));
}

int32_t q_calendarwidget_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_calendarwidget_as_q_paint_device(self));
}

int32_t q_calendarwidget_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_calendarwidget_as_q_paint_device(self));
}

double q_calendarwidget_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_calendarwidget_as_q_paint_device(self));
}

double q_calendarwidget_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_calendarwidget_as_q_paint_device(self));
}

int32_t q_calendarwidget_color_count(void* self) {
    return QPaintDevice_ColorCount(q_calendarwidget_as_q_paint_device(self));
}

int32_t q_calendarwidget_depth(void* self) {
    return QPaintDevice_Depth(q_calendarwidget_as_q_paint_device(self));
}
