#pragma once
#ifndef POSIX_EXTRAS_SIGNON_LIBAUTHSESSION_H
#define POSIX_EXTRAS_SIGNON_LIBAUTHSESSION_H
...
///
void q_signon__authsession_set_object_name(void* self, const char* name);
