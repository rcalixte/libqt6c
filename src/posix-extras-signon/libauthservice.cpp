...
libqt_string SignOn__AuthService_Tr(const char* s) {
    QString _ret = SignOn::AuthService::tr(s);
...
void SignOn__AuthService_MethodsAvailable(SignOn__AuthService* self, const libqt_list /* of libqt_string */ methods) {
    ...
    libqt_string* methods_arr = static_cast<libqt_string*>(methods.data.ptr);
...
void SignOn__AuthService_MechanismsAvailable(SignOn__AuthService* self, const libqt_string method, const libqt_list /* of libqt_string */ mechanisms) {
    ...
    libqt_string* mechanisms_arr = static_cast<libqt_string*>(mechanisms.data.ptr);
...
void SignOn__AuthService_Connect_MechanismsAvailable(SignOn__AuthService* self, intptr_t slot) {
    ...
    SignOn::AuthService::connect(self, &SignOn::AuthService::mechanismsAvailable, [self, slotFunc](const QString& method, const QList<QString>& mechanisms) {
        ...
        char* method_str = static_cast<char*>(malloc(method_b.length() + 1));
        memcpy(method_str, method_b.data(), method_b.length());
        method_str[method_b.length()] = '\0';
...
void SignOn__AuthService_Identities(SignOn__AuthService* self, const libqt_list /* of SignOn__IdentityInfo* */ identityList) {
    ...
    SignOn__IdentityInfo** identityList_arr = static_cast<SignOn__IdentityInfo**>(identityList.data.ptr);
...
libqt_string SignOn__AuthService_Tr2(const char* s, const char* c) {
    QString _ret = SignOn::AuthService::tr(s, c);
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string SignOn__AuthService_Tr3(const char* s, const char* c, int n) {
    QString _ret = SignOn::AuthService::tr(s, c, static_cast<int>(n));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
