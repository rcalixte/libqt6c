...
bool k_fileplaceeditdialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_fileplaceeditdialog_as_q_paint_device(self));
}

int32_t k_fileplaceeditdialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_fileplaceeditdialog_as_q_paint_device(self));
}

int32_t k_fileplaceeditdialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_fileplaceeditdialog_as_q_paint_device(self));
}

int32_t k_fileplaceeditdialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_fileplaceeditdialog_as_q_paint_device(self));
}

int32_t k_fileplaceeditdialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_fileplaceeditdialog_as_q_paint_device(self));
}

int32_t k_fileplaceeditdialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_fileplaceeditdialog_as_q_paint_device(self));
}

int32_t k_fileplaceeditdialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_fileplaceeditdialog_as_q_paint_device(self));
}

double k_fileplaceeditdialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_fileplaceeditdialog_as_q_paint_device(self));
}

double k_fileplaceeditdialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_fileplaceeditdialog_as_q_paint_device(self));
}

int32_t k_fileplaceeditdialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_fileplaceeditdialog_as_q_paint_device(self));
}

int32_t k_fileplaceeditdialog_depth(void* self) {
    return QPaintDevice_Depth(k_fileplaceeditdialog_as_q_paint_device(self));
}
