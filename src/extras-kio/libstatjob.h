#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBSTATJOB_H
#define SRC_EXTRAS_KIO_QT6C_LIBSTATJOB_H
...
///
void k_io__statjob_add_meta_data2(void* self, libqt_map values);
...
/// @param values libqt_map of const char* to const char*
///
void k_io__statjob_merge_meta_data(void* self, libqt_map values);
...
///
void k_io__statjob_total_size(void* self, void* job, uintptr_t size);
...
///
/// @param self KIO__StatJob*
/// @param callback void func(KIO__StatJob* self, KJob* job, uintptr_t size)
///
void k_io__statjob_on_total_size(void* self, void (*callback)(void*, void*, uintptr_t));
...
/// @param size uintptr_t
///
void k_io__statjob_processed_size(void* self, void* job, uintptr_t size);
...
/// @param callback void func(KIO__StatJob* self, KJob* job, uintptr_t size)
///
void k_io__statjob_on_processed_size(void* self, void (*callback)(void*, void*, uintptr_t));
...
///
void k_io__statjob_speed(void* self, void* job, uintptr_t speed);
...
///
/// @param self KIO__StatJob*
/// @param callback void func(KIO__StatJob* self, KJob* job, uintptr_t speed)
///
void k_io__statjob_on_speed(void* self, void (*callback)(void*, void*, uintptr_t));
...
///
int32_t k_io__statjob_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_io__statjob_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
/// @param self KIO__StatJob*
/// @param callback void func(KIO__StatJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
void k_io__statjob_on_total_amount_changed(void* self, void (*callback)(void*, void*, int32_t, uintptr_t));
...
/// @param callback void func(KIO__StatJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
void k_io__statjob_on_processed_amount_changed(void* self, void (*callback)(void*, void*, int32_t, uintptr_t));
...
///
/// @param self KIO__StatJob*
/// @param callback void func(KIO__StatJob* self, KJob* job, uintptr_t percent)
///
void k_io__statjob_on_percent_changed(void* self, void (*callback)(void*, void*, uintptr_t));
