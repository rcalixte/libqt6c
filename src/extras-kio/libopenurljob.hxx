...
class VirtualKIOOpenUrlJob final : public KIO::OpenUrlJob {
  ...
  public:
    ...
    friend bool KIO__OpenUrlJob_SuperHasSubjobs(const KIO::OpenUrlJob* self);
    friend libqt_list /* of KJob* */ KIO__OpenUrlJob_Subjobs(const KIO::OpenUrlJob* self);
    friend libqt_list /* of KJob* */ KIO__OpenUrlJob_SuperSubjobs(const KIO::OpenUrlJob* self);
    friend void KIO__OpenUrlJob_ClearSubjobs(KIO::OpenUrlJob* self);
    friend void KIO__OpenUrlJob_SuperClearSubjobs(KIO::OpenUrlJob* self);
    friend void KIO__OpenUrlJob_SetCapabilities(KIO::OpenUrlJob* self, int capabilities);
    friend void KIO__OpenUrlJob_SuperSetCapabilities(KIO::OpenUrlJob* self, int capabilities);
    friend bool KIO__OpenUrlJob_IsFinished(const KIO::OpenUrlJob* self);
    friend bool KIO__OpenUrlJob_SuperIsFinished(const KIO::OpenUrlJob* self);
    friend void KIO__OpenUrlJob_SetError(KIO::OpenUrlJob* self, int errorCode);
    friend void KIO__OpenUrlJob_SuperSetError(KIO::OpenUrlJob* self, int errorCode);
    friend void KIO__OpenUrlJob_SetErrorText(KIO::OpenUrlJob* self, const libqt_string errorText);
    friend void KIO__OpenUrlJob_SuperSetErrorText(KIO::OpenUrlJob* self, const libqt_string errorText);
    friend void KIO__OpenUrlJob_SetProcessedAmount(KIO::OpenUrlJob* self, int unit, unsigned long long amount);
    friend void KIO__OpenUrlJob_SuperSetProcessedAmount(KIO::OpenUrlJob* self, int unit, unsigned long long amount);
    friend void KIO__OpenUrlJob_SetTotalAmount(KIO::OpenUrlJob* self, int unit, unsigned long long amount);
    friend void KIO__OpenUrlJob_SuperSetTotalAmount(KIO::OpenUrlJob* self, int unit, unsigned long long amount);
    friend void KIO__OpenUrlJob_SetProgressUnit(KIO::OpenUrlJob* self, int unit);
    friend void KIO__OpenUrlJob_SuperSetProgressUnit(KIO::OpenUrlJob* self, int unit);
    friend void KIO__OpenUrlJob_SetPercent(KIO::OpenUrlJob* self, unsigned long percentage);
    friend void KIO__OpenUrlJob_SuperSetPercent(KIO::OpenUrlJob* self, unsigned long percentage);
    friend void KIO__OpenUrlJob_EmitResult(KIO::OpenUrlJob* self);
    friend void KIO__OpenUrlJob_SuperEmitResult(KIO::OpenUrlJob* self);
    ...
    friend void KIO__OpenUrlJob_SuperEmitPercent(KIO::OpenUrlJob* self, unsigned long long processedAmount, unsigned long long totalAmount);
    friend void KIO__OpenUrlJob_EmitSpeed(KIO::OpenUrlJob* self, unsigned long speed);
    friend void KIO__OpenUrlJob_SuperEmitSpeed(KIO::OpenUrlJob* self, unsigned long speed);
    friend void KIO__OpenUrlJob_StartElapsedTimer(KIO::OpenUrlJob* self);
    friend void KIO__OpenUrlJob_SuperStartElapsedTimer(KIO::OpenUrlJob* self);
    friend QObject* KIO__OpenUrlJob_Sender(const KIO::OpenUrlJob* self);
    friend QObject* KIO__OpenUrlJob_SuperSender(const KIO::OpenUrlJob* self);
    friend int KIO__OpenUrlJob_SenderSignalIndex(const KIO::OpenUrlJob* self);
    friend int KIO__OpenUrlJob_SuperSenderSignalIndex(const KIO::OpenUrlJob* self);
    friend int KIO__OpenUrlJob_Receivers(const KIO::OpenUrlJob* self, const char* signal);
    friend int KIO__OpenUrlJob_SuperReceivers(const KIO::OpenUrlJob* self, const char* signal);
    friend bool KIO__OpenUrlJob_IsSignalConnected(const KIO::OpenUrlJob* self, const QMetaMethod* signal);
    friend bool KIO__OpenUrlJob_SuperIsSignalConnected(const KIO::OpenUrlJob* self, const QMetaMethod* signal);
};
