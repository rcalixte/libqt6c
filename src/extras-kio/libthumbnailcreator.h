#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBTHUMBNAILCREATOR_H
#define SRC_EXTRAS_KIO_QT6C_LIBTHUMBNAILCREATOR_H
...
///
/// @param self KIO__ThumbnailCreator*
/// @param callback void* func(KIO__ThumbnailCreator* self, const char* param1)
///
...
///
void k_io__thumbnailcreator_set_object_name(void* self, const char* name);
