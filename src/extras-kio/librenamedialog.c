...
bool k_io__renamedialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_io__renamedialog_as_q_paint_device(self));
}

int32_t k_io__renamedialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_io__renamedialog_as_q_paint_device(self));
}

int32_t k_io__renamedialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_io__renamedialog_as_q_paint_device(self));
}

int32_t k_io__renamedialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_io__renamedialog_as_q_paint_device(self));
}

int32_t k_io__renamedialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_io__renamedialog_as_q_paint_device(self));
}

int32_t k_io__renamedialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_io__renamedialog_as_q_paint_device(self));
}

int32_t k_io__renamedialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_io__renamedialog_as_q_paint_device(self));
}

double k_io__renamedialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_io__renamedialog_as_q_paint_device(self));
}

double k_io__renamedialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_io__renamedialog_as_q_paint_device(self));
}

int32_t k_io__renamedialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_io__renamedialog_as_q_paint_device(self));
}

int32_t k_io__renamedialog_depth(void* self) {
    return QPaintDevice_Depth(k_io__renamedialog_as_q_paint_device(self));
}
