#pragma once
#ifndef EXTRAS_KIO_LIBKFILEFILTERCOMBO_H
#define EXTRAS_KIO_LIBKFILEFILTERCOMBO_H
...
///
/// @param self KFileFilterCombo*
/// @param callback bool func(KFileFilterCombo* self, libqt_string eventType, void* message, intptr_t* result)
///
