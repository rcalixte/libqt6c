...
///
libqt_list k_io__untrustedprogramhandlerinterface_children(void* self);
...
///
QMetaObject__Connection* k_io__untrustedprogramhandlerinterface_connect(void* sender, const char* signal, void* receiver, const char* member);
...
///
QMetaObject__Connection* k_io__untrustedprogramhandlerinterface_connect2(void* sender, void* signal, void* receiver, void* method);
...
/// @param member const char*
///
QMetaObject__Connection* k_io__untrustedprogramhandlerinterface_connect3(void* self, void* sender, const char* signal, const char* member);
...
/// @param member const char*
///
bool k_io__untrustedprogramhandlerinterface_disconnect(void* sender, const char* signal, void* receiver, const char* member);
...
///
bool k_io__untrustedprogramhandlerinterface_disconnect2(void* sender, void* signal, void* receiver, void* member);
...
/// @param self KIO__UntrustedProgramHandlerInterface*
///
bool k_io__untrustedprogramhandlerinterface_disconnect3(void* self);
...
/// @param receiver QObject*
///
bool k_io__untrustedprogramhandlerinterface_disconnect4(void* self, void* receiver);
...
///
bool k_io__untrustedprogramhandlerinterface_disconnect5(void* param1);
...
///
QMetaObject__Connection* k_io__untrustedprogramhandlerinterface_connect5(void* sender, const char* signal, void* receiver, const char* member, int32_t param5);
...
///
QMetaObject__Connection* k_io__untrustedprogramhandlerinterface_connect52(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
/// @param signal const char*
///
bool k_io__untrustedprogramhandlerinterface_disconnect1(void* self, const char* signal);
...
/// @param receiver QObject*
///
bool k_io__untrustedprogramhandlerinterface_disconnect22(void* self, const char* signal, void* receiver);
...
/// @param member const char*
///
bool k_io__untrustedprogramhandlerinterface_disconnect32(void* self, const char* signal, void* receiver, const char* member);
...
/// @param member const char*
///
bool k_io__untrustedprogramhandlerinterface_disconnect23(void* self, void* receiver, const char* member);
