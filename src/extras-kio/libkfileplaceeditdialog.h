#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBKFILEPLACEEDITDIALOG_H
#define SRC_EXTRAS_KIOQT6C_LIBKFILEPLACEEDITDIALOG_H
...
/// [Qt documentation](https://api.kde.org/kfileplaceeditdialog.html#getInformation)
///
/// @param allowGlobal bool
/// @param url QUrl*
/// @param label const char*
...
/// [Qt documentation](https://api.kde.org/kfileplaceeditdialog.html#url)
///
/// @param self KFilePlaceEditDialog*
QUrl* k_fileplaceeditdialog_url(void* self);

/// [Qt documentation](https://api.kde.org/kfileplaceeditdialog.html#label)
///
/// Caller is responsible for freeing the returned memory
///
/// @param self KFilePlaceEditDialog*
...
/// [Qt documentation](https://api.kde.org/kfileplaceeditdialog.html#icon)
///
/// Caller is responsible for freeing the returned memory
///
/// @param self KFilePlaceEditDialog*
...
/// [Qt documentation](https://api.kde.org/kfileplaceeditdialog.html#applicationLocal)
///
/// @param self KFilePlaceEditDialog*
bool k_fileplaceeditdialog_application_local(void* self);

/// [Qt documentation](https://api.kde.org/kfileplaceeditdialog.html#urlChanged)
///
/// @param self KFilePlaceEditDialog*
/// @param param1 const char*
...
void k_fileplaceeditdialog_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KFilePlaceEditDialog*
/// @param typeVal enum Qt__GestureType
void k_fileplaceeditdialog_ungrab_gesture(void* self, int64_t typeVal);
...
void k_fileplaceeditdialog_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KFilePlaceEditDialog*
/// @param typeVal flag of enum Qt__WindowType
void k_fileplaceeditdialog_override_window_flags(void* self, int64_t typeVal);
...
void k_fileplaceeditdialog_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_fileplaceeditdialog_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_fileplaceeditdialog_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
/// [Qt documentation](https://api.kde.org/kfileplaceeditdialog.html#dtor.KFilePlaceEditDialog)
///
