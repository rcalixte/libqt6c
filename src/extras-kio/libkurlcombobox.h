#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBKURLCOMBOBOX_H
#define SRC_EXTRAS_KIOQT6C_LIBKURLCOMBOBOX_H
...
/// [Qt documentation](https://api.kde.org/kurlcombobox.html#setUrl)
///
/// @param self KUrlComboBox*
/// @param url QUrl*
...
/// [Qt documentation](https://api.kde.org/kurlcombobox.html#setMaxItems)
///
/// @param self KUrlComboBox*
/// @param maxItems int
void k_urlcombobox_set_max_items(void* self, int maxItems);

/// [Qt documentation](https://api.kde.org/kurlcombobox.html#maxItems)
///
/// @param self KUrlComboBox*
int32_t k_urlcombobox_max_items(void* self);

/// [Qt documentation](https://api.kde.org/kurlcombobox.html#addDefaultUrl)
///
/// @param self KUrlComboBox*
/// @param url QUrl*
...
/// [Qt documentation](https://api.kde.org/kurlcombobox.html#setDefaults)
///
/// @param self KUrlComboBox*
void k_urlcombobox_set_defaults(void* self);

/// [Qt documentation](https://api.kde.org/kurlcombobox.html#removeUrl)
///
/// @param self KUrlComboBox*
/// @param url QUrl*
void k_urlcombobox_remove_url(void* self, void* url);

/// [Qt documentation](https://api.kde.org/kurlcombobox.html#setCompletionObject)
///
/// @param self KUrlComboBox*
...
/// [Qt documentation](https://api.kde.org/kurlcombobox.html#urlActivated)
///
/// @param self KUrlComboBox*
/// @param url QUrl*
...
/// [Qt documentation](https://api.kde.org/kurlcombobox.html#mousePressEvent)
///
/// @param self KUrlComboBox*
...
/// [Qt documentation](https://api.kde.org/kurlcombobox.html#mouseMoveEvent)
///
/// @param self KUrlComboBox*
/// @param event QMouseEvent*
...
void k_urlcombobox_rotate_text(void* self, int32_t typeVal);
...
void k_urlcombobox_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KUrlComboBox*
/// @param typeVal enum Qt__GestureType
void k_urlcombobox_ungrab_gesture(void* self, int64_t typeVal);
...
void k_urlcombobox_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KUrlComboBox*
/// @param typeVal flag of enum Qt__WindowType
void k_urlcombobox_override_window_flags(void* self, int64_t typeVal);
...
void k_urlcombobox_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_urlcombobox_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_urlcombobox_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
/// [Qt documentation](https://api.kde.org/kurlcombobox.html#dtor.KUrlComboBox)
///
