...
class VirtualKDirModel final : public KDirModel {
  ...
  public:
    ...
    using KDirModel_PersistentIndexList_Callback = libqt_list /* of QModelIndex* */ (*)();
  ...
  public:
    ...
    friend QModelIndex* KDirModel_SuperCreateIndex(const KDirModel* self, int row, int column);
    friend void KDirModel_EncodeData(const KDirModel* self, const libqt_list /* of QModelIndex* */ indexes, QDataStream* stream);
    friend void KDirModel_SuperEncodeData(const KDirModel* self, const libqt_list /* of QModelIndex* */ indexes, QDataStream* stream);
    friend bool KDirModel_DecodeData(KDirModel* self, int row, int column, const QModelIndex* parent, QDataStream* stream);
    friend bool KDirModel_SuperDecodeData(KDirModel* self, int row, int column, const QModelIndex* parent, QDataStream* stream);
    friend void KDirModel_BeginInsertRows(KDirModel* self, const QModelIndex* parent, int first, int last);
    friend void KDirModel_SuperBeginInsertRows(KDirModel* self, const QModelIndex* parent, int first, int last);
    friend void KDirModel_EndInsertRows(KDirModel* self);
    friend void KDirModel_SuperEndInsertRows(KDirModel* self);
    friend void KDirModel_BeginRemoveRows(KDirModel* self, const QModelIndex* parent, int first, int last);
    friend void KDirModel_SuperBeginRemoveRows(KDirModel* self, const QModelIndex* parent, int first, int last);
    friend void KDirModel_EndRemoveRows(KDirModel* self);
    friend void KDirModel_SuperEndRemoveRows(KDirModel* self);
    ...
    friend bool KDirModel_SuperBeginMoveRows(KDirModel* self, const QModelIndex* sourceParent, int sourceFirst, int sourceLast, const QModelIndex* destinationParent, int destinationRow);
    friend void KDirModel_EndMoveRows(KDirModel* self);
    friend void KDirModel_SuperEndMoveRows(KDirModel* self);
    friend void KDirModel_BeginInsertColumns(KDirModel* self, const QModelIndex* parent, int first, int last);
    friend void KDirModel_SuperBeginInsertColumns(KDirModel* self, const QModelIndex* parent, int first, int last);
    friend void KDirModel_EndInsertColumns(KDirModel* self);
    friend void KDirModel_SuperEndInsertColumns(KDirModel* self);
    friend void KDirModel_BeginRemoveColumns(KDirModel* self, const QModelIndex* parent, int first, int last);
    friend void KDirModel_SuperBeginRemoveColumns(KDirModel* self, const QModelIndex* parent, int first, int last);
    friend void KDirModel_EndRemoveColumns(KDirModel* self);
    friend void KDirModel_SuperEndRemoveColumns(KDirModel* self);
    ...
    friend bool KDirModel_SuperBeginMoveColumns(KDirModel* self, const QModelIndex* sourceParent, int sourceFirst, int sourceLast, const QModelIndex* destinationParent, int destinationColumn);
    friend void KDirModel_EndMoveColumns(KDirModel* self);
    friend void KDirModel_SuperEndMoveColumns(KDirModel* self);
    friend void KDirModel_BeginResetModel(KDirModel* self);
    friend void KDirModel_SuperBeginResetModel(KDirModel* self);
    friend void KDirModel_EndResetModel(KDirModel* self);
    friend void KDirModel_SuperEndResetModel(KDirModel* self);
    friend void KDirModel_ChangePersistentIndex(KDirModel* self, const QModelIndex* from, const QModelIndex* to);
    friend void KDirModel_SuperChangePersistentIndex(KDirModel* self, const QModelIndex* from, const QModelIndex* to);
    ...
    friend void KDirModel_SuperChangePersistentIndexList(KDirModel* self, const libqt_list /* of QModelIndex* */ from, const libqt_list /* of QModelIndex* */ to);
    friend libqt_list /* of QModelIndex* */ KDirModel_PersistentIndexList(const KDirModel* self);
    friend libqt_list /* of QModelIndex* */ KDirModel_SuperPersistentIndexList(const KDirModel* self);
    friend QObject* KDirModel_Sender(const KDirModel* self);
    friend QObject* KDirModel_SuperSender(const KDirModel* self);
    friend int KDirModel_SenderSignalIndex(const KDirModel* self);
    friend int KDirModel_SuperSenderSignalIndex(const KDirModel* self);
    friend int KDirModel_Receivers(const KDirModel* self, const char* signal);
    friend int KDirModel_SuperReceivers(const KDirModel* self, const char* signal);
    friend bool KDirModel_IsSignalConnected(const KDirModel* self, const QMetaMethod* signal);
    friend bool KDirModel_SuperIsSignalConnected(const KDirModel* self, const QMetaMethod* signal);
};
