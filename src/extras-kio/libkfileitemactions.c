...
const char* k_fileitemactions_tr(const char* s) {
    libqt_string _str = KFileItemActions_Tr(s);
...
void k_fileitemactions_insert_open_with_actions_to(void* self, void* before, void* topMenu, const char* excludedDesktopEntryNames[]) {
    ...
    if (excludedDesktopEntryNames_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_fileitemactions_insert_open_with_actions_to");
        abort();
    }
...
const char* k_fileitemactions_tr2(const char* s, const char* c) {
    libqt_string _str = KFileItemActions_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_fileitemactions_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KFileItemActions_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_fileitemactions_add_actions_to4(void* self, void* menu, int32_t sources, libqt_list additionalActions, const char* excludeList[]) {
    ...
    if (excludeList_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_fileitemactions_add_actions_to4");
        abort();
    }
...
const char** k_fileitemactions_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_fileitemactions_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_fileitemactions_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_fileitemactions_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
