  ...
  public:
    ...
    void setDesktopEntryName(const QString& desktopEntryName) {
        if (kurifiltersearchprovider_setdesktopentryname_isbase) {
            ...
            char* desktopEntryName_str = static_cast<char*>(malloc(desktopEntryName_str_len + 1));
            memcpy(desktopEntryName_str, desktopEntryName_b.data(), desktopEntryName_str_len);
            desktopEntryName_str[desktopEntryName_str_len] = '\0';
