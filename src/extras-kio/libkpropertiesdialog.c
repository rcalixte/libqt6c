...
bool k_propertiesdialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_propertiesdialog_as_q_paint_device(self));
}

int32_t k_propertiesdialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_propertiesdialog_as_q_paint_device(self));
}

int32_t k_propertiesdialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_propertiesdialog_as_q_paint_device(self));
}

int32_t k_propertiesdialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_propertiesdialog_as_q_paint_device(self));
}

int32_t k_propertiesdialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_propertiesdialog_as_q_paint_device(self));
}

int32_t k_propertiesdialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_propertiesdialog_as_q_paint_device(self));
}

int32_t k_propertiesdialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_propertiesdialog_as_q_paint_device(self));
}

double k_propertiesdialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_propertiesdialog_as_q_paint_device(self));
}

double k_propertiesdialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_propertiesdialog_as_q_paint_device(self));
}

int32_t k_propertiesdialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_propertiesdialog_as_q_paint_device(self));
}

int32_t k_propertiesdialog_depth(void* self) {
    return QPaintDevice_Depth(k_propertiesdialog_as_q_paint_device(self));
}
