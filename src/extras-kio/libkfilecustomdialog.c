...
const char* k_filecustomdialog_tr(const char* s) {
    libqt_string _str = KFileCustomDialog_Tr(s);
...
const char* k_filecustomdialog_tr2(const char* s, const char* c) {
    libqt_string _str = KFileCustomDialog_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_filecustomdialog_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KFileCustomDialog_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_filecustomdialog_grab_gesture(void* self, int64_t type) {
    QWidget_GrabGesture((QWidget*)self, type);
}

void k_filecustomdialog_ungrab_gesture(void* self, int64_t type) {
...
void k_filecustomdialog_set_window_flags(void* self, int64_t type) {
...
void k_filecustomdialog_override_window_flags(void* self, int64_t type) {
...
void k_filecustomdialog_grab_gesture2(void* self, int64_t type, int32_t flags) {
...
const char** k_filecustomdialog_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_filecustomdialog_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_filecustomdialog_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type) {
