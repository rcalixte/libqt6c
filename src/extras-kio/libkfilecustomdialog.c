...
bool k_filecustomdialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_filecustomdialog_as_q_paint_device(self));
}

int32_t k_filecustomdialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_filecustomdialog_as_q_paint_device(self));
}

int32_t k_filecustomdialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_filecustomdialog_as_q_paint_device(self));
}

int32_t k_filecustomdialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_filecustomdialog_as_q_paint_device(self));
}

int32_t k_filecustomdialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_filecustomdialog_as_q_paint_device(self));
}

int32_t k_filecustomdialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_filecustomdialog_as_q_paint_device(self));
}

int32_t k_filecustomdialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_filecustomdialog_as_q_paint_device(self));
}

double k_filecustomdialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_filecustomdialog_as_q_paint_device(self));
}

double k_filecustomdialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_filecustomdialog_as_q_paint_device(self));
}

int32_t k_filecustomdialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_filecustomdialog_as_q_paint_device(self));
}

int32_t k_filecustomdialog_depth(void* self) {
    return QPaintDevice_Depth(k_filecustomdialog_as_q_paint_device(self));
}
