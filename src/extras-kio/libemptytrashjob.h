...
///
/// @param self KIO__EmptyTrashJob*
/// @param callback void func(KIO__EmptyTrashJob* self, KJob* job, const char* title)
...
///
/// @param self KIO__EmptyTrashJob*
/// @param callback void func(KIO__EmptyTrashJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
...
///
/// @param self KIO__EmptyTrashJob*
/// @param callback void func(KIO__EmptyTrashJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
