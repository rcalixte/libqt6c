  ...
  public:
    ...
    void setErrorText(const QString& errorText) {
        if (kio__applicationlauncherjob_seterrortext_isbase) {
            ...
            char* errorText_str = static_cast<char*>(malloc(errorText_str_len + 1));
            memcpy(errorText_str, errorText_b.data(), errorText_str_len);
            errorText_str[errorText_str_len] = '\0';
    ...
    friend void KIO__ApplicationLauncherJob_SuperSetCapabilities(KIO::ApplicationLauncherJob* self, int capabilities);
    friend bool KIO__ApplicationLauncherJob_IsFinished(const KIO::ApplicationLauncherJob* self);
    friend bool KIO__ApplicationLauncherJob_SuperIsFinished(const KIO::ApplicationLauncherJob* self);
    friend void KIO__ApplicationLauncherJob_SetError(KIO::ApplicationLauncherJob* self, int errorCode);
    friend void KIO__ApplicationLauncherJob_SuperSetError(KIO::ApplicationLauncherJob* self, int errorCode);
    friend void KIO__ApplicationLauncherJob_SetErrorText(KIO::ApplicationLauncherJob* self, const libqt_string errorText);
    friend void KIO__ApplicationLauncherJob_SuperSetErrorText(KIO::ApplicationLauncherJob* self, const libqt_string errorText);
    ...
    friend void KIO__ApplicationLauncherJob_SuperSetProcessedAmount(KIO::ApplicationLauncherJob* self, int unit, unsigned long long amount);
    ...
    friend void KIO__ApplicationLauncherJob_SuperSetTotalAmount(KIO::ApplicationLauncherJob* self, int unit, unsigned long long amount);
    friend void KIO__ApplicationLauncherJob_SetProgressUnit(KIO::ApplicationLauncherJob* self, int unit);
    friend void KIO__ApplicationLauncherJob_SuperSetProgressUnit(KIO::ApplicationLauncherJob* self, int unit);
    friend void KIO__ApplicationLauncherJob_SetPercent(KIO::ApplicationLauncherJob* self, unsigned long percentage);
    friend void KIO__ApplicationLauncherJob_SuperSetPercent(KIO::ApplicationLauncherJob* self, unsigned long percentage);
    friend void KIO__ApplicationLauncherJob_EmitResult(KIO::ApplicationLauncherJob* self);
    friend void KIO__ApplicationLauncherJob_SuperEmitResult(KIO::ApplicationLauncherJob* self);
    ...
    friend void KIO__ApplicationLauncherJob_SuperEmitPercent(KIO::ApplicationLauncherJob* self, unsigned long long processedAmount, unsigned long long totalAmount);
    friend void KIO__ApplicationLauncherJob_EmitSpeed(KIO::ApplicationLauncherJob* self, unsigned long speed);
    friend void KIO__ApplicationLauncherJob_SuperEmitSpeed(KIO::ApplicationLauncherJob* self, unsigned long speed);
    friend void KIO__ApplicationLauncherJob_StartElapsedTimer(KIO::ApplicationLauncherJob* self);
    friend void KIO__ApplicationLauncherJob_SuperStartElapsedTimer(KIO::ApplicationLauncherJob* self);
    friend QObject* KIO__ApplicationLauncherJob_Sender(const KIO::ApplicationLauncherJob* self);
    friend QObject* KIO__ApplicationLauncherJob_SuperSender(const KIO::ApplicationLauncherJob* self);
    friend int KIO__ApplicationLauncherJob_SenderSignalIndex(const KIO::ApplicationLauncherJob* self);
    friend int KIO__ApplicationLauncherJob_SuperSenderSignalIndex(const KIO::ApplicationLauncherJob* self);
    friend int KIO__ApplicationLauncherJob_Receivers(const KIO::ApplicationLauncherJob* self, const char* signal);
    friend int KIO__ApplicationLauncherJob_SuperReceivers(const KIO::ApplicationLauncherJob* self, const char* signal);
    friend bool KIO__ApplicationLauncherJob_IsSignalConnected(const KIO::ApplicationLauncherJob* self, const QMetaMethod* signal);
    friend bool KIO__ApplicationLauncherJob_SuperIsSignalConnected(const KIO::ApplicationLauncherJob* self, const QMetaMethod* signal);
};
