#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBSIMPLEJOB_H
#define SRC_EXTRAS_KIOQT6C_LIBSIMPLEJOB_H
...
/// https://api.kde.org/kio-simplejob.html
...
///
/// @param self KIO__SimpleJob*
/// @param callback void func(KIO__SimpleJob* self, KJob* job, const char* title)
...
///
/// @param self KIO__SimpleJob*
/// @param callback void func(KIO__SimpleJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
...
///
/// @param self KIO__SimpleJob*
/// @param callback void func(KIO__SimpleJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
...
QMetaObject__Connection* k_io__simplejob_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_io__simplejob_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
/// [Qt documentation](https://api.kde.org/kio.html#rmdir)
///
/// @param param1 QUrl*
KIO__SimpleJob* k_io_rmdir(void* param1);

/// [Qt documentation](https://api.kde.org/kio.html#chown)
///
/// @param param1 QUrl*
/// @param param2 const char*
...
/// [Qt documentation](https://api.kde.org/kio.html#setModificationTime)
///
/// @param param1 QUrl*
...
/// [Qt documentation](https://api.kde.org/kio.html#http_update_cache)
///
/// @param param1 QUrl*
/// @param param2 bool
