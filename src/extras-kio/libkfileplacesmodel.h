...
///
/// @param self KFilePlacesModel*
/// @param callback QMimeData* func(KFilePlacesModel* self, libqt_list of QModelIndex* indexes)
///
...
///
void k_fileplacesmodel_on_data_changed3(void* self, void (*callback)(void*, void*, void*, libqt_list));
...
///
void k_fileplacesmodel_on_match(void* self, libqt_list (*callback)(void*, void*, int, void*, int, int32_t));
...
///
void k_fileplacesmodel_on_encode_data(void* self, void (*callback)(void*, libqt_list, void*));
...
///
void k_fileplacesmodel_on_persistent_index_list(void* self, libqt_list (*callback)());
