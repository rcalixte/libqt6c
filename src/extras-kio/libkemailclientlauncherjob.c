...
const char* k_emailclientlauncherjob_tr(const char* s) {
    libqt_string _str = KEMailClientLauncherJob_Tr(s);
...
void k_emailclientlauncherjob_set_to(void* self, const char* to[static 1]) {
    ...
    if (to_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_emailclientlauncherjob_set_to");
        abort();
    }
...
void k_emailclientlauncherjob_set_cc(void* self, const char* cc[static 1]) {
    ...
    if (cc_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_emailclientlauncherjob_set_cc");
        abort();
    }
...
void k_emailclientlauncherjob_set_bcc(void* self, const char* bcc[static 1]) {
    ...
    if (bcc_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_emailclientlauncherjob_set_bcc");
        abort();
    }
...
const char* k_emailclientlauncherjob_tr2(const char* s, const char* c) {
    libqt_string _str = KEMailClientLauncherJob_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_emailclientlauncherjob_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KEMailClientLauncherJob_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_emailclientlauncherjob_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_emailclientlauncherjob_dynamic_property_names");
        abort();
    }
