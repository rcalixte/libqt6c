...
void k_io__widgetsaskuseractionhandler_set_object_name(void* self, const char* name) {
...
int32_t k_io__widgetsaskuseractionhandler_start_timer2(void* self, int64_t time) {
...
int32_t k_io__widgetsaskuseractionhandler_start_timer23(void* self, int64_t time, int32_t timerType) {
