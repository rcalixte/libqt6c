  ...
  public:
    ...
    virtual void askUserSkip(KJob* job, KIO::SkipDialog_Options options, const QString& error_text) override {
        if (kio__widgetsaskuseractionhandler_askuserskip_isbase) {
            ...
            char* error_text_str = static_cast<char*>(malloc(error_text_str_len + 1));
            memcpy(error_text_str, error_text_b.data(), error_text_str_len);
            error_text_str[error_text_str_len] = '\0';
    ...
    virtual void requestUserMessageBox(KIO::AskUserActionInterface::MessageDialogType type, const QString& text, const QString& title, const QString& primaryActionText, const QString& secondaryActionText, const QString& primaryActionIconName, const QString& secondaryActionIconName, const QString& dontAskAgainName, const QString& details, QWidget* parent) override {
        if (kio__widgetsaskuseractionhandler_requestusermessagebox_isbase) {
            ...
            char* primaryActionText_str = static_cast<char*>(malloc(primaryActionText_str_len + 1));
            memcpy(primaryActionText_str, primaryActionText_b.data(), primaryActionText_str_len);
            primaryActionText_str[primaryActionText_str_len] = '\0';
            ...
            char* secondaryActionText_str = static_cast<char*>(malloc(secondaryActionText_str_len + 1));
            memcpy(secondaryActionText_str, secondaryActionText_b.data(), secondaryActionText_str_len);
            secondaryActionText_str[secondaryActionText_str_len] = '\0';
            ...
            char* primaryActionIconName_str = static_cast<char*>(malloc(primaryActionIconName_str_len + 1));
            memcpy(primaryActionIconName_str, primaryActionIconName_b.data(), primaryActionIconName_str_len);
            primaryActionIconName_str[primaryActionIconName_str_len] = '\0';
            ...
            char* secondaryActionIconName_str = static_cast<char*>(malloc(secondaryActionIconName_str_len + 1));
            memcpy(secondaryActionIconName_str, secondaryActionIconName_b.data(), secondaryActionIconName_str_len);
            secondaryActionIconName_str[secondaryActionIconName_str_len] = '\0';
            ...
            char* dontAskAgainName_str = static_cast<char*>(malloc(dontAskAgainName_str_len + 1));
            memcpy(dontAskAgainName_str, dontAskAgainName_b.data(), dontAskAgainName_str_len);
            dontAskAgainName_str[dontAskAgainName_str_len] = '\0';
