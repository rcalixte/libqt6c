#pragma once
#ifndef SRC_EXTRAS_KIOC_LIBKENCODINGFILEDIALOG_HPP
#define SRC_EXTRAS_KIOC_LIBKENCODINGFILEDIALOG_HPP
...
libqt_string KEncodingFileDialog_Tr(const char* s);
...
libqt_string KEncodingFileDialog_Tr2(const char* s, const char* c);
libqt_string KEncodingFileDialog_Tr3(const char* s, const char* c, int n);
