...
KFileFilter* KFileFilter_new2(const libqt_string label, const libqt_list /* of libqt_string */ filePatterns, const libqt_list /* of libqt_string */ mimePatterns) {
    ...
    libqt_string* filePatterns_arr = static_cast<libqt_string*>(filePatterns.data.ptr);
    ...
    libqt_string* mimePatterns_arr = static_cast<libqt_string*>(mimePatterns.data.ptr);
