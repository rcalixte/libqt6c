...
void k_fileplacesview_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_fileplacesview_ungrab_gesture(void* self, int64_t typeVal) {
...
void k_fileplacesview_set_window_flags(void* self, int64_t typeVal) {
...
void k_fileplacesview_override_window_flags(void* self, int64_t typeVal) {
...
void k_fileplacesview_grab_gesture2(void* self, int64_t typeVal, int32_t flags) {
...
QMetaObject__Connection* k_fileplacesview_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_fileplacesview_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
