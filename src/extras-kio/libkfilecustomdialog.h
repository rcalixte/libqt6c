#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBKFILECUSTOMDIALOG_H
#define SRC_EXTRAS_KIO_QT6C_LIBKFILECUSTOMDIALOG_H
...
///
/// @param self KFileCustomDialog*
/// @param callback bool func(KFileCustomDialog* self, libqt_string eventType, void* message, intptr_t* result)
///
