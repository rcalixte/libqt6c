#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBKFILEPREVIEWGENERATOR_H
#define SRC_EXTRAS_KIOQT6C_LIBKFILEPREVIEWGENERATOR_H
...
/// [Qt documentation](https://api.kde.org/kfilepreviewgenerator.html#setPreviewShown)
///
/// @param self KFilePreviewGenerator*
/// @param show bool
void k_filepreviewgenerator_set_preview_shown(void* self, bool show);

/// [Qt documentation](https://api.kde.org/kfilepreviewgenerator.html#isPreviewShown)
///
/// @param self KFilePreviewGenerator*
bool k_filepreviewgenerator_is_preview_shown(void* self);

/// [Qt documentation](https://api.kde.org/kfilepreviewgenerator.html#setEnabledPlugins)
///
/// @param self KFilePreviewGenerator*
...
/// [Qt documentation](https://api.kde.org/kfilepreviewgenerator.html#updateIcons)
///
/// @param self KFilePreviewGenerator*
void k_filepreviewgenerator_update_icons(void* self);

/// [Qt documentation](https://api.kde.org/kfilepreviewgenerator.html#cancelPreviews)
///
/// @param self KFilePreviewGenerator*
...
QMetaObject__Connection* k_filepreviewgenerator_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_filepreviewgenerator_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
