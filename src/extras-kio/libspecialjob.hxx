  ...
  public:
    ...
    const QList<KJob*>& subjobs() const {
        if (kio__specialjob_subjobs_isbase) {
            ...
            KJob** callback_ret_arr = static_cast<KJob**>(callback_ret.data.ptr);
    ...
    friend bool KIO__SpecialJob_SuperHasSubjobs(const KIO::SpecialJob* self);
    friend libqt_list /* of KJob* */ KIO__SpecialJob_Subjobs(const KIO::SpecialJob* self);
    friend libqt_list /* of KJob* */ KIO__SpecialJob_SuperSubjobs(const KIO::SpecialJob* self);
    friend void KIO__SpecialJob_ClearSubjobs(KIO::SpecialJob* self);
    friend void KIO__SpecialJob_SuperClearSubjobs(KIO::SpecialJob* self);
    friend void KIO__SpecialJob_SetCapabilities(KIO::SpecialJob* self, int capabilities);
    friend void KIO__SpecialJob_SuperSetCapabilities(KIO::SpecialJob* self, int capabilities);
    friend bool KIO__SpecialJob_IsFinished(const KIO::SpecialJob* self);
    friend bool KIO__SpecialJob_SuperIsFinished(const KIO::SpecialJob* self);
    friend void KIO__SpecialJob_SetError(KIO::SpecialJob* self, int errorCode);
    friend void KIO__SpecialJob_SuperSetError(KIO::SpecialJob* self, int errorCode);
    friend void KIO__SpecialJob_SetErrorText(KIO::SpecialJob* self, const libqt_string errorText);
    friend void KIO__SpecialJob_SuperSetErrorText(KIO::SpecialJob* self, const libqt_string errorText);
    friend void KIO__SpecialJob_SetProcessedAmount(KIO::SpecialJob* self, int unit, unsigned long long amount);
    friend void KIO__SpecialJob_SuperSetProcessedAmount(KIO::SpecialJob* self, int unit, unsigned long long amount);
    friend void KIO__SpecialJob_SetTotalAmount(KIO::SpecialJob* self, int unit, unsigned long long amount);
    friend void KIO__SpecialJob_SuperSetTotalAmount(KIO::SpecialJob* self, int unit, unsigned long long amount);
    friend void KIO__SpecialJob_SetProgressUnit(KIO::SpecialJob* self, int unit);
    friend void KIO__SpecialJob_SuperSetProgressUnit(KIO::SpecialJob* self, int unit);
    friend void KIO__SpecialJob_SetPercent(KIO::SpecialJob* self, unsigned long percentage);
    friend void KIO__SpecialJob_SuperSetPercent(KIO::SpecialJob* self, unsigned long percentage);
    friend void KIO__SpecialJob_EmitResult(KIO::SpecialJob* self);
    friend void KIO__SpecialJob_SuperEmitResult(KIO::SpecialJob* self);
    ...
    friend void KIO__SpecialJob_SuperEmitPercent(KIO::SpecialJob* self, unsigned long long processedAmount, unsigned long long totalAmount);
    friend void KIO__SpecialJob_EmitSpeed(KIO::SpecialJob* self, unsigned long speed);
    friend void KIO__SpecialJob_SuperEmitSpeed(KIO::SpecialJob* self, unsigned long speed);
    friend void KIO__SpecialJob_StartElapsedTimer(KIO::SpecialJob* self);
    friend void KIO__SpecialJob_SuperStartElapsedTimer(KIO::SpecialJob* self);
    friend QObject* KIO__SpecialJob_Sender(const KIO::SpecialJob* self);
    friend QObject* KIO__SpecialJob_SuperSender(const KIO::SpecialJob* self);
    friend int KIO__SpecialJob_SenderSignalIndex(const KIO::SpecialJob* self);
    friend int KIO__SpecialJob_SuperSenderSignalIndex(const KIO::SpecialJob* self);
    friend int KIO__SpecialJob_Receivers(const KIO::SpecialJob* self, const char* signal);
    friend int KIO__SpecialJob_SuperReceivers(const KIO::SpecialJob* self, const char* signal);
    friend bool KIO__SpecialJob_IsSignalConnected(const KIO::SpecialJob* self, const QMetaMethod* signal);
    friend bool KIO__SpecialJob_SuperIsSignalConnected(const KIO::SpecialJob* self, const QMetaMethod* signal);
};
