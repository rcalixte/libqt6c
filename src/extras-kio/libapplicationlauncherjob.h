...
///
/// @param self KIO__ApplicationLauncherJob*
/// @param callback void func(KIO__ApplicationLauncherJob* self, KJob* job, const char* title)
...
///
/// @param self KIO__ApplicationLauncherJob*
/// @param callback void func(KIO__ApplicationLauncherJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
...
///
/// @param self KIO__ApplicationLauncherJob*
/// @param callback void func(KIO__ApplicationLauncherJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
