#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBBATCHRENAMEJOB_H
#define SRC_EXTRAS_KIOQT6C_LIBBATCHRENAMEJOB_H
...
void k_io__batchrenamejob_description(void* self, void* job, const char* title);
...
///
/// @param self KIO__BatchRenameJob*
/// @param callback void func(KIO__BatchRenameJob* self, KJob* job, const char* title)
void k_io__batchrenamejob_on_description(void* self, void (*callback)(void*, void*, const char*));
...
void k_io__batchrenamejob_description3(void* self, void* job, const char* title, libqt_pair /* tuple of const char* and const char* */ field1);
...
///
/// @param self KIO__BatchRenameJob*
/// @param callback void func(KIO__BatchRenameJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
void k_io__batchrenamejob_on_description3(void* self, void (*callback)(void*, void*, const char*, libqt_pair /* tuple of const char* and const char* */));
...
void k_io__batchrenamejob_description4(void* self, void* job, const char* title, libqt_pair /* tuple of const char* and const char* */ field1, libqt_pair /* tuple of const char* and const char* */ field2);
...
///
/// @param self KIO__BatchRenameJob*
/// @param callback void func(KIO__BatchRenameJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
void k_io__batchrenamejob_on_description4(void* self, void (*callback)(void*, void*, const char*, libqt_pair /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */));
...
QMetaObject__Connection* k_io__batchrenamejob_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_io__batchrenamejob_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
