...
const QMetaObject* k_propertiesdialogplugin_super_meta_object(void* self) {
    return KPropertiesDialogPlugin_SuperMetaObject((KPropertiesDialogPlugin*)self);
}
...
void* k_propertiesdialogplugin_super_metacast(void* self, const char* param1) {
    return KPropertiesDialogPlugin_SuperMetacast((KPropertiesDialogPlugin*)self, param1);
}
...
int32_t k_propertiesdialogplugin_super_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KPropertiesDialogPlugin_SuperMetacall((KPropertiesDialogPlugin*)self, param1, param2, param3);
}
...
void k_propertiesdialogplugin_super_apply_changes(void* self) {
    KPropertiesDialogPlugin_SuperApplyChanges((KPropertiesDialogPlugin*)self);
}
...
int32_t k_propertiesdialogplugin_super_font_height(void* self) {
    return KPropertiesDialogPlugin_SuperFontHeight((KPropertiesDialogPlugin*)self);
}
...
bool k_propertiesdialogplugin_super_event(void* self, void* event) {
    return KPropertiesDialogPlugin_SuperEvent((KPropertiesDialogPlugin*)self, (QEvent*)event);
}
...
bool k_propertiesdialogplugin_super_event_filter(void* self, void* watched, void* event) {
    return KPropertiesDialogPlugin_SuperEventFilter((KPropertiesDialogPlugin*)self, (QObject*)watched, (QEvent*)event);
}
...
void k_propertiesdialogplugin_super_timer_event(void* self, void* event) {
    KPropertiesDialogPlugin_SuperTimerEvent((KPropertiesDialogPlugin*)self, (QTimerEvent*)event);
}
...
void k_propertiesdialogplugin_super_child_event(void* self, void* event) {
    KPropertiesDialogPlugin_SuperChildEvent((KPropertiesDialogPlugin*)self, (QChildEvent*)event);
}
...
void k_propertiesdialogplugin_super_custom_event(void* self, void* event) {
    KPropertiesDialogPlugin_SuperCustomEvent((KPropertiesDialogPlugin*)self, (QEvent*)event);
}
...
void k_propertiesdialogplugin_super_connect_notify(void* self, void* signal) {
    KPropertiesDialogPlugin_SuperConnectNotify((KPropertiesDialogPlugin*)self, (QMetaMethod*)signal);
}
...
void k_propertiesdialogplugin_super_disconnect_notify(void* self, void* signal) {
    KPropertiesDialogPlugin_SuperDisconnectNotify((KPropertiesDialogPlugin*)self, (QMetaMethod*)signal);
}
...
QObject* k_propertiesdialogplugin_super_sender(void* self) {
    return KPropertiesDialogPlugin_SuperSender((KPropertiesDialogPlugin*)self);
}
...
int32_t k_propertiesdialogplugin_super_sender_signal_index(void* self) {
    return KPropertiesDialogPlugin_SuperSenderSignalIndex((KPropertiesDialogPlugin*)self);
}
...
int32_t k_propertiesdialogplugin_super_receivers(void* self, const char* signal) {
    return KPropertiesDialogPlugin_SuperReceivers((KPropertiesDialogPlugin*)self, signal);
}
...
bool k_propertiesdialogplugin_super_is_signal_connected(void* self, void* signal) {
    return KPropertiesDialogPlugin_SuperIsSignalConnected((KPropertiesDialogPlugin*)self, (QMetaMethod*)signal);
}
