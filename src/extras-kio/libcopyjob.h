#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBCOPYJOB_H
#define SRC_EXTRAS_KIO_QT6C_LIBCOPYJOB_H
...
///
/// @param self KIO__CopyJob*
/// @param callback void func(KIO__CopyJob* self, KIO__Job* job, uintptr_t files)
///
...
///
/// @param self KIO__CopyJob*
/// @param callback void func(KIO__CopyJob* self, KIO__Job* job, uintptr_t dirs)
///
...
///
/// @param self KIO__CopyJob*
/// @param callback void func(KIO__CopyJob* self, KJob* job, uintptr_t size)
///
...
///
/// @param self KIO__CopyJob*
/// @param callback void func(KIO__CopyJob* self, KJob* job, uintptr_t speed)
///
...
///
/// @param self KIO__CopyJob*
/// @param callback void func(KIO__CopyJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
...
///
/// @param self KIO__CopyJob*
/// @param callback void func(KIO__CopyJob* self, KJob* job, uintptr_t percent)
///
