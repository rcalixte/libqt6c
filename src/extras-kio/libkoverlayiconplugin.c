...
const char* k_overlayiconplugin_tr(const char* s) {
    libqt_string _str = KOverlayIconPlugin_Tr(s);
...
const char** k_overlayiconplugin_get_overlays(void* self, void* item) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_overlayiconplugin_get_overlays");
        abort();
    }
...
void k_overlayiconplugin_overlays_changed(void* self, void* url, const char* overlays[]) {
    ...
    if (overlays_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_overlayiconplugin_overlays_changed");
        abort();
    }
...
const char* k_overlayiconplugin_tr2(const char* s, const char* c) {
    libqt_string _str = KOverlayIconPlugin_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_overlayiconplugin_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KOverlayIconPlugin_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_overlayiconplugin_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_overlayiconplugin_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QMetaObject__Connection* k_overlayiconplugin_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_overlayiconplugin_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
