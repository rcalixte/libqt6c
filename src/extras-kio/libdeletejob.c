...
void* k_io__deletejob_metacast(void* self, const char* param1) {
    return KIO__DeleteJob_Metacast((KIO__DeleteJob*)self, param1);
}

int32_t k_io__deletejob_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KIO__DeleteJob_Metacall((KIO__DeleteJob*)self, param1, param2, param3);
}

const char* k_io__deletejob_tr(const char* s) {
    libqt_string _str = KIO__DeleteJob_Tr(s);
...
libqt_list /* of QUrl* */ k_io__deletejob_urls(void* self) {
    libqt_list _arr = KIO__DeleteJob_Urls((KIO__DeleteJob*)self);
    return _arr;
}

void k_io__deletejob_total_files(void* self, void* job, uint64_t files) {
    KIO__DeleteJob_TotalFiles((KIO__DeleteJob*)self, (KJob*)job, files);
}

void k_io__deletejob_on_total_files(void* self, void (*callback)(void*, void*, uint64_t)) {
    KIO__DeleteJob_Connect_TotalFiles((KIO__DeleteJob*)self, (intptr_t)callback);
}

void k_io__deletejob_total_dirs(void* self, void* job, uint64_t dirs) {
    KIO__DeleteJob_TotalDirs((KIO__DeleteJob*)self, (KJob*)job, dirs);
}

void k_io__deletejob_on_total_dirs(void* self, void (*callback)(void*, void*, uint64_t)) {
    KIO__DeleteJob_Connect_TotalDirs((KIO__DeleteJob*)self, (intptr_t)callback);
}

void k_io__deletejob_processed_files(void* self, void* job, uint64_t files) {
    KIO__DeleteJob_ProcessedFiles((KIO__DeleteJob*)self, (KIO__Job*)job, files);
}

void k_io__deletejob_on_processed_files(void* self, void (*callback)(void*, void*, uint64_t)) {
    KIO__DeleteJob_Connect_ProcessedFiles((KIO__DeleteJob*)self, (intptr_t)callback);
}

void k_io__deletejob_processed_dirs(void* self, void* job, uint64_t dirs) {
    KIO__DeleteJob_ProcessedDirs((KIO__DeleteJob*)self, (KIO__Job*)job, dirs);
}

void k_io__deletejob_on_processed_dirs(void* self, void (*callback)(void*, void*, uint64_t)) {
    KIO__DeleteJob_Connect_ProcessedDirs((KIO__DeleteJob*)self, (intptr_t)callback);
}

void k_io__deletejob_deleting(void* self, void* job, void* file) {
    KIO__DeleteJob_Deleting((KIO__DeleteJob*)self, (KIO__Job*)job, (QUrl*)file);
}

void k_io__deletejob_on_deleting(void* self, void (*callback)(void*, void*, void*)) {
    KIO__DeleteJob_Connect_Deleting((KIO__DeleteJob*)self, (intptr_t)callback);
}

const char* k_io__deletejob_tr2(const char* s, const char* c) {
    libqt_string _str = KIO__DeleteJob_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_io__deletejob_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KIO__DeleteJob_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_io__deletejob_detailed_error_strings(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_io__deletejob_detailed_error_strings");
        abort();
    }
...
const char** k_io__deletejob_detailed_error_strings1(void* self, void* reqUrl) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_io__deletejob_detailed_error_strings1");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** k_io__deletejob_detailed_error_strings2(void* self, void* reqUrl, int method) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_io__deletejob_detailed_error_strings2");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** k_io__deletejob_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_io__deletejob_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
