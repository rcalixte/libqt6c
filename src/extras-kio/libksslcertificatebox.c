...
QWidget* k_sslcertificatebox_find(uintptr_t param1) {
...
int32_t k_sslcertificatebox_start_timer2(void* self, int64_t time) {
...
QMetaObject__Connection* k_sslcertificatebox_connect(void* sender, const char* signal, void* receiver, const char* member) {
    return QObject_Connect((QObject*)sender, signal, (QObject*)receiver, member);
}

QMetaObject__Connection* k_sslcertificatebox_connect2(void* sender, void* signal, void* receiver, void* method) {
    return QObject_Connect2((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method);
}

QMetaObject__Connection* k_sslcertificatebox_connect3(void* self, void* sender, const char* signal, const char* member) {
    return QObject_Connect3((QObject*)self, (QObject*)sender, signal, member);
}

bool k_sslcertificatebox_disconnect(void* sender, const char* signal, void* receiver, const char* member) {
    return QObject_Disconnect((QObject*)sender, signal, (QObject*)receiver, member);
}

bool k_sslcertificatebox_disconnect2(void* sender, void* signal, void* receiver, void* member) {
    return QObject_Disconnect2((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)member);
}

bool k_sslcertificatebox_disconnect3(void* self) {
    return QObject_Disconnect3((QObject*)self);
}

bool k_sslcertificatebox_disconnect4(void* self, void* receiver) {
    return QObject_Disconnect4((QObject*)self, (QObject*)receiver);
}

bool k_sslcertificatebox_disconnect5(void* param1) {
...
const char** k_sslcertificatebox_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_sslcertificatebox_dynamic_property_names\n");
        abort();
    }
...
int32_t k_sslcertificatebox_start_timer23(void* self, int64_t time, int32_t timerType) {
    return QObject_StartTimer23((QObject*)self, time, timerType);
}

QMetaObject__Connection* k_sslcertificatebox_connect5(void* sender, const char* signal, void* receiver, const char* member, int32_t param5) {
    return QObject_Connect5((QObject*)sender, signal, (QObject*)receiver, member, param5);
}

QMetaObject__Connection* k_sslcertificatebox_connect52(void* sender, void* signal, void* receiver, void* method, int32_t type) {
...
bool k_sslcertificatebox_disconnect1(void* self, const char* signal) {
    return QObject_Disconnect1((QObject*)self, signal);
}

bool k_sslcertificatebox_disconnect22(void* self, const char* signal, void* receiver) {
    return QObject_Disconnect22((QObject*)self, signal, (QObject*)receiver);
}

bool k_sslcertificatebox_disconnect32(void* self, const char* signal, void* receiver, const char* member) {
    return QObject_Disconnect32((QObject*)self, signal, (QObject*)receiver, member);
}

bool k_sslcertificatebox_disconnect23(void* self, void* receiver, const char* member) {
...
bool k_sslcertificatebox_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_sslcertificatebox_as_q_paint_device(self));
}

int32_t k_sslcertificatebox_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_sslcertificatebox_as_q_paint_device(self));
}

int32_t k_sslcertificatebox_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_sslcertificatebox_as_q_paint_device(self));
}

int32_t k_sslcertificatebox_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_sslcertificatebox_as_q_paint_device(self));
}

int32_t k_sslcertificatebox_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_sslcertificatebox_as_q_paint_device(self));
}

int32_t k_sslcertificatebox_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_sslcertificatebox_as_q_paint_device(self));
}

int32_t k_sslcertificatebox_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_sslcertificatebox_as_q_paint_device(self));
}

double k_sslcertificatebox_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_sslcertificatebox_as_q_paint_device(self));
}

double k_sslcertificatebox_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_sslcertificatebox_as_q_paint_device(self));
}

int32_t k_sslcertificatebox_color_count(void* self) {
    return QPaintDevice_ColorCount(k_sslcertificatebox_as_q_paint_device(self));
}

int32_t k_sslcertificatebox_depth(void* self) {
    return QPaintDevice_Depth(k_sslcertificatebox_as_q_paint_device(self));
}
