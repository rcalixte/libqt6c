#pragma once
#ifndef SRC_EXTRAS_KFILEMETADATAC_LIBSIMPLEEXTRACTIONRESULT_HPP
#define SRC_EXTRAS_KFILEMETADATAC_LIBSIMPLEEXTRACTIONRESULT_HPP
...
void KFileMetaData__SimpleExtractionResult_QBaseAddType(KFileMetaData__SimpleExtractionResult* self, int type);
