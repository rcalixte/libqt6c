...
void KFileMetaData__SimpleExtractionResult_AddType(KFileMetaData__SimpleExtractionResult* self, int type) {
    ...
    if (vkfilemetadata__simpleextractionresult && vkfilemetadata__simpleextractionresult->isVirtualKFileMetaDataSimpleExtractionResult) {
        ...
        ((VirtualKFileMetaDataSimpleExtractionResult*)self)->addType(static_cast<KFileMetaData::Type::Type>(type));
    }
}
...
void KFileMetaData__SimpleExtractionResult_QBaseAddType(KFileMetaData__SimpleExtractionResult* self, int type) {
    ...
    if (vkfilemetadatasimpleextractionresult && vkfilemetadatasimpleextractionresult->isVirtualKFileMetaDataSimpleExtractionResult) {
        ...
        vkfilemetadatasimpleextractionresult->addType(static_cast<KFileMetaData::Type::Type>(type));
    } else {
        self->KFileMetaData::SimpleExtractionResult::addType(static_cast<KFileMetaData::Type::Type>(type));
    }
}
