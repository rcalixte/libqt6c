...
libqt_list /* of pair_qaccessibleinterface_int32_t tuple of QAccessibleInterface* and int */ QAccessibleWidget_QBaseRelations(const QAccessibleWidget* self, int match);
