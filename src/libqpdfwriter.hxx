...
class VirtualQPdfWriter final : public QPdfWriter {
  ...
  public:
    ...
    friend void QPdfWriter_ConnectNotify(QPdfWriter* self, QMetaMethod* signal);
    friend void QPdfWriter_QBaseConnectNotify(QPdfWriter* self, QMetaMethod* signal);
    friend void QPdfWriter_DisconnectNotify(QPdfWriter* self, QMetaMethod* signal);
    friend void QPdfWriter_QBaseDisconnectNotify(QPdfWriter* self, QMetaMethod* signal);
    ...
    friend bool QPdfWriter_IsSignalConnected(const QPdfWriter* self, QMetaMethod* signal);
    friend bool QPdfWriter_QBaseIsSignalConnected(const QPdfWriter* self, QMetaMethod* signal);
};
