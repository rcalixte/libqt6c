...
class VirtualQPushButton final : public QPushButton {
  ...
  public:
    ...
    friend bool QPushButton_HitButton(const QPushButton* self, QPoint* pos);
    friend bool QPushButton_QBaseHitButton(const QPushButton* self, QPoint* pos);
    ...
    friend bool QPushButton_NativeEvent(QPushButton* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QPushButton_QBaseNativeEvent(QPushButton* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QPushButton_ConnectNotify(QPushButton* self, QMetaMethod* signal);
    friend void QPushButton_QBaseConnectNotify(QPushButton* self, QMetaMethod* signal);
    friend void QPushButton_DisconnectNotify(QPushButton* self, QMetaMethod* signal);
    friend void QPushButton_QBaseDisconnectNotify(QPushButton* self, QMetaMethod* signal);
    ...
    friend bool QPushButton_IsSignalConnected(const QPushButton* self, QMetaMethod* signal);
    friend bool QPushButton_QBaseIsSignalConnected(const QPushButton* self, QMetaMethod* signal);
};
