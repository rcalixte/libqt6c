...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QGenericPlugin* self, void (*slot)(QGenericPlugin*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QGenericPlugin* self, void (*slot)(QGenericPlugin*, QObject*) ```
...
///
/// ``` QGenericPlugin* self, void (*slot)(QGenericPlugin*, const char*) ```
