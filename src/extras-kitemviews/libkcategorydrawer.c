...
int32_t k_categorydrawer_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KCategoryDrawer_Metacall((KCategoryDrawer*)self, param1, param2, param3);
}
...
const char* k_categorydrawer_tr(const char* s) {
    libqt_string _str = KCategoryDrawer_Tr(s);
...
const char* k_categorydrawer_tr2(const char* s, const char* c) {
    libqt_string _str = KCategoryDrawer_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_categorydrawer_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KCategoryDrawer_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_categorydrawer_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_categorydrawer_dynamic_property_names");
        abort();
    }
...
void k_categorydrawer_on_event(void* self, bool (*callback)(void*, void*)) {
    KCategoryDrawer_OnEvent((KCategoryDrawer*)self, (intptr_t)callback);
}
...
void k_categorydrawer_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    KCategoryDrawer_OnEventFilter((KCategoryDrawer*)self, (intptr_t)callback);
}
...
void k_categorydrawer_on_timer_event(void* self, void (*callback)(void*, void*)) {
    KCategoryDrawer_OnTimerEvent((KCategoryDrawer*)self, (intptr_t)callback);
}
...
void k_categorydrawer_on_child_event(void* self, void (*callback)(void*, void*)) {
    KCategoryDrawer_OnChildEvent((KCategoryDrawer*)self, (intptr_t)callback);
}
...
void k_categorydrawer_delete(void* self) {
    KCategoryDrawer_Delete((KCategoryDrawer*)(self));
}
