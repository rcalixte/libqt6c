...
const char* k_categorizedsortfilterproxymodel_tr(const char* s) {
    libqt_string _str = KCategorizedSortFilterProxyModel_Tr(s);
...
const char* k_categorizedsortfilterproxymodel_tr2(const char* s, const char* c) {
    libqt_string _str = KCategorizedSortFilterProxyModel_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_categorizedsortfilterproxymodel_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KCategorizedSortFilterProxyModel_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_categorizedsortfilterproxymodel_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_categorizedsortfilterproxymodel_dynamic_property_names");
        abort();
    }
...
const char** k_categorizedsortfilterproxymodel_mime_types(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_categorizedsortfilterproxymodel_mime_types");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
libqt_map /* of int to QVariant* */ k_categorizedsortfilterproxymodel_item_data(void* self, void* index) {
    return KCategorizedSortFilterProxyModel_ItemData((KCategorizedSortFilterProxyModel*)self, (QModelIndex*)index);
}

libqt_map /* of int to QVariant* */ k_categorizedsortfilterproxymodel_qbase_item_data(void* self, void* index) {
    return KCategorizedSortFilterProxyModel_QBaseItemData((KCategorizedSortFilterProxyModel*)self, (QModelIndex*)index);
}
...
bool k_categorizedsortfilterproxymodel_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KCategorizedSortFilterProxyModel_SetItemData((KCategorizedSortFilterProxyModel*)self, (QModelIndex*)index, roles);
}

bool k_categorizedsortfilterproxymodel_qbase_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KCategorizedSortFilterProxyModel_QBaseSetItemData((KCategorizedSortFilterProxyModel*)self, (QModelIndex*)index, roles);
}
...
libqt_map /* of int to char* */ k_categorizedsortfilterproxymodel_role_names(void* self) {
    return KCategorizedSortFilterProxyModel_RoleNames((KCategorizedSortFilterProxyModel*)self);
}

libqt_map /* of int to char* */ k_categorizedsortfilterproxymodel_qbase_role_names(void* self) {
    return KCategorizedSortFilterProxyModel_QBaseRoleNames((KCategorizedSortFilterProxyModel*)self);
}
