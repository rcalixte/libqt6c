...
///
/// @param self KCategorizedSortFilterProxyModel*
/// @param callback void func(KCategorizedSortFilterProxyModel* self, QModelIndex* topLeft, QModelIndex* bottomRight, int* )
///
...
///
/// @param self KCategorizedSortFilterProxyModel*
/// @param callback void func(KCategorizedSortFilterProxyModel* self, QPersistentModelIndex** parents)
///
...
///
/// @param self KCategorizedSortFilterProxyModel*
/// @param callback void func(KCategorizedSortFilterProxyModel* self, QPersistentModelIndex** parents, enum QAbstractItemModel__LayoutChangeHint hint)
///
...
///
/// @param self KCategorizedSortFilterProxyModel*
/// @param callback QMimeData* func(KCategorizedSortFilterProxyModel* self, QModelIndex** indexes)
///
...
/// @return libqt_list of QModelIndex*
///
libqt_list k_categorizedsortfilterproxymodel_qbase_match(void* self, void* start, int role, void* value, int hits, int32_t flags);
...
///
/// @param self KCategorizedSortFilterProxyModel*
/// @param callback QModelIndex** func(KCategorizedSortFilterProxyModel* self, QModelIndex* start, int role, QVariant* value, int hits, flag of enum Qt__MatchFlag flags)
///
...
/// @return libqt_map of int to QVariant*
///
libqt_map k_categorizedsortfilterproxymodel_qbase_item_data(void* self, void* index);
...
/// @param roles libqt_map of int to QVariant*
///
bool k_categorizedsortfilterproxymodel_qbase_set_item_data(void* self, void* index, libqt_map roles);
...
///
/// @param self KCategorizedSortFilterProxyModel*
/// @param callback bool func(KCategorizedSortFilterProxyModel* self, QModelIndex* index, libqt_map of int to QVariant*)
///
...
/// @return libqt_map of int to char*
///
libqt_map k_categorizedsortfilterproxymodel_qbase_role_names(void* self);
...
///
/// @param self KCategorizedSortFilterProxyModel*
/// @param callback void func(KCategorizedSortFilterProxyModel* self, QModelIndex** indexes, QDataStream* stream)
///
...
/// @return libqt_list of QModelIndex*
///
libqt_list k_categorizedsortfilterproxymodel_qbase_persistent_index_list(void* self);
