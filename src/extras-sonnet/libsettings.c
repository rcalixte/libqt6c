...
const char* k_sonnet__settings_tr(const char* s) {
    libqt_string _str = Sonnet__Settings_Tr(s);
...
void k_sonnet__settings_set_preferred_languages(void* self, const char* lang[]) {
    ...
    if (lang_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__settings_set_preferred_languages");
        abort();
    }
...
const char** k_sonnet__settings_preferred_languages(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__settings_preferred_languages");
        abort();
    }
...
void k_sonnet__settings_set_current_ignore_list(void* self, const char* ignores[]) {
    ...
    if (ignores_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__settings_set_current_ignore_list");
        abort();
    }
...
const char** k_sonnet__settings_current_ignore_list(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__settings_current_ignore_list");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** k_sonnet__settings_clients(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__settings_clients");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** k_sonnet__settings_default_ignore_list() {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__settings_default_ignore_list");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** k_sonnet__settings_default_preferred_languages() {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__settings_default_preferred_languages");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char* k_sonnet__settings_tr2(const char* s, const char* c) {
    libqt_string _str = Sonnet__Settings_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_sonnet__settings_tr3(const char* s, const char* c, int n) {
    libqt_string _str = Sonnet__Settings_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_sonnet__settings_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__settings_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QMetaObject__Connection* k_sonnet__settings_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_sonnet__settings_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
