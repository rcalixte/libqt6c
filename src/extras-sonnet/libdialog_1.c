...
bool k_sonnet__dialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_sonnet__dialog_as_q_paint_device(self));
}

int32_t k_sonnet__dialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_sonnet__dialog_as_q_paint_device(self));
}

int32_t k_sonnet__dialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_sonnet__dialog_as_q_paint_device(self));
}

int32_t k_sonnet__dialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_sonnet__dialog_as_q_paint_device(self));
}

int32_t k_sonnet__dialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_sonnet__dialog_as_q_paint_device(self));
}

int32_t k_sonnet__dialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_sonnet__dialog_as_q_paint_device(self));
}

int32_t k_sonnet__dialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_sonnet__dialog_as_q_paint_device(self));
}

double k_sonnet__dialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_sonnet__dialog_as_q_paint_device(self));
}

double k_sonnet__dialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_sonnet__dialog_as_q_paint_device(self));
}

int32_t k_sonnet__dialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_sonnet__dialog_as_q_paint_device(self));
}

int32_t k_sonnet__dialog_depth(void* self) {
    return QPaintDevice_Depth(k_sonnet__dialog_as_q_paint_device(self));
}
