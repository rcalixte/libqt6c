...
void k_sonnet__configwidget_grab_gesture2(void* self, int64_t typeVal, int32_t flags) {
...
const char** k_sonnet__configwidget_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_sonnet__configwidget_dynamic_property_names");
        abort();
    }
