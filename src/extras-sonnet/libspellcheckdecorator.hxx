  ...
  public:
    ...
    virtual bool isSpellCheckingEnabledForBlock(const QString& textBlock) const override {
        if (sonnet__spellcheckdecorator_isspellcheckingenabledforblock_isbase) {
            ...
            char* textBlock_str = static_cast<char*>(malloc(textBlock_str_len + 1));
            memcpy(textBlock_str, textBlock_b.data(), textBlock_str_len);
            textBlock_str[textBlock_str_len] = '\0';
