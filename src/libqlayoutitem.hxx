...
class VirtualQLayoutItem final : public QLayoutItem {
  ...
  public:
    ...
    // Friend functions
    friend void QLayoutItem_OperatorAssign(QLayoutItem* self, QLayoutItem* param1);
    friend void QLayoutItem_QBaseOperatorAssign(QLayoutItem* self, QLayoutItem* param1);
};
