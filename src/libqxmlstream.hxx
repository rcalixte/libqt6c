  ...
  public:
    ...
    virtual QString resolveEntity(const QString& publicId, const QString& systemId) override {
        if (qxmlstreamentityresolver_resolveentity_isbase) {
            ...
            char* publicId_str = static_cast<char*>(malloc(publicId_str_len + 1));
            memcpy(publicId_str, publicId_b.data(), publicId_str_len);
            publicId_str[publicId_str_len] = '\0';
            ...
            char* systemId_str = static_cast<char*>(malloc(systemId_str_len + 1));
            memcpy(systemId_str, systemId_b.data(), systemId_str_len);
            systemId_str[systemId_str_len] = '\0';
