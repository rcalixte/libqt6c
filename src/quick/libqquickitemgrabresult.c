...
const QMetaObject* q_quickitemgrabresult_meta_object(void* self) {
    return QQuickItemGrabResult_MetaObject((QQuickItemGrabResult*)self);
}

void* q_quickitemgrabresult_metacast(void* self, const char* param1) {
    return QQuickItemGrabResult_Metacast((QQuickItemGrabResult*)self, param1);
}

int32_t q_quickitemgrabresult_metacall(void* self, int32_t param1, int param2, void* param3) {
    return QQuickItemGrabResult_Metacall((QQuickItemGrabResult*)self, param1, param2, param3);
}
...
QImage* q_quickitemgrabresult_image(void* self) {
    return QQuickItemGrabResult_Image((QQuickItemGrabResult*)self);
}

QUrl* q_quickitemgrabresult_url(void* self) {
    return QQuickItemGrabResult_Url((QQuickItemGrabResult*)self);
}

bool q_quickitemgrabresult_save_to_file(void* self, const char* fileName) {
    return QQuickItemGrabResult_SaveToFile((QQuickItemGrabResult*)self, qstring(fileName));
}

bool q_quickitemgrabresult_save_to_file2(void* self, void* fileName) {
    return QQuickItemGrabResult_SaveToFile2((QQuickItemGrabResult*)self, (QUrl*)fileName);
}

void q_quickitemgrabresult_ready(void* self) {
    QQuickItemGrabResult_Ready((QQuickItemGrabResult*)self);
}

void q_quickitemgrabresult_on_ready(void* self, void (*callback)(void*)) {
    QQuickItemGrabResult_Connect_Ready((QQuickItemGrabResult*)self, (intptr_t)callback);
}
...
libqt_list /* of QObject* */ q_quickitemgrabresult_children(void* self) {
...
const char** q_quickitemgrabresult_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_quickitemgrabresult_dynamic_property_names\n");
        abort();
    }
...
void q_quickitemgrabresult_delete(void* self) {
    QQuickItemGrabResult_Delete((QQuickItemGrabResult*)(self));
}
