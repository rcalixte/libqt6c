...
QQuickView* QQuickView_New4(const char* uri, const char* typeName) {
    return new VirtualQQuickView(QAnyStringView(uri), QAnyStringView(typeName));
}
...
QQuickView* QQuickView_New8(const char* uri, const char* typeName, QWindow* parent) {
    return new VirtualQQuickView(QAnyStringView(uri), QAnyStringView(typeName), parent);
}
...
void QQuickView_LoadFromModule(QQuickView* self, const char* uri, const char* typeName) {
