...
void* q_treewidget_super_metacast(void* self, const char* param1) {
    return QTreeWidget_SuperMetacast((QTreeWidget*)self, param1);
}
...
int32_t q_treewidget_super_metacall(void* self, int32_t param1, int param2, void* param3) {
    return QTreeWidget_SuperMetacall((QTreeWidget*)self, param1, param2, param3);
}
...
void q_treewidget_super_drop_event(void* self, void* event) {
    QTreeWidget_SuperDropEvent((QTreeWidget*)self, (QDropEvent*)event);
}
...
void q_treewidget_super_keyboard_search(void* self, const char* search) {
    QTreeWidget_SuperKeyboardSearch((QTreeWidget*)self, qstring(search));
}
...
void q_treewidget_super_vertical_scrollbar_value_changed(void* self, int value) {
    QTreeWidget_SuperVerticalScrollbarValueChanged((QTreeWidget*)self, value);
}
...
void q_treewidget_super_scroll_contents_by(void* self, int dx, int dy) {
    QTreeWidget_SuperScrollContentsBy((QTreeWidget*)self, dx, dy);
}
...
QModelIndex* q_treewidget_super_move_cursor(void* self, int32_t cursorAction, int32_t modifiers) {
    return QTreeWidget_SuperMoveCursor((QTreeWidget*)self, cursorAction, modifiers);
}
...
void q_treewidget_super_change_event(void* self, void* event) {
    QTreeWidget_SuperChangeEvent((QTreeWidget*)self, (QEvent*)event);
}
...
void q_treewidget_super_timer_event(void* self, void* event) {
    QTreeWidget_SuperTimerEvent((QTreeWidget*)self, (QTimerEvent*)event);
}
...
void q_treewidget_super_paint_event(void* self, void* event) {
    QTreeWidget_SuperPaintEvent((QTreeWidget*)self, (QPaintEvent*)event);
}
...
void q_treewidget_super_mouse_press_event(void* self, void* event) {
    QTreeWidget_SuperMousePressEvent((QTreeWidget*)self, (QMouseEvent*)event);
}
...
void q_treewidget_super_mouse_release_event(void* self, void* event) {
    QTreeWidget_SuperMouseReleaseEvent((QTreeWidget*)self, (QMouseEvent*)event);
}
...
void q_treewidget_super_mouse_double_click_event(void* self, void* event) {
    QTreeWidget_SuperMouseDoubleClickEvent((QTreeWidget*)self, (QMouseEvent*)event);
}
...
void q_treewidget_super_mouse_move_event(void* self, void* event) {
    QTreeWidget_SuperMouseMoveEvent((QTreeWidget*)self, (QMouseEvent*)event);
}
...
void q_treewidget_super_key_press_event(void* self, void* event) {
    QTreeWidget_SuperKeyPressEvent((QTreeWidget*)self, (QKeyEvent*)event);
}
...
void q_treewidget_super_drag_move_event(void* self, void* event) {
    QTreeWidget_SuperDragMoveEvent((QTreeWidget*)self, (QDragMoveEvent*)event);
}
...
bool q_treewidget_super_viewport_event(void* self, void* event) {
    return QTreeWidget_SuperViewportEvent((QTreeWidget*)self, (QEvent*)event);
}
...
void q_treewidget_super_horizontal_scrollbar_action(void* self, int action) {
    QTreeWidget_SuperHorizontalScrollbarAction((QTreeWidget*)self, action);
}
...
void q_treewidget_super_vertical_scrollbar_action(void* self, int action) {
    QTreeWidget_SuperVerticalScrollbarAction((QTreeWidget*)self, action);
}
...
void q_treewidget_super_horizontal_scrollbar_value_changed(void* self, int value) {
    QTreeWidget_SuperHorizontalScrollbarValueChanged((QTreeWidget*)self, value);
}
...
void q_treewidget_super_close_editor(void* self, void* editor, int32_t hint) {
    QTreeWidget_SuperCloseEditor((QTreeWidget*)self, (QWidget*)editor, hint);
}
...
void q_treewidget_super_commit_data(void* self, void* editor) {
    QTreeWidget_SuperCommitData((QTreeWidget*)self, (QWidget*)editor);
}
...
void q_treewidget_super_editor_destroyed(void* self, void* editor) {
    QTreeWidget_SuperEditorDestroyed((QTreeWidget*)self, (QObject*)editor);
}
...
void q_treewidget_super_start_drag(void* self, int32_t supportedActions) {
    QTreeWidget_SuperStartDrag((QTreeWidget*)self, supportedActions);
}
...
bool q_treewidget_super_focus_next_prev_child(void* self, bool next) {
    return QTreeWidget_SuperFocusNextPrevChild((QTreeWidget*)self, next);
}
...
void q_treewidget_super_drag_enter_event(void* self, void* event) {
    QTreeWidget_SuperDragEnterEvent((QTreeWidget*)self, (QDragEnterEvent*)event);
}
...
void q_treewidget_super_drag_leave_event(void* self, void* event) {
    QTreeWidget_SuperDragLeaveEvent((QTreeWidget*)self, (QDragLeaveEvent*)event);
}
...
void q_treewidget_super_focus_in_event(void* self, void* event) {
    QTreeWidget_SuperFocusInEvent((QTreeWidget*)self, (QFocusEvent*)event);
}
...
void q_treewidget_super_focus_out_event(void* self, void* event) {
    QTreeWidget_SuperFocusOutEvent((QTreeWidget*)self, (QFocusEvent*)event);
}
...
void q_treewidget_super_resize_event(void* self, void* event) {
    QTreeWidget_SuperResizeEvent((QTreeWidget*)self, (QResizeEvent*)event);
}
...
void q_treewidget_super_input_method_event(void* self, void* event) {
    QTreeWidget_SuperInputMethodEvent((QTreeWidget*)self, (QInputMethodEvent*)event);
}
...
bool q_treewidget_super_event_filter(void* self, void* object, void* event) {
    return QTreeWidget_SuperEventFilter((QTreeWidget*)self, (QObject*)object, (QEvent*)event);
}
...
void q_treewidget_super_setup_viewport(void* self, void* viewport) {
    QTreeWidget_SuperSetupViewport((QTreeWidget*)self, (QWidget*)viewport);
}
...
void q_treewidget_super_wheel_event(void* self, void* param1) {
    QTreeWidget_SuperWheelEvent((QTreeWidget*)self, (QWheelEvent*)param1);
}
...
void q_treewidget_super_context_menu_event(void* self, void* param1) {
    QTreeWidget_SuperContextMenuEvent((QTreeWidget*)self, (QContextMenuEvent*)param1);
}
...
void q_treewidget_super_set_visible(void* self, bool visible) {
    QTreeWidget_SuperSetVisible((QTreeWidget*)self, visible);
}
...
void q_treewidget_super_key_release_event(void* self, void* event) {
    QTreeWidget_SuperKeyReleaseEvent((QTreeWidget*)self, (QKeyEvent*)event);
}
...
void q_treewidget_super_enter_event(void* self, void* event) {
    QTreeWidget_SuperEnterEvent((QTreeWidget*)self, (QEnterEvent*)event);
}
...
void q_treewidget_super_leave_event(void* self, void* event) {
    QTreeWidget_SuperLeaveEvent((QTreeWidget*)self, (QEvent*)event);
}
...
void q_treewidget_super_move_event(void* self, void* event) {
    QTreeWidget_SuperMoveEvent((QTreeWidget*)self, (QMoveEvent*)event);
}
...
void q_treewidget_super_close_event(void* self, void* event) {
    QTreeWidget_SuperCloseEvent((QTreeWidget*)self, (QCloseEvent*)event);
}
...
void q_treewidget_super_tablet_event(void* self, void* event) {
    QTreeWidget_SuperTabletEvent((QTreeWidget*)self, (QTabletEvent*)event);
}
...
void q_treewidget_super_action_event(void* self, void* event) {
    QTreeWidget_SuperActionEvent((QTreeWidget*)self, (QActionEvent*)event);
}
...
void q_treewidget_super_show_event(void* self, void* event) {
    QTreeWidget_SuperShowEvent((QTreeWidget*)self, (QShowEvent*)event);
}
...
void q_treewidget_super_hide_event(void* self, void* event) {
    QTreeWidget_SuperHideEvent((QTreeWidget*)self, (QHideEvent*)event);
}
...
void q_treewidget_super_child_event(void* self, void* event) {
    QTreeWidget_SuperChildEvent((QTreeWidget*)self, (QChildEvent*)event);
}
...
void q_treewidget_super_custom_event(void* self, void* event) {
    QTreeWidget_SuperCustomEvent((QTreeWidget*)self, (QEvent*)event);
}
