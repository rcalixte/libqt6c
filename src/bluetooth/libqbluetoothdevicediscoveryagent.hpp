#pragma once
#ifndef SRC_BLUETOOTHC_LIBQBLUETOOTHDEVICEDISCOVERYAGENT_HPP
#define SRC_BLUETOOTHC_LIBQBLUETOOTHDEVICEDISCOVERYAGENT_HPP
...
void QBluetoothDeviceDiscoveryAgent_ErrorOccurred(QBluetoothDeviceDiscoveryAgent* self, int error);
