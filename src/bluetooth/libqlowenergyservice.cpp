...
void QLowEnergyService_ErrorOccurred(QLowEnergyService* self, int error) {
    self->errorOccurred(static_cast<QLowEnergyService::ServiceError>(error));
}

void QLowEnergyService_Connect_ErrorOccurred(QLowEnergyService* self, intptr_t slot) {
    void (*slotFunc)(QLowEnergyService*, int) = reinterpret_cast<void (*)(QLowEnergyService*, int)>(slot);
    QLowEnergyService::connect(self, &QLowEnergyService::errorOccurred, [self, slotFunc](QLowEnergyService::ServiceError error) {
