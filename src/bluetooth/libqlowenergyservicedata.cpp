...
void QLowEnergyServiceData_SetType(QLowEnergyServiceData* self, int type) {
    self->setType(static_cast<QLowEnergyServiceData::ServiceType>(type));
}
...
void QLowEnergyServiceData_SetIncludedServices(QLowEnergyServiceData* self, const libqt_list /* of QLowEnergyService* */ services) {
    ...
    QLowEnergyService** services_arr = static_cast<QLowEnergyService**>(services.data.ptr);
...
void QLowEnergyServiceData_SetCharacteristics(QLowEnergyServiceData* self, const libqt_list /* of QLowEnergyCharacteristicData* */ characteristics) {
    ...
    QLowEnergyCharacteristicData** characteristics_arr = static_cast<QLowEnergyCharacteristicData**>(characteristics.data.ptr);
