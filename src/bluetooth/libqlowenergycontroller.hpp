#pragma once
#ifndef SRC_BLUETOOTHC_LIBQLOWENERGYCONTROLLER_HPP
#define SRC_BLUETOOTHC_LIBQLOWENERGYCONTROLLER_HPP
...
void QLowEnergyController_SetRemoteAddressType(QLowEnergyController* self, int type);
