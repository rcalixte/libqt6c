  ...
  public:
    ...
    void setSocketError(QBluetoothSocket::SocketError error) {
        if (qbluetoothsocket_setsocketerror_isbase) {
            ...
            QBluetoothSocket::setSocketError(error);
            return;
        }
    ...
    friend void QBluetoothSocket_SetSocketError(QBluetoothSocket* self, int error);
    friend void QBluetoothSocket_SuperSetSocketError(QBluetoothSocket* self, int error);
