...
void QBluetoothServiceDiscoveryAgent_ErrorOccurred(QBluetoothServiceDiscoveryAgent* self, int error) {
    self->errorOccurred(static_cast<QBluetoothServiceDiscoveryAgent::Error>(error));
}
...
void QBluetoothServiceDiscoveryAgent_Connect_ErrorOccurred(QBluetoothServiceDiscoveryAgent* self, intptr_t slot) {
    ...
    QBluetoothServiceDiscoveryAgent::connect(self, &QBluetoothServiceDiscoveryAgent::errorOccurred, [self, slotFunc](QBluetoothServiceDiscoveryAgent::Error error) {
