...
void QBluetoothDeviceDiscoveryAgent_ErrorOccurred(QBluetoothDeviceDiscoveryAgent* self, int error) {
    self->errorOccurred(static_cast<QBluetoothDeviceDiscoveryAgent::Error>(error));
}
...
void QBluetoothDeviceDiscoveryAgent_Connect_ErrorOccurred(QBluetoothDeviceDiscoveryAgent* self, intptr_t slot) {
    ...
    QBluetoothDeviceDiscoveryAgent::connect(self, &QBluetoothDeviceDiscoveryAgent::errorOccurred, [self, slotFunc](QBluetoothDeviceDiscoveryAgent::Error error) {
