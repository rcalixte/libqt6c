...
int32_t q_nmeasatelliteinfosource_metacall(void* self, int32_t param1, int param2, void* param3) {
    return QNmeaSatelliteInfoSource_Metacall((QNmeaSatelliteInfoSource*)self, param1, param2, param3);
}
...
void q_nmeasatelliteinfosource_set_update_interval(void* self, int msec) {
    QNmeaSatelliteInfoSource_SetUpdateInterval((QNmeaSatelliteInfoSource*)self, msec);
}
...
void q_nmeasatelliteinfosource_request_update(void* self, int timeout) {
    QNmeaSatelliteInfoSource_RequestUpdate((QNmeaSatelliteInfoSource*)self, timeout);
}
...
QGeoSatelliteInfoSource* q_nmeasatelliteinfosource_create_default_source2(libqt_map /* of const char* to QVariant* */ parameters, void* parent) {
    ...
    if (parameters_ret.keys == NULL) {
        fprintf(stderr, "Failed to allocate memory for map keys in q_nmeasatelliteinfosource_create_default_source2\n");
        abort();
    }
    ...
    if (parameters_ret.values == NULL) {
        ...
        fprintf(stderr, "Failed to allocate memory for map values in q_nmeasatelliteinfosource_create_default_source2\n");
        abort();
    }
...
QGeoSatelliteInfoSource* q_nmeasatelliteinfosource_create_source2(const char* sourceName, libqt_map /* of const char* to QVariant* */ parameters, void* parent) {
    // Convert libqt_map to QMap<QString,QVariant>
    libqt_map parameters_ret;
    parameters_ret.len = parameters.len;
    parameters_ret.keys = (libqt_string*)malloc(parameters_ret.len * sizeof(libqt_string));
    if (parameters_ret.keys == NULL) {
        fprintf(stderr, "Failed to allocate memory for map keys in q_nmeasatelliteinfosource_create_source2\n");
        abort();
    }
    parameters_ret.values = (QVariant**)malloc(parameters_ret.len * sizeof(QVariant*));
    if (parameters_ret.values == NULL) {
        free(parameters_ret.keys);
        fprintf(stderr, "Failed to allocate memory for map values in q_nmeasatelliteinfosource_create_source2\n");
        abort();
    }
    const char** parameters_karr = (const char**)parameters.keys;
    libqt_string* parameters_kdest = (libqt_string*)parameters_ret.keys;
...
void q_nmeasatelliteinfosource_on_event(void* self, bool (*callback)(void*, void*)) {
    QNmeaSatelliteInfoSource_OnEvent((QNmeaSatelliteInfoSource*)self, (intptr_t)callback);
}
...
void q_nmeasatelliteinfosource_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    QNmeaSatelliteInfoSource_OnEventFilter((QNmeaSatelliteInfoSource*)self, (intptr_t)callback);
}
...
void q_nmeasatelliteinfosource_on_timer_event(void* self, void (*callback)(void*, void*)) {
    QNmeaSatelliteInfoSource_OnTimerEvent((QNmeaSatelliteInfoSource*)self, (intptr_t)callback);
}
...
void q_nmeasatelliteinfosource_on_child_event(void* self, void (*callback)(void*, void*)) {
    QNmeaSatelliteInfoSource_OnChildEvent((QNmeaSatelliteInfoSource*)self, (intptr_t)callback);
}
...
void q_nmeasatelliteinfosource_delete(void* self) {
    QNmeaSatelliteInfoSource_Delete((QNmeaSatelliteInfoSource*)(self));
}
