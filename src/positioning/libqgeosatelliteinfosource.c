...
const char** q_geosatelliteinfosource_available_sources() {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_geosatelliteinfosource_available_sources");
        abort();
    }
...
QMetaObject__Connection* q_geosatelliteinfosource_connect(void* sender, void* signal, void* receiver, void* method) {
    return QObject_Connect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method);
}

QMetaObject__Connection* q_geosatelliteinfosource_connect2(void* self, void* sender, const char* signal, const char* member) {
    return QObject_Connect2((QObject*)self, (QObject*)sender, signal, member);
}

bool q_geosatelliteinfosource_disconnect(void* sender, void* signal, void* receiver, void* member) {
    return QObject_Disconnect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)member);
}

bool q_geosatelliteinfosource_disconnect2(void* param1) {
...
const char** q_geosatelliteinfosource_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_geosatelliteinfosource_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
bool q_geosatelliteinfosource_move_to_thread2(void* self, void* thread, void* param2) {
...
QMetaObject__Connection* q_geosatelliteinfosource_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type) {
