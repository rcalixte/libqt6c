#pragma once
#ifndef SRC_POSIX_EXTRAS_ACCOUNTSQT6C_LIBPROVIDER_H
#define SRC_POSIX_EXTRAS_ACCOUNTSQT6C_LIBPROVIDER_H
...
/// [Qt documentation](https://accounts-sso.gitlab.io/libaccounts-qt/classAccounts_1_1Provider.html)
///
