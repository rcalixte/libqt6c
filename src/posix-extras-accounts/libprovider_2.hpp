#pragma once
#ifndef SRC_POSIX_EXTRAS_ACCOUNTSC_LIBPROVIDER_HPP
#define SRC_POSIX_EXTRAS_ACCOUNTSC_LIBPROVIDER_HPP
...
libqt_list /* set of const char* */ Accounts__Provider_Tags(const Accounts__Provider* self);
