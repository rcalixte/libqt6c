#pragma once
#ifndef POSIX_EXTRAS_ACCOUNTS_LIBACCOUNT_SERVICE_H
#define POSIX_EXTRAS_ACCOUNTS_LIBACCOUNT_SERVICE_H
...
///
/// @param self Accounts__AccountService*
/// @param callback void* func(Accounts__AccountService* self, const char* param1)
///
