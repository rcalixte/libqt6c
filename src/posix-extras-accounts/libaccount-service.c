...
#include "libaccount-service.hpp"
...
const char* q_accounts__accountservice_tr(const char* s) {
    libqt_string _str = Accounts__AccountService_Tr(s);
...
const char* q_accounts__accountservice_tr2(const char* s, const char* c) {
    libqt_string _str = Accounts__AccountService_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* q_accounts__accountservice_tr3(const char* s, const char* c, int n) {
    libqt_string _str = Accounts__AccountService_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
