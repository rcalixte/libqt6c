#pragma once
#ifndef SRC_POSIX_EXTRAS_ACCOUNTSC_LIBSERVICE_TYPE_HPP
#define SRC_POSIX_EXTRAS_ACCOUNTSC_LIBSERVICE_TYPE_HPP
...
libqt_list /* set of const char* */ Accounts__ServiceType_Tags(const Accounts__ServiceType* self);
