#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_POPPLERC_LIBPOPPLER_FORM_HPP
#define SRC_RESTRICTED_EXTRAS_POPPLERC_LIBPOPPLER_FORM_HPP
...
Poppler__Link* Poppler__FormField_AdditionalAction(const Poppler__FormField* self, int type);
Poppler__Link* Poppler__FormField_AdditionalAction2(const Poppler__FormField* self, int type);
