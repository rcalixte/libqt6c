...
void Poppler__TextAnnotation_SetInplaceAlign(Poppler__TextAnnotation* self, int align) {
    self->setInplaceAlign(static_cast<Poppler::TextAnnotation::InplaceAlignPosition>(align));
}
...
void Poppler__GeomAnnotation_SetGeomType(Poppler__GeomAnnotation* self, int type) {
    self->setGeomType(static_cast<Poppler::GeomAnnotation::GeomType>(type));
}
...
void Poppler__HighlightAnnotation_SetHighlightType(Poppler__HighlightAnnotation* self, int type) {
    self->setHighlightType(static_cast<Poppler::HighlightAnnotation::HighlightType>(type));
}
...
void Poppler__HighlightAnnotation_SetHighlightQuads(Poppler__HighlightAnnotation* self, const libqt_list /* of Poppler__HighlightAnnotation__Quad* */ quads) {
    ...
    Poppler__HighlightAnnotation__Quad** quads_arr = static_cast<Poppler__HighlightAnnotation__Quad**>(quads.data.ptr);
...
libqt_list /* of libqt_list of QPointF* */ Poppler__InkAnnotation_InkPaths(const Poppler__InkAnnotation* self) {
    ...
    for (qsizetype i = 0; i < _ret.size(); ++i) {
        ...
        _lv_out.data.ptr = static_cast<void*>(_lv_arr);
        _arr[i] = _lv_out;
    }
    libqt_list _out;
    _out.len = _ret.size();
...
void Poppler__InkAnnotation_SetInkPaths(Poppler__InkAnnotation* self, const libqt_list /* of libqt_list of QPointF* */ paths) {
    ...
    libqt_list /* of QPointF* */* paths_arr = static_cast<libqt_list /* of QPointF* */*>(paths.data.ptr);
    for (size_t i = 0; i < paths.len; ++i) {
        QVector<QPointF> paths_arr_i_QVector;
        paths_arr_i_QVector.reserve(paths_arr[i].len);
        QPointF** paths_arr_i_arr = static_cast<QPointF**>(paths_arr[i].data.ptr);
...
Poppler__Link* Poppler__ScreenAnnotation_AdditionalAction(const Poppler__ScreenAnnotation* self, int type) {
    return self->additionalAction(static_cast<Poppler::Annotation::AdditionalActionType>(type)).release();
}
...
Poppler__Link* Poppler__WidgetAnnotation_AdditionalAction(const Poppler__WidgetAnnotation* self, int type) {
    return self->additionalAction(static_cast<Poppler::Annotation::AdditionalActionType>(type)).release();
}
...
void Poppler__Annotation__Style_SetDashArray(Poppler__Annotation__Style* self, const libqt_list /* of double */ array) {
    ...
    double* array_arr = static_cast<double*>(array.data.doubles);
