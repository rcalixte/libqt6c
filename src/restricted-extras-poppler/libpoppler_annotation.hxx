...
class VirtualPopplerTextAnnotation final : public Poppler::TextAnnotation {
  ...
  public:
    VirtualPopplerTextAnnotation(Poppler::TextAnnotation::TextType type) : Poppler::TextAnnotation(type) {};
...
class VirtualPopplerLineAnnotation final : public Poppler::LineAnnotation {
  ...
  public:
    VirtualPopplerLineAnnotation(Poppler::LineAnnotation::LineType type) : Poppler::LineAnnotation(type) {};
