...
void QPlaceMatchReply_SetPlaces(QPlaceMatchReply* self, const libqt_list /* of QPlace* */ results) {
    ...
    QPlace** results_arr = static_cast<QPlace**>(results.data.ptr);
...
// Derived class handler implementation
void QPlaceMatchReply_SetError(QPlaceMatchReply* self, int error, const libqt_string errorString) {
    auto* vqplacematchreply = dynamic_cast<VirtualQPlaceMatchReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacematchreply && vqplacematchreply->isVirtualQPlaceMatchReply) {
        vqplacematchreply->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQPlaceMatchReply*)self)->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    }
}

// Base class handler implementation
void QPlaceMatchReply_QBaseSetError(QPlaceMatchReply* self, int error, const libqt_string errorString) {
    auto* vqplacematchreply = dynamic_cast<VirtualQPlaceMatchReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacematchreply && vqplacematchreply->isVirtualQPlaceMatchReply) {
