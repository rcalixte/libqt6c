#pragma once
#ifndef LOCATION_LIBQPLACEMANAGERENGINE_H
#define LOCATION_LIBQPLACEMANAGERENGINE_H
...
/// @param locales libqt_list of QLocale*
///
void q_placemanagerengine_super_set_locales(void* self, libqt_list locales);
