#pragma once
#ifndef SRC_LOCATIONC_LIBQPLACECONTENTREQUEST_HPP
#define SRC_LOCATIONC_LIBQPLACECONTENTREQUEST_HPP
...
void QPlaceContentRequest_SetContentType(QPlaceContentRequest* self, int type);
