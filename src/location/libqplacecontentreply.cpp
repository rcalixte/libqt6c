...
// Derived class handler implementation
void QPlaceContentReply_SetError(QPlaceContentReply* self, int error, const libqt_string errorString) {
    auto* vqplacecontentreply = dynamic_cast<VirtualQPlaceContentReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacecontentreply && vqplacecontentreply->isVirtualQPlaceContentReply) {
        vqplacecontentreply->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQPlaceContentReply*)self)->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    }
}

// Base class handler implementation
void QPlaceContentReply_SuperSetError(QPlaceContentReply* self, int error, const libqt_string errorString) {
    auto* vqplacecontentreply = dynamic_cast<VirtualQPlaceContentReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacecontentreply && vqplacecontentreply->isVirtualQPlaceContentReply) {
