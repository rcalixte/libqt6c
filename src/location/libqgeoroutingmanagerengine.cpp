...
void QGeoRoutingManagerEngine_ErrorOccurred(QGeoRoutingManagerEngine* self, QGeoRouteReply* reply, int error) {
...
void QGeoRoutingManagerEngine_Connect_ErrorOccurred(QGeoRoutingManagerEngine* self, intptr_t slot) {
    ...
    QGeoRoutingManagerEngine::connect(self, &QGeoRoutingManagerEngine::errorOccurred, [self, slotFunc](QGeoRouteReply* reply, QGeoRouteReply::Error error) {
        QGeoRouteReply* sigval1 = reply;
...
void QGeoRoutingManagerEngine_ErrorOccurred3(QGeoRoutingManagerEngine* self, QGeoRouteReply* reply, int error, const libqt_string errorString) {
...
void QGeoRoutingManagerEngine_Connect_ErrorOccurred3(QGeoRoutingManagerEngine* self, intptr_t slot) {
    ...
    QGeoRoutingManagerEngine::connect(self, &QGeoRoutingManagerEngine::errorOccurred, [self, slotFunc](QGeoRouteReply* reply, QGeoRouteReply::Error error, const QString& errorString) {
        QGeoRouteReply* sigval1 = reply;
        int sigval2 = static_cast<int>(error);
