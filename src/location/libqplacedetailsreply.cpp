...
// Derived class handler implementation
void QPlaceDetailsReply_SetError(QPlaceDetailsReply* self, int error, const libqt_string errorString) {
    auto* vqplacedetailsreply = dynamic_cast<VirtualQPlaceDetailsReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacedetailsreply && vqplacedetailsreply->isVirtualQPlaceDetailsReply) {
        vqplacedetailsreply->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQPlaceDetailsReply*)self)->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    }
}

// Base class handler implementation
void QPlaceDetailsReply_QBaseSetError(QPlaceDetailsReply* self, int error, const libqt_string errorString) {
    auto* vqplacedetailsreply = dynamic_cast<VirtualQPlaceDetailsReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacedetailsreply && vqplacedetailsreply->isVirtualQPlaceDetailsReply) {
