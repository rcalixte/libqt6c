  ...
  public:
    ...
    void setSuggestions(const QList<QString>& suggestions) {
        if (qplacesearchsuggestionreply_setsuggestions_isbase) {
            ...
            suggestions_out.data.ptr = static_cast<void*>(suggestions_arr);
    ...
    void setError(QPlaceReply::Error error, const QString& errorString) {
        if (qplacesearchsuggestionreply_seterror_isbase) {
            ...
            QPlaceSearchSuggestionReply::setError(error, errorString);
    ...
    friend void QPlaceSearchSuggestionReply_SetError(QPlaceSearchSuggestionReply* self, int error, const libqt_string errorString);
    friend void QPlaceSearchSuggestionReply_QBaseSetError(QPlaceSearchSuggestionReply* self, int error, const libqt_string errorString);
