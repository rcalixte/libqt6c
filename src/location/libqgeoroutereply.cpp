...
void QGeoRouteReply_ErrorOccurred(QGeoRouteReply* self, int error) {
    self->errorOccurred(static_cast<QGeoRouteReply::Error>(error));
}
...
void QGeoRouteReply_ErrorOccurred2(QGeoRouteReply* self, int error, const libqt_string errorString) {
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    self->errorOccurred(static_cast<QGeoRouteReply::Error>(error), errorString_QString);
}
...
// Derived class handler implementation
void QGeoRouteReply_SetError(QGeoRouteReply* self, int error, const libqt_string errorString) {
    auto* vqgeoroutereply = dynamic_cast<VirtualQGeoRouteReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqgeoroutereply && vqgeoroutereply->isVirtualQGeoRouteReply) {
        vqgeoroutereply->setError(static_cast<QGeoRouteReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQGeoRouteReply*)self)->setError(static_cast<QGeoRouteReply::Error>(error), errorString_QString);
    }
}

// Base class handler implementation
void QGeoRouteReply_SuperSetError(QGeoRouteReply* self, int error, const libqt_string errorString) {
    auto* vqgeoroutereply = dynamic_cast<VirtualQGeoRouteReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqgeoroutereply && vqgeoroutereply->isVirtualQGeoRouteReply) {
...
void QGeoRouteReply_SetRoutes(QGeoRouteReply* self, const libqt_list /* of QGeoRoute* */ routes) {
    ...
    QGeoRoute** routes_arr = static_cast<QGeoRoute**>(routes.data.ptr);
