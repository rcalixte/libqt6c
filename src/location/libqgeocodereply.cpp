...
void QGeoCodeReply_ErrorOccurred(QGeoCodeReply* self, int error) {
    self->errorOccurred(static_cast<QGeoCodeReply::Error>(error));
}
...
void QGeoCodeReply_ErrorOccurred2(QGeoCodeReply* self, int error, const libqt_string errorString) {
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    self->errorOccurred(static_cast<QGeoCodeReply::Error>(error), errorString_QString);
}
...
void QGeoCodeReply_SetError(QGeoCodeReply* self, int error, const libqt_string errorString) {
    ...
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqgeocodereply && vqgeocodereply->isVirtualQGeoCodeReply) {
        vqgeocodereply->setError(static_cast<QGeoCodeReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQGeoCodeReply*)self)->setError(static_cast<QGeoCodeReply::Error>(error), errorString_QString);
    }
}
...
void QGeoCodeReply_SetLocations(QGeoCodeReply* self, const libqt_list /* of QGeoLocation* */ locations) {
    ...
    QGeoLocation** locations_arr = static_cast<QGeoLocation**>(locations.data.ptr);
