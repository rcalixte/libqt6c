...
// Derived class handler implementation
void QPlaceSearchReply_SetError(QPlaceSearchReply* self, int error, const libqt_string errorString) {
    auto* vqplacesearchreply = dynamic_cast<VirtualQPlaceSearchReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacesearchreply && vqplacesearchreply->isVirtualQPlaceSearchReply) {
        vqplacesearchreply->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQPlaceSearchReply*)self)->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    }
}

// Base class handler implementation
void QPlaceSearchReply_SuperSetError(QPlaceSearchReply* self, int error, const libqt_string errorString) {
    auto* vqplacesearchreply = dynamic_cast<VirtualQPlaceSearchReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacesearchreply && vqplacesearchreply->isVirtualQPlaceSearchReply) {
