...
class VirtualQPlaceMatchReply final : public QPlaceMatchReply {
  ...
  public:
    ...
    ~VirtualQPlaceMatchReply() {
        qplacematchreply_metaobject_callback = nullptr;
        qplacematchreply_metacast_callback = nullptr;
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        } else if (qplacematchreply_metaobject_callback != nullptr) {
            QMetaObject* callback_ret = qplacematchreply_metaobject_callback();
            return callback_ret;
        } else {
            return QPlaceMatchReply::metaObject();
        }
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        } else if (qplacematchreply_metacast_callback != nullptr) {
    ...
    void setPlaces(const QList<QPlace>& results) {
        if (qplacematchreply_setplaces_isbase) {
            ...
            results_out.data.ptr = static_cast<void*>(results_arr);
    ...
    void setError(QPlaceReply::Error error, const QString& errorString) {
        if (qplacematchreply_seterror_isbase) {
            ...
            QPlaceMatchReply::setError(error, errorString);
    ...
    friend void QPlaceMatchReply_SetError(QPlaceMatchReply* self, int error, const libqt_string errorString);
    friend void QPlaceMatchReply_QBaseSetError(QPlaceMatchReply* self, int error, const libqt_string errorString);
