#pragma once
#ifndef SRC_LOCATIONC_LIBQGEOCODINGMANAGERENGINE_HPP
#define SRC_LOCATIONC_LIBQGEOCODINGMANAGERENGINE_HPP
...
void QGeoCodingManagerEngine_ErrorOccurred(QGeoCodingManagerEngine* self, QGeoCodeReply* reply, int error);
