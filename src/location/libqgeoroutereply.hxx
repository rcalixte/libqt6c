...
class VirtualQGeoRouteReply final : public QGeoRouteReply {
  ...
  public:
    ...
    using QGeoRouteReply_MetaObject_Callback = QMetaObject* (*)();
    ...
    using QGeoRouteReply_SetError_Callback = void (*)(QGeoRouteReply*, int, const char*);
  ...
  protected:
    ...
    // Instance base flags
    mutable bool qgeoroutereply_metaobject_isbase = false;
    mutable bool qgeoroutereply_metacast_isbase = false;
  ...
  public:
    VirtualQGeoRouteReply(QGeoRouteReply::Error error, const QString& errorString) : QGeoRouteReply(error, errorString) {};
    VirtualQGeoRouteReply(QGeoRouteReply::Error error, const QString& errorString, QObject* parent) : QGeoRouteReply(error, errorString, parent) {};
    ...
    // Base flag setters
    inline void setQGeoRouteReply_MetaObject_IsBase(bool value) const { qgeoroutereply_metaobject_isbase = value; }
    inline void setQGeoRouteReply_Metacast_IsBase(bool value) const { qgeoroutereply_metacast_isbase = value; }
    ...
    void setError(QGeoRouteReply::Error error, const QString& errorString) {
        if (qgeoroutereply_seterror_isbase) {
            ...
            QGeoRouteReply::setError(error, errorString);
    ...
    void setRoutes(const QList<QGeoRoute>& routes) {
        if (qgeoroutereply_setroutes_isbase) {
            ...
            routes_out.data.ptr = static_cast<void*>(routes_arr);
    ...
    friend void QGeoRouteReply_SetError(QGeoRouteReply* self, int error, const libqt_string errorString);
    friend void QGeoRouteReply_QBaseSetError(QGeoRouteReply* self, int error, const libqt_string errorString);
