...
void QPlaceManager_SetLocales(QPlaceManager* self, const libqt_list /* of QLocale* */ locale) {
    ...
    QLocale** locale_arr = static_cast<QLocale**>(locale.data.ptr);
...
void QPlaceManager_ErrorOccurred(QPlaceManager* self, QPlaceReply* param1, int error) {
    self->errorOccurred(param1, static_cast<QPlaceReply::Error>(error));
}
...
void QPlaceManager_Connect_ErrorOccurred(QPlaceManager* self, intptr_t slot) {
    ...
    QPlaceManager::connect(self, &QPlaceManager::errorOccurred, [self, slotFunc](QPlaceReply* param1, QPlaceReply::Error error) {
...
void QPlaceManager_Connect_PlaceAdded(QPlaceManager* self, intptr_t slot) {
    ...
    QPlaceManager::connect(self, &QPlaceManager::placeAdded, [self, slotFunc](const QString& placeId) {
        ...
        char* placeId_str = static_cast<char*>(malloc(placeId_b.length() + 1));
        memcpy(placeId_str, placeId_b.data(), placeId_b.length());
        placeId_str[placeId_b.length()] = '\0';
...
void QPlaceManager_ErrorOccurred3(QPlaceManager* self, QPlaceReply* param1, int error, const libqt_string errorString) {
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    self->errorOccurred(param1, static_cast<QPlaceReply::Error>(error), errorString_QString);
}
...
void QPlaceManager_Connect_ErrorOccurred3(QPlaceManager* self, intptr_t slot) {
    ...
    QPlaceManager::connect(self, &QPlaceManager::errorOccurred, [self, slotFunc](QPlaceReply* param1, QPlaceReply::Error error, const QString& errorString) {
        QPlaceReply* sigval1 = param1;
        int sigval2 = static_cast<int>(error);
