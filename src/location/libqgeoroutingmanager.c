...
QMetaObject__Connection* q_georoutingmanager_connect(void* sender, void* signal, void* receiver, void* method) {
    return QObject_Connect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method);
}

QMetaObject__Connection* q_georoutingmanager_connect2(void* self, void* sender, const char* signal, const char* member) {
    return QObject_Connect2((QObject*)self, (QObject*)sender, signal, member);
}

bool q_georoutingmanager_disconnect(void* sender, void* signal, void* receiver, void* member) {
    return QObject_Disconnect((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)member);
}

bool q_georoutingmanager_disconnect2(void* param1) {
...
const char** q_georoutingmanager_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_georoutingmanager_dynamic_property_names");
        abort();
    }
...
bool q_georoutingmanager_move_to_thread2(void* self, void* thread, void* param2) {
...
QMetaObject__Connection* q_georoutingmanager_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type) {
