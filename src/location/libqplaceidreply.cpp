...
// Derived class handler implementation
void QPlaceIdReply_SetError(QPlaceIdReply* self, int error, const libqt_string errorString) {
    auto* vqplaceidreply = dynamic_cast<VirtualQPlaceIdReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplaceidreply && vqplaceidreply->isVirtualQPlaceIdReply) {
        vqplaceidreply->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQPlaceIdReply*)self)->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    }
}

// Base class handler implementation
void QPlaceIdReply_QBaseSetError(QPlaceIdReply* self, int error, const libqt_string errorString) {
    auto* vqplaceidreply = dynamic_cast<VirtualQPlaceIdReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplaceidreply && vqplaceidreply->isVirtualQPlaceIdReply) {
