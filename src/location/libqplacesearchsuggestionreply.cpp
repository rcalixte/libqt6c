...
// Derived class handler implementation
void QPlaceSearchSuggestionReply_SetError(QPlaceSearchSuggestionReply* self, int error, const libqt_string errorString) {
    auto* vqplacesearchsuggestionreply = dynamic_cast<VirtualQPlaceSearchSuggestionReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacesearchsuggestionreply && vqplacesearchsuggestionreply->isVirtualQPlaceSearchSuggestionReply) {
        vqplacesearchsuggestionreply->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQPlaceSearchSuggestionReply*)self)->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    }
}

// Base class handler implementation
void QPlaceSearchSuggestionReply_SuperSetError(QPlaceSearchSuggestionReply* self, int error, const libqt_string errorString) {
    auto* vqplacesearchsuggestionreply = dynamic_cast<VirtualQPlaceSearchSuggestionReply*>(self);
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacesearchsuggestionreply && vqplacesearchsuggestionreply->isVirtualQPlaceSearchSuggestionReply) {
