#pragma once
#ifndef SRC_LOCATIONC_LIBQPLACEREPLY_HPP
#define SRC_LOCATIONC_LIBQPLACEREPLY_HPP
...
void QPlaceReply_SetError(QPlaceReply* self, int error, const libqt_string errorString);
void QPlaceReply_OnSetError(QPlaceReply* self, intptr_t slot);
void QPlaceReply_QBaseSetError(QPlaceReply* self, int error, const libqt_string errorString);
