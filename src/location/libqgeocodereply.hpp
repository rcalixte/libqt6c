#pragma once
#ifndef SRC_LOCATIONC_LIBQGEOCODEREPLY_HPP
#define SRC_LOCATIONC_LIBQGEOCODEREPLY_HPP
...
void QGeoCodeReply_SetError(QGeoCodeReply* self, int error, const libqt_string errorString);
void QGeoCodeReply_OnSetError(QGeoCodeReply* self, intptr_t slot);
void QGeoCodeReply_QBaseSetError(QGeoCodeReply* self, int error, const libqt_string errorString);
