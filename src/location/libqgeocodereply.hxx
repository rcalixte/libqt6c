...
class VirtualQGeoCodeReply final : public QGeoCodeReply {
  ...
  public:
    VirtualQGeoCodeReply(QGeoCodeReply::Error error, const QString& errorString) : QGeoCodeReply(error, errorString) {};
    VirtualQGeoCodeReply(QGeoCodeReply::Error error, const QString& errorString, QObject* parent) : QGeoCodeReply(error, errorString, parent) {};
    ...
    void setError(QGeoCodeReply::Error error, const QString& errorString) {
        if (qgeocodereply_seterror_isbase) {
            ...
            QGeoCodeReply::setError(error, errorString);
    ...
    void setLocations(const QList<QGeoLocation>& locations) {
        if (qgeocodereply_setlocations_isbase) {
            ...
            locations_out.data.ptr = static_cast<void*>(locations_arr);
    ...
    friend void QGeoCodeReply_SetError(QGeoCodeReply* self, int error, const libqt_string errorString);
    friend void QGeoCodeReply_SuperSetError(QGeoCodeReply* self, int error, const libqt_string errorString);
