...
void QPlaceReply_ErrorOccurred(QPlaceReply* self, int error) {
    self->errorOccurred(static_cast<QPlaceReply::Error>(error));
}
...
void QPlaceReply_ErrorOccurred2(QPlaceReply* self, int error, const libqt_string errorString) {
    ...
    self->errorOccurred(static_cast<QPlaceReply::Error>(error), errorString_QString);
}
...
void QPlaceReply_SetError(QPlaceReply* self, int error, const libqt_string errorString) {
    ...
    QString errorString_QString = QString::fromUtf8(errorString.data, errorString.len);
    if (vqplacereply && vqplacereply->isVirtualQPlaceReply) {
        vqplacereply->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    } else {
        ((VirtualQPlaceReply*)self)->setError(static_cast<QPlaceReply::Error>(error), errorString_QString);
    }
}
