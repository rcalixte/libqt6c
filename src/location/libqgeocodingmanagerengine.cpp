...
void QGeoCodingManagerEngine_Connect_ErrorOccurred(QGeoCodingManagerEngine* self, intptr_t slot) {
    ...
    QGeoCodingManagerEngine::connect(self, &QGeoCodingManagerEngine::errorOccurred, [self, slotFunc](QGeoCodeReply* reply, QGeoCodeReply::Error error) {
        QGeoCodeReply* sigval1 = reply;
...
void QGeoCodingManagerEngine_Connect_ErrorOccurred3(QGeoCodingManagerEngine* self, intptr_t slot) {
    ...
    QGeoCodingManagerEngine::connect(self, &QGeoCodingManagerEngine::errorOccurred, [self, slotFunc](QGeoCodeReply* reply, QGeoCodeReply::Error error, const QString& errorString) {
        QGeoCodeReply* sigval1 = reply;
        int sigval2 = static_cast<int>(error);
