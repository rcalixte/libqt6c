  ...
  public:
    ...
    void setError(QPlaceReply::Error error, const QString& errorString) {
        if (qplacecontentreply_seterror_isbase) {
            ...
            QPlaceContentReply::setError(error, errorString);
    ...
    friend void QPlaceContentReply_SetError(QPlaceContentReply* self, int error, const libqt_string errorString);
    friend void QPlaceContentReply_QBaseSetError(QPlaceContentReply* self, int error, const libqt_string errorString);
