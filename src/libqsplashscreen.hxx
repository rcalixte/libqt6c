...
class VirtualQSplashScreen final : public QSplashScreen {
  ...
  public:
    ...
    friend bool QSplashScreen_NativeEvent(QSplashScreen* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QSplashScreen_QBaseNativeEvent(QSplashScreen* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QSplashScreen_ConnectNotify(QSplashScreen* self, QMetaMethod* signal);
    friend void QSplashScreen_QBaseConnectNotify(QSplashScreen* self, QMetaMethod* signal);
    friend void QSplashScreen_DisconnectNotify(QSplashScreen* self, QMetaMethod* signal);
    friend void QSplashScreen_QBaseDisconnectNotify(QSplashScreen* self, QMetaMethod* signal);
    ...
    friend bool QSplashScreen_IsSignalConnected(const QSplashScreen* self, QMetaMethod* signal);
    friend bool QSplashScreen_QBaseIsSignalConnected(const QSplashScreen* self, QMetaMethod* signal);
};
