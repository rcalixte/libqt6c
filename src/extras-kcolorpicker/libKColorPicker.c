...
bool k_colorpicker__kcolorpicker_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

int32_t k_colorpicker__kcolorpicker_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

int32_t k_colorpicker__kcolorpicker_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

int32_t k_colorpicker__kcolorpicker_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

int32_t k_colorpicker__kcolorpicker_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

int32_t k_colorpicker__kcolorpicker_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

int32_t k_colorpicker__kcolorpicker_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

double k_colorpicker__kcolorpicker_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

double k_colorpicker__kcolorpicker_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

int32_t k_colorpicker__kcolorpicker_color_count(void* self) {
    return QPaintDevice_ColorCount(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}

int32_t k_colorpicker__kcolorpicker_depth(void* self) {
    return QPaintDevice_Depth(k_colorpicker__kcolorpicker_as_q_paint_device(self));
}
