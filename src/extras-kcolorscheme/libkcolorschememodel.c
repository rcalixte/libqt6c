...
const char* k_colorschememodel_tr(const char* s) {
    libqt_string _str = KColorSchemeModel_Tr(s);
...
const char* k_colorschememodel_tr2(const char* s, const char* c) {
    libqt_string _str = KColorSchemeModel_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_colorschememodel_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KColorSchemeModel_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_colorschememodel_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_colorschememodel_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_colorschememodel_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_colorschememodel_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
libqt_map /* of int to QVariant* */ k_colorschememodel_item_data(void* self, void* index) {
    return KColorSchemeModel_ItemData((KColorSchemeModel*)self, (QModelIndex*)index);
}

libqt_map /* of int to QVariant* */ k_colorschememodel_qbase_item_data(void* self, void* index) {
    return KColorSchemeModel_QBaseItemData((KColorSchemeModel*)self, (QModelIndex*)index);
}
...
bool k_colorschememodel_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KColorSchemeModel_SetItemData((KColorSchemeModel*)self, (QModelIndex*)index, roles);
}

bool k_colorschememodel_qbase_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KColorSchemeModel_QBaseSetItemData((KColorSchemeModel*)self, (QModelIndex*)index, roles);
}
...
const char** k_colorschememodel_mime_types(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_colorschememodel_mime_types");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
libqt_map /* of int to char* */ k_colorschememodel_role_names(void* self) {
    return KColorSchemeModel_RoleNames((KColorSchemeModel*)self);
}

libqt_map /* of int to char* */ k_colorschememodel_qbase_role_names(void* self) {
    return KColorSchemeModel_QBaseRoleNames((KColorSchemeModel*)self);
}
