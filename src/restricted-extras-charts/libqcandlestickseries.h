#pragma once
#ifndef RESTRICTED_EXTRAS_CHARTS_LIBQCANDLESTICKSERIES_H
#define RESTRICTED_EXTRAS_CHARTS_LIBQCANDLESTICKSERIES_H
...
///
int32_t q_candlestickseries_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_candlestickseries_start_timer23(void* self, int64_t time, int32_t timerType);
