#pragma once
#ifndef RESTRICTED_EXTRAS_CHARTS_LIBQPIESERIES_H
#define RESTRICTED_EXTRAS_CHARTS_LIBQPIESERIES_H
...
///
/// @param self QPieSeries*
/// @param callback void* func(QPieSeries* self, const char* param1)
///
...
///
int32_t q_pieseries_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_pieseries_start_timer23(void* self, int64_t time, int32_t timerType);
