...
void q_horizontalbarseries_on_barsets_added(void* self, void (*callback)(void*, QBarSet**)) {
...
void q_horizontalbarseries_on_barsets_removed(void* self, void (*callback)(void*, QBarSet**)) {
