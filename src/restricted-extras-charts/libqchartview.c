...
libqt_list /* of QGraphicsItem* */ q_chartview_items6(void* self, void* polygon) {
...
libqt_list /* of QGraphicsItem* */ q_chartview_items23(void* self, void* polygon, int32_t mode) {
...
bool q_chartview_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_chartview_as_q_paint_device(self));
}

int32_t q_chartview_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_chartview_as_q_paint_device(self));
}

int32_t q_chartview_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_chartview_as_q_paint_device(self));
}

int32_t q_chartview_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_chartview_as_q_paint_device(self));
}

int32_t q_chartview_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_chartview_as_q_paint_device(self));
}

int32_t q_chartview_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_chartview_as_q_paint_device(self));
}

int32_t q_chartview_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_chartview_as_q_paint_device(self));
}

double q_chartview_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_chartview_as_q_paint_device(self));
}

double q_chartview_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_chartview_as_q_paint_device(self));
}

int32_t q_chartview_color_count(void* self) {
    return QPaintDevice_ColorCount(q_chartview_as_q_paint_device(self));
}

int32_t q_chartview_depth(void* self) {
    return QPaintDevice_Depth(q_chartview_as_q_paint_device(self));
}
