#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_CHARTS_QT6C_LIBQCANDLESTICKLEGENDMARKER_H
#define SRC_RESTRICTED_EXTRAS_CHARTS_QT6C_LIBQCANDLESTICKLEGENDMARKER_H
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_meta_object` instead
///
#define q_candlesticklegendmarker_qbase_meta_object q_candlesticklegendmarker_super_meta_object
...
/// @param self QCandlestickLegendMarker*
///
const QMetaObject* q_candlesticklegendmarker_super_meta_object(void* self);
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_metacast` instead
///
#define q_candlesticklegendmarker_qbase_metacast q_candlesticklegendmarker_super_metacast
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_metacall` instead
///
#define q_candlesticklegendmarker_qbase_metacall q_candlesticklegendmarker_super_metacall
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_type` instead
///
#define q_candlesticklegendmarker_qbase_type q_candlesticklegendmarker_super_type
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_series` instead
///
#define q_candlesticklegendmarker_qbase_series q_candlesticklegendmarker_super_series
...
///
libqt_list q_candlesticklegendmarker_children(void* self);
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_event` instead
///
#define q_candlesticklegendmarker_qbase_event q_candlesticklegendmarker_super_event
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_event_filter` instead
///
#define q_candlesticklegendmarker_qbase_event_filter q_candlesticklegendmarker_super_event_filter
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_timer_event` instead
///
#define q_candlesticklegendmarker_qbase_timer_event q_candlesticklegendmarker_super_timer_event
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_child_event` instead
///
#define q_candlesticklegendmarker_qbase_child_event q_candlesticklegendmarker_super_child_event
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_custom_event` instead
///
#define q_candlesticklegendmarker_qbase_custom_event q_candlesticklegendmarker_super_custom_event
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_connect_notify` instead
///
#define q_candlesticklegendmarker_qbase_connect_notify q_candlesticklegendmarker_super_connect_notify
...
/// @param signal QMetaMethod*
///
void q_candlesticklegendmarker_super_connect_notify(void* self, void* signal);
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_disconnect_notify` instead
///
#define q_candlesticklegendmarker_qbase_disconnect_notify q_candlesticklegendmarker_super_disconnect_notify
...
/// @param signal QMetaMethod*
///
void q_candlesticklegendmarker_super_disconnect_notify(void* self, void* signal);
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_sender` instead
///
#define q_candlesticklegendmarker_qbase_sender q_candlesticklegendmarker_super_sender
...
/// @param self QCandlestickLegendMarker*
///
QObject* q_candlesticklegendmarker_super_sender(void* self);
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_sender_signal_index` instead
///
#define q_candlesticklegendmarker_qbase_sender_signal_index q_candlesticklegendmarker_super_sender_signal_index
...
/// @param self QCandlestickLegendMarker*
///
int32_t q_candlesticklegendmarker_super_sender_signal_index(void* self);
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_receivers` instead
///
#define q_candlesticklegendmarker_qbase_receivers q_candlesticklegendmarker_super_receivers
...
/// @param signal const char*
///
int32_t q_candlesticklegendmarker_super_receivers(void* self, const char* signal);
...
/// @warning DEPRECATED: Use `q_candlesticklegendmarker_super_is_signal_connected` instead
///
#define q_candlesticklegendmarker_qbase_is_signal_connected q_candlesticklegendmarker_super_is_signal_connected
...
/// @param signal QMetaMethod*
///
bool q_candlesticklegendmarker_super_is_signal_connected(void* self, void* signal);
