...
void q_abstractbarseries_on_barsets_added(void* self, void (*callback)(void*, libqt_list /* of QBarSet* */)) {
...
void q_abstractbarseries_on_barsets_removed(void* self, void (*callback)(void*, libqt_list /* of QBarSet* */)) {
