...
bool q_boxplotseries_move_to_thread2(void* self, void* thread, void* param2);
...
QMetaObject__Connection* q_boxplotseries_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* q_boxplotseries_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
