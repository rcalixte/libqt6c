#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_CHARTS_QT6C_LIBQCATEGORYAXIS_H
#define SRC_RESTRICTED_EXTRAS_CHARTS_QT6C_LIBQCATEGORYAXIS_H
...
///
/// @param self QCategoryAxis*
/// @param callback void* func(QCategoryAxis* self, const char* param1)
///
