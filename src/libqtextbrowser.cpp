...
// Base class handler implementation
QVariant* QTextBrowser_SuperLoadResource(QTextBrowser* self, int type, const QUrl* name) {
    auto* vqtextbrowser = dynamic_cast<VirtualQTextBrowser*>(self);
    if (vqtextbrowser && vqtextbrowser->isVirtualQTextBrowser) {
...
// Base class handler implementation
void QTextBrowser_SuperDoSetSource(QTextBrowser* self, const QUrl* name, int type) {
    auto* vqtextbrowser = dynamic_cast<VirtualQTextBrowser*>(self);
    if (vqtextbrowser && vqtextbrowser->isVirtualQTextBrowser) {
