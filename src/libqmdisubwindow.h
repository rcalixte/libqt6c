...
/// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowTitleChanged)
///
/// ``` QMdiSubWindow* self, void (*slot)(QMdiSubWindow*, const char*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#windowIconChanged)
///
/// ``` QMdiSubWindow* self, void (*slot)(QMdiSubWindow*, QIcon*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qwidget.html#customContextMenuRequested)
///
/// ``` QMdiSubWindow* self, void (*slot)(QMdiSubWindow*, QPoint*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QMdiSubWindow* self, void (*slot)(QMdiSubWindow*, QObject*) ```
