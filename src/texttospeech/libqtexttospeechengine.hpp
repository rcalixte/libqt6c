#pragma once
#ifndef SRC_TEXTTOSPEECHC_LIBQTEXTTOSPEECHENGINE_HPP
#define SRC_TEXTTOSPEECHC_LIBQTEXTTOSPEECHENGINE_HPP
...
void QTextToSpeechEngine_ErrorOccurred(QTextToSpeechEngine* self, int error, const libqt_string errorString);
