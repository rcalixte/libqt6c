...
class VirtualQScrollBar final : public QScrollBar {
  ...
  public:
    ...
    friend bool QScrollBar_NativeEvent(QScrollBar* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QScrollBar_QBaseNativeEvent(QScrollBar* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QScrollBar_ConnectNotify(QScrollBar* self, QMetaMethod* signal);
    friend void QScrollBar_QBaseConnectNotify(QScrollBar* self, QMetaMethod* signal);
    friend void QScrollBar_DisconnectNotify(QScrollBar* self, QMetaMethod* signal);
    friend void QScrollBar_QBaseDisconnectNotify(QScrollBar* self, QMetaMethod* signal);
    ...
    friend bool QScrollBar_IsSignalConnected(const QScrollBar* self, QMetaMethod* signal);
    friend bool QScrollBar_QBaseIsSignalConnected(const QScrollBar* self, QMetaMethod* signal);
};
