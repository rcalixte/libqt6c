...
class VirtualKCompressionDevice final : public KCompressionDevice {
  ...
  public:
    VirtualKCompressionDevice(QIODevice* inputDevice, bool autoDeleteInputDevice, KCompressionDevice::CompressionType type) : KCompressionDevice(inputDevice, autoDeleteInputDevice, type) {};
    VirtualKCompressionDevice(const QString& fileName, KCompressionDevice::CompressionType type) : KCompressionDevice(fileName, type) {};
