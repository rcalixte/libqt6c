#pragma once
#ifndef SRC_EXTRAS_KARCHIVE_QT6C_LIBKTAR_H
#define SRC_EXTRAS_KARCHIVE_QT6C_LIBKTAR_H
...
/// k_tar_new constructs a new KTar object.
///
...
/// k_tar_new2 constructs a new KTar object.
///
/// @param dev QIODevice*
///
...
/// k_tar_new3 constructs a new KTar object.
///
/// @param param1 KTar*
///
...
/// k_tar_new4 constructs a new KTar object.
///
/// @param filename const char*
...
///
/// @param self KTar*
/// @param callback bool func(KTar* self, const char* name, const char* user, const char* group, long long size, mode_t perm, QDateTime* atime, QDateTime* mtime, QDateTime* ctime)
///
...
///
/// @param self KTar*
/// @param callback bool func(KTar* self, long long size)
///
...
///
/// @param self KTar*
/// @param callback bool func(KTar* self, const char* data, long long size)
///
...
///
/// @param self KTar*
/// @param callback void func(KTar* self, const char* errorStr)
///
...
///
/// @param self KTar*
/// @param callback KArchiveDirectory* func(KTar* self, const char* path)
///
...
///
/// @param self KTar*
/// @param callback void func(KTar* self, QIODevice* dev)
///
...
///
/// @param self KTar*
/// @param callback void func(KTar* self, KArchiveDirectory* rootDir)
///
