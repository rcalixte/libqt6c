...
KFilterBase* KCompressionDevice_FilterForCompressionType(int type) {
    return KCompressionDevice::filterForCompressionType(static_cast<KCompressionDevice::CompressionType>(type));
}
