...
class VirtualQDialogButtonBox final : public QDialogButtonBox {
  ...
  public:
    ...
    friend bool QDialogButtonBox_NativeEvent(QDialogButtonBox* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QDialogButtonBox_QBaseNativeEvent(QDialogButtonBox* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QDialogButtonBox_ConnectNotify(QDialogButtonBox* self, QMetaMethod* signal);
    friend void QDialogButtonBox_QBaseConnectNotify(QDialogButtonBox* self, QMetaMethod* signal);
    friend void QDialogButtonBox_DisconnectNotify(QDialogButtonBox* self, QMetaMethod* signal);
    friend void QDialogButtonBox_QBaseDisconnectNotify(QDialogButtonBox* self, QMetaMethod* signal);
    ...
    friend bool QDialogButtonBox_IsSignalConnected(const QDialogButtonBox* self, QMetaMethod* signal);
    friend bool QDialogButtonBox_QBaseIsSignalConnected(const QDialogButtonBox* self, QMetaMethod* signal);
};
