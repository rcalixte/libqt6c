#pragma once
#ifndef SRC_EXTRAS_KIDLETIMEQT6C_LIBKIDLETIME_H
#define SRC_EXTRAS_KIDLETIMEQT6C_LIBKIDLETIME_H
...
/// https://api.kde.org/kidletime.html
...
/// [Qt documentation](https://api.kde.org/kidletime.html#instance)
///
KIdleTime* k_idletime_instance();

/// [Qt documentation](https://api.kde.org/kidletime.html#idleTime)
///
/// @param self KIdleTime*
int32_t k_idletime_idle_time(void* self);

/// [Qt documentation](https://api.kde.org/kidletime.html#idleTimeouts)
///
/// @param self KIdleTime*
libqt_map /* of int to int */ k_idletime_idle_timeouts(void* self);

/// [Qt documentation](https://api.kde.org/kidletime.html#simulateUserActivity)
///
/// @param self KIdleTime*
void k_idletime_simulate_user_activity(void* self);

/// [Qt documentation](https://api.kde.org/kidletime.html#addIdleTimeout)
///
/// @param self KIdleTime*
/// @param msec int
int32_t k_idletime_add_idle_timeout(void* self, int msec);

/// [Qt documentation](https://api.kde.org/kidletime.html#removeIdleTimeout)
///
/// @param self KIdleTime*
/// @param identifier int
void k_idletime_remove_idle_timeout(void* self, int identifier);

/// [Qt documentation](https://api.kde.org/kidletime.html#removeAllIdleTimeouts)
///
/// @param self KIdleTime*
void k_idletime_remove_all_idle_timeouts(void* self);

/// [Qt documentation](https://api.kde.org/kidletime.html#catchNextResumeEvent)
///
/// @param self KIdleTime*
void k_idletime_catch_next_resume_event(void* self);

/// [Qt documentation](https://api.kde.org/kidletime.html#stopCatchingResumeEvent)
///
/// @param self KIdleTime*
void k_idletime_stop_catching_resume_event(void* self);

/// [Qt documentation](https://api.kde.org/kidletime.html#resumingFromIdle)
///
/// @param self KIdleTime*
...
/// [Qt documentation](https://api.kde.org/kidletime.html#timeoutReached)
///
/// @param self KIdleTime*
/// @param identifier int
/// @param msec int
...
/// [Qt documentation](https://api.kde.org/kidletime.html#dtor.KIdleTime)
///
