#pragma once
#ifndef SRCC_LIBQPROXYSTYLE_HPP
#define SRCC_LIBQPROXYSTYLE_HPP
...
QSize* QProxyStyle_SuperSizeFromContents(const QProxyStyle* self, int type, const QStyleOption* option, const QSize* size, const QWidget* widget);
