...
bool k_icondialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_icondialog_as_q_paint_device(self));
}

int32_t k_icondialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_icondialog_as_q_paint_device(self));
}

int32_t k_icondialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_icondialog_as_q_paint_device(self));
}

int32_t k_icondialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_icondialog_as_q_paint_device(self));
}

int32_t k_icondialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_icondialog_as_q_paint_device(self));
}

int32_t k_icondialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_icondialog_as_q_paint_device(self));
}

int32_t k_icondialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_icondialog_as_q_paint_device(self));
}

double k_icondialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_icondialog_as_q_paint_device(self));
}

double k_icondialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_icondialog_as_q_paint_device(self));
}

int32_t k_icondialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_icondialog_as_q_paint_device(self));
}

int32_t k_icondialog_depth(void* self) {
    return QPaintDevice_Depth(k_icondialog_as_q_paint_device(self));
}
