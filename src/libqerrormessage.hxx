...
class VirtualQErrorMessage final : public QErrorMessage {
  ...
  public:
    ...
    friend bool QErrorMessage_NativeEvent(QErrorMessage* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QErrorMessage_QBaseNativeEvent(QErrorMessage* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QErrorMessage_ConnectNotify(QErrorMessage* self, QMetaMethod* signal);
    friend void QErrorMessage_QBaseConnectNotify(QErrorMessage* self, QMetaMethod* signal);
    friend void QErrorMessage_DisconnectNotify(QErrorMessage* self, QMetaMethod* signal);
    friend void QErrorMessage_QBaseDisconnectNotify(QErrorMessage* self, QMetaMethod* signal);
    ...
    friend bool QErrorMessage_IsSignalConnected(const QErrorMessage* self, QMetaMethod* signal);
    friend bool QErrorMessage_QBaseIsSignalConnected(const QErrorMessage* self, QMetaMethod* signal);
};
