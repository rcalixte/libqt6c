...
class VirtualQTableView final : public QTableView {
  ...
  public:
    ...
    friend void QTableView_SuperRowMoved(QTableView* self, int row, int oldIndex, int newIndex);
    friend void QTableView_ColumnMoved(QTableView* self, int column, int oldIndex, int newIndex);
    friend void QTableView_SuperColumnMoved(QTableView* self, int column, int oldIndex, int newIndex);
    friend void QTableView_RowResized(QTableView* self, int row, int oldHeight, int newHeight);
    friend void QTableView_SuperRowResized(QTableView* self, int row, int oldHeight, int newHeight);
    friend void QTableView_ColumnResized(QTableView* self, int column, int oldWidth, int newWidth);
    friend void QTableView_SuperColumnResized(QTableView* self, int column, int oldWidth, int newWidth);
    friend void QTableView_RowCountChanged(QTableView* self, int oldCount, int newCount);
    friend void QTableView_SuperRowCountChanged(QTableView* self, int oldCount, int newCount);
    friend void QTableView_ColumnCountChanged(QTableView* self, int oldCount, int newCount);
    friend void QTableView_SuperColumnCountChanged(QTableView* self, int oldCount, int newCount);
    friend int QTableView_State(const QTableView* self);
    friend int QTableView_SuperState(const QTableView* self);
    friend void QTableView_SetState(QTableView* self, int state);
    friend void QTableView_SuperSetState(QTableView* self, int state);
    friend void QTableView_ScheduleDelayedItemsLayout(QTableView* self);
    friend void QTableView_SuperScheduleDelayedItemsLayout(QTableView* self);
    friend void QTableView_ExecuteDelayedItemsLayout(QTableView* self);
    friend void QTableView_SuperExecuteDelayedItemsLayout(QTableView* self);
    friend void QTableView_SetDirtyRegion(QTableView* self, const QRegion* region);
    friend void QTableView_SuperSetDirtyRegion(QTableView* self, const QRegion* region);
    friend void QTableView_ScrollDirtyRegion(QTableView* self, int dx, int dy);
    friend void QTableView_SuperScrollDirtyRegion(QTableView* self, int dx, int dy);
    friend QPoint* QTableView_DirtyRegionOffset(const QTableView* self);
    friend QPoint* QTableView_SuperDirtyRegionOffset(const QTableView* self);
    friend void QTableView_StartAutoScroll(QTableView* self);
    friend void QTableView_SuperStartAutoScroll(QTableView* self);
    friend void QTableView_StopAutoScroll(QTableView* self);
    friend void QTableView_SuperStopAutoScroll(QTableView* self);
    friend void QTableView_DoAutoScroll(QTableView* self);
    friend void QTableView_SuperDoAutoScroll(QTableView* self);
    friend int QTableView_DropIndicatorPosition(const QTableView* self);
    friend int QTableView_SuperDropIndicatorPosition(const QTableView* self);
    friend void QTableView_SetViewportMargins(QTableView* self, int left, int top, int right, int bottom);
    friend void QTableView_SuperSetViewportMargins(QTableView* self, int left, int top, int right, int bottom);
    friend QMargins* QTableView_ViewportMargins(const QTableView* self);
    friend QMargins* QTableView_SuperViewportMargins(const QTableView* self);
    friend void QTableView_DrawFrame(QTableView* self, QPainter* param1);
    friend void QTableView_SuperDrawFrame(QTableView* self, QPainter* param1);
    friend void QTableView_UpdateMicroFocus(QTableView* self);
    friend void QTableView_SuperUpdateMicroFocus(QTableView* self);
    friend void QTableView_Create(QTableView* self);
    friend void QTableView_SuperCreate(QTableView* self);
    friend void QTableView_Destroy(QTableView* self);
    friend void QTableView_SuperDestroy(QTableView* self);
    friend bool QTableView_FocusNextChild(QTableView* self);
    friend bool QTableView_SuperFocusNextChild(QTableView* self);
    friend bool QTableView_FocusPreviousChild(QTableView* self);
    friend bool QTableView_SuperFocusPreviousChild(QTableView* self);
    friend QObject* QTableView_Sender(const QTableView* self);
    friend QObject* QTableView_SuperSender(const QTableView* self);
    friend int QTableView_SenderSignalIndex(const QTableView* self);
    friend int QTableView_SuperSenderSignalIndex(const QTableView* self);
