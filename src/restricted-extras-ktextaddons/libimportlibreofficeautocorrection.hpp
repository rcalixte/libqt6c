#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_KTEXTADDONSC_LIBIMPORTLIBREOFFICEAUTOCORRECTION_HPP
#define SRC_RESTRICTED_EXTRAS_KTEXTADDONSC_LIBIMPORTLIBREOFFICEAUTOCORRECTION_HPP
