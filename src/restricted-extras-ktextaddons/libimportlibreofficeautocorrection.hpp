#pragma once
#ifndef RESTRICTED_EXTRAS_KTEXTADDONS_LIBIMPORTLIBREOFFICEAUTOCORRECTION_HPP
#define RESTRICTED_EXTRAS_KTEXTADDONS_LIBIMPORTLIBREOFFICEAUTOCORRECTION_HPP
