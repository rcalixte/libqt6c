...
bool k_textgrammarcheck__grammalecteconfigdialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

int32_t k_textgrammarcheck__grammalecteconfigdialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

int32_t k_textgrammarcheck__grammalecteconfigdialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

int32_t k_textgrammarcheck__grammalecteconfigdialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

int32_t k_textgrammarcheck__grammalecteconfigdialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

int32_t k_textgrammarcheck__grammalecteconfigdialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

int32_t k_textgrammarcheck__grammalecteconfigdialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

double k_textgrammarcheck__grammalecteconfigdialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

double k_textgrammarcheck__grammalecteconfigdialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

int32_t k_textgrammarcheck__grammalecteconfigdialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}

int32_t k_textgrammarcheck__grammalecteconfigdialog_depth(void* self) {
    return QPaintDevice_Depth(k_textgrammarcheck__grammalecteconfigdialog_as_q_paint_device(self));
}
