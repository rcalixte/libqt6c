#pragma once
#ifndef RESTRICTED_EXTRAS_KTEXTADDONS_LIBIMPORTLIBREOFFICEAUTOCORRECTION_HXX
#define RESTRICTED_EXTRAS_KTEXTADDONS_LIBIMPORTLIBREOFFICEAUTOCORRECTION_HXX
