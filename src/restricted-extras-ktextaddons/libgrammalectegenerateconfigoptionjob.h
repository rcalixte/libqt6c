#pragma once
#ifndef RESTRICTED_EXTRAS_KTEXTADDONS_LIBGRAMMALECTEGENERATECONFIGOPTIONJOB_H
#define RESTRICTED_EXTRAS_KTEXTADDONS_LIBGRAMMALECTEGENERATECONFIGOPTIONJOB_H
