#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_KTEXTADDONSC_LIBTRANSLATORENGINEACCESSMANAGER_HPP
#define SRC_RESTRICTED_EXTRAS_KTEXTADDONSC_LIBTRANSLATORENGINEACCESSMANAGER_HPP
