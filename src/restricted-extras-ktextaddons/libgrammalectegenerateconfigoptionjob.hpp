#pragma once
#ifndef RESTRICTED_EXTRAS_KTEXTADDONS_LIBGRAMMALECTEGENERATECONFIGOPTIONJOB_HPP
#define RESTRICTED_EXTRAS_KTEXTADDONS_LIBGRAMMALECTEGENERATECONFIGOPTIONJOB_HPP
