...
const QMetaObject* k_textgrammarcheck__grammalectemanager_super_meta_object(void* self) {
    return TextGrammarCheck__GrammalecteManager_SuperMetaObject((TextGrammarCheck__GrammalecteManager*)self);
}

void* k_textgrammarcheck__grammalectemanager_metacast(void* self, const char* param1) {
    return TextGrammarCheck__GrammalecteManager_Metacast((TextGrammarCheck__GrammalecteManager*)self, param1);
}

void k_textgrammarcheck__grammalectemanager_on_metacast(void* self, void* (*callback)(void*, const char*)) {
    TextGrammarCheck__GrammalecteManager_OnMetacast((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

void* k_textgrammarcheck__grammalectemanager_super_metacast(void* self, const char* param1) {
    return TextGrammarCheck__GrammalecteManager_SuperMetacast((TextGrammarCheck__GrammalecteManager*)self, param1);
}

int32_t k_textgrammarcheck__grammalectemanager_metacall(void* self, int32_t param1, int param2, void* param3) {
    return TextGrammarCheck__GrammalecteManager_Metacall((TextGrammarCheck__GrammalecteManager*)self, param1, param2, param3);
}

void k_textgrammarcheck__grammalectemanager_on_metacall(void* self, int32_t (*callback)(void*, int32_t, int, void*)) {
    TextGrammarCheck__GrammalecteManager_OnMetacall((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

int32_t k_textgrammarcheck__grammalectemanager_super_metacall(void* self, int32_t param1, int param2, void* param3) {
    return TextGrammarCheck__GrammalecteManager_SuperMetacall((TextGrammarCheck__GrammalecteManager*)self, param1, param2, param3);
}
...
TextGrammarCheck__GrammalecteManager* k_textgrammarcheck__grammalectemanager_self() {
    return TextGrammarCheck__GrammalecteManager_Self();
}

const char* k_textgrammarcheck__grammalectemanager_python_path(void* self) {
    libqt_string _str = TextGrammarCheck__GrammalecteManager_PythonPath((TextGrammarCheck__GrammalecteManager*)self);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_textgrammarcheck__grammalectemanager_grammalecte_path(void* self) {
    libqt_string _str = TextGrammarCheck__GrammalecteManager_GrammalectePath((TextGrammarCheck__GrammalecteManager*)self);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_textgrammarcheck__grammalectemanager_set_python_path(void* self, const char* pythonPath) {
    TextGrammarCheck__GrammalecteManager_SetPythonPath((TextGrammarCheck__GrammalecteManager*)self, qstring(pythonPath));
}

void k_textgrammarcheck__grammalectemanager_set_grammalecte_path(void* self, const char* grammalectePath) {
    TextGrammarCheck__GrammalecteManager_SetGrammalectePath((TextGrammarCheck__GrammalecteManager*)self, qstring(grammalectePath));
}

const char** k_textgrammarcheck__grammalectemanager_options(void* self) {
    libqt_list _arr = TextGrammarCheck__GrammalecteManager_Options((TextGrammarCheck__GrammalecteManager*)self);
    const libqt_string* _qstr = (libqt_string*)_arr.data.ptr;
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_textgrammarcheck__grammalectemanager_options\n");
        abort();
    }
...
void k_textgrammarcheck__grammalectemanager_set_options(void* self, const char* saveOptions[static 1]) {
    size_t saveOptions_len = libqt_strv_length(saveOptions);
    libqt_string* saveOptions_qstr = (libqt_string*)malloc(saveOptions_len * sizeof(libqt_string));
    if (saveOptions_qstr == NULL) {
...
void k_textgrammarcheck__grammalectemanager_load_settings(void* self) {
    TextGrammarCheck__GrammalecteManager_LoadSettings((TextGrammarCheck__GrammalecteManager*)self);
}

void k_textgrammarcheck__grammalectemanager_save_settings(void* self) {
    TextGrammarCheck__GrammalecteManager_SaveSettings((TextGrammarCheck__GrammalecteManager*)self);
}
...
libqt_list /* of QObject* */ k_textgrammarcheck__grammalectemanager_children(void* self) {
...
const char** k_textgrammarcheck__grammalectemanager_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_textgrammarcheck__grammalectemanager_dynamic_property_names\n");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
bool k_textgrammarcheck__grammalectemanager_event(void* self, void* event) {
    return TextGrammarCheck__GrammalecteManager_Event((TextGrammarCheck__GrammalecteManager*)self, (QEvent*)event);
}

bool k_textgrammarcheck__grammalectemanager_super_event(void* self, void* event) {
    return TextGrammarCheck__GrammalecteManager_SuperEvent((TextGrammarCheck__GrammalecteManager*)self, (QEvent*)event);
}

void k_textgrammarcheck__grammalectemanager_on_event(void* self, bool (*callback)(void*, void*)) {
    TextGrammarCheck__GrammalecteManager_OnEvent((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

bool k_textgrammarcheck__grammalectemanager_event_filter(void* self, void* watched, void* event) {
    return TextGrammarCheck__GrammalecteManager_EventFilter((TextGrammarCheck__GrammalecteManager*)self, (QObject*)watched, (QEvent*)event);
}

bool k_textgrammarcheck__grammalectemanager_super_event_filter(void* self, void* watched, void* event) {
    return TextGrammarCheck__GrammalecteManager_SuperEventFilter((TextGrammarCheck__GrammalecteManager*)self, (QObject*)watched, (QEvent*)event);
}

void k_textgrammarcheck__grammalectemanager_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    TextGrammarCheck__GrammalecteManager_OnEventFilter((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

void k_textgrammarcheck__grammalectemanager_timer_event(void* self, void* event) {
    TextGrammarCheck__GrammalecteManager_TimerEvent((TextGrammarCheck__GrammalecteManager*)self, (QTimerEvent*)event);
}

void k_textgrammarcheck__grammalectemanager_super_timer_event(void* self, void* event) {
    TextGrammarCheck__GrammalecteManager_SuperTimerEvent((TextGrammarCheck__GrammalecteManager*)self, (QTimerEvent*)event);
}

void k_textgrammarcheck__grammalectemanager_on_timer_event(void* self, void (*callback)(void*, void*)) {
    TextGrammarCheck__GrammalecteManager_OnTimerEvent((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

void k_textgrammarcheck__grammalectemanager_child_event(void* self, void* event) {
    TextGrammarCheck__GrammalecteManager_ChildEvent((TextGrammarCheck__GrammalecteManager*)self, (QChildEvent*)event);
}

void k_textgrammarcheck__grammalectemanager_super_child_event(void* self, void* event) {
    TextGrammarCheck__GrammalecteManager_SuperChildEvent((TextGrammarCheck__GrammalecteManager*)self, (QChildEvent*)event);
}

void k_textgrammarcheck__grammalectemanager_on_child_event(void* self, void (*callback)(void*, void*)) {
    TextGrammarCheck__GrammalecteManager_OnChildEvent((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

void k_textgrammarcheck__grammalectemanager_custom_event(void* self, void* event) {
    TextGrammarCheck__GrammalecteManager_CustomEvent((TextGrammarCheck__GrammalecteManager*)self, (QEvent*)event);
}

void k_textgrammarcheck__grammalectemanager_super_custom_event(void* self, void* event) {
    TextGrammarCheck__GrammalecteManager_SuperCustomEvent((TextGrammarCheck__GrammalecteManager*)self, (QEvent*)event);
}

void k_textgrammarcheck__grammalectemanager_on_custom_event(void* self, void (*callback)(void*, void*)) {
    TextGrammarCheck__GrammalecteManager_OnCustomEvent((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

void k_textgrammarcheck__grammalectemanager_connect_notify(void* self, void* signal) {
    TextGrammarCheck__GrammalecteManager_ConnectNotify((TextGrammarCheck__GrammalecteManager*)self, (QMetaMethod*)signal);
}

void k_textgrammarcheck__grammalectemanager_super_connect_notify(void* self, void* signal) {
    TextGrammarCheck__GrammalecteManager_SuperConnectNotify((TextGrammarCheck__GrammalecteManager*)self, (QMetaMethod*)signal);
}

void k_textgrammarcheck__grammalectemanager_on_connect_notify(void* self, void (*callback)(void*, void*)) {
    TextGrammarCheck__GrammalecteManager_OnConnectNotify((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

void k_textgrammarcheck__grammalectemanager_disconnect_notify(void* self, void* signal) {
    TextGrammarCheck__GrammalecteManager_DisconnectNotify((TextGrammarCheck__GrammalecteManager*)self, (QMetaMethod*)signal);
}

void k_textgrammarcheck__grammalectemanager_super_disconnect_notify(void* self, void* signal) {
    TextGrammarCheck__GrammalecteManager_SuperDisconnectNotify((TextGrammarCheck__GrammalecteManager*)self, (QMetaMethod*)signal);
}

void k_textgrammarcheck__grammalectemanager_on_disconnect_notify(void* self, void (*callback)(void*, void*)) {
    TextGrammarCheck__GrammalecteManager_OnDisconnectNotify((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

QObject* k_textgrammarcheck__grammalectemanager_sender(void* self) {
    return TextGrammarCheck__GrammalecteManager_Sender((TextGrammarCheck__GrammalecteManager*)self);
}

QObject* k_textgrammarcheck__grammalectemanager_super_sender(void* self) {
    return TextGrammarCheck__GrammalecteManager_SuperSender((TextGrammarCheck__GrammalecteManager*)self);
}

void k_textgrammarcheck__grammalectemanager_on_sender(void* self, QObject* (*callback)()) {
    TextGrammarCheck__GrammalecteManager_OnSender((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

int32_t k_textgrammarcheck__grammalectemanager_sender_signal_index(void* self) {
    return TextGrammarCheck__GrammalecteManager_SenderSignalIndex((TextGrammarCheck__GrammalecteManager*)self);
}

int32_t k_textgrammarcheck__grammalectemanager_super_sender_signal_index(void* self) {
    return TextGrammarCheck__GrammalecteManager_SuperSenderSignalIndex((TextGrammarCheck__GrammalecteManager*)self);
}

void k_textgrammarcheck__grammalectemanager_on_sender_signal_index(void* self, int32_t (*callback)()) {
    TextGrammarCheck__GrammalecteManager_OnSenderSignalIndex((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

int32_t k_textgrammarcheck__grammalectemanager_receivers(void* self, const char* signal) {
    return TextGrammarCheck__GrammalecteManager_Receivers((TextGrammarCheck__GrammalecteManager*)self, signal);
}

int32_t k_textgrammarcheck__grammalectemanager_super_receivers(void* self, const char* signal) {
    return TextGrammarCheck__GrammalecteManager_SuperReceivers((TextGrammarCheck__GrammalecteManager*)self, signal);
}

void k_textgrammarcheck__grammalectemanager_on_receivers(void* self, int32_t (*callback)(void*, const char*)) {
    TextGrammarCheck__GrammalecteManager_OnReceivers((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}

bool k_textgrammarcheck__grammalectemanager_is_signal_connected(void* self, void* signal) {
    return TextGrammarCheck__GrammalecteManager_IsSignalConnected((TextGrammarCheck__GrammalecteManager*)self, (QMetaMethod*)signal);
}

bool k_textgrammarcheck__grammalectemanager_super_is_signal_connected(void* self, void* signal) {
    return TextGrammarCheck__GrammalecteManager_SuperIsSignalConnected((TextGrammarCheck__GrammalecteManager*)self, (QMetaMethod*)signal);
}

void k_textgrammarcheck__grammalectemanager_on_is_signal_connected(void* self, bool (*callback)(void*, void*)) {
    TextGrammarCheck__GrammalecteManager_OnIsSignalConnected((TextGrammarCheck__GrammalecteManager*)self, (intptr_t)callback);
}
...
void k_textgrammarcheck__grammalectemanager_delete(void* self) {
    TextGrammarCheck__GrammalecteManager_Delete((TextGrammarCheck__GrammalecteManager*)(self));
}
