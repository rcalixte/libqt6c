#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_KTEXTADDONSC_LIBTEXTAUTOCORRECTIONSETTINGS_HPP
#define SRC_RESTRICTED_EXTRAS_KTEXTADDONSC_LIBTEXTAUTOCORRECTIONSETTINGS_HPP
