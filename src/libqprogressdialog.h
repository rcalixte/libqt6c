#pragma once
#ifndef LIBQPROGRESSDIALOG_H
#define LIBQPROGRESSDIALOG_H
...
/// Inherited from QWidget
///
/// Downcasts to a QProgressDialog object
///
...
///
int32_t q_progressdialog_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_progressdialog_start_timer23(void* self, int64_t time, int32_t timerType);
