...
class VirtualQGroupBox final : public QGroupBox {
  ...
  public:
    ...
    friend bool QGroupBox_NativeEvent(QGroupBox* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QGroupBox_QBaseNativeEvent(QGroupBox* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QGroupBox_ConnectNotify(QGroupBox* self, QMetaMethod* signal);
    friend void QGroupBox_QBaseConnectNotify(QGroupBox* self, QMetaMethod* signal);
    friend void QGroupBox_DisconnectNotify(QGroupBox* self, QMetaMethod* signal);
    friend void QGroupBox_QBaseDisconnectNotify(QGroupBox* self, QMetaMethod* signal);
    ...
    friend bool QGroupBox_IsSignalConnected(const QGroupBox* self, QMetaMethod* signal);
    friend bool QGroupBox_QBaseIsSignalConnected(const QGroupBox* self, QMetaMethod* signal);
};
