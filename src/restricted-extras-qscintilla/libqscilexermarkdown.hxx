...
class VirtualQsciLexerMarkdown final : public QsciLexerMarkdown {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerMarkdown_ReadProperties(QsciLexerMarkdown* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMarkdown_QBaseReadProperties(QsciLexerMarkdown* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMarkdown_WriteProperties(const QsciLexerMarkdown* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMarkdown_QBaseWriteProperties(const QsciLexerMarkdown* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerMarkdown_ConnectNotify(QsciLexerMarkdown* self, QMetaMethod* signal);
    friend void QsciLexerMarkdown_QBaseConnectNotify(QsciLexerMarkdown* self, QMetaMethod* signal);
    friend void QsciLexerMarkdown_DisconnectNotify(QsciLexerMarkdown* self, QMetaMethod* signal);
    friend void QsciLexerMarkdown_QBaseDisconnectNotify(QsciLexerMarkdown* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerMarkdown_IsSignalConnected(const QsciLexerMarkdown* self, QMetaMethod* signal);
    friend bool QsciLexerMarkdown_QBaseIsSignalConnected(const QsciLexerMarkdown* self, QMetaMethod* signal);
};
