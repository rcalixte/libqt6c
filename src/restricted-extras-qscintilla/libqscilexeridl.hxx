...
class VirtualQsciLexerIDL final : public QsciLexerIDL {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerIDL_ReadProperties(QsciLexerIDL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerIDL_QBaseReadProperties(QsciLexerIDL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerIDL_WriteProperties(const QsciLexerIDL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerIDL_QBaseWriteProperties(const QsciLexerIDL* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerIDL_ConnectNotify(QsciLexerIDL* self, QMetaMethod* signal);
    friend void QsciLexerIDL_QBaseConnectNotify(QsciLexerIDL* self, QMetaMethod* signal);
    friend void QsciLexerIDL_DisconnectNotify(QsciLexerIDL* self, QMetaMethod* signal);
    friend void QsciLexerIDL_QBaseDisconnectNotify(QsciLexerIDL* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerIDL_IsSignalConnected(const QsciLexerIDL* self, QMetaMethod* signal);
    friend bool QsciLexerIDL_QBaseIsSignalConnected(const QsciLexerIDL* self, QMetaMethod* signal);
};
