...
class VirtualQsciLexerCPP final : public QsciLexerCPP {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerCPP_ReadProperties(QsciLexerCPP* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCPP_QBaseReadProperties(QsciLexerCPP* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCPP_WriteProperties(const QsciLexerCPP* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCPP_QBaseWriteProperties(const QsciLexerCPP* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerCPP_ConnectNotify(QsciLexerCPP* self, QMetaMethod* signal);
    friend void QsciLexerCPP_QBaseConnectNotify(QsciLexerCPP* self, QMetaMethod* signal);
    friend void QsciLexerCPP_DisconnectNotify(QsciLexerCPP* self, QMetaMethod* signal);
    friend void QsciLexerCPP_QBaseDisconnectNotify(QsciLexerCPP* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerCPP_IsSignalConnected(const QsciLexerCPP* self, QMetaMethod* signal);
    friend bool QsciLexerCPP_QBaseIsSignalConnected(const QsciLexerCPP* self, QMetaMethod* signal);
};
