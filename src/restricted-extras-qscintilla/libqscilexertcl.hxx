...
class VirtualQsciLexerTCL final : public QsciLexerTCL {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerTCL_ReadProperties(QsciLexerTCL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerTCL_QBaseReadProperties(QsciLexerTCL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerTCL_WriteProperties(const QsciLexerTCL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerTCL_QBaseWriteProperties(const QsciLexerTCL* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerTCL_ConnectNotify(QsciLexerTCL* self, QMetaMethod* signal);
    friend void QsciLexerTCL_QBaseConnectNotify(QsciLexerTCL* self, QMetaMethod* signal);
    friend void QsciLexerTCL_DisconnectNotify(QsciLexerTCL* self, QMetaMethod* signal);
    friend void QsciLexerTCL_QBaseDisconnectNotify(QsciLexerTCL* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerTCL_IsSignalConnected(const QsciLexerTCL* self, QMetaMethod* signal);
    friend bool QsciLexerTCL_QBaseIsSignalConnected(const QsciLexerTCL* self, QMetaMethod* signal);
};
