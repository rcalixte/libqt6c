...
class VirtualQsciLexerMatlab final : public QsciLexerMatlab {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerMatlab_ReadProperties(QsciLexerMatlab* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMatlab_QBaseReadProperties(QsciLexerMatlab* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMatlab_WriteProperties(const QsciLexerMatlab* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMatlab_QBaseWriteProperties(const QsciLexerMatlab* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerMatlab_ConnectNotify(QsciLexerMatlab* self, QMetaMethod* signal);
    friend void QsciLexerMatlab_QBaseConnectNotify(QsciLexerMatlab* self, QMetaMethod* signal);
    friend void QsciLexerMatlab_DisconnectNotify(QsciLexerMatlab* self, QMetaMethod* signal);
    friend void QsciLexerMatlab_QBaseDisconnectNotify(QsciLexerMatlab* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerMatlab_IsSignalConnected(const QsciLexerMatlab* self, QMetaMethod* signal);
    friend bool QsciLexerMatlab_QBaseIsSignalConnected(const QsciLexerMatlab* self, QMetaMethod* signal);
};
