...
class VirtualQsciLexerJava final : public QsciLexerJava {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerJava_ReadProperties(QsciLexerJava* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJava_QBaseReadProperties(QsciLexerJava* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJava_WriteProperties(const QsciLexerJava* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJava_QBaseWriteProperties(const QsciLexerJava* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerJava_ConnectNotify(QsciLexerJava* self, QMetaMethod* signal);
    friend void QsciLexerJava_QBaseConnectNotify(QsciLexerJava* self, QMetaMethod* signal);
    friend void QsciLexerJava_DisconnectNotify(QsciLexerJava* self, QMetaMethod* signal);
    friend void QsciLexerJava_QBaseDisconnectNotify(QsciLexerJava* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerJava_IsSignalConnected(const QsciLexerJava* self, QMetaMethod* signal);
    friend bool QsciLexerJava_QBaseIsSignalConnected(const QsciLexerJava* self, QMetaMethod* signal);
};
