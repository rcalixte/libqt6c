...
const QMetaObject* q_scilexerbatch_super_meta_object(void* self) {
    return QsciLexerBatch_SuperMetaObject((QsciLexerBatch*)self);
}
...
void q_scilexerbatch_on_metacast(void* self, void* (*callback)(void*, const char*)) {
    QsciLexerBatch_OnMetacast((QsciLexerBatch*)self, (intptr_t)callback);
}

void* q_scilexerbatch_super_metacast(void* self, const char* param1) {
    return QsciLexerBatch_SuperMetacast((QsciLexerBatch*)self, param1);
}
...
int32_t q_scilexerbatch_super_metacall(void* self, int32_t param1, int param2, void* param3) {
    return QsciLexerBatch_SuperMetacall((QsciLexerBatch*)self, param1, param2, param3);
}
...
const char** q_scilexerbatch_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_scilexerbatch_dynamic_property_names\n");
        abort();
    }
...
const char** q_scilexerbatch_auto_completion_word_separators(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_scilexerbatch_auto_completion_word_separators\n");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** q_scilexerbatch_super_auto_completion_word_separators(void* self) {
    libqt_list _arr = QsciLexerBatch_SuperAutoCompletionWordSeparators((QsciLexerBatch*)self);
    const libqt_string* _qstr = (libqt_string*)_arr.data.ptr;
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_scilexerbatch_auto_completion_word_separators\n");
...
void q_scilexerbatch_super_set_editor(void* self, void* editor) {
    QsciLexerBatch_SuperSetEditor((QsciLexerBatch*)self, (QsciScintilla*)editor);
}
...
void q_scilexerbatch_super_refresh_properties(void* self) {
    QsciLexerBatch_SuperRefreshProperties((QsciLexerBatch*)self);
}
...
void q_scilexerbatch_super_set_auto_indent_style(void* self, int autoindentstyle) {
    QsciLexerBatch_SuperSetAutoIndentStyle((QsciLexerBatch*)self, autoindentstyle);
}
...
void q_scilexerbatch_super_set_color(void* self, void* c, int style) {
    QsciLexerBatch_SuperSetColor((QsciLexerBatch*)self, (QColor*)c, style);
}
...
void q_scilexerbatch_super_set_eol_fill(void* self, bool eoffill, int style) {
    QsciLexerBatch_SuperSetEolFill((QsciLexerBatch*)self, eoffill, style);
}
...
void q_scilexerbatch_super_set_font(void* self, void* f, int style) {
    QsciLexerBatch_SuperSetFont((QsciLexerBatch*)self, (QFont*)f, style);
}
...
void q_scilexerbatch_super_set_paper(void* self, void* c, int style) {
    QsciLexerBatch_SuperSetPaper((QsciLexerBatch*)self, (QColor*)c, style);
}
...
bool q_scilexerbatch_super_read_properties(void* self, void* qs, const char* prefix) {
    return QsciLexerBatch_SuperReadProperties((QsciLexerBatch*)self, (QSettings*)qs, qstring(prefix));
}
...
bool q_scilexerbatch_super_event(void* self, void* event) {
    return QsciLexerBatch_SuperEvent((QsciLexerBatch*)self, (QEvent*)event);
}
...
bool q_scilexerbatch_super_event_filter(void* self, void* watched, void* event) {
    return QsciLexerBatch_SuperEventFilter((QsciLexerBatch*)self, (QObject*)watched, (QEvent*)event);
}
...
void q_scilexerbatch_super_timer_event(void* self, void* event) {
    QsciLexerBatch_SuperTimerEvent((QsciLexerBatch*)self, (QTimerEvent*)event);
}
...
void q_scilexerbatch_super_child_event(void* self, void* event) {
    QsciLexerBatch_SuperChildEvent((QsciLexerBatch*)self, (QChildEvent*)event);
}
...
void q_scilexerbatch_super_custom_event(void* self, void* event) {
    QsciLexerBatch_SuperCustomEvent((QsciLexerBatch*)self, (QEvent*)event);
}
...
void q_scilexerbatch_super_connect_notify(void* self, void* signal) {
    QsciLexerBatch_SuperConnectNotify((QsciLexerBatch*)self, (QMetaMethod*)signal);
}
...
void q_scilexerbatch_super_disconnect_notify(void* self, void* signal) {
    QsciLexerBatch_SuperDisconnectNotify((QsciLexerBatch*)self, (QMetaMethod*)signal);
}
...
char* q_scilexerbatch_super_text_as_bytes(void* self, const char* text) {
    libqt_string _str = QsciLexerBatch_SuperTextAsBytes((QsciLexerBatch*)self, qstring(text));
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* q_scilexerbatch_super_bytes_as_text(void* self, const char* bytes, int size) {
    libqt_string _str = QsciLexerBatch_SuperBytesAsText((QsciLexerBatch*)self, bytes, size);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
QObject* q_scilexerbatch_super_sender(void* self) {
    return QsciLexerBatch_SuperSender((QsciLexerBatch*)self);
}
...
int32_t q_scilexerbatch_super_sender_signal_index(void* self) {
    return QsciLexerBatch_SuperSenderSignalIndex((QsciLexerBatch*)self);
}
...
int32_t q_scilexerbatch_super_receivers(void* self, const char* signal) {
    return QsciLexerBatch_SuperReceivers((QsciLexerBatch*)self, signal);
}
...
bool q_scilexerbatch_super_is_signal_connected(void* self, void* signal) {
    return QsciLexerBatch_SuperIsSignalConnected((QsciLexerBatch*)self, (QMetaMethod*)signal);
}
