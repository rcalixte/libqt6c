...
class VirtualQsciLexerPascal final : public QsciLexerPascal {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerPascal_ReadProperties(QsciLexerPascal* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPascal_QBaseReadProperties(QsciLexerPascal* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPascal_WriteProperties(const QsciLexerPascal* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPascal_QBaseWriteProperties(const QsciLexerPascal* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerPascal_ConnectNotify(QsciLexerPascal* self, QMetaMethod* signal);
    friend void QsciLexerPascal_QBaseConnectNotify(QsciLexerPascal* self, QMetaMethod* signal);
    friend void QsciLexerPascal_DisconnectNotify(QsciLexerPascal* self, QMetaMethod* signal);
    friend void QsciLexerPascal_QBaseDisconnectNotify(QsciLexerPascal* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerPascal_IsSignalConnected(const QsciLexerPascal* self, QMetaMethod* signal);
    friend bool QsciLexerPascal_QBaseIsSignalConnected(const QsciLexerPascal* self, QMetaMethod* signal);
};
