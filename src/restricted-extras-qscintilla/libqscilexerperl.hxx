...
class VirtualQsciLexerPerl final : public QsciLexerPerl {
  ...
  public:
    ...
    ~VirtualQsciLexerPerl() {
        qscilexerperl_metaobject_callback = nullptr;
        qscilexerperl_metacast_callback = nullptr;
        ...
        qscilexerperl_defaultcolor2_callback = nullptr;
        qscilexerperl_defaulteolfill_callback = nullptr;
        qscilexerperl_defaultfont2_callback = nullptr;
        qscilexerperl_defaultpaper2_callback = nullptr;
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        } else if (qscilexerperl_metaobject_callback != nullptr) {
            QMetaObject* callback_ret = qscilexerperl_metaobject_callback();
            return callback_ret;
        } else {
            return QsciLexerPerl::metaObject();
        }
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        } else if (qscilexerperl_metacast_callback != nullptr) {
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexerperl_autocompletionwordseparators_isbase) {
            ...
            const char** callback_ret = qscilexerperl_autocompletionwordseparators_callback();
    ...
    virtual QColor defaultColor(int style) const override {
        ...
        } else if (qscilexerperl_defaultcolor2_callback != nullptr) {
            int cbval1 = style;
    ...
    virtual QFont defaultFont(int style) const override {
        ...
        } else if (qscilexerperl_defaultfont2_callback != nullptr) {
            int cbval1 = style;
    ...
    virtual QColor defaultPaper(int style) const override {
        ...
        } else if (qscilexerperl_defaultpaper2_callback != nullptr) {
            int cbval1 = style;
    ...
    QString bytesAsText(const char* bytes, int size) const {
        if (qscilexerperl_bytesastext_isbase) {
            ...
            const char* callback_ret = qscilexerperl_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret);
            return callback_ret_QString;
        } else {
            return QsciLexerPerl::bytesAsText(bytes, size);
