...
class VirtualQsciLexerPerl final : public QsciLexerPerl {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerPerl_ReadProperties(QsciLexerPerl* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPerl_QBaseReadProperties(QsciLexerPerl* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPerl_WriteProperties(const QsciLexerPerl* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPerl_QBaseWriteProperties(const QsciLexerPerl* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerPerl_ConnectNotify(QsciLexerPerl* self, QMetaMethod* signal);
    friend void QsciLexerPerl_QBaseConnectNotify(QsciLexerPerl* self, QMetaMethod* signal);
    friend void QsciLexerPerl_DisconnectNotify(QsciLexerPerl* self, QMetaMethod* signal);
    friend void QsciLexerPerl_QBaseDisconnectNotify(QsciLexerPerl* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerPerl_IsSignalConnected(const QsciLexerPerl* self, QMetaMethod* signal);
    friend bool QsciLexerPerl_QBaseIsSignalConnected(const QsciLexerPerl* self, QMetaMethod* signal);
};
