...
class VirtualQsciLexerAVS final : public QsciLexerAVS {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerAVS_ReadProperties(QsciLexerAVS* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerAVS_QBaseReadProperties(QsciLexerAVS* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerAVS_WriteProperties(const QsciLexerAVS* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerAVS_QBaseWriteProperties(const QsciLexerAVS* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerAVS_ConnectNotify(QsciLexerAVS* self, QMetaMethod* signal);
    friend void QsciLexerAVS_QBaseConnectNotify(QsciLexerAVS* self, QMetaMethod* signal);
    friend void QsciLexerAVS_DisconnectNotify(QsciLexerAVS* self, QMetaMethod* signal);
    friend void QsciLexerAVS_QBaseDisconnectNotify(QsciLexerAVS* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerAVS_IsSignalConnected(const QsciLexerAVS* self, QMetaMethod* signal);
    friend bool QsciLexerAVS_QBaseIsSignalConnected(const QsciLexerAVS* self, QMetaMethod* signal);
};
