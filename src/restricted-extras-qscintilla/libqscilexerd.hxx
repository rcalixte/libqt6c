...
class VirtualQsciLexerD final : public QsciLexerD {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerD_ReadProperties(QsciLexerD* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerD_QBaseReadProperties(QsciLexerD* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerD_WriteProperties(const QsciLexerD* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerD_QBaseWriteProperties(const QsciLexerD* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerD_ConnectNotify(QsciLexerD* self, QMetaMethod* signal);
    friend void QsciLexerD_QBaseConnectNotify(QsciLexerD* self, QMetaMethod* signal);
    friend void QsciLexerD_DisconnectNotify(QsciLexerD* self, QMetaMethod* signal);
    friend void QsciLexerD_QBaseDisconnectNotify(QsciLexerD* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerD_IsSignalConnected(const QsciLexerD* self, QMetaMethod* signal);
    friend bool QsciLexerD_QBaseIsSignalConnected(const QsciLexerD* self, QMetaMethod* signal);
};
