...
QMetaObject* QsciLexerHex_SuperMetaObject(const QsciLexerHex* self) {
    ...
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_MetaObject_IsBase(true);
        return (QMetaObject*)vqscilexerhex->metaObject();
    } else {
        return (QMetaObject*)((VirtualQsciLexerHex*)self)->metaObject();
    }
}
...
void QsciLexerHex_OnMetaObject(const QsciLexerHex* self, intptr_t slot) {
    auto* vqscilexerhex = const_cast<VirtualQsciLexerHex*>(dynamic_cast<const VirtualQsciLexerHex*>(self));
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_MetaObject_Callback(reinterpret_cast<VirtualQsciLexerHex::QsciLexerHex_MetaObject_Callback>(slot));
    }
}
...
void* QsciLexerHex_SuperMetacast(QsciLexerHex* self, const char* param1) {
    auto* vqscilexerhex = dynamic_cast<VirtualQsciLexerHex*>(self);
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_Metacast_IsBase(true);
        return vqscilexerhex->qt_metacast(param1);
    } else {
        return ((VirtualQsciLexerHex*)self)->qt_metacast(param1);
    }
}
...
void QsciLexerHex_OnMetacast(QsciLexerHex* self, intptr_t slot) {
    auto* vqscilexerhex = dynamic_cast<VirtualQsciLexerHex*>(self);
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_Metacast_Callback(reinterpret_cast<VirtualQsciLexerHex::QsciLexerHex_Metacast_Callback>(slot));
    }
}
...
QColor* QsciLexerHex_SuperDefaultColor2(const QsciLexerHex* self, int style) {
    auto* vqscilexerhex = const_cast<VirtualQsciLexerHex*>(dynamic_cast<const VirtualQsciLexerHex*>(self));
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_DefaultColor2_IsBase(true);
        return new QColor(vqscilexerhex->defaultColor(static_cast<int>(style)));
    } else {
        return new QColor(((VirtualQsciLexerHex*)self)->defaultColor(static_cast<int>(style)));
    }
...
void QsciLexerHex_OnDefaultColor2(const QsciLexerHex* self, intptr_t slot) {
    auto* vqscilexerhex = const_cast<VirtualQsciLexerHex*>(dynamic_cast<const VirtualQsciLexerHex*>(self));
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_DefaultColor2_Callback(reinterpret_cast<VirtualQsciLexerHex::QsciLexerHex_DefaultColor2_Callback>(slot));
    }
}
...
QFont* QsciLexerHex_SuperDefaultFont2(const QsciLexerHex* self, int style) {
    auto* vqscilexerhex = const_cast<VirtualQsciLexerHex*>(dynamic_cast<const VirtualQsciLexerHex*>(self));
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_DefaultFont2_IsBase(true);
        return new QFont(vqscilexerhex->defaultFont(static_cast<int>(style)));
    } else {
        return new QFont(((VirtualQsciLexerHex*)self)->defaultFont(static_cast<int>(style)));
    }
...
void QsciLexerHex_OnDefaultFont2(const QsciLexerHex* self, intptr_t slot) {
    auto* vqscilexerhex = const_cast<VirtualQsciLexerHex*>(dynamic_cast<const VirtualQsciLexerHex*>(self));
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_DefaultFont2_Callback(reinterpret_cast<VirtualQsciLexerHex::QsciLexerHex_DefaultFont2_Callback>(slot));
    }
}
...
QColor* QsciLexerHex_SuperDefaultPaper2(const QsciLexerHex* self, int style) {
    auto* vqscilexerhex = const_cast<VirtualQsciLexerHex*>(dynamic_cast<const VirtualQsciLexerHex*>(self));
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_DefaultPaper2_IsBase(true);
        return new QColor(vqscilexerhex->defaultPaper(static_cast<int>(style)));
    } else {
        return new QColor(((VirtualQsciLexerHex*)self)->defaultPaper(static_cast<int>(style)));
    }
...
void QsciLexerHex_OnDefaultPaper2(const QsciLexerHex* self, intptr_t slot) {
    auto* vqscilexerhex = const_cast<VirtualQsciLexerHex*>(dynamic_cast<const VirtualQsciLexerHex*>(self));
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        vqscilexerhex->setQsciLexerHex_DefaultPaper2_Callback(reinterpret_cast<VirtualQsciLexerHex::QsciLexerHex_DefaultPaper2_Callback>(slot));
    }
}
...
libqt_string QsciLexerHex_BytesAsText(const QsciLexerHex* self, const char* bytes, int size) {
    auto* vqscilexerhex = const_cast<VirtualQsciLexerHex*>(dynamic_cast<const VirtualQsciLexerHex*>(self));
    if (vqscilexerhex && vqscilexerhex->isVirtualQsciLexerHex) {
        auto _ret = vqscilexerhex->bytesAsText(bytes, static_cast<int>(size));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
        ...
        auto _ret = ((VirtualQsciLexerHex*)self)->bytesAsText(bytes, static_cast<int>(size));
        // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
        QByteArray _b = _ret.toUtf8();
        libqt_string _str;
        _str.len = _b.length();
