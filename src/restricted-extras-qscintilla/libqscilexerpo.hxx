...
class VirtualQsciLexerPO final : public QsciLexerPO {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerPO_ReadProperties(QsciLexerPO* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPO_QBaseReadProperties(QsciLexerPO* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPO_WriteProperties(const QsciLexerPO* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPO_QBaseWriteProperties(const QsciLexerPO* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerPO_ConnectNotify(QsciLexerPO* self, QMetaMethod* signal);
    friend void QsciLexerPO_QBaseConnectNotify(QsciLexerPO* self, QMetaMethod* signal);
    friend void QsciLexerPO_DisconnectNotify(QsciLexerPO* self, QMetaMethod* signal);
    friend void QsciLexerPO_QBaseDisconnectNotify(QsciLexerPO* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerPO_IsSignalConnected(const QsciLexerPO* self, QMetaMethod* signal);
    friend bool QsciLexerPO_QBaseIsSignalConnected(const QsciLexerPO* self, QMetaMethod* signal);
};
