...
class VirtualQsciLexerCustom final : public QsciLexerCustom {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerCustom_ReadProperties(QsciLexerCustom* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCustom_QBaseReadProperties(QsciLexerCustom* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCustom_WriteProperties(const QsciLexerCustom* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCustom_QBaseWriteProperties(const QsciLexerCustom* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerCustom_ConnectNotify(QsciLexerCustom* self, QMetaMethod* signal);
    friend void QsciLexerCustom_QBaseConnectNotify(QsciLexerCustom* self, QMetaMethod* signal);
    friend void QsciLexerCustom_DisconnectNotify(QsciLexerCustom* self, QMetaMethod* signal);
    friend void QsciLexerCustom_QBaseDisconnectNotify(QsciLexerCustom* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerCustom_IsSignalConnected(const QsciLexerCustom* self, QMetaMethod* signal);
    friend bool QsciLexerCustom_QBaseIsSignalConnected(const QsciLexerCustom* self, QMetaMethod* signal);
};
