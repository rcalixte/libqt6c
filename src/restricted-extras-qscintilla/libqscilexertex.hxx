...
class VirtualQsciLexerTeX final : public QsciLexerTeX {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerTeX_ReadProperties(QsciLexerTeX* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerTeX_QBaseReadProperties(QsciLexerTeX* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerTeX_WriteProperties(const QsciLexerTeX* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerTeX_QBaseWriteProperties(const QsciLexerTeX* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerTeX_ConnectNotify(QsciLexerTeX* self, QMetaMethod* signal);
    friend void QsciLexerTeX_QBaseConnectNotify(QsciLexerTeX* self, QMetaMethod* signal);
    friend void QsciLexerTeX_DisconnectNotify(QsciLexerTeX* self, QMetaMethod* signal);
    friend void QsciLexerTeX_QBaseDisconnectNotify(QsciLexerTeX* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerTeX_IsSignalConnected(const QsciLexerTeX* self, QMetaMethod* signal);
    friend bool QsciLexerTeX_QBaseIsSignalConnected(const QsciLexerTeX* self, QMetaMethod* signal);
};
