...
class VirtualQsciLexerJavaScript final : public QsciLexerJavaScript {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerJavaScript_ReadProperties(QsciLexerJavaScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJavaScript_QBaseReadProperties(QsciLexerJavaScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJavaScript_WriteProperties(const QsciLexerJavaScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJavaScript_QBaseWriteProperties(const QsciLexerJavaScript* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerJavaScript_ConnectNotify(QsciLexerJavaScript* self, QMetaMethod* signal);
    friend void QsciLexerJavaScript_QBaseConnectNotify(QsciLexerJavaScript* self, QMetaMethod* signal);
    friend void QsciLexerJavaScript_DisconnectNotify(QsciLexerJavaScript* self, QMetaMethod* signal);
    friend void QsciLexerJavaScript_QBaseDisconnectNotify(QsciLexerJavaScript* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerJavaScript_IsSignalConnected(const QsciLexerJavaScript* self, QMetaMethod* signal);
    friend bool QsciLexerJavaScript_QBaseIsSignalConnected(const QsciLexerJavaScript* self, QMetaMethod* signal);
};
