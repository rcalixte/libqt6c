...
class VirtualQsciLexerSpice final : public QsciLexerSpice {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerSpice_ReadProperties(QsciLexerSpice* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerSpice_QBaseReadProperties(QsciLexerSpice* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerSpice_WriteProperties(const QsciLexerSpice* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerSpice_QBaseWriteProperties(const QsciLexerSpice* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerSpice_ConnectNotify(QsciLexerSpice* self, QMetaMethod* signal);
    friend void QsciLexerSpice_QBaseConnectNotify(QsciLexerSpice* self, QMetaMethod* signal);
    friend void QsciLexerSpice_DisconnectNotify(QsciLexerSpice* self, QMetaMethod* signal);
    friend void QsciLexerSpice_QBaseDisconnectNotify(QsciLexerSpice* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerSpice_IsSignalConnected(const QsciLexerSpice* self, QMetaMethod* signal);
    friend bool QsciLexerSpice_QBaseIsSignalConnected(const QsciLexerSpice* self, QMetaMethod* signal);
};
