...
class VirtualQsciLexerYAML final : public QsciLexerYAML {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerYAML_ReadProperties(QsciLexerYAML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerYAML_QBaseReadProperties(QsciLexerYAML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerYAML_WriteProperties(const QsciLexerYAML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerYAML_QBaseWriteProperties(const QsciLexerYAML* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerYAML_ConnectNotify(QsciLexerYAML* self, QMetaMethod* signal);
    friend void QsciLexerYAML_QBaseConnectNotify(QsciLexerYAML* self, QMetaMethod* signal);
    friend void QsciLexerYAML_DisconnectNotify(QsciLexerYAML* self, QMetaMethod* signal);
    friend void QsciLexerYAML_QBaseDisconnectNotify(QsciLexerYAML* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerYAML_IsSignalConnected(const QsciLexerYAML* self, QMetaMethod* signal);
    friend bool QsciLexerYAML_QBaseIsSignalConnected(const QsciLexerYAML* self, QMetaMethod* signal);
};
