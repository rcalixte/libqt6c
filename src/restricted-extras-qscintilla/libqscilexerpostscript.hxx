...
class VirtualQsciLexerPostScript final : public QsciLexerPostScript {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerPostScript_ReadProperties(QsciLexerPostScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPostScript_QBaseReadProperties(QsciLexerPostScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPostScript_WriteProperties(const QsciLexerPostScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPostScript_QBaseWriteProperties(const QsciLexerPostScript* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerPostScript_ConnectNotify(QsciLexerPostScript* self, QMetaMethod* signal);
    friend void QsciLexerPostScript_QBaseConnectNotify(QsciLexerPostScript* self, QMetaMethod* signal);
    friend void QsciLexerPostScript_DisconnectNotify(QsciLexerPostScript* self, QMetaMethod* signal);
    friend void QsciLexerPostScript_QBaseDisconnectNotify(QsciLexerPostScript* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerPostScript_IsSignalConnected(const QsciLexerPostScript* self, QMetaMethod* signal);
    friend bool QsciLexerPostScript_QBaseIsSignalConnected(const QsciLexerPostScript* self, QMetaMethod* signal);
};
