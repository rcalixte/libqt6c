...
class VirtualQsciLexerCMake final : public QsciLexerCMake {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerCMake_ReadProperties(QsciLexerCMake* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCMake_QBaseReadProperties(QsciLexerCMake* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCMake_WriteProperties(const QsciLexerCMake* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCMake_QBaseWriteProperties(const QsciLexerCMake* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerCMake_ConnectNotify(QsciLexerCMake* self, QMetaMethod* signal);
    friend void QsciLexerCMake_QBaseConnectNotify(QsciLexerCMake* self, QMetaMethod* signal);
    friend void QsciLexerCMake_DisconnectNotify(QsciLexerCMake* self, QMetaMethod* signal);
    friend void QsciLexerCMake_QBaseDisconnectNotify(QsciLexerCMake* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerCMake_IsSignalConnected(const QsciLexerCMake* self, QMetaMethod* signal);
    friend bool QsciLexerCMake_QBaseIsSignalConnected(const QsciLexerCMake* self, QMetaMethod* signal);
};
