...
class VirtualQsciLexerProperties final : public QsciLexerProperties {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerProperties_ReadProperties(QsciLexerProperties* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerProperties_QBaseReadProperties(QsciLexerProperties* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerProperties_WriteProperties(const QsciLexerProperties* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerProperties_QBaseWriteProperties(const QsciLexerProperties* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerProperties_ConnectNotify(QsciLexerProperties* self, QMetaMethod* signal);
    friend void QsciLexerProperties_QBaseConnectNotify(QsciLexerProperties* self, QMetaMethod* signal);
    friend void QsciLexerProperties_DisconnectNotify(QsciLexerProperties* self, QMetaMethod* signal);
    friend void QsciLexerProperties_QBaseDisconnectNotify(QsciLexerProperties* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerProperties_IsSignalConnected(const QsciLexerProperties* self, QMetaMethod* signal);
    friend bool QsciLexerProperties_QBaseIsSignalConnected(const QsciLexerProperties* self, QMetaMethod* signal);
};
