...
class VirtualQsciLexerProperties final : public QsciLexerProperties {
  ...
  public:
    ...
    ~VirtualQsciLexerProperties() {
        qscilexerproperties_metaobject_callback = nullptr;
        qscilexerproperties_metacast_callback = nullptr;
        ...
        qscilexerproperties_defaultcolor2_callback = nullptr;
        qscilexerproperties_defaulteolfill_callback = nullptr;
        qscilexerproperties_defaultfont2_callback = nullptr;
        qscilexerproperties_defaultpaper2_callback = nullptr;
        ...
        qscilexerproperties_textasbytes_callback = nullptr;
        qscilexerproperties_bytesastext_callback = nullptr;
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        } else if (qscilexerproperties_metaobject_callback != nullptr) {
            QMetaObject* callback_ret = qscilexerproperties_metaobject_callback();
            return callback_ret;
        } else {
            return QsciLexerProperties::metaObject();
        }
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        } else if (qscilexerproperties_metacast_callback != nullptr) {
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexerproperties_autocompletionwordseparators_isbase) {
            ...
            const char** callback_ret = qscilexerproperties_autocompletionwordseparators_callback();
    ...
    virtual QColor defaultColor(int style) const override {
        ...
        } else if (qscilexerproperties_defaultcolor2_callback != nullptr) {
            int cbval1 = style;
    ...
    virtual QFont defaultFont(int style) const override {
        ...
        } else if (qscilexerproperties_defaultfont2_callback != nullptr) {
            int cbval1 = style;
    ...
    virtual QColor defaultPaper(int style) const override {
        ...
        } else if (qscilexerproperties_defaultpaper2_callback != nullptr) {
            int cbval1 = style;
    ...
    QByteArray textAsBytes(const QString& text) const {
        ...
        } else if (qscilexerproperties_textasbytes_callback != nullptr) {
    ...
    QString bytesAsText(const char* bytes, int size) const {
        ...
        } else if (qscilexerproperties_bytesastext_callback != nullptr) {
            const char* cbval1 = (const char*)bytes;
            int cbval2 = size;

            const char* callback_ret = qscilexerproperties_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret);
            return callback_ret_QString;
        } else {
            return QsciLexerProperties::bytesAsText(bytes, size);
    ...
    friend libqt_string QsciLexerProperties_QBaseTextAsBytes(const QsciLexerProperties* self, const libqt_string text);
    friend libqt_string QsciLexerProperties_BytesAsText(const QsciLexerProperties* self, const char* bytes, int size);
    friend libqt_string QsciLexerProperties_QBaseBytesAsText(const QsciLexerProperties* self, const char* bytes, int size);
