...
class VirtualQsciLexerVHDL final : public QsciLexerVHDL {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerVHDL_ReadProperties(QsciLexerVHDL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerVHDL_QBaseReadProperties(QsciLexerVHDL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerVHDL_WriteProperties(const QsciLexerVHDL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerVHDL_QBaseWriteProperties(const QsciLexerVHDL* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerVHDL_ConnectNotify(QsciLexerVHDL* self, QMetaMethod* signal);
    friend void QsciLexerVHDL_QBaseConnectNotify(QsciLexerVHDL* self, QMetaMethod* signal);
    friend void QsciLexerVHDL_DisconnectNotify(QsciLexerVHDL* self, QMetaMethod* signal);
    friend void QsciLexerVHDL_QBaseDisconnectNotify(QsciLexerVHDL* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerVHDL_IsSignalConnected(const QsciLexerVHDL* self, QMetaMethod* signal);
    friend bool QsciLexerVHDL_QBaseIsSignalConnected(const QsciLexerVHDL* self, QMetaMethod* signal);
};
