...
class VirtualQsciLexerSQL final : public QsciLexerSQL {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerSQL_ReadProperties(QsciLexerSQL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerSQL_QBaseReadProperties(QsciLexerSQL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerSQL_WriteProperties(const QsciLexerSQL* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerSQL_QBaseWriteProperties(const QsciLexerSQL* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerSQL_ConnectNotify(QsciLexerSQL* self, QMetaMethod* signal);
    friend void QsciLexerSQL_QBaseConnectNotify(QsciLexerSQL* self, QMetaMethod* signal);
    friend void QsciLexerSQL_DisconnectNotify(QsciLexerSQL* self, QMetaMethod* signal);
    friend void QsciLexerSQL_QBaseDisconnectNotify(QsciLexerSQL* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerSQL_IsSignalConnected(const QsciLexerSQL* self, QMetaMethod* signal);
    friend bool QsciLexerSQL_QBaseIsSignalConnected(const QsciLexerSQL* self, QMetaMethod* signal);
};
