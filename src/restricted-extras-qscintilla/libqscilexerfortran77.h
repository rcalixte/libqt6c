...
///
QMetaObject__Connection* q_scilexerfortran77_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
///
/// @param self QsciLexerFortran77*
/// @param callback char* func(QsciLexerFortran77* self, const char* text)
///
