...
class VirtualQsciLexerBatch final : public QsciLexerBatch {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerBatch_ReadProperties(QsciLexerBatch* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerBatch_QBaseReadProperties(QsciLexerBatch* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerBatch_WriteProperties(const QsciLexerBatch* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerBatch_QBaseWriteProperties(const QsciLexerBatch* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerBatch_ConnectNotify(QsciLexerBatch* self, QMetaMethod* signal);
    friend void QsciLexerBatch_QBaseConnectNotify(QsciLexerBatch* self, QMetaMethod* signal);
    friend void QsciLexerBatch_DisconnectNotify(QsciLexerBatch* self, QMetaMethod* signal);
    friend void QsciLexerBatch_QBaseDisconnectNotify(QsciLexerBatch* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerBatch_IsSignalConnected(const QsciLexerBatch* self, QMetaMethod* signal);
    friend bool QsciLexerBatch_QBaseIsSignalConnected(const QsciLexerBatch* self, QMetaMethod* signal);
};
