...
class VirtualQsciLexerRuby final : public QsciLexerRuby {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerRuby_ReadProperties(QsciLexerRuby* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerRuby_QBaseReadProperties(QsciLexerRuby* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerRuby_WriteProperties(const QsciLexerRuby* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerRuby_QBaseWriteProperties(const QsciLexerRuby* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerRuby_ConnectNotify(QsciLexerRuby* self, QMetaMethod* signal);
    friend void QsciLexerRuby_QBaseConnectNotify(QsciLexerRuby* self, QMetaMethod* signal);
    friend void QsciLexerRuby_DisconnectNotify(QsciLexerRuby* self, QMetaMethod* signal);
    friend void QsciLexerRuby_QBaseDisconnectNotify(QsciLexerRuby* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerRuby_IsSignalConnected(const QsciLexerRuby* self, QMetaMethod* signal);
    friend bool QsciLexerRuby_QBaseIsSignalConnected(const QsciLexerRuby* self, QMetaMethod* signal);
};
