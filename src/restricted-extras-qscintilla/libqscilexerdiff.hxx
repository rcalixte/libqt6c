...
class VirtualQsciLexerDiff final : public QsciLexerDiff {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerDiff_ReadProperties(QsciLexerDiff* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerDiff_QBaseReadProperties(QsciLexerDiff* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerDiff_WriteProperties(const QsciLexerDiff* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerDiff_QBaseWriteProperties(const QsciLexerDiff* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerDiff_ConnectNotify(QsciLexerDiff* self, QMetaMethod* signal);
    friend void QsciLexerDiff_QBaseConnectNotify(QsciLexerDiff* self, QMetaMethod* signal);
    friend void QsciLexerDiff_DisconnectNotify(QsciLexerDiff* self, QMetaMethod* signal);
    friend void QsciLexerDiff_QBaseDisconnectNotify(QsciLexerDiff* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerDiff_IsSignalConnected(const QsciLexerDiff* self, QMetaMethod* signal);
    friend bool QsciLexerDiff_QBaseIsSignalConnected(const QsciLexerDiff* self, QMetaMethod* signal);
};
