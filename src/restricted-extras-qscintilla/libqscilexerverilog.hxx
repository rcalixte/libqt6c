...
class VirtualQsciLexerVerilog final : public QsciLexerVerilog {
  ...
  public:
    ...
    using QsciLexerVerilog_AutoCompletionWordSeparators_Callback = libqt_list /* of libqt_string */ (*)();
  ...
  public:
    ...
    virtual QString description(int style) const override {
        if (qscilexerverilog_description_callback != nullptr) {
            ...
            libqt_string callback_ret = qscilexerverilog_description_callback(this, cbval1);
    ...
    // Friend functions
    friend bool QsciLexerVerilog_ReadProperties(QsciLexerVerilog* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerVerilog_QBaseReadProperties(QsciLexerVerilog* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerVerilog_WriteProperties(const QsciLexerVerilog* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerVerilog_QBaseWriteProperties(const QsciLexerVerilog* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerVerilog_ConnectNotify(QsciLexerVerilog* self, QMetaMethod* signal);
    friend void QsciLexerVerilog_QBaseConnectNotify(QsciLexerVerilog* self, QMetaMethod* signal);
    friend void QsciLexerVerilog_DisconnectNotify(QsciLexerVerilog* self, QMetaMethod* signal);
    friend void QsciLexerVerilog_QBaseDisconnectNotify(QsciLexerVerilog* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerVerilog_IsSignalConnected(const QsciLexerVerilog* self, QMetaMethod* signal);
    friend bool QsciLexerVerilog_QBaseIsSignalConnected(const QsciLexerVerilog* self, QMetaMethod* signal);
};
