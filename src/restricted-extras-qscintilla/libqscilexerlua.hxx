...
class VirtualQsciLexerLua final : public QsciLexerLua {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerLua_ReadProperties(QsciLexerLua* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerLua_QBaseReadProperties(QsciLexerLua* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerLua_WriteProperties(const QsciLexerLua* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerLua_QBaseWriteProperties(const QsciLexerLua* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerLua_ConnectNotify(QsciLexerLua* self, QMetaMethod* signal);
    friend void QsciLexerLua_QBaseConnectNotify(QsciLexerLua* self, QMetaMethod* signal);
    friend void QsciLexerLua_DisconnectNotify(QsciLexerLua* self, QMetaMethod* signal);
    friend void QsciLexerLua_QBaseDisconnectNotify(QsciLexerLua* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerLua_IsSignalConnected(const QsciLexerLua* self, QMetaMethod* signal);
    friend bool QsciLexerLua_QBaseIsSignalConnected(const QsciLexerLua* self, QMetaMethod* signal);
};
