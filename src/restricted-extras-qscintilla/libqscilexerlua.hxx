...
class VirtualQsciLexerLua final : public QsciLexerLua {
  ...
  public:
    ...
    ~VirtualQsciLexerLua() {
        qscilexerlua_metaobject_callback = nullptr;
        qscilexerlua_metacast_callback = nullptr;
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        } else if (qscilexerlua_metaobject_callback != nullptr) {
            QMetaObject* callback_ret = qscilexerlua_metaobject_callback();
            return callback_ret;
        } else {
            return QsciLexerLua::metaObject();
        }
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        } else if (qscilexerlua_metacast_callback != nullptr) {
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexerlua_autocompletionwordseparators_isbase) {
            ...
            const char** callback_ret = qscilexerlua_autocompletionwordseparators_callback();
    ...
    QString bytesAsText(const char* bytes, int size) const {
        if (qscilexerlua_bytesastext_isbase) {
            ...
            const char* callback_ret = qscilexerlua_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret);
            return callback_ret_QString;
        } else {
            return QsciLexerLua::bytesAsText(bytes, size);
