...
class VirtualQsciLexerMakefile final : public QsciLexerMakefile {
  ...
  public:
    ...
    ~VirtualQsciLexerMakefile() {
        qscilexermakefile_metaobject_callback = nullptr;
        qscilexermakefile_metacast_callback = nullptr;
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        } else if (qscilexermakefile_metaobject_callback != nullptr) {
            QMetaObject* callback_ret = qscilexermakefile_metaobject_callback();
            return callback_ret;
        } else {
            return QsciLexerMakefile::metaObject();
        }
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        } else if (qscilexermakefile_metacast_callback != nullptr) {
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexermakefile_autocompletionwordseparators_isbase) {
            ...
            const char** callback_ret = qscilexermakefile_autocompletionwordseparators_callback();
    ...
    QString bytesAsText(const char* bytes, int size) const {
        if (qscilexermakefile_bytesastext_isbase) {
            ...
            const char* callback_ret = qscilexermakefile_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret);
            return callback_ret_QString;
        } else {
            return QsciLexerMakefile::bytesAsText(bytes, size);
