...
class VirtualQsciLexerMakefile final : public QsciLexerMakefile {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerMakefile_ReadProperties(QsciLexerMakefile* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMakefile_QBaseReadProperties(QsciLexerMakefile* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMakefile_WriteProperties(const QsciLexerMakefile* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerMakefile_QBaseWriteProperties(const QsciLexerMakefile* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerMakefile_ConnectNotify(QsciLexerMakefile* self, QMetaMethod* signal);
    friend void QsciLexerMakefile_QBaseConnectNotify(QsciLexerMakefile* self, QMetaMethod* signal);
    friend void QsciLexerMakefile_DisconnectNotify(QsciLexerMakefile* self, QMetaMethod* signal);
    friend void QsciLexerMakefile_QBaseDisconnectNotify(QsciLexerMakefile* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerMakefile_IsSignalConnected(const QsciLexerMakefile* self, QMetaMethod* signal);
    friend bool QsciLexerMakefile_QBaseIsSignalConnected(const QsciLexerMakefile* self, QMetaMethod* signal);
};
