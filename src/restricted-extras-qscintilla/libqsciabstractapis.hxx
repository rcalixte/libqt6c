  ...
  public:
    ...
    virtual void updateAutoCompletionList(const QStringList& context, QStringList& list) override {
        if (qsciabstractapis_updateautocompletionlist_callback != nullptr) {
            ...
            context_out.data.ptr = static_cast<void*>(context_arr);
            ...
            list_out.data.ptr = static_cast<void*>(list_arr);
    ...
    virtual QStringList callTips(const QStringList& context, int commas, QsciScintilla::CallTipsStyle style, QList<int>& shifts) override {
        if (qsciabstractapis_calltips_callback != nullptr) {
            ...
            shifts_out.data.ints = shifts_arr;
    ...
    friend void QsciAbstractAPIs_ConnectNotify(QsciAbstractAPIs* self, QMetaMethod* signal);
    friend void QsciAbstractAPIs_QBaseConnectNotify(QsciAbstractAPIs* self, QMetaMethod* signal);
    friend void QsciAbstractAPIs_DisconnectNotify(QsciAbstractAPIs* self, QMetaMethod* signal);
    friend void QsciAbstractAPIs_QBaseDisconnectNotify(QsciAbstractAPIs* self, QMetaMethod* signal);
    ...
    friend bool QsciAbstractAPIs_IsSignalConnected(const QsciAbstractAPIs* self, QMetaMethod* signal);
    friend bool QsciAbstractAPIs_QBaseIsSignalConnected(const QsciAbstractAPIs* self, QMetaMethod* signal);
};
