...
class VirtualQsciLexerFortran77 final : public QsciLexerFortran77 {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerFortran77_ReadProperties(QsciLexerFortran77* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerFortran77_QBaseReadProperties(QsciLexerFortran77* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerFortran77_WriteProperties(const QsciLexerFortran77* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerFortran77_QBaseWriteProperties(const QsciLexerFortran77* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerFortran77_ConnectNotify(QsciLexerFortran77* self, QMetaMethod* signal);
    friend void QsciLexerFortran77_QBaseConnectNotify(QsciLexerFortran77* self, QMetaMethod* signal);
    friend void QsciLexerFortran77_DisconnectNotify(QsciLexerFortran77* self, QMetaMethod* signal);
    friend void QsciLexerFortran77_QBaseDisconnectNotify(QsciLexerFortran77* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerFortran77_IsSignalConnected(const QsciLexerFortran77* self, QMetaMethod* signal);
    friend bool QsciLexerFortran77_QBaseIsSignalConnected(const QsciLexerFortran77* self, QMetaMethod* signal);
};
