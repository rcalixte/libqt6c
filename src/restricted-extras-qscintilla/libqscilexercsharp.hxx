...
class VirtualQsciLexerCSharp final : public QsciLexerCSharp {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerCSharp_ReadProperties(QsciLexerCSharp* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCSharp_QBaseReadProperties(QsciLexerCSharp* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCSharp_WriteProperties(const QsciLexerCSharp* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCSharp_QBaseWriteProperties(const QsciLexerCSharp* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerCSharp_ConnectNotify(QsciLexerCSharp* self, QMetaMethod* signal);
    friend void QsciLexerCSharp_QBaseConnectNotify(QsciLexerCSharp* self, QMetaMethod* signal);
    friend void QsciLexerCSharp_DisconnectNotify(QsciLexerCSharp* self, QMetaMethod* signal);
    friend void QsciLexerCSharp_QBaseDisconnectNotify(QsciLexerCSharp* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerCSharp_IsSignalConnected(const QsciLexerCSharp* self, QMetaMethod* signal);
    friend bool QsciLexerCSharp_QBaseIsSignalConnected(const QsciLexerCSharp* self, QMetaMethod* signal);
};
