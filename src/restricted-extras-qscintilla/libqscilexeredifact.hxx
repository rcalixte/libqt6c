...
class VirtualQsciLexerEDIFACT final : public QsciLexerEDIFACT {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerEDIFACT_ReadProperties(QsciLexerEDIFACT* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerEDIFACT_QBaseReadProperties(QsciLexerEDIFACT* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerEDIFACT_WriteProperties(const QsciLexerEDIFACT* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerEDIFACT_QBaseWriteProperties(const QsciLexerEDIFACT* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerEDIFACT_ConnectNotify(QsciLexerEDIFACT* self, QMetaMethod* signal);
    friend void QsciLexerEDIFACT_QBaseConnectNotify(QsciLexerEDIFACT* self, QMetaMethod* signal);
    friend void QsciLexerEDIFACT_DisconnectNotify(QsciLexerEDIFACT* self, QMetaMethod* signal);
    friend void QsciLexerEDIFACT_QBaseDisconnectNotify(QsciLexerEDIFACT* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerEDIFACT_IsSignalConnected(const QsciLexerEDIFACT* self, QMetaMethod* signal);
    friend bool QsciLexerEDIFACT_QBaseIsSignalConnected(const QsciLexerEDIFACT* self, QMetaMethod* signal);
};
