...
class VirtualQsciLexerPython final : public QsciLexerPython {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerPython_ReadProperties(QsciLexerPython* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPython_QBaseReadProperties(QsciLexerPython* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPython_WriteProperties(const QsciLexerPython* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPython_QBaseWriteProperties(const QsciLexerPython* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerPython_ConnectNotify(QsciLexerPython* self, QMetaMethod* signal);
    friend void QsciLexerPython_QBaseConnectNotify(QsciLexerPython* self, QMetaMethod* signal);
    friend void QsciLexerPython_DisconnectNotify(QsciLexerPython* self, QMetaMethod* signal);
    friend void QsciLexerPython_QBaseDisconnectNotify(QsciLexerPython* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerPython_IsSignalConnected(const QsciLexerPython* self, QMetaMethod* signal);
    friend bool QsciLexerPython_QBaseIsSignalConnected(const QsciLexerPython* self, QMetaMethod* signal);
};
