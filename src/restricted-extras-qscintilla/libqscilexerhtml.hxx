...
class VirtualQsciLexerHTML final : public QsciLexerHTML {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerHTML_ReadProperties(QsciLexerHTML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerHTML_QBaseReadProperties(QsciLexerHTML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerHTML_WriteProperties(const QsciLexerHTML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerHTML_QBaseWriteProperties(const QsciLexerHTML* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerHTML_ConnectNotify(QsciLexerHTML* self, QMetaMethod* signal);
    friend void QsciLexerHTML_QBaseConnectNotify(QsciLexerHTML* self, QMetaMethod* signal);
    friend void QsciLexerHTML_DisconnectNotify(QsciLexerHTML* self, QMetaMethod* signal);
    friend void QsciLexerHTML_QBaseDisconnectNotify(QsciLexerHTML* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerHTML_IsSignalConnected(const QsciLexerHTML* self, QMetaMethod* signal);
    friend bool QsciLexerHTML_QBaseIsSignalConnected(const QsciLexerHTML* self, QMetaMethod* signal);
};
