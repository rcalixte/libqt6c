...
class VirtualQsciLexerBash final : public QsciLexerBash {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerBash_ReadProperties(QsciLexerBash* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerBash_QBaseReadProperties(QsciLexerBash* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerBash_WriteProperties(const QsciLexerBash* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerBash_QBaseWriteProperties(const QsciLexerBash* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerBash_ConnectNotify(QsciLexerBash* self, QMetaMethod* signal);
    friend void QsciLexerBash_QBaseConnectNotify(QsciLexerBash* self, QMetaMethod* signal);
    friend void QsciLexerBash_DisconnectNotify(QsciLexerBash* self, QMetaMethod* signal);
    friend void QsciLexerBash_QBaseDisconnectNotify(QsciLexerBash* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerBash_IsSignalConnected(const QsciLexerBash* self, QMetaMethod* signal);
    friend bool QsciLexerBash_QBaseIsSignalConnected(const QsciLexerBash* self, QMetaMethod* signal);
};
