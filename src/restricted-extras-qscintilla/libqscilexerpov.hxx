...
class VirtualQsciLexerPOV final : public QsciLexerPOV {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerPOV_ReadProperties(QsciLexerPOV* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPOV_QBaseReadProperties(QsciLexerPOV* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPOV_WriteProperties(const QsciLexerPOV* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerPOV_QBaseWriteProperties(const QsciLexerPOV* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerPOV_ConnectNotify(QsciLexerPOV* self, QMetaMethod* signal);
    friend void QsciLexerPOV_QBaseConnectNotify(QsciLexerPOV* self, QMetaMethod* signal);
    friend void QsciLexerPOV_DisconnectNotify(QsciLexerPOV* self, QMetaMethod* signal);
    friend void QsciLexerPOV_QBaseDisconnectNotify(QsciLexerPOV* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerPOV_IsSignalConnected(const QsciLexerPOV* self, QMetaMethod* signal);
    friend bool QsciLexerPOV_QBaseIsSignalConnected(const QsciLexerPOV* self, QMetaMethod* signal);
};
