...
class VirtualQsciLexerTekHex final : public QsciLexerTekHex {
  ...
  public:
    ...
    ~VirtualQsciLexerTekHex() {
        qscilexertekhex_metaobject_callback = nullptr;
        qscilexertekhex_metacast_callback = nullptr;
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        } else if (qscilexertekhex_metaobject_callback != nullptr) {
            QMetaObject* callback_ret = qscilexertekhex_metaobject_callback();
            return callback_ret;
        } else {
            return QsciLexerTekHex::metaObject();
        }
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        } else if (qscilexertekhex_metacast_callback != nullptr) {
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexertekhex_autocompletionwordseparators_isbase) {
            ...
            const char** callback_ret = qscilexertekhex_autocompletionwordseparators_callback();
    ...
    QString bytesAsText(const char* bytes, int size) const {
        if (qscilexertekhex_bytesastext_isbase) {
            ...
            const char* callback_ret = qscilexertekhex_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret);
            return callback_ret_QString;
        } else {
            return QsciLexerTekHex::bytesAsText(bytes, size);
