...
class VirtualQsciLexerFortran final : public QsciLexerFortran {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerFortran_ReadProperties(QsciLexerFortran* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerFortran_QBaseReadProperties(QsciLexerFortran* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerFortran_WriteProperties(const QsciLexerFortran* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerFortran_QBaseWriteProperties(const QsciLexerFortran* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerFortran_ConnectNotify(QsciLexerFortran* self, QMetaMethod* signal);
    friend void QsciLexerFortran_QBaseConnectNotify(QsciLexerFortran* self, QMetaMethod* signal);
    friend void QsciLexerFortran_DisconnectNotify(QsciLexerFortran* self, QMetaMethod* signal);
    friend void QsciLexerFortran_QBaseDisconnectNotify(QsciLexerFortran* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerFortran_IsSignalConnected(const QsciLexerFortran* self, QMetaMethod* signal);
    friend bool QsciLexerFortran_QBaseIsSignalConnected(const QsciLexerFortran* self, QMetaMethod* signal);
};
