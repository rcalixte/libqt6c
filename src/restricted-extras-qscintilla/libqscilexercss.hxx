...
class VirtualQsciLexerCSS final : public QsciLexerCSS {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerCSS_ReadProperties(QsciLexerCSS* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCSS_QBaseReadProperties(QsciLexerCSS* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCSS_WriteProperties(const QsciLexerCSS* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCSS_QBaseWriteProperties(const QsciLexerCSS* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerCSS_ConnectNotify(QsciLexerCSS* self, QMetaMethod* signal);
    friend void QsciLexerCSS_QBaseConnectNotify(QsciLexerCSS* self, QMetaMethod* signal);
    friend void QsciLexerCSS_DisconnectNotify(QsciLexerCSS* self, QMetaMethod* signal);
    friend void QsciLexerCSS_QBaseDisconnectNotify(QsciLexerCSS* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerCSS_IsSignalConnected(const QsciLexerCSS* self, QMetaMethod* signal);
    friend bool QsciLexerCSS_QBaseIsSignalConnected(const QsciLexerCSS* self, QMetaMethod* signal);
};
