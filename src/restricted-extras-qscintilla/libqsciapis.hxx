...
class VirtualQsciAPIs final : public QsciAPIs {
  ...
  public:
    ...
    friend void QsciAPIs_ConnectNotify(QsciAPIs* self, QMetaMethod* signal);
    friend void QsciAPIs_QBaseConnectNotify(QsciAPIs* self, QMetaMethod* signal);
    friend void QsciAPIs_DisconnectNotify(QsciAPIs* self, QMetaMethod* signal);
    friend void QsciAPIs_QBaseDisconnectNotify(QsciAPIs* self, QMetaMethod* signal);
    ...
    friend bool QsciAPIs_IsSignalConnected(const QsciAPIs* self, QMetaMethod* signal);
    friend bool QsciAPIs_QBaseIsSignalConnected(const QsciAPIs* self, QMetaMethod* signal);
};
