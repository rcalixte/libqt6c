...
const char** q_scilexermatlab_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_scilexermatlab_dynamic_property_names\n");
        abort();
    }
...
const char** q_scilexermatlab_auto_completion_word_separators(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_scilexermatlab_auto_completion_word_separators\n");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
void q_scilexermatlab_on_set_editor(void* self, void (*callback)(void*, void*)) {
    QsciLexerMatlab_OnSetEditor((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_refresh_properties(void* self, void (*callback)()) {
    QsciLexerMatlab_OnRefreshProperties((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_set_auto_indent_style(void* self, void (*callback)(void*, int)) {
    QsciLexerMatlab_OnSetAutoIndentStyle((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_set_color(void* self, void (*callback)(void*, void*, int)) {
    QsciLexerMatlab_OnSetColor((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_set_eol_fill(void* self, void (*callback)(void*, bool, int)) {
    QsciLexerMatlab_OnSetEolFill((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_set_font(void* self, void (*callback)(void*, void*, int)) {
    QsciLexerMatlab_OnSetFont((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_set_paper(void* self, void (*callback)(void*, void*, int)) {
    QsciLexerMatlab_OnSetPaper((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_read_properties(void* self, bool (*callback)(void*, void*, const char*)) {
    QsciLexerMatlab_OnReadProperties((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_event(void* self, bool (*callback)(void*, void*)) {
    QsciLexerMatlab_OnEvent((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    QsciLexerMatlab_OnEventFilter((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_timer_event(void* self, void (*callback)(void*, void*)) {
    QsciLexerMatlab_OnTimerEvent((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_child_event(void* self, void (*callback)(void*, void*)) {
    QsciLexerMatlab_OnChildEvent((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_custom_event(void* self, void (*callback)(void*, void*)) {
    QsciLexerMatlab_OnCustomEvent((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_connect_notify(void* self, void (*callback)(void*, void*)) {
    QsciLexerMatlab_OnConnectNotify((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_disconnect_notify(void* self, void (*callback)(void*, void*)) {
    QsciLexerMatlab_OnDisconnectNotify((QsciLexerMatlab*)self, (intptr_t)callback);
}

char* q_scilexermatlab_text_as_bytes(void* self, const char* text) {
    libqt_string _str = QsciLexerMatlab_TextAsBytes((QsciLexerMatlab*)self, qstring(text));
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void q_scilexermatlab_on_text_as_bytes(void* self, char* (*callback)(void*, const char*)) {
    QsciLexerMatlab_OnTextAsBytes((QsciLexerMatlab*)self, (intptr_t)callback);
}

const char* q_scilexermatlab_bytes_as_text(void* self, const char* bytes, int size) {
    libqt_string _str = QsciLexerMatlab_BytesAsText((QsciLexerMatlab*)self, bytes, size);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void q_scilexermatlab_on_bytes_as_text(void* self, const char* (*callback)(void*, const char*, int)) {
    QsciLexerMatlab_OnBytesAsText((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_sender(void* self, QObject* (*callback)()) {
    QsciLexerMatlab_OnSender((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_sender_signal_index(void* self, int32_t (*callback)()) {
    QsciLexerMatlab_OnSenderSignalIndex((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_receivers(void* self, int32_t (*callback)(void*, const char*)) {
    QsciLexerMatlab_OnReceivers((QsciLexerMatlab*)self, (intptr_t)callback);
}
...
void q_scilexermatlab_on_is_signal_connected(void* self, bool (*callback)(void*, void*)) {
    QsciLexerMatlab_OnIsSignalConnected((QsciLexerMatlab*)self, (intptr_t)callback);
}
