...
class VirtualQsciLexerJSON final : public QsciLexerJSON {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerJSON_ReadProperties(QsciLexerJSON* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJSON_QBaseReadProperties(QsciLexerJSON* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJSON_WriteProperties(const QsciLexerJSON* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerJSON_QBaseWriteProperties(const QsciLexerJSON* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerJSON_ConnectNotify(QsciLexerJSON* self, QMetaMethod* signal);
    friend void QsciLexerJSON_QBaseConnectNotify(QsciLexerJSON* self, QMetaMethod* signal);
    friend void QsciLexerJSON_DisconnectNotify(QsciLexerJSON* self, QMetaMethod* signal);
    friend void QsciLexerJSON_QBaseDisconnectNotify(QsciLexerJSON* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerJSON_IsSignalConnected(const QsciLexerJSON* self, QMetaMethod* signal);
    friend bool QsciLexerJSON_QBaseIsSignalConnected(const QsciLexerJSON* self, QMetaMethod* signal);
};
