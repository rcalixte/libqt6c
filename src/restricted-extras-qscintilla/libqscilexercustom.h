...
/// @param self QsciLexerCustom*
///
const QMetaObject* q_scilexercustom_qbase_meta_object(void* self);
...
/// @param param1 const char*
///
void* q_scilexercustom_qbase_metacast(void* self, const char* param1);
...
///
QMetaObject__Connection* q_scilexercustom_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
///
/// @param self QsciLexerCustom*
/// @param callback char* func(QsciLexerCustom* self, const char* text)
///
void q_scilexercustom_on_text_as_bytes(void* self, char* (*callback)(void*, const char*));
