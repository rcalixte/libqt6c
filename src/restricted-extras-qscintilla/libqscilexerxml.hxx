...
class VirtualQsciLexerXML final : public QsciLexerXML {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerXML_ReadProperties(QsciLexerXML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerXML_QBaseReadProperties(QsciLexerXML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerXML_WriteProperties(const QsciLexerXML* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerXML_QBaseWriteProperties(const QsciLexerXML* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerXML_ConnectNotify(QsciLexerXML* self, QMetaMethod* signal);
    friend void QsciLexerXML_QBaseConnectNotify(QsciLexerXML* self, QMetaMethod* signal);
    friend void QsciLexerXML_DisconnectNotify(QsciLexerXML* self, QMetaMethod* signal);
    friend void QsciLexerXML_QBaseDisconnectNotify(QsciLexerXML* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerXML_IsSignalConnected(const QsciLexerXML* self, QMetaMethod* signal);
    friend bool QsciLexerXML_QBaseIsSignalConnected(const QsciLexerXML* self, QMetaMethod* signal);
};
