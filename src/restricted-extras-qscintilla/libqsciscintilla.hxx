...
class VirtualQsciScintilla final : public QsciScintilla {
  ...
  public:
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        auto metaobject_cb = qsciscintilla_metaobject_callback;
        if (metaobject_cb) {
    ...
    virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
        ...
        auto metacall_cb = qsciscintilla_metacall_callback;
        if (metacall_cb) {
    ...
    virtual QList<QString> apiContext(int pos, int& context_start, int& last_word_start) override {
        ...
        auto apicontext_cb = qsciscintilla_apicontext_callback;
        if (apicontext_cb) {
            int cbval1 = pos;
    ...
    virtual bool findFirst(const QString& expr, bool re, bool cs, bool wo, bool wrap, bool forward, int line, int index, bool show, bool posix, bool cxx11) override {
        ...
        if (findfirst_cb) {
            ...
            char* expr_str = static_cast<char*>(malloc(expr_str_len + 1));
            memcpy(expr_str, expr_b.data(), expr_str_len);
    ...
    virtual bool findNext() override {
        ...
        auto findnext_cb = qsciscintilla_findnext_callback;
        if (findnext_cb) {
            bool callback_ret = findnext_cb();
            return callback_ret;
        }
        return QsciScintilla::findNext();
    }
    ...
    virtual void recolor(int start, int end) override {
        ...
        auto recolor_cb = qsciscintilla_recolor_callback;
        if (recolor_cb) {
            int cbval1 = start;
            int cbval2 = end;
    ...
    virtual void replace(const QString& replaceStr) override {
        ...
        if (replace_cb) {
            ...
            char* replaceStr_str = static_cast<char*>(malloc(replaceStr_str_len + 1));
            memcpy(replaceStr_str, replaceStr_b.data(), replaceStr_str_len);
            replaceStr_str[replaceStr_str_len] = '\0';
    ...
    virtual void autoCompleteFromAll() override {
        ...
        auto autocompletefromall_cb = qsciscintilla_autocompletefromall_callback;
        if (autocompletefromall_cb) {
            autocompletefromall_cb();
            return;
        }
        QsciScintilla::autoCompleteFromAll();
    }
    ...
    virtual void autoCompleteFromAPIs() override {
        ...
        auto autocompletefromapis_cb = qsciscintilla_autocompletefromapis_callback;
        if (autocompletefromapis_cb) {
            autocompletefromapis_cb();
            return;
        }
        QsciScintilla::autoCompleteFromAPIs();
    }
    ...
    virtual void autoCompleteFromDocument() override {
        ...
        auto autocompletefromdocument_cb = qsciscintilla_autocompletefromdocument_callback;
        if (autocompletefromdocument_cb) {
            autocompletefromdocument_cb();
            return;
        }
        QsciScintilla::autoCompleteFromDocument();
    }
    ...
    virtual void callTip() override {
        ...
        auto calltip_cb = qsciscintilla_calltip_callback;
        if (calltip_cb) {
            calltip_cb();
            return;
        }
    ...
    virtual void clear() override {
        ...
        auto clear_cb = qsciscintilla_clear_callback;
        if (clear_cb) {
            clear_cb();
            return;
        }
    ...
    virtual void copy() override {
        ...
        auto copy_cb = qsciscintilla_copy_callback;
        if (copy_cb) {
            copy_cb();
            return;
        }
    ...
    virtual void cut() override {
        ...
        auto cut_cb = qsciscintilla_cut_callback;
        if (cut_cb) {
            cut_cb();
            return;
        }
    ...
    virtual void ensureCursorVisible() override {
        ...
        auto ensurecursorvisible_cb = qsciscintilla_ensurecursorvisible_callback;
        if (ensurecursorvisible_cb) {
            ensurecursorvisible_cb();
            return;
        }
        QsciScintilla::ensureCursorVisible();
    }
    ...
    virtual void moveToMatchingBrace() override {
        ...
        auto movetomatchingbrace_cb = qsciscintilla_movetomatchingbrace_callback;
        if (movetomatchingbrace_cb) {
            movetomatchingbrace_cb();
            return;
        }
        QsciScintilla::moveToMatchingBrace();
    }
    ...
    virtual void paste() override {
        ...
        auto paste_cb = qsciscintilla_paste_callback;
        if (paste_cb) {
            paste_cb();
            return;
        }
    ...
    virtual void redo() override {
        ...
        auto redo_cb = qsciscintilla_redo_callback;
        if (redo_cb) {
            redo_cb();
            return;
        }
    ...
    virtual void removeSelectedText() override {
        ...
        auto removeselectedtext_cb = qsciscintilla_removeselectedtext_callback;
        if (removeselectedtext_cb) {
            removeselectedtext_cb();
            return;
        }
        QsciScintilla::removeSelectedText();
    }
    ...
    virtual void resetSelectionBackgroundColor() override {
        ...
        auto resetselectionbackgroundcolor_cb = qsciscintilla_resetselectionbackgroundcolor_callback;
        if (resetselectionbackgroundcolor_cb) {
            resetselectionbackgroundcolor_cb();
            return;
        }
        QsciScintilla::resetSelectionBackgroundColor();
    }
    ...
    virtual void resetSelectionForegroundColor() override {
        ...
        auto resetselectionforegroundcolor_cb = qsciscintilla_resetselectionforegroundcolor_callback;
        if (resetselectionforegroundcolor_cb) {
            resetselectionforegroundcolor_cb();
            return;
        }
        QsciScintilla::resetSelectionForegroundColor();
    }
    ...
    virtual void selectToMatchingBrace() override {
        ...
        auto selecttomatchingbrace_cb = qsciscintilla_selecttomatchingbrace_callback;
        if (selecttomatchingbrace_cb) {
            selecttomatchingbrace_cb();
            return;
        }
        QsciScintilla::selectToMatchingBrace();
    }
    ...
    virtual void setCaretForegroundColor(const QColor& col) override {
        ...
        auto setcaretforegroundcolor_cb = qsciscintilla_setcaretforegroundcolor_callback;
        if (setcaretforegroundcolor_cb) {
    ...
    virtual void setCaretLineBackgroundColor(const QColor& col) override {
        ...
        auto setcaretlinebackgroundcolor_cb = qsciscintilla_setcaretlinebackgroundcolor_callback;
        if (setcaretlinebackgroundcolor_cb) {
            const QColor& col_ret = col;
            // Cast returned reference into pointer
            QColor* cbval1 = const_cast<QColor*>(&col_ret);
    ...
    virtual void setColor(const QColor& c) override {
        ...
        auto setcolor_cb = qsciscintilla_setcolor_callback;
        if (setcolor_cb) {
    ...
    virtual void setCursorPosition(int line, int index) override {
        ...
        auto setcursorposition_cb = qsciscintilla_setcursorposition_callback;
    ...
    virtual void setFolding(QsciScintilla::FoldStyle fold, int margin) override {
        ...
        auto setfolding_cb = qsciscintilla_setfolding_callback;
        if (setfolding_cb) {
    ...
    virtual void setIndentation(int line, int indentation) override {
        ...
        auto setindentation_cb = qsciscintilla_setindentation_callback;
    ...
    virtual void setIndentationGuidesBackgroundColor(const QColor& col) override {
        ...
        auto setindentationguidesbackgroundcolor_cb = qsciscintilla_setindentationguidesbackgroundcolor_callback;
        if (setindentationguidesbackgroundcolor_cb) {
            const QColor& col_ret = col;
            // Cast returned reference into pointer
            QColor* cbval1 = const_cast<QColor*>(&col_ret);
    ...
    virtual void setIndentationGuidesForegroundColor(const QColor& col) override {
        ...
        auto setindentationguidesforegroundcolor_cb = qsciscintilla_setindentationguidesforegroundcolor_callback;
        if (setindentationguidesforegroundcolor_cb) {
            const QColor& col_ret = col;
            // Cast returned reference into pointer
            QColor* cbval1 = const_cast<QColor*>(&col_ret);
    ...
    virtual void setMarginsBackgroundColor(const QColor& col) override {
        ...
        auto setmarginsbackgroundcolor_cb = qsciscintilla_setmarginsbackgroundcolor_callback;
        if (setmarginsbackgroundcolor_cb) {
            const QColor& col_ret = col;
            // Cast returned reference into pointer
            QColor* cbval1 = const_cast<QColor*>(&col_ret);
    ...
    virtual void setMarginsFont(const QFont& f) override {
        ...
        auto setmarginsfont_cb = qsciscintilla_setmarginsfont_callback;
        if (setmarginsfont_cb) {
            const QFont& f_ret = f;
            // Cast returned reference into pointer
    ...
    virtual void setMarginsForegroundColor(const QColor& col) override {
        ...
        auto setmarginsforegroundcolor_cb = qsciscintilla_setmarginsforegroundcolor_callback;
        if (setmarginsforegroundcolor_cb) {
            const QColor& col_ret = col;
            // Cast returned reference into pointer
            QColor* cbval1 = const_cast<QColor*>(&col_ret);
    ...
    virtual void setMarginLineNumbers(int margin, bool lnrs) override {
        ...
        auto setmarginlinenumbers_cb = qsciscintilla_setmarginlinenumbers_callback;
    ...
    virtual void setMarginMarkerMask(int margin, int mask) override {
        ...
        auto setmarginmarkermask_cb = qsciscintilla_setmarginmarkermask_callback;
    ...
    virtual void setMarginSensitivity(int margin, bool sens) override {
        ...
        auto setmarginsensitivity_cb = qsciscintilla_setmarginsensitivity_callback;
    ...
    virtual void setMarginWidth(int margin, int width) override {
        ...
        auto setmarginwidth_cb = qsciscintilla_setmarginwidth_callback;
    ...
    virtual void setMarginWidth(int margin, const QString& s) override {
        ...
        if (setmarginwidth2_cb) {
            ...
            char* s_str = static_cast<char*>(malloc(s_str_len + 1));
            memcpy(s_str, s_b.data(), s_str_len);
            s_str[s_str_len] = '\0';
    ...
    virtual void setPaper(const QColor& c) override {
        ...
        auto setpaper_cb = qsciscintilla_setpaper_callback;
        if (setpaper_cb) {
            const QColor& c_ret = c;
            // Cast returned reference into pointer
            QColor* cbval1 = const_cast<QColor*>(&c_ret);
    ...
    virtual void setSelection(int lineFrom, int indexFrom, int lineTo, int indexTo) override {
        ...
        auto setselection_cb = qsciscintilla_setselection_callback;
        if (setselection_cb) {
            int cbval1 = lineFrom;
    ...
    virtual void setSelectionBackgroundColor(const QColor& col) override {
        ...
        auto setselectionbackgroundcolor_cb = qsciscintilla_setselectionbackgroundcolor_callback;
        if (setselectionbackgroundcolor_cb) {
            const QColor& col_ret = col;
            // Cast returned reference into pointer
            QColor* cbval1 = const_cast<QColor*>(&col_ret);
    ...
    virtual void setSelectionForegroundColor(const QColor& col) override {
        ...
        auto setselectionforegroundcolor_cb = qsciscintilla_setselectionforegroundcolor_callback;
        if (setselectionforegroundcolor_cb) {
            const QColor& col_ret = col;
            // Cast returned reference into pointer
            QColor* cbval1 = const_cast<QColor*>(&col_ret);
    ...
    virtual void undo() override {
        ...
        auto undo_cb = qsciscintilla_undo_callback;
        if (undo_cb) {
            undo_cb();
            return;
        }
    ...
    virtual void zoomIn() override {
        ...
        auto zoomin2_cb = qsciscintilla_zoomin2_callback;
        if (zoomin2_cb) {
            zoomin2_cb();
            return;
        }
    ...
    virtual void zoomOut() override {
        ...
        auto zoomout2_cb = qsciscintilla_zoomout2_callback;
        if (zoomout2_cb) {
            zoomout2_cb();
            return;
        }
    ...
    virtual QByteArray fromMimeData(const QMimeData* source, bool& rectangular) const override {
        ...
        auto frommimedata_cb = qsciscintilla_frommimedata_callback;
        if (frommimedata_cb) {
            QMimeData* cbval1 = (QMimeData*)source;
    ...
    virtual QMimeData* toMimeData(const QByteArray& text, bool rectangular) const override {
        ...
        auto tomimedata_cb = qsciscintilla_tomimedata_callback;
        if (tomimedata_cb) {
    ...
    virtual void scrollContentsBy(int dx, int dy) override {
        ...
        auto scrollcontentsby_cb = qsciscintilla_scrollcontentsby_callback;
    ...
    virtual bool eventFilter(QObject* param1, QEvent* param2) override {
        ...
        auto eventfilter_cb = qsciscintilla_eventfilter_callback;
        if (eventfilter_cb) {
    ...
    virtual int devType() const override {
        ...
        auto devtype_cb = qsciscintilla_devtype_callback;
        if (devtype_cb) {
    ...
    virtual bool hasHeightForWidth() const override {
        ...
        auto hasheightforwidth_cb = qsciscintilla_hasheightforwidth_callback;
    ...
    virtual QPaintEngine* paintEngine() const override {
        ...
        auto paintengine_cb = qsciscintilla_paintengine_callback;
        if (paintengine_cb) {
    ...
    virtual bool nativeEvent(const QByteArray& eventType, void* message, qintptr* result) override {
        ...
        auto nativeevent_cb = qsciscintilla_nativeevent_callback;
        if (nativeevent_cb) {
    ...
    virtual QPainter* sharedPainter() const override {
        ...
        auto sharedpainter_cb = qsciscintilla_sharedpainter_callback;
        if (sharedpainter_cb) {
    ...
    virtual void connectNotify(const QMetaMethod& signal) override {
        ...
        auto connectnotify_cb = qsciscintilla_connectnotify_callback;
        if (connectnotify_cb) {
    ...
    virtual void disconnectNotify(const QMetaMethod& signal) override {
        ...
        auto disconnectnotify_cb = qsciscintilla_disconnectnotify_callback;
    ...
    void setScrollBars() {
        ...
        auto setscrollbars_cb = qsciscintilla_setscrollbars_callback;
        if (setscrollbars_cb) {
            setscrollbars_cb();
            return;
        }
    ...
    bool contextMenuNeeded(int x, int y) const {
        ...
        auto contextmenuneeded_cb = qsciscintilla_contextmenuneeded_callback;
    ...
    void setViewportMargins(int left, int top, int right, int bottom) {
        ...
        auto setviewportmargins_cb = qsciscintilla_setviewportmargins_callback;
    ...
    void updateMicroFocus() {
        ...
        auto updatemicrofocus_cb = qsciscintilla_updatemicrofocus_callback;
    ...
    void create() {
        ...
        auto create_cb = qsciscintilla_create_callback;
        if (create_cb) {
            create_cb();
            return;
        }
    ...
    void destroy() {
        ...
        auto destroy_cb = qsciscintilla_destroy_callback;
        if (destroy_cb) {
            destroy_cb();
            return;
        }
    ...
    bool focusNextChild() {
        ...
        auto focusnextchild_cb = qsciscintilla_focusnextchild_callback;
    ...
    bool focusPreviousChild() {
        ...
        auto focuspreviouschild_cb = qsciscintilla_focuspreviouschild_callback;
    ...
    QObject* sender() const {
        ...
        auto sender_cb = qsciscintilla_sender_callback;
        if (sender_cb) {
    ...
    int senderSignalIndex() const {
        ...
        auto sendersignalindex_cb = qsciscintilla_sendersignalindex_callback;
    ...
    bool isSignalConnected(const QMetaMethod& signal) const {
        ...
        auto issignalconnected_cb = qsciscintilla_issignalconnected_callback;
    ...
    double getDecodedMetricF(QPaintDevice::PaintDeviceMetric metricA, QPaintDevice::PaintDeviceMetric metricB) const {
        ...
        auto getdecodedmetricf_cb = qsciscintilla_getdecodedmetricf_callback;
    ...
    friend void QsciScintilla_SuperSetViewportMargins(QsciScintilla* self, int left, int top, int right, int bottom);
    friend QMargins* QsciScintilla_ViewportMargins(const QsciScintilla* self);
    friend QMargins* QsciScintilla_SuperViewportMargins(const QsciScintilla* self);
    friend void QsciScintilla_DrawFrame(QsciScintilla* self, QPainter* param1);
    friend void QsciScintilla_SuperDrawFrame(QsciScintilla* self, QPainter* param1);
    friend void QsciScintilla_UpdateMicroFocus(QsciScintilla* self);
    friend void QsciScintilla_SuperUpdateMicroFocus(QsciScintilla* self);
    friend void QsciScintilla_Create(QsciScintilla* self);
    friend void QsciScintilla_SuperCreate(QsciScintilla* self);
    friend void QsciScintilla_Destroy(QsciScintilla* self);
    friend void QsciScintilla_SuperDestroy(QsciScintilla* self);
    friend bool QsciScintilla_FocusNextChild(QsciScintilla* self);
    friend bool QsciScintilla_SuperFocusNextChild(QsciScintilla* self);
    friend bool QsciScintilla_FocusPreviousChild(QsciScintilla* self);
    friend bool QsciScintilla_SuperFocusPreviousChild(QsciScintilla* self);
    friend QObject* QsciScintilla_Sender(const QsciScintilla* self);
    friend QObject* QsciScintilla_SuperSender(const QsciScintilla* self);
    friend int QsciScintilla_SenderSignalIndex(const QsciScintilla* self);
    friend int QsciScintilla_SuperSenderSignalIndex(const QsciScintilla* self);
    friend int QsciScintilla_Receivers(const QsciScintilla* self, const char* signal);
    friend int QsciScintilla_SuperReceivers(const QsciScintilla* self, const char* signal);
    friend bool QsciScintilla_IsSignalConnected(const QsciScintilla* self, const QMetaMethod* signal);
    friend bool QsciScintilla_SuperIsSignalConnected(const QsciScintilla* self, const QMetaMethod* signal);
    friend double QsciScintilla_GetDecodedMetricF(const QsciScintilla* self, int metricA, int metricB);
    friend double QsciScintilla_SuperGetDecodedMetricF(const QsciScintilla* self, int metricA, int metricB);
};
