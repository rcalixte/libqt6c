...
class VirtualQsciLexerCoffeeScript final : public QsciLexerCoffeeScript {
  ...
  public:
    ...
    // Friend functions
    friend bool QsciLexerCoffeeScript_ReadProperties(QsciLexerCoffeeScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCoffeeScript_QBaseReadProperties(QsciLexerCoffeeScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCoffeeScript_WriteProperties(const QsciLexerCoffeeScript* self, QSettings* qs, libqt_string prefix);
    friend bool QsciLexerCoffeeScript_QBaseWriteProperties(const QsciLexerCoffeeScript* self, QSettings* qs, libqt_string prefix);
    ...
    friend void QsciLexerCoffeeScript_ConnectNotify(QsciLexerCoffeeScript* self, QMetaMethod* signal);
    friend void QsciLexerCoffeeScript_QBaseConnectNotify(QsciLexerCoffeeScript* self, QMetaMethod* signal);
    friend void QsciLexerCoffeeScript_DisconnectNotify(QsciLexerCoffeeScript* self, QMetaMethod* signal);
    friend void QsciLexerCoffeeScript_QBaseDisconnectNotify(QsciLexerCoffeeScript* self, QMetaMethod* signal);
    ...
    friend bool QsciLexerCoffeeScript_IsSignalConnected(const QsciLexerCoffeeScript* self, QMetaMethod* signal);
    friend bool QsciLexerCoffeeScript_QBaseIsSignalConnected(const QsciLexerCoffeeScript* self, QMetaMethod* signal);
};
