...
class VirtualQRubberBand final : public QRubberBand {
  ...
  public:
    ...
    friend bool QRubberBand_NativeEvent(QRubberBand* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QRubberBand_QBaseNativeEvent(QRubberBand* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QRubberBand_ConnectNotify(QRubberBand* self, QMetaMethod* signal);
    friend void QRubberBand_QBaseConnectNotify(QRubberBand* self, QMetaMethod* signal);
    friend void QRubberBand_DisconnectNotify(QRubberBand* self, QMetaMethod* signal);
    friend void QRubberBand_QBaseDisconnectNotify(QRubberBand* self, QMetaMethod* signal);
    ...
    friend bool QRubberBand_IsSignalConnected(const QRubberBand* self, QMetaMethod* signal);
    friend bool QRubberBand_QBaseIsSignalConnected(const QRubberBand* self, QMetaMethod* signal);
};
