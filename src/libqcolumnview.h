#pragma once
#ifndef SRC_QT6C_LIBQCOLUMNVIEW_H
#define SRC_QT6C_LIBQCOLUMNVIEW_H
...
///
libqt_list q_columnview_scroll_bar_widgets(void* self, int32_t alignment);
...
///
/// @param self QColumnView*
/// @param callback bool func(QColumnView* self, libqt_string eventType, void* message, intptr_t* result)
///
