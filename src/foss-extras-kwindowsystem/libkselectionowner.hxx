...
class VirtualKSelectionOwner final : public KSelectionOwner {
  ...
  public:
    ...
    using KSelectionOwner_GenericReply_Callback = bool (*)(KSelectionOwner*, xcb_atom_t, xcb_atom_t, xcb_window_t);
    using KSelectionOwner_ReplyTargets_Callback = void (*)(KSelectionOwner*, xcb_atom_t, xcb_window_t);
  ...
  public:
    ...
    ~VirtualKSelectionOwner() {
        ...
        kselectionowner_genericreply_callback = nullptr;
        kselectionowner_replytargets_callback = nullptr;
    ...
    virtual bool genericReply(xcb_atom_t target, xcb_atom_t property, xcb_window_t requestor) override {
        ...
        } else if (kselectionowner_genericreply_callback != nullptr) {
            xcb_atom_t cbval1 = target;
            xcb_atom_t cbval2 = property;
            xcb_window_t cbval3 = requestor;
    ...
    virtual void replyTargets(xcb_atom_t property, xcb_window_t requestor) override {
        ...
        } else if (kselectionowner_replytargets_callback != nullptr) {
            xcb_atom_t cbval1 = property;
            xcb_window_t cbval2 = requestor;
