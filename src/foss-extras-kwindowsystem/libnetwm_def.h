#pragma once
#ifndef FOSS_EXTRAS_KWINDOWSYSTEM_LIBNETWM_DEF_H
#define FOSS_EXTRAS_KWINDOWSYSTEM_LIBNETWM_DEF_H
...
typedef enum {
    ...
    NET_WINDOWTYPEMASK_ALLTYPESMASK = -1
} NET__WindowTypeMask;
...
typedef enum {
    ...
    NET_PROPERTY_WMALLPROPERTIES = -1
} NET__Property;
...
typedef enum {
    ...
    NET_PROPERTY2_WM2ALLPROPERTIES = -1
} NET__Property2;
