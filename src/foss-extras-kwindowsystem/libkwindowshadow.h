#pragma once
#ifndef FOSS_EXTRAS_KWINDOWSYSTEM_LIBKWINDOWSHADOW_H
#define FOSS_EXTRAS_KWINDOWSYSTEM_LIBKWINDOWSHADOW_H
...
///
/// @param self KWindowShadow*
/// @param callback void* func(KWindowShadow* self, const char* param1)
///
