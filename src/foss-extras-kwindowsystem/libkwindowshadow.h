#pragma once
#ifndef SRC_FOSS_EXTRAS_KWINDOWSYSTEMQT6C_LIBKWINDOWSHADOW_H
#define SRC_FOSS_EXTRAS_KWINDOWSYSTEMQT6C_LIBKWINDOWSHADOW_H
...
/// https://api.kde.org/kwindowshadowtile.html

/// k_windowshadowtile_new constructs a new KWindowShadowTile object.
///
KWindowShadowTile* k_windowshadowtile_new();

/// [Qt documentation](https://api.kde.org/kwindowshadowtile.html#image)
///
/// @param self KWindowShadowTile*
QImage* k_windowshadowtile_image(void* self);

/// [Qt documentation](https://api.kde.org/kwindowshadowtile.html#setImage)
///
/// @param self KWindowShadowTile*
/// @param image QImage*
void k_windowshadowtile_set_image(void* self, void* image);

/// [Qt documentation](https://api.kde.org/kwindowshadowtile.html#isCreated)
///
/// @param self KWindowShadowTile*
bool k_windowshadowtile_is_created(void* self);

/// [Qt documentation](https://api.kde.org/kwindowshadowtile.html#create)
///
/// @param self KWindowShadowTile*
bool k_windowshadowtile_create(void* self);

/// [Qt documentation](https://api.kde.org/kwindowshadowtile.html#dtor.KWindowShadowTile)
///
...
/// https://api.kde.org/kwindowshadow.html
...
/// [Qt documentation](https://api.kde.org/kwindowshadow.html#padding)
///
/// @param self KWindowShadow*
QMargins* k_windowshadow_padding(void* self);

/// [Qt documentation](https://api.kde.org/kwindowshadow.html#setPadding)
///
/// @param self KWindowShadow*
/// @param padding QMargins*
void k_windowshadow_set_padding(void* self, void* padding);

/// [Qt documentation](https://api.kde.org/kwindowshadow.html#window)
///
/// @param self KWindowShadow*
QWindow* k_windowshadow_window(void* self);

/// [Qt documentation](https://api.kde.org/kwindowshadow.html#setWindow)
///
/// @param self KWindowShadow*
/// @param window QWindow*
void k_windowshadow_set_window(void* self, void* window);

/// [Qt documentation](https://api.kde.org/kwindowshadow.html#isCreated)
///
/// @param self KWindowShadow*
bool k_windowshadow_is_created(void* self);

/// [Qt documentation](https://api.kde.org/kwindowshadow.html#create)
///
/// @param self KWindowShadow*
bool k_windowshadow_create(void* self);

/// [Qt documentation](https://api.kde.org/kwindowshadow.html#destroy)
///
/// @param self KWindowShadow*
...
/// [Qt documentation](https://api.kde.org/kwindowshadow.html#dtor.KWindowShadow)
///
/// Delete this object from C++ memory.
///
/// @param self KWindowShadow*
