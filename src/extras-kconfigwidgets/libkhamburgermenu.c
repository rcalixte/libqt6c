...
int32_t k_hamburgermenu_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KHamburgerMenu_Metacall((KHamburgerMenu*)self, param1, param2, param3);
}
...
void k_hamburgermenu_set_menu_bar(void* self, void* menuBar) {
    KHamburgerMenu_SetMenuBar((KHamburgerMenu*)self, (QMenuBar*)menuBar);
}

QMenuBar* k_hamburgermenu_menu_bar(void* self) {
    return KHamburgerMenu_MenuBar((KHamburgerMenu*)self);
}

void k_hamburgermenu_set_menu_bar_advertised(void* self, bool advertise) {
    KHamburgerMenu_SetMenuBarAdvertised((KHamburgerMenu*)self, advertise);
}

bool k_hamburgermenu_menu_bar_advertised(void* self) {
    return KHamburgerMenu_MenuBarAdvertised((KHamburgerMenu*)self);
}

void k_hamburgermenu_set_show_menu_bar_action(void* self, void* showMenuBarAction) {
    KHamburgerMenu_SetShowMenuBarAction((KHamburgerMenu*)self, (QAction*)showMenuBarAction);
}

void k_hamburgermenu_add_to_menu(void* self, void* menu) {
    KHamburgerMenu_AddToMenu((KHamburgerMenu*)self, (QMenu*)menu);
}

void k_hamburgermenu_insert_into_menu_before(void* self, void* menu, void* before) {
    KHamburgerMenu_InsertIntoMenuBefore((KHamburgerMenu*)self, (QMenu*)menu, (QAction*)before);
}

void k_hamburgermenu_hide_actions_of(void* self, void* widget) {
    KHamburgerMenu_HideActionsOf((KHamburgerMenu*)self, (QWidget*)widget);
}

void k_hamburgermenu_show_actions_of(void* self, void* widget) {
    KHamburgerMenu_ShowActionsOf((KHamburgerMenu*)self, (QWidget*)widget);
}

void k_hamburgermenu_about_to_show_menu(void* self) {
    KHamburgerMenu_AboutToShowMenu((KHamburgerMenu*)self);
}

void k_hamburgermenu_on_about_to_show_menu(void* self, void (*callback)(void*)) {
    KHamburgerMenu_Connect_AboutToShowMenu((KHamburgerMenu*)self, (intptr_t)callback);
}

QWidget* k_hamburgermenu_create_widget(void* self, void* parent) {
    return KHamburgerMenu_CreateWidget((KHamburgerMenu*)self, (QWidget*)parent);
}
...
const char** k_hamburgermenu_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_hamburgermenu_dynamic_property_names\n");
        abort();
    }
...
void k_hamburgermenu_on_event(void* self, bool (*callback)(void*, void*)) {
    KHamburgerMenu_OnEvent((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_event_filter(void* self, bool (*callback)(void*, void*, void*)) {
    KHamburgerMenu_OnEventFilter((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_delete_widget(void* self, void (*callback)(void*, void*)) {
    KHamburgerMenu_OnDeleteWidget((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_timer_event(void* self, void (*callback)(void*, void*)) {
    KHamburgerMenu_OnTimerEvent((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_child_event(void* self, void (*callback)(void*, void*)) {
    KHamburgerMenu_OnChildEvent((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_custom_event(void* self, void (*callback)(void*, void*)) {
    KHamburgerMenu_OnCustomEvent((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_connect_notify(void* self, void (*callback)(void*, void*)) {
    KHamburgerMenu_OnConnectNotify((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_disconnect_notify(void* self, void (*callback)(void*, void*)) {
    KHamburgerMenu_OnDisconnectNotify((KHamburgerMenu*)self, (intptr_t)callback);
}

libqt_list /* of QWidget* */ k_hamburgermenu_created_widgets(void* self) {
    libqt_list _arr = KHamburgerMenu_CreatedWidgets((KHamburgerMenu*)self);
    return _arr;
}
...
void k_hamburgermenu_on_created_widgets(void* self, libqt_list /* of QWidget* */ (*callback)()) {
    KHamburgerMenu_OnCreatedWidgets((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_sender(void* self, QObject* (*callback)()) {
    KHamburgerMenu_OnSender((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_sender_signal_index(void* self, int32_t (*callback)()) {
    KHamburgerMenu_OnSenderSignalIndex((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_receivers(void* self, int32_t (*callback)(void*, const char*)) {
    KHamburgerMenu_OnReceivers((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_on_is_signal_connected(void* self, bool (*callback)(void*, void*)) {
    KHamburgerMenu_OnIsSignalConnected((KHamburgerMenu*)self, (intptr_t)callback);
}
...
void k_hamburgermenu_delete(void* self) {
    KHamburgerMenu_Delete((KHamburgerMenu*)(self));
}
