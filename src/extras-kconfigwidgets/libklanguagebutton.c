...
bool k_languagebutton_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_languagebutton_as_q_paint_device(self));
}

int32_t k_languagebutton_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_languagebutton_as_q_paint_device(self));
}

int32_t k_languagebutton_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_languagebutton_as_q_paint_device(self));
}

int32_t k_languagebutton_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_languagebutton_as_q_paint_device(self));
}

int32_t k_languagebutton_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_languagebutton_as_q_paint_device(self));
}

int32_t k_languagebutton_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_languagebutton_as_q_paint_device(self));
}

int32_t k_languagebutton_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_languagebutton_as_q_paint_device(self));
}

double k_languagebutton_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_languagebutton_as_q_paint_device(self));
}

double k_languagebutton_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_languagebutton_as_q_paint_device(self));
}

int32_t k_languagebutton_color_count(void* self) {
    return QPaintDevice_ColorCount(k_languagebutton_as_q_paint_device(self));
}

int32_t k_languagebutton_depth(void* self) {
    return QPaintDevice_Depth(k_languagebutton_as_q_paint_device(self));
}
