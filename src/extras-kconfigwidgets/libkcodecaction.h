#pragma once
#ifndef EXTRAS_KCONFIGWIDGETS_LIBKCODECACTION_H
#define EXTRAS_KCONFIGWIDGETS_LIBKCODECACTION_H
...
///
/// @param self KCodecAction*
/// @param callback void* func(KCodecAction* self, const char* param1)
///
