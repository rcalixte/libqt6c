  ...
  public:
    ...
    void setHelp(const QString& anchor) {
        if (kconfigdialog_sethelp_isbase) {
            ...
            char* anchor_str = static_cast<char*>(malloc(anchor_str_len + 1));
            memcpy(anchor_str, anchor_b.data(), anchor_str_len);
    ...
    void setHelp(const QString& anchor, const QString& appname) {
        if (kconfigdialog_sethelp2_isbase) {
            ...
            char* appname_str = static_cast<char*>(malloc(appname_str_len + 1));
            memcpy(appname_str, appname_b.data(), appname_str_len);
            appname_str[appname_str_len] = '\0';
