...
bool k_configdialog_painting_active(void* self) {
    return QPaintDevice_PaintingActive(k_configdialog_as_q_paint_device(self));
}

int32_t k_configdialog_width_m_m(void* self) {
    return QPaintDevice_WidthMM(k_configdialog_as_q_paint_device(self));
}

int32_t k_configdialog_height_m_m(void* self) {
    return QPaintDevice_HeightMM(k_configdialog_as_q_paint_device(self));
}

int32_t k_configdialog_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(k_configdialog_as_q_paint_device(self));
}

int32_t k_configdialog_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(k_configdialog_as_q_paint_device(self));
}

int32_t k_configdialog_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(k_configdialog_as_q_paint_device(self));
}

int32_t k_configdialog_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(k_configdialog_as_q_paint_device(self));
}

double k_configdialog_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(k_configdialog_as_q_paint_device(self));
}

double k_configdialog_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(k_configdialog_as_q_paint_device(self));
}

int32_t k_configdialog_color_count(void* self) {
    return QPaintDevice_ColorCount(k_configdialog_as_q_paint_device(self));
}

int32_t k_configdialog_depth(void* self) {
    return QPaintDevice_Depth(k_configdialog_as_q_paint_device(self));
}
