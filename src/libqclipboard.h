#pragma once
#ifndef LIBQCLIPBOARD_H
#define LIBQCLIPBOARD_H
...
///
int32_t q_clipboard_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_clipboard_start_timer23(void* self, int64_t time, int32_t timerType);
