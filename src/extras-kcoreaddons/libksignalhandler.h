#pragma once
#ifndef EXTRAS_KCOREADDONS_LIBKSIGNALHANDLER_H
#define EXTRAS_KCOREADDONS_LIBKSIGNALHANDLER_H
...
/// [Upstream resources](https://api.kde.org/ksignalhandler.html)
...
///
int32_t k_signalhandler_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_signalhandler_start_timer23(void* self, int64_t time, int32_t timerType);
