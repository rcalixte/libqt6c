...
int32_t k_process_qbase_metacall(void* self, int32_t param1, int param2, void* param3) {
    return KProcess_QBaseMetacall((KProcess*)self, param1, param2, param3);
}

const char* k_process_tr(const char* s) {
    libqt_string _str = KProcess_Tr(s);
...
void k_process_set_program2(void* self, const char* argv[]) {
    ...
    if (argv_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_set_program2");
        abort();
    }
...
KProcess* k_process_operator_shift_left2(void* self, const char* args[]) {
    ...
    if (args_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_operator_shift_left2");
        abort();
    }
...
const char** k_process_program(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_program");
        abort();
    }
...
int32_t k_process_execute3(const char* argv[]) {
    ...
    libqt_string* argv_qstr = (libqt_string*)malloc(argv_len * sizeof(libqt_string));
    if (argv_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_execute3");
        abort();
    }
    for (size_t i = 0; i < argv_len; ++i) {
        argv_qstr[i] = qstring(argv[i]);
...
int32_t k_process_start_detached3(const char* argv[]) {
    ...
    libqt_string* argv_qstr = (libqt_string*)malloc(argv_len * sizeof(libqt_string));
    if (argv_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_start_detached3");
        abort();
    }
    for (size_t i = 0; i < argv_len; ++i) {
        argv_qstr[i] = qstring(argv[i]);
...
const char* k_process_tr2(const char* s, const char* c) {
    libqt_string _str = KProcess_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_process_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KProcess_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_process_set_program22(void* self, const char* exe, const char* args[]) {
    ...
    libqt_string* args_qstr = (libqt_string*)malloc(args_len * sizeof(libqt_string));
    if (args_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_set_program22");
        abort();
    }
    for (size_t i = 0; i < args_len; ++i) {
        args_qstr[i] = qstring(args[i]);
...
int32_t k_process_execute22(const char* exe, const char* args[]) {
    ...
    libqt_string* args_qstr = (libqt_string*)malloc(args_len * sizeof(libqt_string));
    if (args_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_execute22");
        abort();
    }
    for (size_t i = 0; i < args_len; ++i) {
        args_qstr[i] = qstring(args[i]);
...
int32_t k_process_execute32(const char* exe, const char* args[], int msecs) {
    ...
    libqt_string* args_qstr = (libqt_string*)malloc(args_len * sizeof(libqt_string));
    if (args_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_execute32");
        abort();
    }
    for (size_t i = 0; i < args_len; ++i) {
        args_qstr[i] = qstring(args[i]);
...
int32_t k_process_execute23(const char* argv[], int msecs) {
    ...
    libqt_string* argv_qstr = (libqt_string*)malloc(argv_len * sizeof(libqt_string));
    if (argv_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_execute23");
        abort();
    }
    for (size_t i = 0; i < argv_len; ++i) {
        argv_qstr[i] = qstring(argv[i]);
...
int32_t k_process_start_detached22(const char* exe, const char* args[]) {
    ...
    libqt_string* args_qstr = (libqt_string*)malloc(args_len * sizeof(libqt_string));
    if (args_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_start_detached22");
        abort();
    }
    for (size_t i = 0; i < args_len; ++i) {
        args_qstr[i] = qstring(args[i]);
...
const char** k_process_arguments(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_arguments");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
void k_process_set_arguments(void* self, const char* arguments[]) {
    ...
    if (arguments_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_set_arguments");
        abort();
    }
...
void k_process_set_environment(void* self, const char* environment[]) {
    ...
    if (environment_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_set_environment");
        abort();
    }
...
const char** k_process_environment(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_environment");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** k_process_system_environment() {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_system_environment");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
void k_process_start22(void* self, const char* program, const char* arguments[]) {
    ...
    libqt_string* arguments_qstr = (libqt_string*)malloc(arguments_len * sizeof(libqt_string));
    if (arguments_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_start22");
        abort();
    }
    for (size_t i = 0; i < arguments_len; ++i) {
        arguments_qstr[i] = qstring(arguments[i]);
...
void k_process_start3(void* self, const char* program, const char* arguments[], int32_t mode) {
    ...
    libqt_string* arguments_qstr = (libqt_string*)malloc(arguments_len * sizeof(libqt_string));
    if (arguments_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_start3");
        abort();
    }
    for (size_t i = 0; i < arguments_len; ++i) {
        arguments_qstr[i] = qstring(arguments[i]);
...
bool k_process_start_detached4(const char* program, const char* arguments[], const char* workingDirectory, long long* pid) {
    ...
    libqt_string* arguments_qstr = (libqt_string*)malloc(arguments_len * sizeof(libqt_string));
    if (arguments_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_start_detached4");
        abort();
    }
    for (size_t i = 0; i < arguments_len; ++i) {
        arguments_qstr[i] = qstring(arguments[i]);
...
const char** k_process_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_process_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QMetaObject__Connection* k_process_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_process_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
bool k_process_qbase_wait_for_ready_read(void* self, int msecs) {
    return KProcess_QBaseWaitForReadyRead((KProcess*)self, msecs);
}
...
bool k_process_qbase_wait_for_bytes_written(void* self, int msecs) {
    return KProcess_QBaseWaitForBytesWritten((KProcess*)self, msecs);
}
...
long long k_process_qbase_bytes_to_write(void* self) {
    return KProcess_QBaseBytesToWrite((KProcess*)self);
}
...
bool k_process_qbase_is_sequential(void* self) {
    return KProcess_QBaseIsSequential((KProcess*)self);
}
...
void k_process_qbase_close(void* self) {
    KProcess_QBaseClose((KProcess*)self);
}
...
long long k_process_qbase_read_data(void* self, char* data, long long maxlen) {
    return KProcess_QBaseReadData((KProcess*)self, data, maxlen);
}
...
long long k_process_qbase_write_data(void* self, const char* data, long long lenVal) {
    return KProcess_QBaseWriteData((KProcess*)self, data, lenVal);
}
...
long long k_process_qbase_pos(void* self) {
    return KProcess_QBasePos((KProcess*)self);
}
...
long long k_process_qbase_size(void* self) {
    return KProcess_QBaseSize((KProcess*)self);
}
...
bool k_process_qbase_seek(void* self, long long pos) {
    return KProcess_QBaseSeek((KProcess*)self, pos);
}
...
bool k_process_qbase_at_end(void* self) {
    return KProcess_QBaseAtEnd((KProcess*)self);
}
...
bool k_process_qbase_reset(void* self) {
    return KProcess_QBaseReset((KProcess*)self);
}
...
long long k_process_qbase_bytes_available(void* self) {
    return KProcess_QBaseBytesAvailable((KProcess*)self);
}
...
bool k_process_qbase_can_read_line(void* self) {
    return KProcess_QBaseCanReadLine((KProcess*)self);
}
...
long long k_process_qbase_read_line_data(void* self, char* data, long long maxlen) {
    return KProcess_QBaseReadLineData((KProcess*)self, data, maxlen);
}
...
long long k_process_qbase_skip_data(void* self, long long maxSize) {
    return KProcess_QBaseSkipData((KProcess*)self, maxSize);
}
...
bool k_process_qbase_event(void* self, void* event) {
    return KProcess_QBaseEvent((KProcess*)self, (QEvent*)event);
}
...
bool k_process_qbase_event_filter(void* self, void* watched, void* event) {
    return KProcess_QBaseEventFilter((KProcess*)self, (QObject*)watched, (QEvent*)event);
}
...
void k_process_qbase_timer_event(void* self, void* event) {
    KProcess_QBaseTimerEvent((KProcess*)self, (QTimerEvent*)event);
}
...
void k_process_qbase_child_event(void* self, void* event) {
    KProcess_QBaseChildEvent((KProcess*)self, (QChildEvent*)event);
}
...
void k_process_qbase_custom_event(void* self, void* event) {
    KProcess_QBaseCustomEvent((KProcess*)self, (QEvent*)event);
}
...
void k_process_qbase_connect_notify(void* self, void* signal) {
    KProcess_QBaseConnectNotify((KProcess*)self, (QMetaMethod*)signal);
}
...
void k_process_qbase_disconnect_notify(void* self, void* signal) {
    KProcess_QBaseDisconnectNotify((KProcess*)self, (QMetaMethod*)signal);
}
...
void k_process_qbase_set_process_state(void* self, int32_t state) {
    KProcess_QBaseSetProcessState((KProcess*)self, state);
}
...
void k_process_qbase_set_error_string(void* self, const char* errorString) {
    KProcess_QBaseSetErrorString((KProcess*)self, qstring(errorString));
}
...
QObject* k_process_qbase_sender(void* self) {
    return KProcess_QBaseSender((KProcess*)self);
}
...
int32_t k_process_qbase_sender_signal_index(void* self) {
    return KProcess_QBaseSenderSignalIndex((KProcess*)self);
}
...
int32_t k_process_qbase_receivers(void* self, const char* signal) {
    return KProcess_QBaseReceivers((KProcess*)self, signal);
}
...
bool k_process_qbase_is_signal_connected(void* self, void* signal) {
    return KProcess_QBaseIsSignalConnected((KProcess*)self, (QMetaMethod*)signal);
}
