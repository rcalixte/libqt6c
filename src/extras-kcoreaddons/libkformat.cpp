...
libqt_string KFormat_FormatByteSize(const KFormat* self, double size) {
    auto _ret = self->formatByteSize(static_cast<double>(size));
...
libqt_string KFormat_FormatDuration(const KFormat* self, unsigned long long msecs) {
    auto _ret = self->formatDuration(static_cast<quint64>(msecs));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatDecimalDuration(const KFormat* self, unsigned long long msecs) {
    auto _ret = self->formatDecimalDuration(static_cast<quint64>(msecs));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatSpelloutDuration(const KFormat* self, unsigned long long msecs) {
    auto _ret = self->formatSpelloutDuration(static_cast<quint64>(msecs));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatRelativeDate(const KFormat* self, const QDate* date, int format) {
    auto _ret = self->formatRelativeDate(*date, static_cast<QLocale::FormatType>(format));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatRelativeDateTime(const KFormat* self, const QDateTime* dateTime, int format) {
    auto _ret = self->formatRelativeDateTime(*dateTime, static_cast<QLocale::FormatType>(format));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatValue(const KFormat* self, double value, int unit) {
    auto _ret = self->formatValue(static_cast<double>(value), static_cast<KFormat::Unit>(unit));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatValue2(const KFormat* self, double value, const libqt_string unit) {
    ...
    auto _ret = self->formatValue(static_cast<double>(value), unit_QString);
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatValue3(const KFormat* self, double value, const libqt_string unit, int precision, int prefix, int dialect) {
    QString unit_QString = QString::fromUtf8(unit.data, unit.len);
    auto _ret = self->formatValue(static_cast<double>(value), unit_QString, static_cast<int>(precision), static_cast<KFormat::UnitPrefix>(prefix), static_cast<KFormat::BinaryUnitDialect>(dialect));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatDistance(const KFormat* self, double distance) {
    auto _ret = self->formatDistance(static_cast<double>(distance));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatByteSize2(const KFormat* self, double size, int precision) {
    auto _ret = self->formatByteSize(static_cast<double>(size), static_cast<int>(precision));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatByteSize3(const KFormat* self, double size, int precision, int dialect) {
    auto _ret = self->formatByteSize(static_cast<double>(size), static_cast<int>(precision), static_cast<KFormat::BinaryUnitDialect>(dialect));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatByteSize4(const KFormat* self, double size, int precision, int dialect, int units) {
    auto _ret = self->formatByteSize(static_cast<double>(size), static_cast<int>(precision), static_cast<KFormat::BinaryUnitDialect>(dialect), static_cast<KFormat::BinarySizeUnits>(units));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatDuration2(const KFormat* self, unsigned long long msecs, int options) {
    auto _ret = self->formatDuration(static_cast<quint64>(msecs), static_cast<KFormat::DurationFormatOptions>(options));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatDecimalDuration2(const KFormat* self, unsigned long long msecs, int decimalPlaces) {
    auto _ret = self->formatDecimalDuration(static_cast<quint64>(msecs), static_cast<int>(decimalPlaces));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatValue32(const KFormat* self, double value, int unit, int precision) {
    auto _ret = self->formatValue(static_cast<double>(value), static_cast<KFormat::Unit>(unit), static_cast<int>(precision));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatValue4(const KFormat* self, double value, int unit, int precision, int prefix) {
    auto _ret = self->formatValue(static_cast<double>(value), static_cast<KFormat::Unit>(unit), static_cast<int>(precision), static_cast<KFormat::UnitPrefix>(prefix));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatValue5(const KFormat* self, double value, int unit, int precision, int prefix, int dialect) {
    auto _ret = self->formatValue(static_cast<double>(value), static_cast<KFormat::Unit>(unit), static_cast<int>(precision), static_cast<KFormat::UnitPrefix>(prefix), static_cast<KFormat::BinaryUnitDialect>(dialect));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatValue33(const KFormat* self, double value, const libqt_string unit, int precision) {
    QString unit_QString = QString::fromUtf8(unit.data, unit.len);
    auto _ret = self->formatValue(static_cast<double>(value), unit_QString, static_cast<int>(precision));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatValue42(const KFormat* self, double value, const libqt_string unit, int precision, int prefix) {
    QString unit_QString = QString::fromUtf8(unit.data, unit.len);
    auto _ret = self->formatValue(static_cast<double>(value), unit_QString, static_cast<int>(precision), static_cast<KFormat::UnitPrefix>(prefix));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string KFormat_FormatDistance2(const KFormat* self, double distance, int param2) {
    auto _ret = self->formatDistance(static_cast<double>(distance), static_cast<KFormat::DistanceFormatOptions>(param2));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
