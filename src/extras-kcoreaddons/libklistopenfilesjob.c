...
const char* k_listopenfilesjob_tr(const char* s) {
    libqt_string _str = KListOpenFilesJob_Tr(s);
...
const char* k_listopenfilesjob_tr2(const char* s, const char* c) {
    libqt_string _str = KListOpenFilesJob_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_listopenfilesjob_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KListOpenFilesJob_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_listopenfilesjob_description(void* self, void* job, const char* title) {
...
void k_listopenfilesjob_description3(void* self, void* job, const char* title, libqt_pair /* tuple of const char* and const char* */ field1) {
...
void k_listopenfilesjob_description4(void* self, void* job, const char* title, libqt_pair /* tuple of const char* and const char* */ field1, libqt_pair /* tuple of const char* and const char* */ field2) {
...
QMetaObject__Connection* k_listopenfilesjob_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_listopenfilesjob_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
