...
///
/// @param str const char*
/// @param map libqt_map of QChar* to const char*
/// @param c QChar*
///
const char* k_macroexpander_expand_macros(const char* str, libqt_map map, void* c);
...
/// @param c QChar*
///
const char* k_macroexpander_expand_macros_shell_quote(const char* str, libqt_map map, void* c);
...
///
/// @param str const char*
/// @param map libqt_map of const char* to const char*
/// @param c QChar*
///
const char* k_macroexpander_expand_macros2(const char* str, libqt_map map, void* c);
...
/// @param c QChar*
///
const char* k_macroexpander_expand_macros_shell_quote2(const char* str, libqt_map map, void* c);
...
/// @param c QChar*
///
const char* k_macroexpander_expand_macros3(const char* str, libqt_map map, void* c);
...
/// @param c QChar*
///
const char* k_macroexpander_expand_macros4(const char* str, libqt_map map, void* c);
...
/// @param c QChar*
///
const char* k_macroexpander_expand_macros_shell_quote3(const char* str, libqt_map map, void* c);
...
/// @param c QChar*
///
const char* k_macroexpander_expand_macros_shell_quote4(const char* str, libqt_map map, void* c);
#endif
