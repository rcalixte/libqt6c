...
void k_networkmounts_set_object_name(void* self, const char* name) {
...
int32_t k_networkmounts_start_timer2(void* self, int64_t time) {
...
int32_t k_networkmounts_start_timer23(void* self, int64_t time, int32_t timerType) {
