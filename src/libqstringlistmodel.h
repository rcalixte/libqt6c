...
///
/// @param self QStringListModel*
/// @param callback void* func(QStringListModel* self, const char* param1)
///
...
///
/// @param self QStringListModel*
/// @param callback void func(QStringListModel* self, libqt_list of QPersistentModelIndex* parents)
///
...
///
/// @param self QStringListModel*
/// @param callback void func(QStringListModel* self, libqt_list of QPersistentModelIndex* parents, enum QAbstractItemModel__LayoutChangeHint hint)
///
...
///
/// @param self QStringListModel*
/// @param callback void func(QStringListModel* self, libqt_list of QModelIndex* from, libqt_list of QModelIndex* to)
///
