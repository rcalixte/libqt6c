...
class VirtualQDial final : public QDial {
  ...
  public:
    ...
    friend bool QDial_NativeEvent(QDial* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QDial_QBaseNativeEvent(QDial* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QDial_ConnectNotify(QDial* self, QMetaMethod* signal);
    friend void QDial_QBaseConnectNotify(QDial* self, QMetaMethod* signal);
    friend void QDial_DisconnectNotify(QDial* self, QMetaMethod* signal);
    friend void QDial_QBaseDisconnectNotify(QDial* self, QMetaMethod* signal);
    ...
    friend bool QDial_IsSignalConnected(const QDial* self, QMetaMethod* signal);
    friend bool QDial_QBaseIsSignalConnected(const QDial* self, QMetaMethod* signal);
};
