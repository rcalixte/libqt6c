  ...
  public:
    ...
    virtual QList<QPair<QAccessibleInterface*, QAccessible::Relation>> relations(QAccessible::Relation match) const override {
        if (qaccessiblewidget_relations_isbase) {
            ...
            libqt_pair /* tuple of QAccessibleInterface* and int */* callback_ret_arr = static_cast<libqt_pair /* tuple of QAccessibleInterface* and int */*>(callback_ret.data.ptr);
    ...
    friend void QAccessibleWidget_AddControllingSignal(QAccessibleWidget* self, libqt_string signal);
    friend void QAccessibleWidget_QBaseAddControllingSignal(QAccessibleWidget* self, libqt_string signal);
};
