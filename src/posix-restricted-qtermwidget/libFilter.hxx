  ...
  public:
    ...
    virtual void activate(const QString& action) override {
        if (konsole__filter__hotspot_activate_callback != nullptr) {
            ...
            char* action_str = static_cast<char*>(malloc(action_str_len + 1));
            memcpy(action_str, action_b.data(), action_str_len);
            action_str[action_str_len] = '\0';
    ...
    friend void Konsole__Filter__HotSpot_SuperSetType(Konsole::Filter::HotSpot* self, int type);
};
...
class VirtualKonsoleRegExpFilterHotSpot final : public Konsole::RegExpFilter::HotSpot {
  ...
  public:
    ...
    friend void Konsole__RegExpFilter__HotSpot_SuperSetType(Konsole::RegExpFilter::HotSpot* self, int type);
};
...
class VirtualKonsoleUrlFilterHotSpot final : public Konsole::UrlFilter::HotSpot {
  ...
  public:
    ...
    friend void Konsole__UrlFilter__HotSpot_SuperSetType(Konsole::UrlFilter::HotSpot* self, int type);
};
