  ...
  public:
    ...
    virtual void changeDir(const QString& dir) override {
        if (qtermwidget_changedir_isbase) {
            ...
            char* dir_str = static_cast<char*>(malloc(dir_str_len + 1));
            memcpy(dir_str, dir_b.data(), dir_str_len);
    ...
    virtual void setTerminalBackgroundImage(const QString& backgroundImage) override {
        if (qtermwidget_setterminalbackgroundimage_isbase) {
            ...
            char* backgroundImage_str = static_cast<char*>(malloc(backgroundImage_str_len + 1));
            memcpy(backgroundImage_str, backgroundImage_b.data(), backgroundImage_str_len);
            backgroundImage_str[backgroundImage_str_len] = '\0';
    ...
    virtual void setShellProgram(const QString& program) override {
        if (qtermwidget_setshellprogram_isbase) {
            ...
            char* program_str = static_cast<char*>(malloc(program_str_len + 1));
            memcpy(program_str, program_b.data(), program_str_len);
            program_str[program_str_len] = '\0';
    ...
    virtual void setWordCharacters(const QString& chars) override {
        if (qtermwidget_setwordcharacters_isbase) {
            ...
            char* chars_str = static_cast<char*>(malloc(chars_str_len + 1));
            memcpy(chars_str, chars_b.data(), chars_str_len);
            chars_str[chars_str_len] = '\0';
