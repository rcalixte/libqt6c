...
const char* q_termwidget_tr(const char* s) {
    libqt_string _str = QTermWidget_Tr(s);
...
const char* q_termwidget_tr2(const char* s, const char* c) {
    libqt_string _str = QTermWidget_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* q_termwidget_tr3(const char* s, const char* c, int n) {
    libqt_string _str = QTermWidget_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
int64_t q_termwidget_window_state(void* self) {
    return QWidget_WindowState((QWidget*)self);
}

void q_termwidget_set_window_state(void* self, int64_t state) {
    QWidget_SetWindowState((QWidget*)self, state);
}

void q_termwidget_override_window_state(void* self, int64_t state) {
...
void q_termwidget_render4(void* self, void* target, void* targetOffset, void* sourceRegion, int64_t renderFlags) {
...
void q_termwidget_render42(void* self, void* painter, void* targetOffset, void* sourceRegion, int64_t renderFlags) {
...
void q_termwidget_grab_gesture2(void* self, int64_t typeVal, int64_t flags) {
