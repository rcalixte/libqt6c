#pragma once
#ifndef SRC_POSIX_RESTRICTED_QTERMWIDGETC_LIBFILTER_HPP
#define SRC_POSIX_RESTRICTED_QTERMWIDGETC_LIBFILTER_HPP
...
void Konsole__UrlFilter__HotSpot_SuperSetType(Konsole__UrlFilter__HotSpot* self, int type);
