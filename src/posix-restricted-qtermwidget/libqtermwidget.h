#pragma once
#ifndef SRC_POSIX_RESTRICTED_QTERMWIDGETQT6C_LIBQTERMWIDGET_H
#define SRC_POSIX_RESTRICTED_QTERMWIDGETQT6C_LIBQTERMWIDGET_H
...
void q_termwidget_grab_gesture(void* self, int64_t typeVal);
...
/// @param self QTermWidget*
/// @param typeVal enum Qt__GestureType
void q_termwidget_ungrab_gesture(void* self, int64_t typeVal);
...
void q_termwidget_set_window_flags(void* self, int64_t typeVal);
...
/// @param self QTermWidget*
/// @param typeVal flag of enum Qt__WindowType
void q_termwidget_override_window_flags(void* self, int64_t typeVal);
...
void q_termwidget_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* q_termwidget_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* q_termwidget_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
