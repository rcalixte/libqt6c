...
class VirtualQMdiSubWindow final : public QMdiSubWindow {
  ...
  public:
    ...
    friend bool QMdiSubWindow_NativeEvent(QMdiSubWindow* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QMdiSubWindow_QBaseNativeEvent(QMdiSubWindow* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QMdiSubWindow_ConnectNotify(QMdiSubWindow* self, QMetaMethod* signal);
    friend void QMdiSubWindow_QBaseConnectNotify(QMdiSubWindow* self, QMetaMethod* signal);
    friend void QMdiSubWindow_DisconnectNotify(QMdiSubWindow* self, QMetaMethod* signal);
    friend void QMdiSubWindow_QBaseDisconnectNotify(QMdiSubWindow* self, QMetaMethod* signal);
    ...
    friend bool QMdiSubWindow_IsSignalConnected(const QMdiSubWindow* self, QMetaMethod* signal);
    friend bool QMdiSubWindow_QBaseIsSignalConnected(const QMdiSubWindow* self, QMetaMethod* signal);
};
