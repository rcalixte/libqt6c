...
class VirtualQFrame final : public QFrame {
  ...
  public:
    ...
    friend bool QFrame_NativeEvent(QFrame* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QFrame_QBaseNativeEvent(QFrame* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QFrame_ConnectNotify(QFrame* self, QMetaMethod* signal);
    friend void QFrame_QBaseConnectNotify(QFrame* self, QMetaMethod* signal);
    friend void QFrame_DisconnectNotify(QFrame* self, QMetaMethod* signal);
    friend void QFrame_QBaseDisconnectNotify(QFrame* self, QMetaMethod* signal);
    ...
    friend bool QFrame_IsSignalConnected(const QFrame* self, QMetaMethod* signal);
    friend bool QFrame_QBaseIsSignalConnected(const QFrame* self, QMetaMethod* signal);
};
