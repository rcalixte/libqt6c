...
const char* q_dbusservicewatcher_tr(const char* s) {
    libqt_string _str = QDBusServiceWatcher_Tr(s);
...
const char** q_dbusservicewatcher_watched_services(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_dbusservicewatcher_watched_services");
        abort();
    }
...
void q_dbusservicewatcher_set_watched_services(void* self, const char* services[]) {
    ...
    if (services_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in q_dbusservicewatcher_set_watched_services");
        abort();
    }
...
const char* q_dbusservicewatcher_tr2(const char* s, const char* c) {
    libqt_string _str = QDBusServiceWatcher_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* q_dbusservicewatcher_tr3(const char* s, const char* c, int n) {
    libqt_string _str = QDBusServiceWatcher_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** q_dbusservicewatcher_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_dbusservicewatcher_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QMetaObject__Connection* q_dbusservicewatcher_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* q_dbusservicewatcher_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
