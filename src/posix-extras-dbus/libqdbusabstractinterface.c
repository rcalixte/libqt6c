...
const char** q_dbusabstractinterfacebase_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_dbusabstractinterfacebase_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* q_dbusabstractinterfacebase_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* q_dbusabstractinterfacebase_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
const char* q_dbusabstractinterface_tr(const char* s) {
    libqt_string _str = QDBusAbstractInterface_Tr(s);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* q_dbusabstractinterface_tr2(const char* s, const char* c) {
    libqt_string _str = QDBusAbstractInterface_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* q_dbusabstractinterface_tr3(const char* s, const char* c, int n) {
    libqt_string _str = QDBusAbstractInterface_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** q_dbusabstractinterface_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in q_dbusabstractinterface_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QMetaObject__Connection* q_dbusabstractinterface_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* q_dbusabstractinterface_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
    return QObject_Connect4((QObject*)self, (QObject*)sender, signal, member, typeVal);
}
