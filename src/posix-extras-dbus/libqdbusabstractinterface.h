#pragma once
#ifndef POSIX_EXTRAS_DBUS_LIBQDBUSABSTRACTINTERFACE_H
#define POSIX_EXTRAS_DBUS_LIBQDBUSABSTRACTINTERFACE_H
...
///
int32_t q_dbusabstractinterfacebase_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_dbusabstractinterfacebase_start_timer23(void* self, int64_t time, int32_t timerType);
...
/// @param time int64_t of nanoseconds
///
int32_t q_dbusabstractinterface_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_dbusabstractinterface_start_timer23(void* self, int64_t time, int32_t timerType);
