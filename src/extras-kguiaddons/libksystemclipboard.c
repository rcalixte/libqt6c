...
KSystemClipboard* k_systemclipboard_instance() {
    return KSystemClipboard_Instance();
}

void k_systemclipboard_set_mime_data(void* self, void* mime, int32_t mode) {
    KSystemClipboard_SetMimeData((KSystemClipboard*)self, (QMimeData*)mime, mode);
}

void k_systemclipboard_clear(void* self, int32_t mode) {
    KSystemClipboard_Clear((KSystemClipboard*)self, mode);
}

const QMimeData* k_systemclipboard_mime_data(void* self, int32_t mode) {
    return KSystemClipboard_MimeData((KSystemClipboard*)self, mode);
}

const char* k_systemclipboard_text(void* self, int32_t mode) {
    libqt_string _str = KSystemClipboard_Text((KSystemClipboard*)self, mode);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_systemclipboard_changed(void* self, int32_t mode) {
    KSystemClipboard_Changed((KSystemClipboard*)self, mode);
}

void k_systemclipboard_on_changed(void* self, void (*callback)(void*, int32_t)) {
    KSystemClipboard_Connect_Changed((KSystemClipboard*)self, (intptr_t)callback);
}

const char* k_systemclipboard_tr2(const char* s, const char* c) {
    libqt_string _str = KSystemClipboard_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_systemclipboard_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KSystemClipboard_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_systemclipboard_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_systemclipboard_dynamic_property_names");
        abort();
    }
...
QMetaObject__Connection* k_systemclipboard_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_systemclipboard_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
void k_systemclipboard_delete(void* self) {
    KSystemClipboard_Delete((KSystemClipboard*)(self));
}
