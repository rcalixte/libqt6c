#pragma once
#ifndef SRC_EXTRAS_KGUIADDONSQT6C_LIBKWINDOWINSETSCONTROLLER_H
#define SRC_EXTRAS_KGUIADDONSQT6C_LIBKWINDOWINSETSCONTROLLER_H
...
/// k_windowinsetscontroller_new2 constructs a new KWindowInsetsController object.
///
