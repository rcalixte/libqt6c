...
class VirtualQLCDNumber final : public QLCDNumber {
  ...
  public:
    ...
    friend bool QLCDNumber_NativeEvent(QLCDNumber* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QLCDNumber_QBaseNativeEvent(QLCDNumber* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QLCDNumber_ConnectNotify(QLCDNumber* self, QMetaMethod* signal);
    friend void QLCDNumber_QBaseConnectNotify(QLCDNumber* self, QMetaMethod* signal);
    friend void QLCDNumber_DisconnectNotify(QLCDNumber* self, QMetaMethod* signal);
    friend void QLCDNumber_QBaseDisconnectNotify(QLCDNumber* self, QMetaMethod* signal);
    ...
    friend bool QLCDNumber_IsSignalConnected(const QLCDNumber* self, QMetaMethod* signal);
    friend bool QLCDNumber_QBaseIsSignalConnected(const QLCDNumber* self, QMetaMethod* signal);
};
