  ...
  public:
    ...
    virtual QWidget* createWidget(const QString& className, QWidget* parent, const QString& name) override {
        if (quiloader_createwidget_isbase) {
            ...
            char* className_str = static_cast<char*>(malloc(className_str_len + 1));
            memcpy(className_str, className_b.data(), className_str_len);
            className_str[className_str_len] = '\0';
