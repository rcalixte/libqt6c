...
class VirtualQTableWidget final : public QTableWidget {
  ...
  public:
    ...
    friend QMimeData* QTableWidget_MimeData(const QTableWidget* self, libqt_list /* of QTableWidgetItem* */ items);
    friend QMimeData* QTableWidget_QBaseMimeData(const QTableWidget* self, libqt_list /* of QTableWidgetItem* */ items);
    friend bool QTableWidget_DropMimeData(QTableWidget* self, int row, int column, QMimeData* data, int action);
    friend bool QTableWidget_QBaseDropMimeData(QTableWidget* self, int row, int column, QMimeData* data, int action);
    ...
    friend void QTableWidget_SetSelection(QTableWidget* self, QRect* rect, int command);
    friend void QTableWidget_QBaseSetSelection(QTableWidget* self, QRect* rect, int command);
    friend QRegion* QTableWidget_VisualRegionForSelection(const QTableWidget* self, QItemSelection* selection);
    friend QRegion* QTableWidget_QBaseVisualRegionForSelection(const QTableWidget* self, QItemSelection* selection);
    ...
    friend bool QTableWidget_IsIndexHidden(const QTableWidget* self, QModelIndex* index);
    friend bool QTableWidget_QBaseIsIndexHidden(const QTableWidget* self, QModelIndex* index);
    friend void QTableWidget_SelectionChanged(QTableWidget* self, QItemSelection* selected, QItemSelection* deselected);
    friend void QTableWidget_QBaseSelectionChanged(QTableWidget* self, QItemSelection* selected, QItemSelection* deselected);
    friend void QTableWidget_CurrentChanged(QTableWidget* self, QModelIndex* current, QModelIndex* previous);
    friend void QTableWidget_QBaseCurrentChanged(QTableWidget* self, QModelIndex* current, QModelIndex* previous);
    friend void QTableWidget_DataChanged(QTableWidget* self, QModelIndex* topLeft, QModelIndex* bottomRight, libqt_list /* of int */ roles);
    friend void QTableWidget_QBaseDataChanged(QTableWidget* self, QModelIndex* topLeft, QModelIndex* bottomRight, libqt_list /* of int */ roles);
    friend void QTableWidget_RowsInserted(QTableWidget* self, QModelIndex* parent, int start, int end);
    friend void QTableWidget_QBaseRowsInserted(QTableWidget* self, QModelIndex* parent, int start, int end);
    friend void QTableWidget_RowsAboutToBeRemoved(QTableWidget* self, QModelIndex* parent, int start, int end);
    friend void QTableWidget_QBaseRowsAboutToBeRemoved(QTableWidget* self, QModelIndex* parent, int start, int end);
    ...
    friend bool QTableWidget_Edit2(QTableWidget* self, QModelIndex* index, int trigger, QEvent* event);
    friend bool QTableWidget_QBaseEdit2(QTableWidget* self, QModelIndex* index, int trigger, QEvent* event);
    friend int QTableWidget_SelectionCommand(const QTableWidget* self, QModelIndex* index, QEvent* event);
    friend int QTableWidget_QBaseSelectionCommand(const QTableWidget* self, QModelIndex* index, QEvent* event);
    ...
    friend bool QTableWidget_NativeEvent(QTableWidget* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QTableWidget_QBaseNativeEvent(QTableWidget* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QTableWidget_ConnectNotify(QTableWidget* self, QMetaMethod* signal);
    friend void QTableWidget_QBaseConnectNotify(QTableWidget* self, QMetaMethod* signal);
    friend void QTableWidget_DisconnectNotify(QTableWidget* self, QMetaMethod* signal);
    friend void QTableWidget_QBaseDisconnectNotify(QTableWidget* self, QMetaMethod* signal);
    ...
    friend void QTableWidget_SetDirtyRegion(QTableWidget* self, QRegion* region);
    friend void QTableWidget_QBaseSetDirtyRegion(QTableWidget* self, QRegion* region);
    ...
    friend bool QTableWidget_IsSignalConnected(const QTableWidget* self, QMetaMethod* signal);
    friend bool QTableWidget_QBaseIsSignalConnected(const QTableWidget* self, QMetaMethod* signal);
};
