...
const char* k_nscore__itemsmodel_tr(const char* s) {
    libqt_string _str = KNSCore__ItemsModel_Tr(s);
...
const char* k_nscore__itemsmodel_tr2(const char* s, const char* c) {
    libqt_string _str = KNSCore__ItemsModel_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_nscore__itemsmodel_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KNSCore__ItemsModel_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_nscore__itemsmodel_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_nscore__itemsmodel_dynamic_property_names");
        abort();
    }
...
libqt_map /* of int to QVariant* */ k_nscore__itemsmodel_item_data(void* self, void* index) {
    return KNSCore__ItemsModel_ItemData((KNSCore__ItemsModel*)self, (QModelIndex*)index);
}

libqt_map /* of int to QVariant* */ k_nscore__itemsmodel_qbase_item_data(void* self, void* index) {
    return KNSCore__ItemsModel_QBaseItemData((KNSCore__ItemsModel*)self, (QModelIndex*)index);
}
...
bool k_nscore__itemsmodel_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KNSCore__ItemsModel_SetItemData((KNSCore__ItemsModel*)self, (QModelIndex*)index, roles);
}

bool k_nscore__itemsmodel_qbase_set_item_data(void* self, void* index, libqt_map /* of int to QVariant* */ roles) {
    return KNSCore__ItemsModel_QBaseSetItemData((KNSCore__ItemsModel*)self, (QModelIndex*)index, roles);
}
...
const char** k_nscore__itemsmodel_mime_types(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_nscore__itemsmodel_mime_types");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
libqt_map /* of int to char* */ k_nscore__itemsmodel_role_names(void* self) {
    return KNSCore__ItemsModel_RoleNames((KNSCore__ItemsModel*)self);
}

libqt_map /* of int to char* */ k_nscore__itemsmodel_qbase_role_names(void* self) {
    return KNSCore__ItemsModel_QBaseRoleNames((KNSCore__ItemsModel*)self);
}
