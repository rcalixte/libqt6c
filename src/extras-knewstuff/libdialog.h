...
/// [Qt documentation](https://api.kde.org/knswidgets-dialog.html#engine)
///
/// @param self KNSWidgets__Dialog*
KNSCore__EngineBase* k_nswidgets__dialog_engine(void* self);

/// [Qt documentation](https://api.kde.org/knswidgets-dialog.html#changedEntries)
///
/// @param self KNSWidgets__Dialog*
libqt_list /* of KNSCore__Entry* */ k_nswidgets__dialog_changed_entries(void* self);

/// [Qt documentation](https://api.kde.org/knswidgets-dialog.html#open)
///
/// @param self KNSWidgets__Dialog*
