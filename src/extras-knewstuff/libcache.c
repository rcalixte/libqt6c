...
void k_nscore__cache_set_object_name(void* self, const char* name) {
...
int32_t k_nscore__cache_start_timer2(void* self, int64_t time) {
...
int32_t k_nscore__cache_start_timer23(void* self, int64_t time, int32_t timerType) {
