  ...
  public:
    ...
    virtual bool init(const QString& configfile) override {
        if (knscore__enginebase_init_isbase) {
            ...
            char* configfile_str = static_cast<char*>(malloc(configfile_str_len + 1));
            memcpy(configfile_str, configfile_b.data(), configfile_str_len);
            configfile_str[configfile_str_len] = '\0';
