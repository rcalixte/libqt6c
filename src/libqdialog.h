#pragma once
#ifndef SRC_QT6C_LIBQDIALOG_H
#define SRC_QT6C_LIBQDIALOG_H
...
/// @warning DEPRECATED: Use `q_dialog_super_meta_object` instead
///
#define q_dialog_qbase_meta_object q_dialog_super_meta_object
...
///
/// @param self QDialog*
/// @param callback void* func(QDialog* self, const char* param1)
///
void q_dialog_on_metacast(void* self, void* (*callback)(void*, const char*));

/// @warning DEPRECATED: Use `q_dialog_super_metacast` instead
///
#define q_dialog_qbase_metacast q_dialog_super_metacast
...
/// @param param1 const char*
///
void* q_dialog_super_metacast(void* self, const char* param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_metacall` instead
///
#define q_dialog_qbase_metacall q_dialog_super_metacall
...
/// @param param3 void*
///
int32_t q_dialog_super_metacall(void* self, int32_t param1, int param2, void* param3);
...
/// @warning DEPRECATED: Use `q_dialog_super_set_visible` instead
///
#define q_dialog_qbase_set_visible q_dialog_super_set_visible
...
/// @param visible bool
///
void q_dialog_super_set_visible(void* self, bool visible);
...
/// @warning DEPRECATED: Use `q_dialog_super_size_hint` instead
///
#define q_dialog_qbase_size_hint q_dialog_super_size_hint
...
/// @warning DEPRECATED: Use `q_dialog_super_minimum_size_hint` instead
///
#define q_dialog_qbase_minimum_size_hint q_dialog_super_minimum_size_hint
...
/// @warning DEPRECATED: Use `q_dialog_super_open` instead
///
#define q_dialog_qbase_open q_dialog_super_open
...
/// @param self QDialog*
///
void q_dialog_super_open(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_exec` instead
///
#define q_dialog_qbase_exec q_dialog_super_exec
...
/// @param self QDialog*
///
int32_t q_dialog_super_exec(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_done` instead
///
#define q_dialog_qbase_done q_dialog_super_done
...
/// @param param1 int
///
void q_dialog_super_done(void* self, int param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_accept` instead
///
#define q_dialog_qbase_accept q_dialog_super_accept
...
/// @param self QDialog*
///
void q_dialog_super_accept(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_reject` instead
///
#define q_dialog_qbase_reject q_dialog_super_reject
...
/// @param self QDialog*
///
void q_dialog_super_reject(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_key_press_event` instead
///
#define q_dialog_qbase_key_press_event q_dialog_super_key_press_event
...
/// @param param1 QKeyEvent*
///
void q_dialog_super_key_press_event(void* self, void* param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_close_event` instead
///
#define q_dialog_qbase_close_event q_dialog_super_close_event
...
/// @param param1 QCloseEvent*
///
void q_dialog_super_close_event(void* self, void* param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_show_event` instead
///
#define q_dialog_qbase_show_event q_dialog_super_show_event
...
/// @param param1 QShowEvent*
///
void q_dialog_super_show_event(void* self, void* param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_resize_event` instead
///
#define q_dialog_qbase_resize_event q_dialog_super_resize_event
...
/// @param param1 QResizeEvent*
///
void q_dialog_super_resize_event(void* self, void* param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_context_menu_event` instead
///
#define q_dialog_qbase_context_menu_event q_dialog_super_context_menu_event
...
/// @param param1 QContextMenuEvent*
///
void q_dialog_super_context_menu_event(void* self, void* param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_event_filter` instead
///
#define q_dialog_qbase_event_filter q_dialog_super_event_filter
...
/// @param param2 QEvent*
///
bool q_dialog_super_event_filter(void* self, void* param1, void* param2);
...
/// @warning DEPRECATED: Use `q_dialog_super_adjust_position` instead
///
#define q_dialog_qbase_adjust_position q_dialog_super_adjust_position
...
///
void q_dialog_grab_gesture(void* self, int32_t type);
...
/// @param type enum Qt__GestureType
///
void q_dialog_ungrab_gesture(void* self, int32_t type);
...
/// @param f flag of enum Qt__WindowType
///
void q_dialog_set_parent2(void* self, void* parent, int32_t f);
...
///
void q_dialog_set_window_flags(void* self, int32_t type);
...
///
void q_dialog_set_window_flag(void* self, int32_t param1);
...
/// @param type flag of enum Qt__WindowType
///
void q_dialog_override_window_flags(void* self, int32_t type);
...
///
QWidget* q_dialog_find(uintptr_t param1);
...
///
void q_dialog_set_input_method_hints(void* self, int32_t hints);
...
///
void q_dialog_grab_gesture2(void* self, int32_t type, int32_t flags);
...
/// @param on bool
///
void q_dialog_set_window_flag2(void* self, int32_t param1, bool on);
...
///
QWidget* q_dialog_create_window_container3(void* window, void* parent, int32_t flags);
...
///
int32_t q_dialog_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_dialog_start_timer23(void* self, int64_t time, int32_t timerType);
...
/// @warning DEPRECATED: Use `q_dialog_super_dev_type` instead
///
#define q_dialog_qbase_dev_type q_dialog_super_dev_type
...
/// @warning DEPRECATED: Use `q_dialog_super_height_for_width` instead
///
#define q_dialog_qbase_height_for_width q_dialog_super_height_for_width
...
/// @warning DEPRECATED: Use `q_dialog_super_has_height_for_width` instead
///
#define q_dialog_qbase_has_height_for_width q_dialog_super_has_height_for_width
...
/// @warning DEPRECATED: Use `q_dialog_super_paint_engine` instead
///
#define q_dialog_qbase_paint_engine q_dialog_super_paint_engine
...
/// @warning DEPRECATED: Use `q_dialog_super_event` instead
///
#define q_dialog_qbase_event q_dialog_super_event
...
/// @param event QEvent*
///
bool q_dialog_super_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_mouse_press_event` instead
///
#define q_dialog_qbase_mouse_press_event q_dialog_super_mouse_press_event
...
/// @param event QMouseEvent*
///
void q_dialog_super_mouse_press_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_mouse_release_event` instead
///
#define q_dialog_qbase_mouse_release_event q_dialog_super_mouse_release_event
...
/// @param event QMouseEvent*
///
void q_dialog_super_mouse_release_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_mouse_double_click_event` instead
///
#define q_dialog_qbase_mouse_double_click_event q_dialog_super_mouse_double_click_event
...
/// @param event QMouseEvent*
///
void q_dialog_super_mouse_double_click_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_mouse_move_event` instead
///
#define q_dialog_qbase_mouse_move_event q_dialog_super_mouse_move_event
...
/// @param event QMouseEvent*
///
void q_dialog_super_mouse_move_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_wheel_event` instead
///
#define q_dialog_qbase_wheel_event q_dialog_super_wheel_event
...
/// @param event QWheelEvent*
///
void q_dialog_super_wheel_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_key_release_event` instead
///
#define q_dialog_qbase_key_release_event q_dialog_super_key_release_event
...
/// @param event QKeyEvent*
///
void q_dialog_super_key_release_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_focus_in_event` instead
///
#define q_dialog_qbase_focus_in_event q_dialog_super_focus_in_event
...
/// @param event QFocusEvent*
///
void q_dialog_super_focus_in_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_focus_out_event` instead
///
#define q_dialog_qbase_focus_out_event q_dialog_super_focus_out_event
...
/// @param event QFocusEvent*
///
void q_dialog_super_focus_out_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_enter_event` instead
///
#define q_dialog_qbase_enter_event q_dialog_super_enter_event
...
/// @param event QEnterEvent*
///
void q_dialog_super_enter_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_leave_event` instead
///
#define q_dialog_qbase_leave_event q_dialog_super_leave_event
...
/// @param event QEvent*
///
void q_dialog_super_leave_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_paint_event` instead
///
#define q_dialog_qbase_paint_event q_dialog_super_paint_event
...
/// @param event QPaintEvent*
///
void q_dialog_super_paint_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_move_event` instead
///
#define q_dialog_qbase_move_event q_dialog_super_move_event
...
/// @param event QMoveEvent*
///
void q_dialog_super_move_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_tablet_event` instead
///
#define q_dialog_qbase_tablet_event q_dialog_super_tablet_event
...
/// @param event QTabletEvent*
///
void q_dialog_super_tablet_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_action_event` instead
///
#define q_dialog_qbase_action_event q_dialog_super_action_event
...
/// @param event QActionEvent*
///
void q_dialog_super_action_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_drag_enter_event` instead
///
#define q_dialog_qbase_drag_enter_event q_dialog_super_drag_enter_event
...
/// @param event QDragEnterEvent*
///
void q_dialog_super_drag_enter_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_drag_move_event` instead
///
#define q_dialog_qbase_drag_move_event q_dialog_super_drag_move_event
...
/// @param event QDragMoveEvent*
///
void q_dialog_super_drag_move_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_drag_leave_event` instead
///
#define q_dialog_qbase_drag_leave_event q_dialog_super_drag_leave_event
...
/// @param event QDragLeaveEvent*
///
void q_dialog_super_drag_leave_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_drop_event` instead
///
#define q_dialog_qbase_drop_event q_dialog_super_drop_event
...
/// @param event QDropEvent*
///
void q_dialog_super_drop_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_hide_event` instead
///
#define q_dialog_qbase_hide_event q_dialog_super_hide_event
...
/// @param event QHideEvent*
///
void q_dialog_super_hide_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_native_event` instead
///
#define q_dialog_qbase_native_event q_dialog_super_native_event
...
/// @param result intptr_t*
///
bool q_dialog_super_native_event(void* self, char* eventType, void* message, intptr_t* result);
...
///
/// @param self QDialog*
/// @param callback bool func(QDialog* self, libqt_string eventType, void* message, intptr_t* result)
///
...
/// @warning DEPRECATED: Use `q_dialog_super_change_event` instead
///
#define q_dialog_qbase_change_event q_dialog_super_change_event
...
/// @param param1 QEvent*
///
void q_dialog_super_change_event(void* self, void* param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_metric` instead
///
#define q_dialog_qbase_metric q_dialog_super_metric
...
/// @warning DEPRECATED: Use `q_dialog_super_init_painter` instead
///
#define q_dialog_qbase_init_painter q_dialog_super_init_painter
...
/// @warning DEPRECATED: Use `q_dialog_super_redirected` instead
///
#define q_dialog_qbase_redirected q_dialog_super_redirected
...
/// @warning DEPRECATED: Use `q_dialog_super_shared_painter` instead
///
#define q_dialog_qbase_shared_painter q_dialog_super_shared_painter
...
/// @warning DEPRECATED: Use `q_dialog_super_input_method_event` instead
///
#define q_dialog_qbase_input_method_event q_dialog_super_input_method_event
...
/// @param param1 QInputMethodEvent*
///
void q_dialog_super_input_method_event(void* self, void* param1);
...
/// @warning DEPRECATED: Use `q_dialog_super_input_method_query` instead
///
#define q_dialog_qbase_input_method_query q_dialog_super_input_method_query
...
/// @warning DEPRECATED: Use `q_dialog_super_focus_next_prev_child` instead
///
#define q_dialog_qbase_focus_next_prev_child q_dialog_super_focus_next_prev_child
...
/// @param next bool
///
bool q_dialog_super_focus_next_prev_child(void* self, bool next);
...
/// @warning DEPRECATED: Use `q_dialog_super_timer_event` instead
///
#define q_dialog_qbase_timer_event q_dialog_super_timer_event
...
/// @param event QTimerEvent*
///
void q_dialog_super_timer_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_child_event` instead
///
#define q_dialog_qbase_child_event q_dialog_super_child_event
...
/// @param event QChildEvent*
///
void q_dialog_super_child_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_custom_event` instead
///
#define q_dialog_qbase_custom_event q_dialog_super_custom_event
...
/// @param event QEvent*
///
void q_dialog_super_custom_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_dialog_super_connect_notify` instead
///
#define q_dialog_qbase_connect_notify q_dialog_super_connect_notify
...
/// @warning DEPRECATED: Use `q_dialog_super_disconnect_notify` instead
///
#define q_dialog_qbase_disconnect_notify q_dialog_super_disconnect_notify
...
/// @warning DEPRECATED: Use `q_dialog_super_update_micro_focus` instead
///
#define q_dialog_qbase_update_micro_focus q_dialog_super_update_micro_focus
...
/// @param self QDialog*
///
void q_dialog_super_update_micro_focus(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_create` instead
///
#define q_dialog_qbase_create q_dialog_super_create
...
/// @param self QDialog*
///
void q_dialog_super_create(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_destroy` instead
///
#define q_dialog_qbase_destroy q_dialog_super_destroy
...
/// @param self QDialog*
///
void q_dialog_super_destroy(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_focus_next_child` instead
///
#define q_dialog_qbase_focus_next_child q_dialog_super_focus_next_child
...
/// @param self QDialog*
///
bool q_dialog_super_focus_next_child(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_focus_previous_child` instead
///
#define q_dialog_qbase_focus_previous_child q_dialog_super_focus_previous_child
...
/// @param self QDialog*
///
bool q_dialog_super_focus_previous_child(void* self);
...
/// @warning DEPRECATED: Use `q_dialog_super_sender` instead
///
#define q_dialog_qbase_sender q_dialog_super_sender
...
/// @warning DEPRECATED: Use `q_dialog_super_sender_signal_index` instead
///
#define q_dialog_qbase_sender_signal_index q_dialog_super_sender_signal_index
...
/// @warning DEPRECATED: Use `q_dialog_super_receivers` instead
///
#define q_dialog_qbase_receivers q_dialog_super_receivers
...
/// @warning DEPRECATED: Use `q_dialog_super_is_signal_connected` instead
///
#define q_dialog_qbase_is_signal_connected q_dialog_super_is_signal_connected
...
/// @warning DEPRECATED: Use `q_dialog_super_get_decoded_metric_f` instead
///
#define q_dialog_qbase_get_decoded_metric_f q_dialog_super_get_decoded_metric_f
