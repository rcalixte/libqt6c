  ...
  public:
    ...
    virtual void setImagePath(const QString& svgFilePath) override {
        if (ksvg__svg_setimagepath_isbase) {
            ...
            char* svgFilePath_str = static_cast<char*>(malloc(svgFilePath_str_len + 1));
            memcpy(svgFilePath_str, svgFilePath_b.data(), svgFilePath_str_len);
            svgFilePath_str[svgFilePath_str_len] = '\0';
