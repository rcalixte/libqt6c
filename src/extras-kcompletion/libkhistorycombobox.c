...
const char* k_historycombobox_tr(const char* s) {
    libqt_string _str = KHistoryComboBox_Tr(s);
...
void k_historycombobox_set_history_items(void* self, const char* items[]) {
    ...
    if (items_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_historycombobox_set_history_items");
        abort();
    }
...
void k_historycombobox_set_history_items2(void* self, const char* items[], bool setCompletionList) {
    ...
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_historycombobox_set_history_items2");
        abort();
    }
    for (size_t i = 0; i < items_len; ++i) {
        items_qstr[i] = qstring(items[i]);
...
const char** k_historycombobox_history_items(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_historycombobox_history_items");
        abort();
    }
...
void k_historycombobox_insert_items(void* self, const char* items[]) {
    ...
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_historycombobox_insert_items");
        abort();
    }
    for (size_t i = 0; i < items_len; ++i) {
        items_qstr[i] = qstring(items[i]);
...
const char* k_historycombobox_tr2(const char* s, const char* c) {
    libqt_string _str = KHistoryComboBox_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_historycombobox_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KHistoryComboBox_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_historycombobox_rotate_text(void* self, int32_t typeVal) {
...
void k_historycombobox_add_items(void* self, const char* texts[]) {
    ...
    if (texts_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_historycombobox_add_items");
        abort();
    }
...
void k_historycombobox_grab_gesture(void* self, int64_t typeVal) {
    QWidget_GrabGesture((QWidget*)self, typeVal);
}

void k_historycombobox_ungrab_gesture(void* self, int64_t typeVal) {
...
void k_historycombobox_set_window_flags(void* self, int64_t typeVal) {
...
void k_historycombobox_override_window_flags(void* self, int64_t typeVal) {
...
void k_historycombobox_grab_gesture2(void* self, int64_t typeVal, int32_t flags) {
...
const char** k_historycombobox_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_historycombobox_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QMetaObject__Connection* k_historycombobox_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_historycombobox_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
...
void k_historycombobox_set_completed_items(void* self, const char* items[], bool autoSuggest) {
    ...
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_historycombobox_set_completed_items");
        abort();
    }
    for (size_t i = 0; i < items_len; ++i) {
        items_qstr[i] = qstring(items[i]);
...
libqt_map /* of int32_t to libqt_list  of QKeySequence*  */ k_historycombobox_key_binding_map(void* self) {
    return KHistoryComboBox_KeyBindingMap((KHistoryComboBox*)self);
}

libqt_map /* of int32_t to libqt_list  of QKeySequence*  */ k_historycombobox_qbase_key_binding_map(void* self) {
    return KHistoryComboBox_QBaseKeyBindingMap((KHistoryComboBox*)self);
}
...
void k_historycombobox_set_key_binding_map(void* self, libqt_map /* of int32_t to QKeySequence* */ keyBindingMap) {
    KHistoryComboBox_SetKeyBindingMap((KHistoryComboBox*)self, keyBindingMap);
}

void k_historycombobox_qbase_set_key_binding_map(void* self, libqt_map /* of int32_t to QKeySequence* */ keyBindingMap) {
    KHistoryComboBox_QBaseSetKeyBindingMap((KHistoryComboBox*)self, keyBindingMap);
}
