...
const char* k_combobox_tr(const char* s) {
    libqt_string _str = KComboBox_Tr(s);
...
void k_combobox_set_completed_items(void* self, const char* items[], bool autoSuggest) {
    ...
    if (items_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_combobox_set_completed_items");
        abort();
    }
...
const char* k_combobox_tr2(const char* s, const char* c) {
    libqt_string _str = KComboBox_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_combobox_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KComboBox_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
void k_combobox_add_items(void* self, const char* texts[]) {
    ...
    if (texts_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_combobox_add_items");
        abort();
    }
...
void k_combobox_insert_items(void* self, int index, const char* texts[]) {
    ...
    libqt_string* texts_qstr = (libqt_string*)malloc(texts_len * sizeof(libqt_string));
    if (texts_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_combobox_insert_items");
        abort();
    }
    for (size_t i = 0; i < texts_len; ++i) {
        texts_qstr[i] = qstring(texts[i]);
...
QVariant* k_combobox_input_method_query2(void* self, int64_t query, void* argument) {
...
void k_combobox_set_parent2(void* self, void* parent, int64_t f) {
...
int64_t k_combobox_window_flags(void* self) {
    return QWidget_WindowFlags((QWidget*)self);
}

void k_combobox_set_window_flag(void* self, int64_t param1) {
...
int64_t k_combobox_window_type(void* self) {
...
int64_t k_combobox_input_method_hints(void* self) {
    return QWidget_InputMethodHints((QWidget*)self);
}

void k_combobox_set_input_method_hints(void* self, int64_t hints) {
...
void k_combobox_set_window_flag2(void* self, int64_t param1, bool on) {
...
QWidget* k_combobox_create_window_container3(void* window, void* parent, int64_t flags) {
...
const char** k_combobox_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_combobox_dynamic_property_names");
        abort();
    }
...
bool k_combobox_move_to_thread2(void* self, void* thread, void* param2) {
...
QVariant* k_combobox_input_method_query(void* self, int64_t param1) {
    return KComboBox_InputMethodQuery((KComboBox*)self, param1);
}

QVariant* k_combobox_qbase_input_method_query(void* self, int64_t param1) {
    return KComboBox_QBaseInputMethodQuery((KComboBox*)self, param1);
}

void k_combobox_on_input_method_query(void* self, QVariant* (*callback)(void*, int64_t)) {
