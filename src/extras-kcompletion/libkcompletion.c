...
const char* k_completion_tr(const char* s) {
    libqt_string _str = KCompletion_Tr(s);
...
const char** k_completion_substring_completion(void* self, const char* stringVal) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_substring_completion");
        abort();
    }
...
const char** k_completion_items(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_items");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** k_completion_all_matches(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_all_matches");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
const char** k_completion_all_matches2(void* self, const char* stringVal) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_all_matches2");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
void k_completion_insert_items(void* self, const char* items[]) {
    ...
    if (items_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_insert_items");
        abort();
    }
...
void k_completion_set_items(void* self, const char* itemList[]) {
    ...
    if (itemList_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_set_items");
        abort();
    }
...
void k_completion_matches(void* self, const char* matchlist[]) {
    ...
    if (matchlist_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_matches");
        abort();
    }
...
void k_completion_post_process_matches(void* self, const char* matchList[]) {
    ...
    libqt_string* matchList_qstr = (libqt_string*)malloc(matchList_len * sizeof(libqt_string));
    if (matchList_qstr == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_post_process_matches");
        abort();
    }
    for (size_t i = 0; i < matchList_len; ++i) {
        matchList_qstr[i] = qstring(matchList[i]);
...
const char* k_completion_tr2(const char* s, const char* c) {
    libqt_string _str = KCompletion_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_completion_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KCompletion_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_completion_dynamic_property_names(void* self) {
    ...
    const char** _ret = (const char**)malloc((_arr.len + 1) * sizeof(const char*));
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_completion_dynamic_property_names");
        abort();
    }
    for (size_t i = 0; i < _arr.len; ++i) {
        _ret[i] = qstring_to_char(_qstr[i]);
...
QMetaObject__Connection* k_completion_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_completion_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
