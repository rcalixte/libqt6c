...
const char* k_emailvalidator_tr(const char* s) {
    libqt_string _str = KEmailValidator_Tr(s);
...
const char* k_emailvalidator_tr2(const char* s, const char* c) {
    libqt_string _str = KEmailValidator_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_emailvalidator_tr3(const char* s, const char* c, int n) {
    libqt_string _str = KEmailValidator_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
QMetaObject__Connection* k_emailvalidator_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal) {
    return QObject_Connect5((QObject*)sender, (QMetaMethod*)signal, (QObject*)receiver, (QMetaMethod*)method, typeVal);
}

QMetaObject__Connection* k_emailvalidator_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal) {
