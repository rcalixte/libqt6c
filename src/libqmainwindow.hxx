...
class VirtualQMainWindow final : public QMainWindow {
  ...
  public:
    ...
    friend bool QMainWindow_NativeEvent(QMainWindow* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QMainWindow_QBaseNativeEvent(QMainWindow* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QMainWindow_ConnectNotify(QMainWindow* self, QMetaMethod* signal);
    friend void QMainWindow_QBaseConnectNotify(QMainWindow* self, QMetaMethod* signal);
    friend void QMainWindow_DisconnectNotify(QMainWindow* self, QMetaMethod* signal);
    friend void QMainWindow_QBaseDisconnectNotify(QMainWindow* self, QMetaMethod* signal);
    ...
    friend bool QMainWindow_IsSignalConnected(const QMainWindow* self, QMetaMethod* signal);
    friend bool QMainWindow_QBaseIsSignalConnected(const QMainWindow* self, QMetaMethod* signal);
};
