#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_QCUSTOMPLOTC_LIBQCUSTOMPLOT_HPP
#define SRC_RESTRICTED_EXTRAS_QCUSTOMPLOTC_LIBQCUSTOMPLOT_HPP
...
void QCPDataSelection_EnforceType(QCPDataSelection* self, int type);
...
void QCPAxis_SetScaleType(QCPAxis* self, int type);
...
int QCPAxis_Orientation2(int type);
int QCPAxis_Opposite(int type);
...
void QCPItemPosition_SetType(QCPItemPosition* self, int type);
void QCPItemPosition_SetTypeX(QCPItemPosition* self, int type);
void QCPItemPosition_SetTypeY(QCPItemPosition* self, int type);
...
int QCPAxisRect_AxisCount(const QCPAxisRect* self, int type);
QCPAxis* QCPAxisRect_Axis(const QCPAxisRect* self, int type);
...
QCPAxis* QCPAxisRect_AddAxis(QCPAxisRect* self, int type);
...
QCPAxis* QCPAxisRect_Axis2(const QCPAxisRect* self, int type, int index);
QCPAxis* QCPAxisRect_AddAxis2(QCPAxisRect* self, int type, QCPAxis* axis);
...
void QCPAxisRect_UpdateAxesOffset(QCPAxisRect* self, int type);
void QCPAxisRect_OnUpdateAxesOffset(QCPAxisRect* self, intptr_t slot);
void QCPAxisRect_QBaseUpdateAxesOffset(QCPAxisRect* self, int type);
...
void QCPColorScale_SetType(QCPColorScale* self, int type);
...
void QCPErrorBars_SetData2(QCPErrorBars* self, const libqt_list /* of double */ error);
...
void QCPErrorBars_SetErrorType(QCPErrorBars* self, int type);
...
void QCPErrorBars_AddData(QCPErrorBars* self, const libqt_list /* of double */ error);
void QCPErrorBars_AddData2(QCPErrorBars* self, const libqt_list /* of double */ errorMinus, const libqt_list /* of double */ errorPlus);
void QCPErrorBars_AddData3(QCPErrorBars* self, double error);
...
void QCPPolarAxisRadial_SetScaleType(QCPPolarAxisRadial* self, int type);
...
void QCPPolarGrid_SetType(QCPPolarGrid* self, int type);
void QCPPolarGrid_SetSubGridType(QCPPolarGrid* self, int type);
