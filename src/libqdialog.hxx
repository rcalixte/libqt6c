...
class VirtualQDialog final : public QDialog {
  ...
  public:
    ...
    friend bool QDialog_NativeEvent(QDialog* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QDialog_QBaseNativeEvent(QDialog* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QDialog_ConnectNotify(QDialog* self, QMetaMethod* signal);
    friend void QDialog_QBaseConnectNotify(QDialog* self, QMetaMethod* signal);
    friend void QDialog_DisconnectNotify(QDialog* self, QMetaMethod* signal);
    friend void QDialog_QBaseDisconnectNotify(QDialog* self, QMetaMethod* signal);
    ...
    friend bool QDialog_IsSignalConnected(const QDialog* self, QMetaMethod* signal);
    friend bool QDialog_QBaseIsSignalConnected(const QDialog* self, QMetaMethod* signal);
};
