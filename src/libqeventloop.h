...
void q_eventloop_kill_timer2(void* self, int64_t id);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QEventLoop* self, void (*slot)(QEventLoop*) ```
...
int32_t q_eventloop_start_timer22(void* self, int interval, int64_t timerType);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QEventLoop* self, void (*slot)(QEventLoop*, QObject*) ```
...
///
/// ``` QEventLoop* self, void (*slot)(QEventLoop*, const char*) ```
