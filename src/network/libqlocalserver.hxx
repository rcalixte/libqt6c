...
class VirtualQLocalServer final : public QLocalServer {
  ...
  public:
    ...
    friend void QLocalServer_ConnectNotify(QLocalServer* self, QMetaMethod* signal);
    friend void QLocalServer_QBaseConnectNotify(QLocalServer* self, QMetaMethod* signal);
    friend void QLocalServer_DisconnectNotify(QLocalServer* self, QMetaMethod* signal);
    friend void QLocalServer_QBaseDisconnectNotify(QLocalServer* self, QMetaMethod* signal);
    ...
    friend bool QLocalServer_IsSignalConnected(const QLocalServer* self, QMetaMethod* signal);
    friend bool QLocalServer_QBaseIsSignalConnected(const QLocalServer* self, QMetaMethod* signal);
};
