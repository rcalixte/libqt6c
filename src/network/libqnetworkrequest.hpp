#pragma once
#ifndef SRC_NETWORKC_LIBQNETWORKREQUEST_HPP
#define SRC_NETWORKC_LIBQNETWORKREQUEST_HPP
...
bool QNetworkRequest_HasRawHeader(const QNetworkRequest* self, char* headerName);
libqt_list /* of libqt_string */ QNetworkRequest_RawHeaderList(const QNetworkRequest* self);
libqt_string QNetworkRequest_RawHeader(const QNetworkRequest* self, char* headerName);
