...
libqt_string QHttpHeaders_Value(const QHttpHeaders* self, char* name);
...
libqt_string QHttpHeaders_Value22(const QHttpHeaders* self, char* name, libqt_string defaultValue);
