...
class VirtualQMenu final : public QMenu {
  ...
  public:
    ...
    friend void QMenu_InitStyleOption(const QMenu* self, QStyleOptionMenuItem* option, QAction* action);
    friend void QMenu_QBaseInitStyleOption(const QMenu* self, QStyleOptionMenuItem* option, QAction* action);
    ...
    friend bool QMenu_NativeEvent(QMenu* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QMenu_QBaseNativeEvent(QMenu* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QMenu_ConnectNotify(QMenu* self, QMetaMethod* signal);
    friend void QMenu_QBaseConnectNotify(QMenu* self, QMetaMethod* signal);
    friend void QMenu_DisconnectNotify(QMenu* self, QMetaMethod* signal);
    friend void QMenu_QBaseDisconnectNotify(QMenu* self, QMetaMethod* signal);
    ...
    friend bool QMenu_IsSignalConnected(const QMenu* self, QMetaMethod* signal);
    friend bool QMenu_QBaseIsSignalConnected(const QMenu* self, QMetaMethod* signal);
};
