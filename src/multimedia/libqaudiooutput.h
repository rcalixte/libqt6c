#pragma once
#ifndef SRC_MULTIMEDIA_QT6C_LIBQAUDIOOUTPUT_H
#define SRC_MULTIMEDIA_QT6C_LIBQAUDIOOUTPUT_H
...
/// @warning DEPRECATED: Use `q_audiooutput_super_meta_object` instead
///
#define q_audiooutput_qbase_meta_object q_audiooutput_super_meta_object
...
/// @param self QAudioOutput*
///
const QMetaObject* q_audiooutput_super_meta_object(void* self);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_metacast` instead
///
#define q_audiooutput_qbase_metacast q_audiooutput_super_metacast
...
/// @param param1 const char*
///
void* q_audiooutput_super_metacast(void* self, const char* param1);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_metacall` instead
///
#define q_audiooutput_qbase_metacall q_audiooutput_super_metacall
...
/// @param param3 void*
///
int32_t q_audiooutput_super_metacall(void* self, int32_t param1, int param2, void* param3);
...
///
int32_t q_audiooutput_start_timer2(void* self, int64_t time);
...
///
libqt_list q_audiooutput_children(void* self);
...
///
QMetaObject__Connection* q_audiooutput_connect(void* sender, const char* signal, void* receiver, const char* member);
...
///
QMetaObject__Connection* q_audiooutput_connect2(void* sender, void* signal, void* receiver, void* method);
...
/// @param member const char*
///
QMetaObject__Connection* q_audiooutput_connect3(void* self, void* sender, const char* signal, const char* member);
...
/// @param member const char*
///
bool q_audiooutput_disconnect(void* sender, const char* signal, void* receiver, const char* member);
...
///
bool q_audiooutput_disconnect2(void* sender, void* signal, void* receiver, void* member);
...
/// @param self QAudioOutput*
///
bool q_audiooutput_disconnect3(void* self);
...
/// @param receiver QObject*
///
bool q_audiooutput_disconnect4(void* self, void* receiver);
...
///
bool q_audiooutput_disconnect5(void* param1);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_audiooutput_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
QMetaObject__Connection* q_audiooutput_connect5(void* sender, const char* signal, void* receiver, const char* member, int32_t param5);
...
///
QMetaObject__Connection* q_audiooutput_connect52(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
/// @param signal const char*
///
bool q_audiooutput_disconnect1(void* self, const char* signal);
...
/// @param receiver QObject*
///
bool q_audiooutput_disconnect22(void* self, const char* signal, void* receiver);
...
/// @param member const char*
///
bool q_audiooutput_disconnect32(void* self, const char* signal, void* receiver, const char* member);
...
/// @param member const char*
///
bool q_audiooutput_disconnect23(void* self, void* receiver, const char* member);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_event` instead
///
#define q_audiooutput_qbase_event q_audiooutput_super_event
...
/// @param event QEvent*
///
bool q_audiooutput_super_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_event_filter` instead
///
#define q_audiooutput_qbase_event_filter q_audiooutput_super_event_filter
...
/// @param event QEvent*
///
bool q_audiooutput_super_event_filter(void* self, void* watched, void* event);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_timer_event` instead
///
#define q_audiooutput_qbase_timer_event q_audiooutput_super_timer_event
...
/// @param event QTimerEvent*
///
void q_audiooutput_super_timer_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_child_event` instead
///
#define q_audiooutput_qbase_child_event q_audiooutput_super_child_event
...
/// @param event QChildEvent*
///
void q_audiooutput_super_child_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_custom_event` instead
///
#define q_audiooutput_qbase_custom_event q_audiooutput_super_custom_event
...
/// @param event QEvent*
///
void q_audiooutput_super_custom_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_connect_notify` instead
///
#define q_audiooutput_qbase_connect_notify q_audiooutput_super_connect_notify
...
/// @param signal QMetaMethod*
///
void q_audiooutput_super_connect_notify(void* self, void* signal);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_disconnect_notify` instead
///
#define q_audiooutput_qbase_disconnect_notify q_audiooutput_super_disconnect_notify
...
/// @param signal QMetaMethod*
///
void q_audiooutput_super_disconnect_notify(void* self, void* signal);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_sender` instead
///
#define q_audiooutput_qbase_sender q_audiooutput_super_sender
...
/// @param self QAudioOutput*
///
QObject* q_audiooutput_super_sender(void* self);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_sender_signal_index` instead
///
#define q_audiooutput_qbase_sender_signal_index q_audiooutput_super_sender_signal_index
...
/// @param self QAudioOutput*
///
int32_t q_audiooutput_super_sender_signal_index(void* self);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_receivers` instead
///
#define q_audiooutput_qbase_receivers q_audiooutput_super_receivers
...
/// @param signal const char*
///
int32_t q_audiooutput_super_receivers(void* self, const char* signal);
...
/// @warning DEPRECATED: Use `q_audiooutput_super_is_signal_connected` instead
///
#define q_audiooutput_qbase_is_signal_connected q_audiooutput_super_is_signal_connected
...
/// @param signal QMetaMethod*
///
bool q_audiooutput_super_is_signal_connected(void* self, void* signal);
