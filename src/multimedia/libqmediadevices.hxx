...
class VirtualQMediaDevices final : public QMediaDevices {
  ...
  public:
    ...
    friend void QMediaDevices_ConnectNotify(QMediaDevices* self, QMetaMethod* signal);
    friend void QMediaDevices_QBaseConnectNotify(QMediaDevices* self, QMetaMethod* signal);
    friend void QMediaDevices_DisconnectNotify(QMediaDevices* self, QMetaMethod* signal);
    friend void QMediaDevices_QBaseDisconnectNotify(QMediaDevices* self, QMetaMethod* signal);
    ...
    friend bool QMediaDevices_IsSignalConnected(const QMediaDevices* self, QMetaMethod* signal);
    friend bool QMediaDevices_QBaseIsSignalConnected(const QMediaDevices* self, QMetaMethod* signal);
};
