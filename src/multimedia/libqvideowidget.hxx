...
class VirtualQVideoWidget final : public QVideoWidget {
  ...
  public:
    ...
    friend bool QVideoWidget_NativeEvent(QVideoWidget* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QVideoWidget_QBaseNativeEvent(QVideoWidget* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QVideoWidget_ConnectNotify(QVideoWidget* self, QMetaMethod* signal);
    friend void QVideoWidget_QBaseConnectNotify(QVideoWidget* self, QMetaMethod* signal);
    friend void QVideoWidget_DisconnectNotify(QVideoWidget* self, QMetaMethod* signal);
    friend void QVideoWidget_QBaseDisconnectNotify(QVideoWidget* self, QMetaMethod* signal);
    ...
    friend bool QVideoWidget_IsSignalConnected(const QVideoWidget* self, QMetaMethod* signal);
    friend bool QVideoWidget_QBaseIsSignalConnected(const QVideoWidget* self, QMetaMethod* signal);
};
