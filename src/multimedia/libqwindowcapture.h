...
void q_windowcapture_kill_timer_with_id(void* self, int64_t id);
...
bool q_windowcapture_disconnect_with_q_meta_object_connection(void* param1);
...
int32_t q_windowcapture_start_timer2(void* self, int interval, int64_t timerType);
