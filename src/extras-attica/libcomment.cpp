...
libqt_string Attica__Comment_CommentTypeToString(const int type) {
    QString _ret = Attica::Comment::commentTypeToString(static_cast<const Attica::Comment::Type>(type));
...
void Attica__Comment_SetChildren(Attica__Comment* self, libqt_list /* of Attica__Comment* */ comments) {
    ...
    Attica__Comment** comments_arr = static_cast<Attica__Comment**>(comments.data.ptr);
