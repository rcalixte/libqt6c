...
libqt_string Attica__Achievement_AchievementTypeToString(const int type) {
    QString _ret = Attica::Achievement::achievementTypeToString(static_cast<const Attica::Achievement::Type>(type));
...
void Attica__Achievement_SetDependencies(Attica__Achievement* self, const libqt_list /* of libqt_string */ dependencies) {
    ...
    libqt_string* dependencies_arr = static_cast<libqt_string*>(dependencies.data.ptr);
...
void Attica__Achievement_SetType(Attica__Achievement* self, int type) {
    self->setType(static_cast<Attica::Achievement::Type>(type));
}
...
void Attica__Achievement_SetOptions(Attica__Achievement* self, const libqt_list /* of libqt_string */ options) {
    ...
    libqt_string* options_arr = static_cast<libqt_string*>(options.data.ptr);
