...
const QMetaObject* k_attica__deletejob_meta_object(void* self) {
    return Attica__DeleteJob_MetaObject((Attica__DeleteJob*)self);
}

void* k_attica__deletejob_metacast(void* self, const char* param1) {
    return Attica__DeleteJob_Metacast((Attica__DeleteJob*)self, param1);
}

int32_t k_attica__deletejob_metacall(void* self, int32_t param1, int param2, void* param3) {
    return Attica__DeleteJob_Metacall((Attica__DeleteJob*)self, param1, param2, param3);
}

const char* k_attica__deletejob_tr(const char* s) {
    libqt_string _str = Attica__DeleteJob_Tr(s);
...
const char* k_attica__deletejob_tr2(const char* s, const char* c) {
    libqt_string _str = Attica__DeleteJob_Tr2(s, c);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char* k_attica__deletejob_tr3(const char* s, const char* c, int n) {
    libqt_string _str = Attica__DeleteJob_Tr3(s, c, n);
    char* _ret = qstring_to_char(_str);
    libqt_string_free(&_str);
    return _ret;
}
...
const char** k_attica__deletejob_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Memory allocation failed in k_attica__deletejob_dynamic_property_names");
        abort();
    }
...
void k_attica__deletejob_delete(void* self) {
    Attica__DeleteJob_Delete((Attica__DeleteJob*)(self));
}
