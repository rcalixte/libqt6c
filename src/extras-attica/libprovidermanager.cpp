...
void Attica__ProviderManager_FailedToLoad(Attica__ProviderManager* self, const QUrl* provider, int error) {
    self->failedToLoad(*provider, static_cast<QNetworkReply::NetworkError>(error));
}
...
void Attica__ProviderManager_Connect_FailedToLoad(Attica__ProviderManager* self, intptr_t slot) {
    ...
    Attica::ProviderManager::connect(self, &Attica::ProviderManager::failedToLoad, [self, slotFunc](const QUrl& provider, QNetworkReply::NetworkError error) {
