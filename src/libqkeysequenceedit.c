...
const char** q_keysequenceedit_dynamic_property_names(void* self) {
    ...
    if (_ret == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_keysequenceedit_dynamic_property_names\n");
        abort();
    }
...
bool q_keysequenceedit_painting_active(void* self) {
    return QPaintDevice_PaintingActive(q_keysequenceedit_as_q_paint_device(self));
}

int32_t q_keysequenceedit_width_m_m(void* self) {
    return QPaintDevice_WidthMM(q_keysequenceedit_as_q_paint_device(self));
}

int32_t q_keysequenceedit_height_m_m(void* self) {
    return QPaintDevice_HeightMM(q_keysequenceedit_as_q_paint_device(self));
}

int32_t q_keysequenceedit_logical_dpi_x(void* self) {
    return QPaintDevice_LogicalDpiX(q_keysequenceedit_as_q_paint_device(self));
}

int32_t q_keysequenceedit_logical_dpi_y(void* self) {
    return QPaintDevice_LogicalDpiY(q_keysequenceedit_as_q_paint_device(self));
}

int32_t q_keysequenceedit_physical_dpi_x(void* self) {
    return QPaintDevice_PhysicalDpiX(q_keysequenceedit_as_q_paint_device(self));
}

int32_t q_keysequenceedit_physical_dpi_y(void* self) {
    return QPaintDevice_PhysicalDpiY(q_keysequenceedit_as_q_paint_device(self));
}

double q_keysequenceedit_device_pixel_ratio(void* self) {
    return QPaintDevice_DevicePixelRatio(q_keysequenceedit_as_q_paint_device(self));
}

double q_keysequenceedit_device_pixel_ratio_f(void* self) {
    return QPaintDevice_DevicePixelRatioF(q_keysequenceedit_as_q_paint_device(self));
}

int32_t q_keysequenceedit_color_count(void* self) {
    return QPaintDevice_ColorCount(q_keysequenceedit_as_q_paint_device(self));
}

int32_t q_keysequenceedit_depth(void* self) {
    return QPaintDevice_Depth(q_keysequenceedit_as_q_paint_device(self));
}
