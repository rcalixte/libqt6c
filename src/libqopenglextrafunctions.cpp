...
void QOpenGLExtraFunctions_GlTexSubImage3D(QOpenGLExtraFunctions* self, uint32_t target, int32_t level, int32_t xoffset, int32_t yoffset, int32_t zoffset, int32_t width, int32_t height, int32_t depth, uint32_t format, uint32_t type, const void* pixels) {
...
void QOpenGLExtraFunctions_GlTransformFeedbackVaryings(QOpenGLExtraFunctions* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode) {
...
void QOpenGLExtraFunctions_GlVertexAttribIPointer(QOpenGLExtraFunctions* self, uint32_t index, int32_t size, uint32_t type, int32_t stride, const void* pointer) {
...
int32_t QOpenGLExtraFunctions_GlGetFragDataLocation(QOpenGLExtraFunctions* self, uint32_t program, const char* name) {
...
void QOpenGLExtraFunctions_GlGetUniformIndices(QOpenGLExtraFunctions* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices) {
...
uint32_t QOpenGLExtraFunctions_GlGetUniformBlockIndex(QOpenGLExtraFunctions* self, uint32_t program, const char* uniformBlockName) {
...
void QOpenGLExtraFunctions_GlGetActiveUniformBlockName(QOpenGLExtraFunctions* self, uint32_t program, uint32_t uniformBlockIndex, int32_t bufSize, int32_t* length, char* uniformBlockName) {
...
void QOpenGLExtraFunctions_GlDrawElementsInstanced(QOpenGLExtraFunctions* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount) {
...
void QOpenGLExtraFunctions_GlDrawElementsIndirect(QOpenGLExtraFunctions* self, uint32_t mode, uint32_t type, const void* indirect) {
...
uint32_t QOpenGLExtraFunctions_GlGetProgramResourceIndex(QOpenGLExtraFunctions* self, uint32_t program, uint32_t programInterface, const char* name) {
...
void QOpenGLExtraFunctions_GlGetProgramResourceName(QOpenGLExtraFunctions* self, uint32_t program, uint32_t programInterface, uint32_t index, int32_t bufSize, int32_t* length, char* name) {
...
int32_t QOpenGLExtraFunctions_GlGetProgramResourceLocation(QOpenGLExtraFunctions* self, uint32_t program, uint32_t programInterface, const char* name) {
...
uint32_t QOpenGLExtraFunctions_GlCreateShaderProgramv(QOpenGLExtraFunctions* self, uint32_t type, int32_t count, const char** strings) {
...
void QOpenGLExtraFunctions_GlGetProgramPipelineInfoLog(QOpenGLExtraFunctions* self, uint32_t pipeline, int32_t bufSize, int32_t* length, char* infoLog) {
...
void QOpenGLExtraFunctions_GlVertexAttribFormat(QOpenGLExtraFunctions* self, uint32_t attribindex, int32_t size, uint32_t type, unsigned char normalized, uint32_t relativeoffset) {
...
void QOpenGLExtraFunctions_GlVertexAttribIFormat(QOpenGLExtraFunctions* self, uint32_t attribindex, int32_t size, uint32_t type, uint32_t relativeoffset) {
...
void QOpenGLExtraFunctions_GlDebugMessageControl(QOpenGLExtraFunctions* self, uint32_t source, uint32_t type, uint32_t severity, int32_t count, const uint32_t* ids, unsigned char enabled) {
...
void QOpenGLExtraFunctions_GlDebugMessageInsert(QOpenGLExtraFunctions* self, uint32_t source, uint32_t type, uint32_t id, uint32_t severity, int32_t length, const char* buf) {
...
void QOpenGLExtraFunctions_GlPushDebugGroup(QOpenGLExtraFunctions* self, uint32_t source, uint32_t id, int32_t length, const char* message) {
...
void QOpenGLExtraFunctions_GlObjectLabel(QOpenGLExtraFunctions* self, uint32_t identifier, uint32_t name, int32_t length, const char* label) {
...
void QOpenGLExtraFunctions_GlGetObjectLabel(QOpenGLExtraFunctions* self, uint32_t identifier, uint32_t name, int32_t bufSize, int32_t* length, char* label) {
...
void QOpenGLExtraFunctions_GlObjectPtrLabel(QOpenGLExtraFunctions* self, const void* ptr, int32_t length, const char* label) {
    self->glObjectPtrLabel(ptr, static_cast<GLsizei>(length), static_cast<const GLchar*>(label));
}

void QOpenGLExtraFunctions_GlGetObjectPtrLabel(QOpenGLExtraFunctions* self, const void* ptr, int32_t bufSize, int32_t* length, char* label) {
...
void QOpenGLExtraFunctions_GlDrawElementsBaseVertex(QOpenGLExtraFunctions* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t basevertex) {
...
void QOpenGLExtraFunctions_GlDrawRangeElementsBaseVertex(QOpenGLExtraFunctions* self, uint32_t mode, uint32_t start, uint32_t end, int32_t count, uint32_t type, const void* indices, int32_t basevertex) {
...
void QOpenGLExtraFunctions_GlDrawElementsInstancedBaseVertex(QOpenGLExtraFunctions* self, uint32_t mode, int32_t count, uint32_t type, const void* indices, int32_t instancecount, int32_t basevertex) {
...
void QOpenGLExtraFunctions_GlReadnPixels(QOpenGLExtraFunctions* self, int32_t x, int32_t y, int32_t width, int32_t height, uint32_t format, uint32_t type, int32_t bufSize, void* data) {
