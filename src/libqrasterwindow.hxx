...
class VirtualQRasterWindow final : public QRasterWindow {
  ...
  public:
    ...
    friend bool QRasterWindow_NativeEvent(QRasterWindow* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QRasterWindow_QBaseNativeEvent(QRasterWindow* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QRasterWindow_ConnectNotify(QRasterWindow* self, QMetaMethod* signal);
    friend void QRasterWindow_QBaseConnectNotify(QRasterWindow* self, QMetaMethod* signal);
    friend void QRasterWindow_DisconnectNotify(QRasterWindow* self, QMetaMethod* signal);
    friend void QRasterWindow_QBaseDisconnectNotify(QRasterWindow* self, QMetaMethod* signal);
    ...
    friend bool QRasterWindow_IsSignalConnected(const QRasterWindow* self, QMetaMethod* signal);
    friend bool QRasterWindow_QBaseIsSignalConnected(const QRasterWindow* self, QMetaMethod* signal);
};
