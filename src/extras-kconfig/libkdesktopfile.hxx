  ...
  public:
    ...
    virtual bool hasGroupImpl(const QString& groupName) const override {
        if (kdesktopfile_hasgroupimpl_isbase) {
            ...
            char* groupName_str = static_cast<char*>(malloc(groupName_str_len + 1));
            memcpy(groupName_str, groupName_b.data(), groupName_str_len);
            groupName_str[groupName_str_len] = '\0';
