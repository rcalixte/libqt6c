...
class VirtualKCoreConfigSkeletonItemString final : public KCoreConfigSkeleton::ItemString {
  ...
  public:
    ...
    VirtualKCoreConfigSkeletonItemString(const QString& _group, const QString& _key, QString& reference, const QString& defaultValue, KCoreConfigSkeleton::ItemString::Type type) : KCoreConfigSkeleton::ItemString(_group, _key, reference, defaultValue, type) {};
