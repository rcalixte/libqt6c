#pragma once
#ifndef EXTRAS_KCONFIG_LIBKWINDOWSTATESAVER_H
#define EXTRAS_KCONFIG_LIBKWINDOWSTATESAVER_H
...
///
void k_windowstatesaver_set_object_name(void* self, const char* name);
...
///
int32_t k_windowstatesaver_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_windowstatesaver_start_timer23(void* self, int64_t time, int32_t timerType);
