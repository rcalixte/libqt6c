...
class VirtualQStatusBar final : public QStatusBar {
  ...
  public:
    ...
    friend bool QStatusBar_NativeEvent(QStatusBar* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QStatusBar_QBaseNativeEvent(QStatusBar* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QStatusBar_ConnectNotify(QStatusBar* self, QMetaMethod* signal);
    friend void QStatusBar_QBaseConnectNotify(QStatusBar* self, QMetaMethod* signal);
    friend void QStatusBar_DisconnectNotify(QStatusBar* self, QMetaMethod* signal);
    friend void QStatusBar_QBaseDisconnectNotify(QStatusBar* self, QMetaMethod* signal);
    ...
    friend bool QStatusBar_IsSignalConnected(const QStatusBar* self, QMetaMethod* signal);
    friend bool QStatusBar_QBaseIsSignalConnected(const QStatusBar* self, QMetaMethod* signal);
};
