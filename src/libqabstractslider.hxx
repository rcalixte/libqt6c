...
class VirtualQAbstractSlider final : public QAbstractSlider {
  ...
  public:
    ...
    friend bool QAbstractSlider_NativeEvent(QAbstractSlider* self, libqt_string eventType, void* message, intptr_t* result);
    friend bool QAbstractSlider_QBaseNativeEvent(QAbstractSlider* self, libqt_string eventType, void* message, intptr_t* result);
    ...
    friend void QAbstractSlider_ConnectNotify(QAbstractSlider* self, QMetaMethod* signal);
    friend void QAbstractSlider_QBaseConnectNotify(QAbstractSlider* self, QMetaMethod* signal);
    friend void QAbstractSlider_DisconnectNotify(QAbstractSlider* self, QMetaMethod* signal);
    friend void QAbstractSlider_QBaseDisconnectNotify(QAbstractSlider* self, QMetaMethod* signal);
    ...
    friend bool QAbstractSlider_IsSignalConnected(const QAbstractSlider* self, QMetaMethod* signal);
    friend bool QAbstractSlider_QBaseIsSignalConnected(const QAbstractSlider* self, QMetaMethod* signal);
};
