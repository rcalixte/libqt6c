...
* Update reserved words (#153)

### 6.8.2 rev84 (25 August 2026)

* Add initial support for manual casting methods (#152)

### 6.8.2 rev83 (12 August 2026)

* **BREAKING CHANGE:** Remove deprecated functions (#150)

### 6.8.2 rev82 (9 August 2026)

* **BREAKING CHANGE:** Detect and project default constructors (#149)

### 6.8.2 rev81 (28 July 2026)

* Revamp header guards (#148)
...
* **BREAKING CHANGE:** Unblock additional string types (#139)

### 6.8.2 rev75 (20 May 2026)

* **BREAKING CHANGE:** Fix memory leaks from callback return values (#138)
* Add platform-specific method (#137)

### 6.8.2 rev74 (10 May 2026)

* Add [KTextAddons](https://api.kde.org/legacy/ktextaddons/html/) (#135)

### 6.8.2 rev73 (5 May 2026)

* **BREAKING CHANGE:** Extend projected string types (#134)
* Add initial support for optional values (#133)
