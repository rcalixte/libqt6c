...
* Add [Qt XML](https://doc.qt.io/qt-6/qtxml-index.html), [KGlobalAccel](https://api-staging.kde.org/kglobalaccel-index.html), and [KXmlGui](https://api-staging.kde.org/kxmlgui-index.html) (#51)
