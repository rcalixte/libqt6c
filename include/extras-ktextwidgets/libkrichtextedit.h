#pragma once
#ifndef SRC_EXTRAS_KTEXTWIDGETSQT6C_LIBKRICHTEXTEDIT_H
#define SRC_EXTRAS_KTEXTWIDGETSQT6C_LIBKRICHTEXTEDIT_H
...
///
/// @param self KRichTextEdit*
/// @param callback QVariant* func(KRichTextEdit* self, int typeVal, QUrl* name)
