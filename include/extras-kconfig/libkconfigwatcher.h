#pragma once
#ifndef SRC_EXTRAS_KCONFIG_QT6C_LIBKCONFIGWATCHER_H
#define SRC_EXTRAS_KCONFIG_QT6C_LIBKCONFIGWATCHER_H
...
/// [Upstream resources](https://api.kde.org/kconfigwatcher.html)
...
/// [Upstream resources](https://api.kde.org/kconfigwatcher.html#configChanged)
///
/// @param self KConfigWatcher*
...
///
int32_t k_configwatcher_start_timer2(void* self, int64_t time);
...
///
libqt_list k_configwatcher_children(void* self);
...
///
QMetaObject__Connection* k_configwatcher_connect(void* sender, const char* signal, void* receiver, const char* member);
...
///
QMetaObject__Connection* k_configwatcher_connect2(void* sender, void* signal, void* receiver, void* method);
...
/// @param member const char*
///
QMetaObject__Connection* k_configwatcher_connect3(void* self, void* sender, const char* signal, const char* member);
...
/// @param member const char*
///
bool k_configwatcher_disconnect(void* sender, const char* signal, void* receiver, const char* member);
...
///
bool k_configwatcher_disconnect2(void* sender, void* signal, void* receiver, void* member);
...
/// @param self KConfigWatcher*
///
bool k_configwatcher_disconnect3(void* self);
...
/// @param receiver QObject*
///
bool k_configwatcher_disconnect4(void* self, void* receiver);
...
///
bool k_configwatcher_disconnect5(void* param1);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_configwatcher_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
QMetaObject__Connection* k_configwatcher_connect5(void* sender, const char* signal, void* receiver, const char* member, int32_t param5);
...
///
QMetaObject__Connection* k_configwatcher_connect52(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
/// @param signal const char*
///
bool k_configwatcher_disconnect1(void* self, const char* signal);
...
/// @param receiver QObject*
///
bool k_configwatcher_disconnect22(void* self, const char* signal, void* receiver);
...
/// @param member const char*
///
bool k_configwatcher_disconnect32(void* self, const char* signal, void* receiver, const char* member);
...
/// @param member const char*
///
bool k_configwatcher_disconnect23(void* self, void* receiver, const char* member);
...
/// [Upstream resources](https://api.kde.org/kconfigwatcher.html#dtor.KConfigWatcher)
///
