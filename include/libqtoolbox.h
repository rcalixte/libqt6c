...
QWidget* q_toolbox_child_at_with_q_point_f(void* self, void* p);
...
void q_toolbox_kill_timer_with_id(void* self, int64_t id);
...
///
/// ``` QToolBox* self, void (*slot)(QObject*, const char*) ```
