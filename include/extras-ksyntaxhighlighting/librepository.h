#pragma once
#ifndef EXTRAS_KSYNTAXHIGHLIGHTING_LIBREPOSITORY_H
#define EXTRAS_KSYNTAXHIGHLIGHTING_LIBREPOSITORY_H
...
///
void k_syntaxhighlighting__repository_set_object_name(void* self, const char* name);
