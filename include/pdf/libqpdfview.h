#pragma once
#ifndef SRC_PDF_QT6C_LIBQPDFVIEW_H
#define SRC_PDF_QT6C_LIBQPDFVIEW_H
...
///
/// @param self QPdfView*
/// @param callback void* func(QPdfView* self, const char* param1)
///
...
///
/// @param self QPdfView*
/// @param searchModel QPdfSearchModel*
///
...
///
/// @param self QPdfView*
/// @param documentMargins QMargins*
///
...
///
libqt_list q_pdfview_scroll_bar_widgets(void* self, int32_t alignment);
...
///
/// @param self QPdfView*
/// @param callback bool func(QPdfView* self, libqt_string eventType, void* message, intptr_t* result)
///
