#pragma once
#ifndef SRC_OPENGLQT6C_LIBQOPENGLFUNCTIONS_2_1_H
#define SRC_OPENGLQT6C_LIBQOPENGLFUNCTIONS_2_1_H
...
/// @param size int64_t
/// @param data void*
void q_openglfunctions_2_1_gl_get_buffer_sub_data(void* self, uint32_t target, int64_t offset, int64_t size, void* data);
...
/// @param size int64_t
/// @param data void*
void q_openglfunctions_2_1_gl_buffer_sub_data(void* self, uint32_t target, int64_t offset, int64_t size, void* data);
...
void q_openglfunctions_2_1_gl_buffer_data(void* self, uint32_t target, int64_t size, void* data, uint32_t usage);
...
/// @param program uint32_t
/// @param name char*
int32_t q_openglfunctions_2_1_gl_get_uniform_location(void* self, uint32_t program, char* name);
...
/// @param program uint32_t
/// @param name char*
int32_t q_openglfunctions_2_1_gl_get_attrib_location(void* self, uint32_t program, char* name);
...
/// @param index uint32_t
/// @param name char*
void q_openglfunctions_2_1_gl_bind_attrib_location(void* self, uint32_t program, uint32_t index, char* name);
