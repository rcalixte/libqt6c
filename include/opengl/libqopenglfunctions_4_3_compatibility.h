#pragma once
#ifndef OPENGL_LIBQOPENGLFUNCTIONS_4_3_COMPATIBILITY_H
#define OPENGL_LIBQOPENGLFUNCTIONS_4_3_COMPATIBILITY_H
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html)
...
/// @param self QOpenGLFunctions_4_3_Compatibility*
///
bool q_openglfunctions_4_3_compatibility_super_initialize_open_g_l_functions(void* self);
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glGetPointerv)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
/// @param pname uint32_t
/// @param params void*
///
void q_openglfunctions_4_3_compatibility_gl_get_pointerv(void* self, uint32_t pname, void* params);
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glMultiDrawElements)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
/// @param mode uint32_t
/// @param count int32_t*
...
///
void q_openglfunctions_4_3_compatibility_gl_multi_draw_elements(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount);
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glGetBufferPointerv)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
/// @param target uint32_t
/// @param pname uint32_t
/// @param params void*
///
void q_openglfunctions_4_3_compatibility_gl_get_buffer_pointerv(void* self, uint32_t target, uint32_t pname, void* params);
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glShaderSource)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glGetVertexAttribPointerv)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
/// @param index uint32_t
/// @param pname uint32_t
/// @param pointer void*
///
void q_openglfunctions_4_3_compatibility_gl_get_vertex_attrib_pointerv(void* self, uint32_t index, uint32_t pname, void* pointer);
...
///
int32_t q_openglfunctions_4_3_compatibility_gl_get_uniform_location(void* self, uint32_t program, const char* name);
...
/// @param name const char*
///
int32_t q_openglfunctions_4_3_compatibility_gl_get_attrib_location(void* self, uint32_t program, const char* name);
...
/// @param name const char*
///
void q_openglfunctions_4_3_compatibility_gl_bind_attrib_location(void* self, uint32_t program, uint32_t index, const char* name);
...
/// @param name const char*
///
int32_t q_openglfunctions_4_3_compatibility_gl_get_frag_data_location(void* self, uint32_t program, const char* name);
...
/// @param name const char*
///
void q_openglfunctions_4_3_compatibility_gl_bind_frag_data_location(void* self, uint32_t program, uint32_t color, const char* name);
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glTransformFeedbackVaryings)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
/// @param program uint32_t
/// @param count int32_t
...
///
void q_openglfunctions_4_3_compatibility_gl_transform_feedback_varyings(void* self, uint32_t program, int32_t count, const char** varyings, uint32_t bufferMode);
...
///
uint32_t q_openglfunctions_4_3_compatibility_gl_get_uniform_block_index(void* self, uint32_t program, const char* uniformBlockName);
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glGetUniformIndices)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
/// @param program uint32_t
/// @param uniformCount int32_t
...
/// @param uniformIndices uint32_t*
///
void q_openglfunctions_4_3_compatibility_gl_get_uniform_indices(void* self, uint32_t program, int32_t uniformCount, const char** uniformNames, uint32_t* uniformIndices);
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glMultiDrawElementsBaseVertex)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
/// @param mode uint32_t
/// @param count int32_t*
...
///
void q_openglfunctions_4_3_compatibility_gl_multi_draw_elements_base_vertex(void* self, uint32_t mode, int32_t* count, uint32_t type, void* indices, int32_t drawcount, int32_t* basevertex);
...
/// @param name const char*
///
int32_t q_openglfunctions_4_3_compatibility_gl_get_frag_data_index(void* self, uint32_t program, const char* name);
...
/// @param name const char*
///
void q_openglfunctions_4_3_compatibility_gl_bind_frag_data_location_indexed(void* self, uint32_t program, uint32_t colorNumber, uint32_t index, const char* name);
...
/// @param name const char*
///
uint32_t q_openglfunctions_4_3_compatibility_gl_get_subroutine_index(void* self, uint32_t program, uint32_t shadertype, const char* name);
...
/// @param name const char*
///
int32_t q_openglfunctions_4_3_compatibility_gl_get_subroutine_uniform_location(void* self, uint32_t program, uint32_t shadertype, const char* name);
...
/// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-3-compatibility.html#glCreateShaderProgramv)
///
/// @param self QOpenGLFunctions_4_3_Compatibility*
/// @param type uint32_t
/// @param count int32_t
...
///
uint32_t q_openglfunctions_4_3_compatibility_gl_create_shader_programv(void* self, uint32_t type, int32_t count, const char** strings);
...
/// @param name const char*
///
int32_t q_openglfunctions_4_3_compatibility_gl_get_program_resource_location_index(void* self, uint32_t program, uint32_t programInterface, const char* name);
...
/// @param name const char*
///
int32_t q_openglfunctions_4_3_compatibility_gl_get_program_resource_location(void* self, uint32_t program, uint32_t programInterface, const char* name);
...
/// @param name const char*
///
uint32_t q_openglfunctions_4_3_compatibility_gl_get_program_resource_index(void* self, uint32_t program, uint32_t programInterface, const char* name);
...
/// @param self QOpenGLFunctions_4_3_Compatibility*
///
bool q_openglfunctions_4_3_compatibility_super_is_initialized(void* self);
...
/// @param context QOpenGLContext*
///
void q_openglfunctions_4_3_compatibility_super_set_owning_context(void* self, void* context);
...
/// @param self QOpenGLFunctions_4_3_Compatibility*
///
QOpenGLContext* q_openglfunctions_4_3_compatibility_super_owning_context(void* self);
