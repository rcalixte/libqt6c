#pragma once
#ifndef POSIX_EXTRAS_SIGNON_LIBAUTHSERVICE_H
#define POSIX_EXTRAS_SIGNON_LIBAUTHSERVICE_H
...
///
/// @param self SignOn__AuthService*
/// @param callback void* func(SignOn__AuthService* self, const char* param1)
///
...
typedef enum {
    SIGNON_AUTHSERVICE_IDENTITYFILTERCRITERIA_AUTHMETHOD = 0,
    SIGNON_AUTHSERVICE_IDENTITYFILTERCRITERIA_USERNAME = 1,
    SIGNON_AUTHSERVICE_IDENTITYFILTERCRITERIA_REALM = 2,
    SIGNON_AUTHSERVICE_IDENTITYFILTERCRITERIA_CAPTION = 3
} SignOn__AuthService__IdentityFilterCriteria;
