#pragma once
#ifndef SRC_QT6C_LIBQGENERICPLUGIN_H
#define SRC_QT6C_LIBQGENERICPLUGIN_H
...
///
/// @param self QGenericPlugin*
/// @param callback void* func(QGenericPlugin* self, const char* param1)
///
...
///
int32_t q_genericplugin_start_timer2(void* self, int64_t time);
...
///
libqt_list q_genericplugin_children(void* self);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_genericplugin_start_timer23(void* self, int64_t time, int32_t timerType);
