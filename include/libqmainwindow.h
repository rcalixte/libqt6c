...
void q_mainwindow_grab_gesture(void* self, int64_t type);
...
/// @param self QMainWindow*
/// @param type enum Qt__GestureType
void q_mainwindow_ungrab_gesture(void* self, int64_t type);
...
void q_mainwindow_set_window_flags(void* self, int64_t type);
...
/// @param self QMainWindow*
/// @param type flag of enum Qt__WindowType
void q_mainwindow_override_window_flags(void* self, int64_t type);
...
void q_mainwindow_grab_gesture2(void* self, int64_t type, int32_t flags);
...
///
/// @param self QMainWindow*
/// @param callback bool func(QMainWindow* self, const char* eventType, void* message, intptr_t* result)
...
void q_mainwindow_on_input_method_query(void* self, QVariant* (*callback)(void*, int64_t));
