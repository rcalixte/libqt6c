...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
///
/// ``` QMainWindow* self, enum Qt__TimerId id ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
///
/// ``` QMainWindow* self, QThread* thread, Disambiguated_t* param2 ```
...
/// Wrapper to allow calling virtual or protected method
///
/// ``` QMainWindow* self, enum QPaintDevice__PaintDeviceMetric metricA, enum QPaintDevice__PaintDeviceMetric metricB ```
...
/// Wrapper to allow overriding base class virtual or protected method
///
/// ``` QMainWindow* self, double (*slot)(QMainWindow*, enum QPaintDevice__PaintDeviceMetric, enum QPaintDevice__PaintDeviceMetric) ```
void q_mainwindow_on_get_decoded_metric_f(void* self, double (*slot)(void*, int64_t, int64_t));
