...
///
QMetaObject__Connection* q_progressbar_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
///
/// @param self QProgressBar*
/// @param callback bool func(QProgressBar* self, const char* eventType, void* message, intptr_t* result)
///
