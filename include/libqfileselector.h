#pragma once
#ifndef SRC_QT6C_LIBQFILESELECTOR_H
#define SRC_QT6C_LIBQFILESELECTOR_H
...
///
int32_t q_fileselector_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_fileselector_start_timer23(void* self, int64_t time, int32_t timerType);
