#pragma once
#ifndef FOSS_EXTRAS_PACKAGEKITQT_LIBDAEMON_H
#define FOSS_EXTRAS_PACKAGEKITQT_LIBDAEMON_H
...
///
void q_packagekit__daemon_set_object_name(void* self, const char* name);
...
///
int32_t q_packagekit__daemon_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_packagekit__daemon_start_timer23(void* self, int64_t time, int32_t timerType);
