...
void q_piemodelmapper_kill_timer2(void* self, int64_t id);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QPieModelMapper* self, void (*slot)(QPieModelMapper*) ```
...
int32_t q_piemodelmapper_start_timer22(void* self, int interval, int64_t timerType);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QPieModelMapper* self, void (*slot)(QPieModelMapper*, QObject*) ```
...
///
/// ``` QPieModelMapper* self, void (*slot)(QPieModelMapper*, const char*) ```
