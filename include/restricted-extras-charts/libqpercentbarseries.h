...
/// @warning DEPRECATED: Use `q_percentbarseries_super_meta_object` instead
///
#define q_percentbarseries_qbase_meta_object q_percentbarseries_super_meta_object
...
///
/// @param self QPercentBarSeries*
/// @param callback void* func(QPercentBarSeries* self, const char* param1)
///
void q_percentbarseries_on_metacast(void* self, void* (*callback)(void*, const char*));

/// @warning DEPRECATED: Use `q_percentbarseries_super_metacast` instead
///
#define q_percentbarseries_qbase_metacast q_percentbarseries_super_metacast
...
/// @param param1 const char*
///
void* q_percentbarseries_super_metacast(void* self, const char* param1);
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_metacall` instead
///
#define q_percentbarseries_qbase_metacall q_percentbarseries_super_metacall
...
/// @param param3 void*
///
int32_t q_percentbarseries_super_metacall(void* self, int32_t param1, int param2, void* param3);
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_type` instead
///
#define q_percentbarseries_qbase_type q_percentbarseries_super_type
...
///
/// @param self QPercentBarSeries*
/// @param callback void func(QPercentBarSeries* self, libqt_list of QBarSet* sets)
///
void q_percentbarseries_on_barsets_added(void* self, void (*callback)(void*, libqt_list));
...
/// @param callback void func(QPercentBarSeries* self, libqt_list of QBarSet* sets)
///
void q_percentbarseries_on_barsets_removed(void* self, void (*callback)(void*, libqt_list));
...
///
libqt_list q_percentbarseries_attached_axes(void* self);
...
///
int32_t q_percentbarseries_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_percentbarseries_start_timer23(void* self, int64_t time, int32_t timerType);
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_event` instead
///
#define q_percentbarseries_qbase_event q_percentbarseries_super_event
...
/// @param event QEvent*
///
bool q_percentbarseries_super_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_event_filter` instead
///
#define q_percentbarseries_qbase_event_filter q_percentbarseries_super_event_filter
...
/// @param event QEvent*
///
bool q_percentbarseries_super_event_filter(void* self, void* watched, void* event);
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_timer_event` instead
///
#define q_percentbarseries_qbase_timer_event q_percentbarseries_super_timer_event
...
/// @param event QTimerEvent*
///
void q_percentbarseries_super_timer_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_child_event` instead
///
#define q_percentbarseries_qbase_child_event q_percentbarseries_super_child_event
...
/// @param event QChildEvent*
///
void q_percentbarseries_super_child_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_custom_event` instead
///
#define q_percentbarseries_qbase_custom_event q_percentbarseries_super_custom_event
...
/// @param event QEvent*
///
void q_percentbarseries_super_custom_event(void* self, void* event);
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_connect_notify` instead
///
#define q_percentbarseries_qbase_connect_notify q_percentbarseries_super_connect_notify
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_disconnect_notify` instead
///
#define q_percentbarseries_qbase_disconnect_notify q_percentbarseries_super_disconnect_notify
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_sender` instead
///
#define q_percentbarseries_qbase_sender q_percentbarseries_super_sender
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_sender_signal_index` instead
///
#define q_percentbarseries_qbase_sender_signal_index q_percentbarseries_super_sender_signal_index
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_receivers` instead
///
#define q_percentbarseries_qbase_receivers q_percentbarseries_super_receivers
...
/// @warning DEPRECATED: Use `q_percentbarseries_super_is_signal_connected` instead
///
#define q_percentbarseries_qbase_is_signal_connected q_percentbarseries_super_is_signal_connected
