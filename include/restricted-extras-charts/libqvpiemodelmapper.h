#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_CHARTS_QT6C_LIBQVPIEMODELMAPPER_H
#define SRC_RESTRICTED_EXTRAS_CHARTS_QT6C_LIBQVPIEMODELMAPPER_H
...
///
/// @param self QVPieModelMapper*
/// @param callback void* func(QVPieModelMapper* self, const char* param1)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback int32_t func(QVPieModelMapper* self, enum QMetaObject__Call param1, int param2, void* param3)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self)
///
...
///
int32_t q_vpiemodelmapper_start_timer2(void* self, int64_t time);
...
///
QMetaObject__Connection* q_vpiemodelmapper_connect(void* sender, const char* signal, void* receiver, const char* member);
...
///
QMetaObject__Connection* q_vpiemodelmapper_connect2(void* sender, void* signal, void* receiver, void* method);
...
/// @param member const char*
///
QMetaObject__Connection* q_vpiemodelmapper_connect3(void* self, void* sender, const char* signal, const char* member);
...
/// @param member const char*
///
bool q_vpiemodelmapper_disconnect(void* sender, const char* signal, void* receiver, const char* member);
...
///
bool q_vpiemodelmapper_disconnect2(void* sender, void* signal, void* receiver, void* member);
...
/// @param self QVPieModelMapper*
///
bool q_vpiemodelmapper_disconnect3(void* self);
...
/// @param receiver QObject*
///
bool q_vpiemodelmapper_disconnect4(void* self, void* receiver);
...
///
bool q_vpiemodelmapper_disconnect5(void* param1);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_vpiemodelmapper_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
QMetaObject__Connection* q_vpiemodelmapper_connect5(void* sender, const char* signal, void* receiver, const char* member, int32_t param5);
...
///
QMetaObject__Connection* q_vpiemodelmapper_connect52(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
/// @param signal const char*
///
bool q_vpiemodelmapper_disconnect1(void* self, const char* signal);
...
/// @param receiver QObject*
///
bool q_vpiemodelmapper_disconnect22(void* self, const char* signal, void* receiver);
...
/// @param member const char*
///
bool q_vpiemodelmapper_disconnect32(void* self, const char* signal, void* receiver, const char* member);
...
/// @param member const char*
///
bool q_vpiemodelmapper_disconnect23(void* self, void* receiver, const char* member);
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, QObject* param1)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback bool func(QVPieModelMapper* self, QEvent* event)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback bool func(QVPieModelMapper* self, QObject* watched, QEvent* event)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, QTimerEvent* event)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, QChildEvent* event)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, QEvent* event)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, QMetaMethod* signal)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, int first)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, int count)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, int valuesSection)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, int labelsSection)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, enum Qt__Orientation orientation)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback int32_t func(QVPieModelMapper* self, const char* signal)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback bool func(QVPieModelMapper* self, QMetaMethod* signal)
///
...
///
/// @param self QVPieModelMapper*
/// @param callback void func(QVPieModelMapper* self, const char* objectName)
///
