#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKPAGEDIALOG_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKPAGEDIALOG_H
...
void k_pagedialog_grab_gesture(void* self, int64_t type);
...
/// @param self KPageDialog*
/// @param type enum Qt__GestureType
void k_pagedialog_ungrab_gesture(void* self, int64_t type);
...
void k_pagedialog_set_window_flags(void* self, int64_t type);
...
/// @param self KPageDialog*
/// @param type flag of enum Qt__WindowType
void k_pagedialog_override_window_flags(void* self, int64_t type);
...
void k_pagedialog_grab_gesture2(void* self, int64_t type, int32_t flags);
