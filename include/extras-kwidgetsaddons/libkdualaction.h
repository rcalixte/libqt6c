#pragma once
#ifndef EXTRAS_KWIDGETSADDONS_LIBKDUALACTION_H
#define EXTRAS_KWIDGETSADDONS_LIBKDUALACTION_H
...
///
/// @param self KDualAction*
/// @param callback void* func(KDualAction* self, const char* param1)
///
...
///
void k_dualaction_set_object_name(void* self, const char* name);
