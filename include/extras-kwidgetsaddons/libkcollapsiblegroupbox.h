#pragma once
#ifndef EXTRAS_KWIDGETSADDONS_LIBKCOLLAPSIBLEGROUPBOX_H
#define EXTRAS_KWIDGETSADDONS_LIBKCOLLAPSIBLEGROUPBOX_H
...
///
/// @param self KCollapsibleGroupBox*
/// @param callback void* func(KCollapsibleGroupBox* self, const char* param1)
///
...
///
libqt_list k_collapsiblegroupbox_actions(void* self);
...
///
libqt_list k_collapsiblegroupbox_children(void* self);
...
///
/// @param self KCollapsibleGroupBox*
/// @param callback bool func(KCollapsibleGroupBox* self, libqt_string eventType, void* message, intptr_t* result)
///
