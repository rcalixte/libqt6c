...
void k_recentfilesmenu_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KRecentFilesMenu*
/// @param typeVal enum Qt__GestureType
void k_recentfilesmenu_ungrab_gesture(void* self, int64_t typeVal);
...
void k_recentfilesmenu_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KRecentFilesMenu*
/// @param typeVal flag of enum Qt__WindowType
void k_recentfilesmenu_override_window_flags(void* self, int64_t typeVal);
...
QMetaObject__Connection* k_recentfilesmenu_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_recentfilesmenu_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
