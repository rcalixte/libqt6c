#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKCOLUMNRESIZER_H
#define SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKCOLUMNRESIZER_H
...
///
void k_columnresizer_set_object_name(void* self, const char* name);
...
///
int32_t k_columnresizer_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_columnresizer_start_timer23(void* self, int64_t time, int32_t timerType);
