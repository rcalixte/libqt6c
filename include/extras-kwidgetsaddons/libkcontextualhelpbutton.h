#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKCONTEXTUALHELPBUTTON_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKCONTEXTUALHELPBUTTON_H
...
void k_contextualhelpbutton_set_arrow_type(void* self, int32_t typeVal);
...
void k_contextualhelpbutton_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KContextualHelpButton*
/// @param typeVal enum Qt__GestureType
void k_contextualhelpbutton_ungrab_gesture(void* self, int64_t typeVal);
...
void k_contextualhelpbutton_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KContextualHelpButton*
/// @param typeVal flag of enum Qt__WindowType
void k_contextualhelpbutton_override_window_flags(void* self, int64_t typeVal);
...
QMetaObject__Connection* k_contextualhelpbutton_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_contextualhelpbutton_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
