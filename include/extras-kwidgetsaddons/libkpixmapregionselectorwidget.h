#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKPIXMAPREGIONSELECTORWIDGET_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKPIXMAPREGIONSELECTORWIDGET_H
...
void k_pixmapregionselectorwidget_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
