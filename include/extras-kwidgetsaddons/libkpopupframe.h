#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKPOPUPFRAME_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKPOPUPFRAME_H
...
void k_popupframe_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KPopupFrame*
/// @param typeVal enum Qt__GestureType
void k_popupframe_ungrab_gesture(void* self, int64_t typeVal);
...
int64_t k_popupframe_window_state(void* self);
...
void k_popupframe_set_window_state(void* self, int64_t state);
...
/// @param self KPopupFrame*
/// @param state flag of enum Qt__WindowState
void k_popupframe_override_window_state(void* self, int64_t state);
...
void k_popupframe_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KPopupFrame*
/// @param typeVal flag of enum Qt__WindowType
void k_popupframe_override_window_flags(void* self, int64_t typeVal);
...
void k_popupframe_render4(void* self, void* target, void* targetOffset, void* sourceRegion, int64_t renderFlags);
...
/// @param sourceRegion QRegion*
/// @param renderFlags flag of enum QWidget__RenderFlag
void k_popupframe_render42(void* self, void* painter, void* targetOffset, void* sourceRegion, int64_t renderFlags);
...
void k_popupframe_grab_gesture2(void* self, int64_t typeVal, int64_t flags);
...
QMetaObject__Connection* k_popupframe_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_popupframe_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
