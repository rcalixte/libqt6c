#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKDATEPICKERPOPUP_H
#define SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKDATEPICKERPOPUP_H
...
///
libqt_map k_datepickerpopup_date_map(void* self);
...
///
void k_datepickerpopup_set_date_map(void* self, libqt_map dateMap);
...
///
libqt_list k_datepickerpopup_actions(void* self);
...
/// @param name const char*
///
void k_datepickerpopup_set_object_name(void* self, const char* name);
...
///
libqt_list k_datepickerpopup_children(void* self);
...
///
/// @param self KDatePickerPopup*
/// @param callback bool func(KDatePickerPopup* self, libqt_string eventType, void* message, intptr_t* result)
///
