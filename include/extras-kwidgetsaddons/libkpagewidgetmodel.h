...
///
/// @param self KPageWidgetModel*
/// @param callback QMimeData* func(KPageWidgetModel* self, QModelIndex** indexes)
...
///
/// @param self KPageWidgetModel*
/// @param callback QModelIndex** func(KPageWidgetModel* self, QModelIndex* start, int role, QVariant* value, int hits, flag of enum Qt__MatchFlag flags)
...
///
/// @param self KPageWidgetModel*
/// @param callback void func(KPageWidgetModel* self, QModelIndex** indexes, QDataStream* stream)
