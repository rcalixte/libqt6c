#pragma once
#ifndef EXTRAS_KWIDGETSADDONS_LIBKDRAGWIDGETDECORATOR_H
#define EXTRAS_KWIDGETSADDONS_LIBKDRAGWIDGETDECORATOR_H
...
///
void k_dragwidgetdecoratorbase_set_object_name(void* self, const char* name);
