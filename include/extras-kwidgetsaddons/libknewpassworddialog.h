#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKNEWPASSWORDDIALOG_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKNEWPASSWORDDIALOG_H
...
int64_t k_newpassworddialog_window_state(void* self);
...
void k_newpassworddialog_set_window_state(void* self, int64_t state);
...
/// @param self KNewPasswordDialog*
/// @param state flag of enum Qt__WindowState
void k_newpassworddialog_override_window_state(void* self, int64_t state);
...
void k_newpassworddialog_render4(void* self, void* target, void* targetOffset, void* sourceRegion, int64_t renderFlags);
...
/// @param sourceRegion QRegion*
/// @param renderFlags flag of enum QWidget__RenderFlag
void k_newpassworddialog_render42(void* self, void* painter, void* targetOffset, void* sourceRegion, int64_t renderFlags);
...
void k_newpassworddialog_grab_gesture2(void* self, int64_t typeVal, int64_t flags);
