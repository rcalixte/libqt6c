#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKLED_H
#define SRC_EXTRAS_KWIDGETSADDONS_QT6C_LIBKLED_H
...
/// k_led_new2 constructs a new KLed object.
///
KLed* k_led_new2();

/// [Upstream resources](https://api.kde.org/kled.html)

/// k_led_new3 constructs a new KLed object.
///
/// @param color QColor*
///
...
/// k_led_new4 constructs a new KLed object.
///
/// @param color QColor*
...
/// k_led_new5 constructs a new KLed object.
///
/// @param color QColor*
/// @param parent QWidget*
///
...
/// k_led_new6 constructs a new KLed object.
///
/// @param color QColor*
/// @param state enum KLed__State
/// @param look enum KLed__Look
...
/// [Upstream resources](https://api.kde.org/kled.html#setLook)
///
/// @param self KLed*
/// @param look enum KLed__Look
///
...
/// [Upstream resources](https://api.kde.org/kled.html#setShape)
///
/// @param self KLed*
/// @param shape enum KLed__Shape
///
...
/// [Upstream resources](https://api.kde.org/kled.html#setDarkFactor)
///
/// @param self KLed*
...
/// [Upstream resources](https://api.kde.org/kled.html#on)
///
/// @param self KLed*
///
void k_led_on(void* self);

/// [Upstream resources](https://api.kde.org/kled.html#off)
///
/// @param self KLed*
///
...
///
void k_led_set_window_state(void* self, int32_t state);
...
/// @param state flag of enum Qt__WindowState
///
void k_led_override_window_state(void* self, int32_t state);
...
///
QWidget* k_led_find(uintptr_t param1);
...
///
int32_t k_led_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_led_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
/// @param self KLed*
/// @param callback bool func(KLed* self, libqt_string eventType, void* message, intptr_t* result)
///
...
/// [Upstream resources](https://api.kde.org/kled.html#dtor.KLed)
///
...
typedef enum {
    KLED_SHAPE_RECTANGULAR = 0,
    KLED_SHAPE_CIRCULAR = 1
} KLed__Shape;
