#pragma once
#ifndef SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKLED_H
#define SRC_EXTRAS_KWIDGETSADDONSQT6C_LIBKLED_H
...
void k_led_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
