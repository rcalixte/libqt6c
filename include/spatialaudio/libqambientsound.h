#pragma once
#ifndef SRC_SPATIALAUDIO_QT6C_LIBQAMBIENTSOUND_H
#define SRC_SPATIALAUDIO_QT6C_LIBQAMBIENTSOUND_H
...
///
QMetaObject__Connection* q_ambientsound_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
