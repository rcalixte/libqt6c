#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBKSSLCERTIFICATEBOX_H
#define SRC_EXTRAS_KIOQT6C_LIBKSSLCERTIFICATEBOX_H
...
/// [Qt documentation](https://api.kde.org/ksslcertificatebox.html#setCertificate)
///
/// @param self KSslCertificateBox*
...
/// [Qt documentation](https://api.kde.org/ksslcertificatebox.html#clear)
///
/// @param self KSslCertificateBox*
...
void k_sslcertificatebox_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KSslCertificateBox*
/// @param typeVal enum Qt__GestureType
void k_sslcertificatebox_ungrab_gesture(void* self, int64_t typeVal);
...
void k_sslcertificatebox_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KSslCertificateBox*
/// @param typeVal flag of enum Qt__WindowType
void k_sslcertificatebox_override_window_flags(void* self, int64_t typeVal);
...
void k_sslcertificatebox_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_sslcertificatebox_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_sslcertificatebox_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
/// [Qt documentation](https://api.kde.org/ksslcertificatebox.html#dtor.KSslCertificateBox)
///
