#pragma once
#ifndef EXTRAS_KIO_LIBOPENURLJOB_H
#define EXTRAS_KIO_LIBOPENURLJOB_H
...
///
void k_io__openurljob_total_size(void* self, void* job, uintptr_t size);
...
///
/// @param self KIO__OpenUrlJob*
/// @param callback void func(KIO__OpenUrlJob* self, KJob* job, uintptr_t size)
///
void k_io__openurljob_on_total_size(void* self, void (*callback)(void*, void*, uintptr_t));
...
/// @param size uintptr_t
///
void k_io__openurljob_processed_size(void* self, void* job, uintptr_t size);
...
/// @param callback void func(KIO__OpenUrlJob* self, KJob* job, uintptr_t size)
///
void k_io__openurljob_on_processed_size(void* self, void (*callback)(void*, void*, uintptr_t));
...
///
void k_io__openurljob_speed(void* self, void* job, uintptr_t speed);
...
///
/// @param self KIO__OpenUrlJob*
/// @param callback void func(KIO__OpenUrlJob* self, KJob* job, uintptr_t speed)
///
void k_io__openurljob_on_speed(void* self, void (*callback)(void*, void*, uintptr_t));
...
///
int32_t k_io__openurljob_start_timer2(void* self, int64_t time);
...
///
libqt_list k_io__openurljob_children(void* self);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_io__openurljob_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
void k_io__openurljob_on_subjobs(void* self, libqt_list (*callback)());
...
///
/// @param self KIO__OpenUrlJob*
/// @param callback void func(KIO__OpenUrlJob* self, enum KJob__Unit unit, uintptr_t amount)
///
...
///
/// @param self KIO__OpenUrlJob*
/// @param callback void func(KIO__OpenUrlJob* self, uintptr_t percentage)
///
...
///
/// @param self KIO__OpenUrlJob*
/// @param callback void func(KIO__OpenUrlJob* self, uintptr_t processedAmount, uintptr_t totalAmount)
///
...
///
/// @param self KIO__OpenUrlJob*
/// @param callback void func(KIO__OpenUrlJob* self, uintptr_t speed)
///
...
///
/// @param self KIO__OpenUrlJob*
/// @param callback void func(KIO__OpenUrlJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
void k_io__openurljob_on_total_amount_changed(void* self, void (*callback)(void*, void*, int32_t, uintptr_t));
...
/// @param callback void func(KIO__OpenUrlJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
void k_io__openurljob_on_processed_amount_changed(void* self, void (*callback)(void*, void*, int32_t, uintptr_t));
...
///
/// @param self KIO__OpenUrlJob*
/// @param callback void func(KIO__OpenUrlJob* self, KJob* job, uintptr_t percent)
///
void k_io__openurljob_on_percent_changed(void* self, void (*callback)(void*, void*, uintptr_t));
