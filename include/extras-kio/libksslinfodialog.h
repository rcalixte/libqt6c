#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBKSSLINFODIALOG_H
#define SRC_EXTRAS_KIOQT6C_LIBKSSLINFODIALOG_H
...
/// [Qt documentation](https://api.kde.org/ksslinfodialog.html#setMainPartEncrypted)
///
/// @param self KSslInfoDialog*
/// @param mainPartEncrypted bool
void k_sslinfodialog_set_main_part_encrypted(void* self, bool mainPartEncrypted);

/// [Qt documentation](https://api.kde.org/ksslinfodialog.html#setAuxiliaryPartsEncrypted)
///
/// @param self KSslInfoDialog*
...
void k_sslinfodialog_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KSslInfoDialog*
/// @param typeVal enum Qt__GestureType
void k_sslinfodialog_ungrab_gesture(void* self, int64_t typeVal);
...
void k_sslinfodialog_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KSslInfoDialog*
/// @param typeVal flag of enum Qt__WindowType
void k_sslinfodialog_override_window_flags(void* self, int64_t typeVal);
...
void k_sslinfodialog_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_sslinfodialog_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_sslinfodialog_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
/// [Qt documentation](https://api.kde.org/ksslinfodialog.html#dtor.KSslInfoDialog)
///
