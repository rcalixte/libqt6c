#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBEMPTYTRASHJOB_H
#define SRC_EXTRAS_KIO_QT6C_LIBEMPTYTRASHJOB_H
...
/// [Upstream resources](https://api.kde.org/kio-emptytrashjob.html)
...
///
void k_io__emptytrashjob_add_meta_data2(void* self, libqt_map values);
...
/// @param values libqt_map of const char* to const char*
///
void k_io__emptytrashjob_merge_meta_data(void* self, libqt_map values);
...
///
/// @param self KIO__EmptyTrashJob*
/// @param callback void func(KIO__EmptyTrashJob* self, KJob* job, uintptr_t size)
///
...
///
/// @param self KIO__EmptyTrashJob*
/// @param callback void func(KIO__EmptyTrashJob* self, KJob* job, uintptr_t speed)
///
...
///
libqt_list k_io__emptytrashjob_children(void* self);
...
///
/// @param self KIO__EmptyTrashJob*
/// @param callback void func(KIO__EmptyTrashJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
...
///
/// @param self KIO__EmptyTrashJob*
/// @param callback void func(KIO__EmptyTrashJob* self, KJob* job, uintptr_t percent)
///
