#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBMIMETYPEFINDERJOB_H
#define SRC_EXTRAS_KIOQT6C_LIBMIMETYPEFINDERJOB_H
...
/// https://api.kde.org/kio-mimetypefinderjob.html
...
/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#setFollowRedirections)
///
/// @param self KIO__MimeTypeFinderJob*
/// @param b bool
void k_io__mimetypefinderjob_set_follow_redirections(void* self, bool b);

/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#setSuggestedFileName)
///
/// @param self KIO__MimeTypeFinderJob*
...
/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#suggestedFileName)
///
/// Caller is responsible for freeing the returned memory
///
/// @param self KIO__MimeTypeFinderJob*
...
/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#setAuthenticationPromptEnabled)
///
/// @param self KIO__MimeTypeFinderJob*
/// @param enable bool
void k_io__mimetypefinderjob_set_authentication_prompt_enabled(void* self, bool enable);

/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#isAuthenticationPromptEnabled)
///
/// @param self KIO__MimeTypeFinderJob*
bool k_io__mimetypefinderjob_is_authentication_prompt_enabled(void* self);

/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#start)
///
/// @param self KIO__MimeTypeFinderJob*
...
/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#mimeType)
///
/// Caller is responsible for freeing the returned memory
///
/// @param self KIO__MimeTypeFinderJob*
...
/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#doKill)
///
/// @param self KIO__MimeTypeFinderJob*
...
/// [Qt documentation](https://api.kde.org/kio-mimetypefinderjob.html#slotResult)
///
/// @param self KIO__MimeTypeFinderJob*
/// @param job KJob*
...
void k_io__mimetypefinderjob_description(void* self, void* job, const char* title);
...
///
/// @param self KIO__MimeTypeFinderJob*
/// @param callback void func(KIO__MimeTypeFinderJob* self, KJob* job, const char* title)
void k_io__mimetypefinderjob_on_description(void* self, void (*callback)(void*, void*, const char*));
...
void k_io__mimetypefinderjob_description3(void* self, void* job, const char* title, libqt_pair /* tuple of const char* and const char* */ field1);
...
///
/// @param self KIO__MimeTypeFinderJob*
/// @param callback void func(KIO__MimeTypeFinderJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
void k_io__mimetypefinderjob_on_description3(void* self, void (*callback)(void*, void*, const char*, libqt_pair /* tuple of const char* and const char* */));
...
void k_io__mimetypefinderjob_description4(void* self, void* job, const char* title, libqt_pair /* tuple of const char* and const char* */ field1, libqt_pair /* tuple of const char* and const char* */ field2);
...
///
/// @param self KIO__MimeTypeFinderJob*
/// @param callback void func(KIO__MimeTypeFinderJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
void k_io__mimetypefinderjob_on_description4(void* self, void (*callback)(void*, void*, const char*, libqt_pair /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */));
...
QMetaObject__Connection* k_io__mimetypefinderjob_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_io__mimetypefinderjob_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
