...
/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#text)
///
/// Caller is responsible for freeing the returned memory
///
/// @param self KOpenWithDialog*
...
/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#hideNoCloseOnExit)
///
/// @param self KOpenWithDialog*
void k_openwithdialog_hide_no_close_on_exit(void* self);

/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#hideRunInTerminal)
///
/// @param self KOpenWithDialog*
void k_openwithdialog_hide_run_in_terminal(void* self);

/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#setSaveNewApplications)
///
/// @param self KOpenWithDialog*
/// @param b bool
void k_openwithdialog_set_save_new_applications(void* self, bool b);

/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#slotSelected)
///
/// @param self KOpenWithDialog*
...
/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#slotHighlighted)
///
/// @param self KOpenWithDialog*
/// @param _name const char*
/// @param _exec const char*
...
/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#slotTextChanged)
///
/// @param self KOpenWithDialog*
void k_openwithdialog_slot_text_changed(void* self);

/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#slotTerminalToggled)
///
/// @param self KOpenWithDialog*
/// @param param1 bool
void k_openwithdialog_slot_terminal_toggled(void* self, bool param1);

/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#accept)
///
/// @param self KOpenWithDialog*
...
/// [Qt documentation](https://api.kde.org/kopenwithdialog.html#dtor.KOpenWithDialog)
///
