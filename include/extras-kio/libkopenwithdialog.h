#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBKOPENWITHDIALOG_H
#define SRC_EXTRAS_KIO_QT6C_LIBKOPENWITHDIALOG_H
...
///
libqt_list k_openwithdialog_actions(void* self);
...
///
libqt_list k_openwithdialog_children(void* self);
