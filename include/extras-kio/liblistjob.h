...
///
/// @param self KIO__ListJob*
/// @param callback void func(KIO__ListJob* self, KJob* job, const char* title)
...
///
/// @param self KIO__ListJob*
/// @param callback void func(KIO__ListJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
...
///
/// @param self KIO__ListJob*
/// @param callback void func(KIO__ListJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
