...
///
/// @param self KIO__ListJob*
/// @param callback void func(KIO__ListJob* self, KJob* job, uintptr_t size)
///
...
///
/// @param self KIO__ListJob*
/// @param callback void func(KIO__ListJob* self, KJob* job, uintptr_t speed)
///
...
///
/// @param self KIO__ListJob*
/// @param callback void func(KIO__ListJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
...
///
/// @param self KIO__ListJob*
/// @param callback void func(KIO__ListJob* self, KJob* job, uintptr_t percent)
///
