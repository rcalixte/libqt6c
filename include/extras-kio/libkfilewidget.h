#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBKFILEWIDGET_H
#define SRC_EXTRAS_KIO_QT6C_LIBKFILEWIDGET_H
...
///
int32_t k_filewidget_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_filewidget_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
/// @param self KFileWidget*
/// @param callback bool func(KFileWidget* self, libqt_string eventType, void* message, intptr_t* result)
///
