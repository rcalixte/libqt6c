...
///
/// @param self KIO__TransferJob*
/// @param callback void func(KIO__TransferJob* self, KIO__Job* job, uintptr_t offset)
///
...
///
void k_io__transferjob_add_meta_data2(void* self, libqt_map values);
...
/// @param values libqt_map of const char* to const char*
///
void k_io__transferjob_merge_meta_data(void* self, libqt_map values);
...
///
/// @param self KIO__TransferJob*
/// @param callback void func(KIO__TransferJob* self, KJob* job, uintptr_t size)
///
...
///
/// @param self KIO__TransferJob*
/// @param callback void func(KIO__TransferJob* self, KJob* job, uintptr_t speed)
///
...
///
/// @param self KIO__TransferJob*
/// @param callback void func(KIO__TransferJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
...
///
/// @param self KIO__TransferJob*
/// @param callback void func(KIO__TransferJob* self, KJob* job, uintptr_t percent)
///
