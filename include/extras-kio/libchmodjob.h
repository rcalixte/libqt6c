...
///
void k_io__chmodjob_add_meta_data2(void* self, libqt_map values);
...
/// @param values libqt_map of const char* to const char*
///
void k_io__chmodjob_merge_meta_data(void* self, libqt_map values);
...
///
/// @param self KIO__ChmodJob*
/// @param callback void func(KIO__ChmodJob* self, KJob* job, uintptr_t size)
///
...
///
/// @param self KIO__ChmodJob*
/// @param callback void func(KIO__ChmodJob* self, KJob* job, uintptr_t speed)
///
...
///
libqt_list k_io__chmodjob_children(void* self);
...
///
/// @param self KIO__ChmodJob*
/// @param callback void func(KIO__ChmodJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
...
///
/// @param self KIO__ChmodJob*
/// @param callback void func(KIO__ChmodJob* self, KJob* job, uintptr_t percent)
///
