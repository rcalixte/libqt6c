#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBFILESYSTEMFREESPACEJOB_H
#define SRC_EXTRAS_KIO_QT6C_LIBFILESYSTEMFREESPACEJOB_H
...
/// [Upstream resources](https://api.kde.org/kio-filesystemfreespacejob.html)
...
///
void k_io__filesystemfreespacejob_add_meta_data2(void* self, libqt_map values);
...
/// @param values libqt_map of const char* to const char*
///
void k_io__filesystemfreespacejob_merge_meta_data(void* self, libqt_map values);
...
///
void k_io__filesystemfreespacejob_set_object_name(void* self, const char* name);
...
///
int32_t k_io__filesystemfreespacejob_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_io__filesystemfreespacejob_start_timer23(void* self, int64_t time, int32_t timerType);
