#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBDIRECTORYSIZEJOB_H
#define SRC_EXTRAS_KIOQT6C_LIBDIRECTORYSIZEJOB_H
...
/// [Qt documentation](https://api.kde.org/kio-directorysizejob.html#totalSize)
///
/// @param self KIO__DirectorySizeJob*
uint64_t k_io__directorysizejob_total_size(void* self);

/// [Qt documentation](https://api.kde.org/kio-directorysizejob.html#totalFiles)
///
/// @param self KIO__DirectorySizeJob*
uint64_t k_io__directorysizejob_total_files(void* self);

/// [Qt documentation](https://api.kde.org/kio-directorysizejob.html#totalSubdirs)
///
/// @param self KIO__DirectorySizeJob*
...
void k_io__directorysizejob_description(void* self, void* job, const char* title);
...
///
/// @param self KIO__DirectorySizeJob*
/// @param callback void func(KIO__DirectorySizeJob* self, KJob* job, const char* title)
void k_io__directorysizejob_on_description(void* self, void (*callback)(void*, void*, const char*));
...
void k_io__directorysizejob_description3(void* self, void* job, const char* title, libqt_pair /* tuple of const char* and const char* */ field1);
...
///
/// @param self KIO__DirectorySizeJob*
/// @param callback void func(KIO__DirectorySizeJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
void k_io__directorysizejob_on_description3(void* self, void (*callback)(void*, void*, const char*, libqt_pair /* tuple of const char* and const char* */));
...
void k_io__directorysizejob_description4(void* self, void* job, const char* title, libqt_pair /* tuple of const char* and const char* */ field1, libqt_pair /* tuple of const char* and const char* */ field2);
...
///
/// @param self KIO__DirectorySizeJob*
/// @param callback void func(KIO__DirectorySizeJob* self, KJob* job, const char* title, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */ /* tuple of const char* and const char* */)
void k_io__directorysizejob_on_description4(void* self, void (*callback)(void*, void*, const char*, libqt_pair /* tuple of const char* and const char* */, libqt_pair /* tuple of const char* and const char* */));
...
/// [Qt documentation](https://api.kde.org/kio.html#directorySize)
///
/// @param param1 QUrl*
