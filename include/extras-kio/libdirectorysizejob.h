#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBDIRECTORYSIZEJOB_H
#define SRC_EXTRAS_KIO_QT6C_LIBDIRECTORYSIZEJOB_H
...
///
void k_io__directorysizejob_add_meta_data2(void* self, libqt_map values);
...
/// @param values libqt_map of const char* to const char*
///
void k_io__directorysizejob_merge_meta_data(void* self, libqt_map values);
...
///
void k_io__directorysizejob_processed_size(void* self, void* job, uintptr_t size);
...
///
/// @param self KIO__DirectorySizeJob*
/// @param callback void func(KIO__DirectorySizeJob* self, KJob* job, uintptr_t size)
///
void k_io__directorysizejob_on_processed_size(void* self, void (*callback)(void*, void*, uintptr_t));
...
///
void k_io__directorysizejob_speed(void* self, void* job, uintptr_t speed);
...
///
/// @param self KIO__DirectorySizeJob*
/// @param callback void func(KIO__DirectorySizeJob* self, KJob* job, uintptr_t speed)
///
void k_io__directorysizejob_on_speed(void* self, void (*callback)(void*, void*, uintptr_t));
...
///
libqt_list k_io__directorysizejob_children(void* self);
...
///
/// @param self KIO__DirectorySizeJob*
/// @param callback void func(KIO__DirectorySizeJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
void k_io__directorysizejob_on_total_amount_changed(void* self, void (*callback)(void*, void*, int32_t, uintptr_t));
...
/// @param callback void func(KIO__DirectorySizeJob* self, KJob* job, enum KJob__Unit unit, uintptr_t amount)
///
void k_io__directorysizejob_on_processed_amount_changed(void* self, void (*callback)(void*, void*, int32_t, uintptr_t));
...
///
/// @param self KIO__DirectorySizeJob*
/// @param callback void func(KIO__DirectorySizeJob* self, KJob* job, uintptr_t percent)
///
void k_io__directorysizejob_on_percent_changed(void* self, void (*callback)(void*, void*, uintptr_t));
