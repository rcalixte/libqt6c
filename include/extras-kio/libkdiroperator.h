#pragma once
#ifndef SRC_EXTRAS_KIO_QT6C_LIBKDIROPERATOR_H
#define SRC_EXTRAS_KIO_QT6C_LIBKDIROPERATOR_H
...
///
libqt_list k_diroperator_all_actions(void* self);
...
/// @return libqt_list of QAction*
///
libqt_list k_diroperator_actions(void* self);
...
///
QWidget* k_diroperator_find(uintptr_t param1);
...
///
libqt_list k_diroperator_children(void* self);
...
///
/// @param self KDirOperator*
/// @param callback bool func(KDirOperator* self, libqt_string eventType, void* message, intptr_t* result)
///
