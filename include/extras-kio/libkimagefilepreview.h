#pragma once
#ifndef SRC_EXTRAS_KIOQT6C_LIBKIMAGEFILEPREVIEW_H
#define SRC_EXTRAS_KIOQT6C_LIBKIMAGEFILEPREVIEW_H
...
/// [Qt documentation](https://api.kde.org/kimagefilepreview.html#sizeHint)
///
/// @param self KImageFilePreview*
...
/// [Qt documentation](https://api.kde.org/kimagefilepreview.html#showPreview)
///
/// @param self KImageFilePreview*
/// @param url QUrl*
...
/// [Qt documentation](https://api.kde.org/kimagefilepreview.html#clearPreview)
///
/// @param self KImageFilePreview*
...
/// [Qt documentation](https://api.kde.org/kimagefilepreview.html#gotPreview)
///
/// @param self KImageFilePreview*
...
/// [Qt documentation](https://api.kde.org/kimagefilepreview.html#resizeEvent)
///
/// @param self KImageFilePreview*
...
/// [Qt documentation](https://api.kde.org/kimagefilepreview.html#createJob)
///
/// @param self KImageFilePreview*
/// @param url QUrl*
/// @param width int
...
///
/// [Qt documentation](https://api.kde.org/kpreviewwidgetbase.html#supportedMimeTypes)
///
/// Caller is responsible for freeing the returned memory
///
/// @param self KImageFilePreview*
...
void k_imagefilepreview_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KImageFilePreview*
/// @param typeVal enum Qt__GestureType
void k_imagefilepreview_ungrab_gesture(void* self, int64_t typeVal);
...
void k_imagefilepreview_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KImageFilePreview*
/// @param typeVal flag of enum Qt__WindowType
void k_imagefilepreview_override_window_flags(void* self, int64_t typeVal);
...
void k_imagefilepreview_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_imagefilepreview_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_imagefilepreview_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
/// [Qt documentation](https://api.kde.org/kimagefilepreview.html#dtor.KImageFilePreview)
///
