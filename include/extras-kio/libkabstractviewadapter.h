#pragma once
#ifndef EXTRAS_KIO_LIBKABSTRACTVIEWADAPTER_H
#define EXTRAS_KIO_LIBKABSTRACTVIEWADAPTER_H
...
///
int32_t k_abstractviewadapter_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_abstractviewadapter_start_timer23(void* self, int64_t time, int32_t timerType);
