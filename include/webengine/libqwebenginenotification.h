#pragma once
#ifndef WEBENGINE_LIBQWEBENGINENOTIFICATION_H
#define WEBENGINE_LIBQWEBENGINENOTIFICATION_H
...
///
int32_t q_webenginenotification_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t q_webenginenotification_start_timer23(void* self, int64_t time, int32_t timerType);
