...
///
/// @param self KSelectionOwner*
/// @param callback void* func(KSelectionOwner* self, const char* param1)
///
...
///
int32_t k_selectionowner_start_timer2(void* self, int64_t time);
...
///
QMetaObject__Connection* k_selectionowner_connect(void* sender, const char* signal, void* receiver, const char* member);
...
///
QMetaObject__Connection* k_selectionowner_connect2(void* sender, void* signal, void* receiver, void* method);
...
/// @param member const char*
///
QMetaObject__Connection* k_selectionowner_connect3(void* self, void* sender, const char* signal, const char* member);
...
/// @param member const char*
///
bool k_selectionowner_disconnect(void* sender, const char* signal, void* receiver, const char* member);
...
///
bool k_selectionowner_disconnect2(void* sender, void* signal, void* receiver, void* member);
...
/// @param self KSelectionOwner*
///
bool k_selectionowner_disconnect3(void* self);
...
/// @param receiver QObject*
///
bool k_selectionowner_disconnect4(void* self, void* receiver);
...
///
bool k_selectionowner_disconnect5(void* param1);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_selectionowner_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
QMetaObject__Connection* k_selectionowner_connect5(void* sender, const char* signal, void* receiver, const char* member, int32_t param5);
...
///
QMetaObject__Connection* k_selectionowner_connect52(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
/// @param signal const char*
///
bool k_selectionowner_disconnect1(void* self, const char* signal);
...
/// @param receiver QObject*
///
bool k_selectionowner_disconnect22(void* self, const char* signal, void* receiver);
...
/// @param member const char*
///
bool k_selectionowner_disconnect32(void* self, const char* signal, void* receiver, const char* member);
...
/// @param member const char*
///
bool k_selectionowner_disconnect23(void* self, void* receiver, const char* member);
