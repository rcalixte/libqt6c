#pragma once
#ifndef SRC_FOSS_EXTRAS_KWINDOWSYSTEM_QT6C_LIBKWINDOWSYSTEM_H
#define SRC_FOSS_EXTRAS_KWINDOWSYSTEM_QT6C_LIBKWINDOWSYSTEM_H
...
/// [Upstream resources](https://api.kde.org/kwindowsystem.html)
...
/// [Upstream resources](https://api.kde.org/kwindowsystem.html#self)
///
...
/// [Upstream resources](https://api.kde.org/kwindowsystem.html#showingDesktop)
///
bool k_windowsystem_showing_desktop();

/// [Upstream resources](https://api.kde.org/kwindowsystem.html#setShowingDesktop)
///
/// @param showing bool
///
void k_windowsystem_set_showing_desktop(bool showing);

/// [Upstream resources](https://api.kde.org/kwindowsystem.html#setMainWindow)
///
...
/// [Upstream resources](https://api.kde.org/kwindowsystem.html#updateStartupId)
///
/// @param window QWindow*
///
void k_windowsystem_update_startup_id(void* window);

/// [Upstream resources](https://api.kde.org/kwindowsystem.html#platform)
///
/// @return enum KWindowSystem__Platform
///
int32_t k_windowsystem_platform();

/// [Upstream resources](https://api.kde.org/kwindowsystem.html#isPlatformX11)
///
bool k_windowsystem_is_platform_x11();

/// [Upstream resources](https://api.kde.org/kwindowsystem.html#isPlatformWayland)
///
bool k_windowsystem_is_platform_wayland();

/// [Upstream resources](https://api.kde.org/kwindowsystem.html#setCurrentXdgActivationToken)
///
/// @param token const char*
///
void k_windowsystem_set_current_xdg_activation_token(const char* token);

/// [Upstream resources](https://api.kde.org/kwindowsystem.html#showingDesktopChanged)
///
/// @param self KWindowSystem*
/// @param showing bool
///
...
///
void k_windowsystem_set_object_name(void* self, const char* name);
...
///
int32_t k_windowsystem_start_timer2(void* self, int64_t time);
...
///
libqt_list k_windowsystem_children(void* self);
...
///
QMetaObject__Connection* k_windowsystem_connect(void* sender, const char* signal, void* receiver, const char* member);
...
///
QMetaObject__Connection* k_windowsystem_connect2(void* sender, void* signal, void* receiver, void* method);
...
/// @param member const char*
///
QMetaObject__Connection* k_windowsystem_connect3(void* self, void* sender, const char* signal, const char* member);
...
/// @param member const char*
///
bool k_windowsystem_disconnect(void* sender, const char* signal, void* receiver, const char* member);
...
///
bool k_windowsystem_disconnect2(void* sender, void* signal, void* receiver, void* member);
...
/// @param self KWindowSystem*
///
bool k_windowsystem_disconnect3(void* self);
...
/// @param receiver QObject*
///
bool k_windowsystem_disconnect4(void* self, void* receiver);
...
///
bool k_windowsystem_disconnect5(void* param1);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_windowsystem_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
QMetaObject__Connection* k_windowsystem_connect5(void* sender, const char* signal, void* receiver, const char* member, int32_t param5);
...
///
QMetaObject__Connection* k_windowsystem_connect52(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
/// @param signal const char*
///
bool k_windowsystem_disconnect1(void* self, const char* signal);
...
/// @param receiver QObject*
///
bool k_windowsystem_disconnect22(void* self, const char* signal, void* receiver);
...
/// @param member const char*
///
bool k_windowsystem_disconnect32(void* self, const char* signal, void* receiver, const char* member);
...
/// @param member const char*
///
bool k_windowsystem_disconnect23(void* self, void* receiver, const char* member);
...
/// [Upstream resources](https://api.kde.org/kwindowsystem.html#dtor.KWindowSystem)
///
