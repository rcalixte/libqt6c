#pragma once
#ifndef FOSS_EXTRAS_KWINDOWSYSTEM_LIBKWAYLANDEXTRAS_H
#define FOSS_EXTRAS_KWINDOWSYSTEM_LIBKWAYLANDEXTRAS_H
...
///
int32_t k_waylandextras_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_waylandextras_start_timer23(void* self, int64_t time, int32_t timerType);
