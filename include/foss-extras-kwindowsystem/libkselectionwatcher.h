#pragma once
#ifndef SRC_FOSS_EXTRAS_KWINDOWSYSTEMQT6C_LIBKSELECTIONWATCHER_H
#define SRC_FOSS_EXTRAS_KWINDOWSYSTEMQT6C_LIBKSELECTIONWATCHER_H
...
QMetaObject__Connection* k_selectionwatcher_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_selectionwatcher_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
/// [Qt documentation](https://api.kde.org/kselectionwatcher.html#dtor.KSelectionWatcher)
///
