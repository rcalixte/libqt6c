...
int64_t k_sonnet__configview_window_state(void* self);
...
void k_sonnet__configview_set_window_state(void* self, int64_t state);
...
/// @param self Sonnet__ConfigView*
/// @param state flag of enum Qt__WindowState
void k_sonnet__configview_override_window_state(void* self, int64_t state);
...
void k_sonnet__configview_render4(void* self, void* target, void* targetOffset, void* sourceRegion, int64_t renderFlags);
...
/// @param sourceRegion QRegion*
/// @param renderFlags flag of enum QWidget__RenderFlag
void k_sonnet__configview_render42(void* self, void* painter, void* targetOffset, void* sourceRegion, int64_t renderFlags);
...
void k_sonnet__configview_grab_gesture2(void* self, int64_t typeVal, int64_t flags);
