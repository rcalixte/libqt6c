#pragma once
#ifndef SRC_EXTRAS_KPARTSQT6C_LIBPART_H
#define SRC_EXTRAS_KPARTSQT6C_LIBPART_H
...
void k_parts__part_plug_action_list(void* self, const char* name, libqt_list actionList);
...
const char* k_parts__part_find_most_recent_x_m_l_file(const char* files[], const char* doc);
