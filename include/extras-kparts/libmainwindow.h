#pragma once
#ifndef SRC_EXTRAS_KPARTSQT6C_LIBMAINWINDOW_H
#define SRC_EXTRAS_KPARTSQT6C_LIBMAINWINDOW_H
...
const char* k_parts__mainwindow_find_most_recent_x_m_l_file(const char* files[], const char* doc);
