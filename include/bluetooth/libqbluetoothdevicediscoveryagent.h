#pragma once
#ifndef SRC_BLUETOOTH_QT6C_LIBQBLUETOOTHDEVICEDISCOVERYAGENT_H
#define SRC_BLUETOOTH_QT6C_LIBQBLUETOOTHDEVICEDISCOVERYAGENT_H
...
/// q_bluetoothdevicediscoveryagent_new constructs a new QBluetoothDeviceDiscoveryAgent object.
///
QBluetoothDeviceDiscoveryAgent* q_bluetoothdevicediscoveryagent_new();

/// [Upstream resources](https://doc.qt.io/qt-6/qbluetoothdevicediscoveryagent.html)

/// q_bluetoothdevicediscoveryagent_new2 constructs a new QBluetoothDeviceDiscoveryAgent object.
///
...
/// q_bluetoothdevicediscoveryagent_new3 constructs a new QBluetoothDeviceDiscoveryAgent object.
///
...
/// q_bluetoothdevicediscoveryagent_new4 constructs a new QBluetoothDeviceDiscoveryAgent object.
///
/// @param deviceAdapter QBluetoothAddress*
/// @param parent QObject*
///
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_meta_object` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_meta_object q_bluetoothdevicediscoveryagent_super_meta_object
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback void* func(QBluetoothDeviceDiscoveryAgent* self, const char* param1)
///
void q_bluetoothdevicediscoveryagent_on_metacast(void* self, void* (*callback)(void*, const char*));

/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_metacast` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_metacast q_bluetoothdevicediscoveryagent_super_metacast
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback int32_t func(QBluetoothDeviceDiscoveryAgent* self, enum QMetaObject__Call param1, int param2, void* param3)
///
void q_bluetoothdevicediscoveryagent_on_metacall(void* self, int32_t (*callback)(void*, int32_t, int, void*));

/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_metacall` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_metacall q_bluetoothdevicediscoveryagent_super_metacall
...
///
/// @return flag of enum QBluetoothDeviceDiscoveryAgent__DiscoveryMethod
///
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param method flag of enum QBluetoothDeviceDiscoveryAgent__DiscoveryMethod
///
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback void func(QBluetoothDeviceDiscoveryAgent* self)
///
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param error enum QBluetoothDeviceDiscoveryAgent__Error
///
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback void func(QBluetoothDeviceDiscoveryAgent* self, enum QBluetoothDeviceDiscoveryAgent__Error error)
///
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback void func(QBluetoothDeviceDiscoveryAgent* self, QObject* param1)
///
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_event` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_event q_bluetoothdevicediscoveryagent_super_event
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback bool func(QBluetoothDeviceDiscoveryAgent* self, QEvent* event)
///
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_event_filter` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_event_filter q_bluetoothdevicediscoveryagent_super_event_filter
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback bool func(QBluetoothDeviceDiscoveryAgent* self, QObject* watched, QEvent* event)
///
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_timer_event` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_timer_event q_bluetoothdevicediscoveryagent_super_timer_event
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback void func(QBluetoothDeviceDiscoveryAgent* self, QTimerEvent* event)
///
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_child_event` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_child_event q_bluetoothdevicediscoveryagent_super_child_event
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback void func(QBluetoothDeviceDiscoveryAgent* self, QChildEvent* event)
///
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_custom_event` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_custom_event q_bluetoothdevicediscoveryagent_super_custom_event
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback void func(QBluetoothDeviceDiscoveryAgent* self, QEvent* event)
///
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_connect_notify` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_connect_notify q_bluetoothdevicediscoveryagent_super_connect_notify
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_disconnect_notify` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_disconnect_notify q_bluetoothdevicediscoveryagent_super_disconnect_notify
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_sender` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_sender q_bluetoothdevicediscoveryagent_super_sender
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_sender_signal_index` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_sender_signal_index q_bluetoothdevicediscoveryagent_super_sender_signal_index
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_receivers` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_receivers q_bluetoothdevicediscoveryagent_super_receivers
...
/// @warning DEPRECATED: Use `q_bluetoothdevicediscoveryagent_super_is_signal_connected` instead
///
#define q_bluetoothdevicediscoveryagent_qbase_is_signal_connected q_bluetoothdevicediscoveryagent_super_is_signal_connected
...
///
/// @param self QBluetoothDeviceDiscoveryAgent*
/// @param callback void func(QBluetoothDeviceDiscoveryAgent* self, const char* objectName)
///
...
typedef enum {
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_NOERROR = 0,
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_INPUTOUTPUTERROR = 1,
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_POWEREDOFFERROR = 2,
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_INVALIDBLUETOOTHADAPTERERROR = 3,
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_UNSUPPORTEDPLATFORMERROR = 4,
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_UNSUPPORTEDDISCOVERYMETHOD = 5,
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_LOCATIONSERVICETURNEDOFFERROR = 6,
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_MISSINGPERMISSIONSERROR = 7,
    QBLUETOOTHDEVICEDISCOVERYAGENT_ERROR_UNKNOWNERROR = 100
} QBluetoothDeviceDiscoveryAgent__Error;

/// [Upstream resources](https://doc.qt.io/qt-6/qbluetoothdevicediscoveryagent.html#public-types)

typedef enum {
    QBLUETOOTHDEVICEDISCOVERYAGENT_DISCOVERYMETHOD_NOMETHOD = 0,
    QBLUETOOTHDEVICEDISCOVERYAGENT_DISCOVERYMETHOD_CLASSICMETHOD = 1,
    QBLUETOOTHDEVICEDISCOVERYAGENT_DISCOVERYMETHOD_LOWENERGYMETHOD = 2
