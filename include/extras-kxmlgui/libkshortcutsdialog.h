#pragma once
#ifndef SRC_EXTRAS_KXMLGUI_QT6C_LIBKSHORTCUTSDIALOG_H
#define SRC_EXTRAS_KXMLGUI_QT6C_LIBKSHORTCUTSDIALOG_H
...
///
/// @param self KShortcutsDialog*
/// @param callback bool func(KShortcutsDialog* self, libqt_string eventType, void* message, intptr_t* result)
///
