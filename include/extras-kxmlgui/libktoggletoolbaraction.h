#pragma once
#ifndef EXTRAS_KXMLGUI_LIBKTOGGLETOOLBARACTION_H
#define EXTRAS_KXMLGUI_LIBKTOGGLETOOLBARACTION_H
...
///
void k_toggletoolbaraction_set_object_name(void* self, const char* name);
