...
///
void k_toolbar_add_actions(void* self, libqt_list /* of QAction* */ actions);
...
/// @param actions libqt_list of QAction*
///
void k_toolbar_insert_actions(void* self, void* before, libqt_list /* of QAction* */ actions);
...
/// @param param1 enum Qt__InputMethodQuery
///
QVariant* k_toolbar_qbase_input_method_query(void* self, int32_t param1);
