#pragma once
#ifndef SRC_EXTRAS_KXMLGUIQT6C_LIBKEDITTOOLBAR_H
#define SRC_EXTRAS_KXMLGUIQT6C_LIBKEDITTOOLBAR_H
...
void k_edittoolbar_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KEditToolBar*
/// @param typeVal enum Qt__GestureType
void k_edittoolbar_ungrab_gesture(void* self, int64_t typeVal);
...
void k_edittoolbar_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KEditToolBar*
/// @param typeVal flag of enum Qt__WindowType
void k_edittoolbar_override_window_flags(void* self, int64_t typeVal);
...
void k_edittoolbar_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_edittoolbar_connect(void* sender, void* signal, void* receiver, void* method);
...
QMetaObject__Connection* k_edittoolbar_connect2(void* self, void* sender, const char* signal, const char* member);
...
bool k_edittoolbar_disconnect(void* sender, void* signal, void* receiver, void* member);
...
bool k_edittoolbar_disconnect2(void* param1);
...
bool k_edittoolbar_move_to_thread2(void* self, void* thread, void* param2);
...
QMetaObject__Connection* k_edittoolbar_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_edittoolbar_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
///
/// @param self KEditToolBar*
/// @param callback bool func(KEditToolBar* self, const char* eventType, void* message, intptr_t* result)
