#pragma once
#ifndef SRC_EXTRAS_SOLID_QT6C_LIBSTORAGEVOLUME_H
#define SRC_EXTRAS_SOLID_QT6C_LIBSTORAGEVOLUME_H
...
/// [Upstream resources](https://api.kde.org/solid-storagevolume.html)
...
///
libqt_list k_solid__storagevolume_children(void* self);
