...
void q_printpreviewdialog_grab_gesture(void* self, int64_t type);
...
/// @param self QPrintPreviewDialog*
/// @param type enum Qt__GestureType
void q_printpreviewdialog_ungrab_gesture(void* self, int64_t type);
...
void q_printpreviewdialog_set_window_flags(void* self, int64_t type);
...
/// @param self QPrintPreviewDialog*
/// @param type flag of enum Qt__WindowType
void q_printpreviewdialog_override_window_flags(void* self, int64_t type);
...
void q_printpreviewdialog_grab_gesture2(void* self, int64_t type, int32_t flags);
