...
///
/// ``` QPrintDialog* self, libqt_list /* of QWidget* */ tabs ```
...
///
/// ``` QPrintDialog* self, libqt_list /* of QAction* */ actions ```
...
///
/// ``` QPrintDialog* self, QAction* before, libqt_list /* of QAction* */ actions ```
