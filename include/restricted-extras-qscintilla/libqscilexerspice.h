...
///
QMetaObject__Connection* q_scilexerspice_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
///
/// @param self QsciLexerSpice*
/// @param callback char* func(QsciLexerSpice* self, const char* text)
///
