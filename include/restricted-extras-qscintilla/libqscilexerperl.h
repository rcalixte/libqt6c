...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
///
/// ``` QsciLexerPerl* self, enum Qt__TimerId id ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
///
/// ``` QsciLexerPerl* self, QThread* thread, Disambiguated_t* param2 ```
...
///
/// ``` QsciLexerPerl* self, QColor* (*slot)(QsciLexerPerl*, int) ```
void q_scilexerperl_on_default_color2(void* self, QColor* (*slot)(void*, int));
...
///
/// ``` QsciLexerPerl* self, QFont* (*slot)(QsciLexerPerl*, int) ```
void q_scilexerperl_on_default_font2(void* self, QFont* (*slot)(void*, int));
...
///
/// ``` QsciLexerPerl* self, QColor* (*slot)(QsciLexerPerl*, int) ```
void q_scilexerperl_on_default_paper2(void* self, QColor* (*slot)(void*, int));
...
/// Wrapper to allow calling virtual or protected method
///
/// ``` QsciLexerPerl* self, const char* text ```
...
/// Wrapper to allow overriding base class virtual or protected method
///
/// ``` QsciLexerPerl* self, char* (*slot)(QsciLexerPerl*, const char*) ```
void q_scilexerperl_on_text_as_bytes(void* self, char* (*slot)(void*, const char*));
...
/// Wrapper to allow calling virtual or protected method
///
/// ``` QsciLexerPerl* self, const char* bytes, int size ```
...
/// Wrapper to allow overriding base class virtual or protected method
///
/// ``` QsciLexerPerl* self, const char* (*slot)(QsciLexerPerl*, const char*, int) ```
void q_scilexerperl_on_bytes_as_text(void* self, const char* (*slot)(void*, const char*, int));
