...
void q_scilexerperl_on_metacall(void* self, int32_t (*callback)(void*, int64_t, int, void*));
...
void q_scilexerperl_kill_timer2(void* self, int64_t id);
...
int32_t q_scilexerperl_start_timer22(void* self, int interval, int64_t timerType);
