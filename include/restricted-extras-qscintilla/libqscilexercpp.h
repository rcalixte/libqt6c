...
///
QMetaObject__Connection* q_scilexercpp_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
///
/// @param self QsciLexerCPP*
/// @param callback char* func(QsciLexerCPP* self, const char* text)
///
