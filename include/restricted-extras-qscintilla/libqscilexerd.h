...
/// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
///
/// ``` QsciLexerD* self, void (*slot)(QsciLexerD*, const char*, const char*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QsciLexerD* self, void (*slot)(QsciLexerD*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QsciLexerD* self, void (*slot)(QsciLexerD*, QObject*) ```
...
///
/// ``` QsciLexerD* self, void (*slot)(QsciLexerD*, const char*) ```
