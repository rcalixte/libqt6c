...
/// [Qt documentation](https://www.riverbankcomputing.com/static/Docs/QScintilla/classQsciLexer.html)
///
/// ``` QsciLexerBatch* self, void (*slot)(QsciLexerBatch*, const char*, const char*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QsciLexerBatch* self, void (*slot)(QsciLexerBatch*) ```
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QsciLexerBatch* self, void (*slot)(QsciLexerBatch*, QObject*) ```
...
///
/// ``` QsciLexerBatch* self, void (*slot)(QsciLexerBatch*, const char*) ```
