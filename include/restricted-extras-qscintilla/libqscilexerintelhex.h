...
///
QMetaObject__Connection* q_scilexerintelhex_connect5(void* sender, void* signal, void* receiver, void* method, int32_t type);
...
///
/// @param self QsciLexerIntelHex*
/// @param callback char* func(QsciLexerIntelHex* self, const char* text)
///
