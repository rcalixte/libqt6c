...
/// @return libqt_map of int to char*
///
libqt_map k_checkableproxymodel_qbase_role_names(void* self);
...
/// @return libqt_list of QModelIndex*
///
libqt_list k_checkableproxymodel_qbase_match(void* self, void* start, int role, void* value, int hits, int32_t flags);
...
/// @return libqt_map of int to QVariant*
///
libqt_map k_checkableproxymodel_qbase_item_data(void* self, void* index);
...
/// @param roles libqt_map of int to QVariant*
///
bool k_checkableproxymodel_qbase_set_item_data(void* self, void* index, libqt_map roles);
...
/// @return libqt_list of QModelIndex*
///
libqt_list k_checkableproxymodel_qbase_persistent_index_list(void* self);
