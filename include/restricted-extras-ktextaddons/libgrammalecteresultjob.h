#pragma once
#ifndef SRC_RESTRICTED_EXTRAS_KTEXTADDONS_QT6C_LIBGRAMMALECTERESULTJOB_H
#define SRC_RESTRICTED_EXTRAS_KTEXTADDONS_QT6C_LIBGRAMMALECTERESULTJOB_H
...
/// k_textgrammarcheck__grammalecteresultjob_new constructs a new TextGrammarCheck::GrammalecteResultJob object.
///
TextGrammarCheck__GrammalecteResultJob* k_textgrammarcheck__grammalecteresultjob_new();

/// [Upstream resources](https://api.kde.org/legacy/ktextaddons/html/classTextGrammarCheck_1_1GrammalecteResultJob.html)

/// k_textgrammarcheck__grammalecteresultjob_new2 constructs a new TextGrammarCheck::GrammalecteResultJob object.
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback void func(TextGrammarCheck__GrammalecteResultJob* self, const char* result)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param type enum TextGrammarCheck__GrammalecteResultJob__ErrorType
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback void func(TextGrammarCheck__GrammalecteResultJob* self, enum TextGrammarCheck__GrammalecteResultJob__ErrorType type)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback void func(TextGrammarCheck__GrammalecteResultJob* self)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback void func(TextGrammarCheck__GrammalecteResultJob* self, QObject* param1)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback bool func(TextGrammarCheck__GrammalecteResultJob* self, QEvent* event)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback bool func(TextGrammarCheck__GrammalecteResultJob* self, QObject* watched, QEvent* event)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback void func(TextGrammarCheck__GrammalecteResultJob* self, QTimerEvent* event)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback void func(TextGrammarCheck__GrammalecteResultJob* self, QChildEvent* event)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback void func(TextGrammarCheck__GrammalecteResultJob* self, QEvent* event)
///
...
///
/// @param self TextGrammarCheck__GrammalecteResultJob*
/// @param callback void func(TextGrammarCheck__GrammalecteResultJob* self, const char* objectName)
///
...
typedef enum {
    TEXTGRAMMARCHECK_GRAMMALECTERESULTJOB_ERRORTYPE_NOERROR = 0,
    TEXTGRAMMARCHECK_GRAMMALECTERESULTJOB_ERRORTYPE_TEXTISEMPTY = 1,
    TEXTGRAMMARCHECK_GRAMMALECTERESULTJOB_ERRORTYPE_PYTHONPATHMISSING = 2,
    TEXTGRAMMARCHECK_GRAMMALECTERESULTJOB_ERRORTYPE_GRAMMALECTEMISSING = 3,
    TEXTGRAMMARCHECK_GRAMMALECTERESULTJOB_ERRORTYPE_PYTHONPATHNOTEXIST = 4,
    TEXTGRAMMARCHECK_GRAMMALECTERESULTJOB_ERRORTYPE_GRAMMARLECTCLINOTEXIST = 5,
    TEXTGRAMMARCHECK_GRAMMALECTERESULTJOB_ERRORTYPE_UNKNOWN = 6
} TextGrammarCheck__GrammalecteResultJob__ErrorType;
