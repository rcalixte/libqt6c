#pragma once
#ifndef SRC_EXTRAS_KIMAGEANNOTATOR_QT6C_LIBKIMAGEANNOTATOR_H
#define SRC_EXTRAS_KIMAGEANNOTATOR_QT6C_LIBKIMAGEANNOTATOR_H
...
///
/// @param self kImageAnnotator__KImageAnnotator*
/// @param callback void* func(kImageAnnotator__KImageAnnotator* self, const char* param1)
///
...
///
int32_t k_imageannotator__kimageannotator_start_timer2(void* self, int64_t time);
...
/// @param timerType enum Qt__TimerType
///
int32_t k_imageannotator__kimageannotator_start_timer23(void* self, int64_t time, int32_t timerType);
...
///
/// @param self kImageAnnotator__KImageAnnotator*
/// @param callback bool func(kImageAnnotator__KImageAnnotator* self, libqt_string eventType, void* message, intptr_t* result)
///
