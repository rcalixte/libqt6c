#pragma once
#ifndef SRC_EXTRAS_KBOOKMARKSQT6C_LIBKBOOKMARKDIALOG_H
#define SRC_EXTRAS_KBOOKMARKSQT6C_LIBKBOOKMARKDIALOG_H
...
/// [Qt documentation](https://api.kde.org/kbookmarkdialog.html#editBookmark)
///
/// @param self KBookmarkDialog*
/// @param bm KBookmark*
KBookmark* k_bookmarkdialog_edit_bookmark(void* self, void* bm);

/// [Qt documentation](https://api.kde.org/kbookmarkdialog.html#addBookmark)
///
/// @param self KBookmarkDialog*
...
/// [Qt documentation](https://api.kde.org/kbookmarkdialog.html#addBookmarks)
///
/// @param self KBookmarkDialog*
...
/// [Qt documentation](https://api.kde.org/kbookmarkdialog.html#createNewFolder)
///
/// @param self KBookmarkDialog*
/// @param name const char*
KBookmarkGroup* k_bookmarkdialog_create_new_folder(void* self, const char* name);

/// [Qt documentation](https://api.kde.org/kbookmarkdialog.html#selectFolder)
///
/// @param self KBookmarkDialog*
KBookmarkGroup* k_bookmarkdialog_select_folder(void* self);

/// [Qt documentation](https://api.kde.org/kbookmarkdialog.html#accept)
///
/// @param self KBookmarkDialog*
...
/// [Qt documentation](https://api.kde.org/kbookmarkdialog.html#newFolderButton)
///
/// @param self KBookmarkDialog*
...
void k_bookmarkdialog_grab_gesture(void* self, int64_t typeVal);
...
/// @param self KBookmarkDialog*
/// @param typeVal enum Qt__GestureType
void k_bookmarkdialog_ungrab_gesture(void* self, int64_t typeVal);
...
void k_bookmarkdialog_set_window_flags(void* self, int64_t typeVal);
...
/// @param self KBookmarkDialog*
/// @param typeVal flag of enum Qt__WindowType
void k_bookmarkdialog_override_window_flags(void* self, int64_t typeVal);
...
void k_bookmarkdialog_grab_gesture2(void* self, int64_t typeVal, int32_t flags);
...
QMetaObject__Connection* k_bookmarkdialog_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_bookmarkdialog_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
...
/// [Qt documentation](https://api.kde.org/kbookmarkdialog.html#dtor.KBookmarkDialog)
///
