#pragma once
#ifndef SRC_EXTRAS_KBOOKMARKS_QT6C_LIBKBOOKMARKDIALOG_H
#define SRC_EXTRAS_KBOOKMARKS_QT6C_LIBKBOOKMARKDIALOG_H
...
///
libqt_list k_bookmarkdialog_actions(void* self);
...
///
QWidget* k_bookmarkdialog_find(uintptr_t param1);
...
///
libqt_list k_bookmarkdialog_children(void* self);
...
///
/// @param self KBookmarkDialog*
/// @param callback bool func(KBookmarkDialog* self, libqt_string eventType, void* message, intptr_t* result)
///
