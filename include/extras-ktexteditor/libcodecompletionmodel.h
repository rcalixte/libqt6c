...
///
/// @param self KTextEditor__CodeCompletionModel*
/// @param callback void func(KTextEditor__CodeCompletionModel* self, libqt_list of QPersistentModelIndex* parents)
///
void k_texteditor__codecompletionmodel_on_layout_changed1(void* self, void (*callback)(void*, libqt_list));
...
///
/// @param self KTextEditor__CodeCompletionModel*
/// @param callback void func(KTextEditor__CodeCompletionModel* self, libqt_list of QPersistentModelIndex* parents, enum QAbstractItemModel__LayoutChangeHint hint)
///
void k_texteditor__codecompletionmodel_on_layout_changed2(void* self, void (*callback)(void*, libqt_list, int32_t));
...
/// @param callback void func(KTextEditor__CodeCompletionModel* self, libqt_list of QPersistentModelIndex* parents)
///
void k_texteditor__codecompletionmodel_on_layout_about_to_be_changed1(void* self, void (*callback)(void*, libqt_list));
...
/// @param callback void func(KTextEditor__CodeCompletionModel* self, libqt_list of QPersistentModelIndex* parents, enum QAbstractItemModel__LayoutChangeHint hint)
///
void k_texteditor__codecompletionmodel_on_layout_about_to_be_changed2(void* self, void (*callback)(void*, libqt_list, int32_t));
...
///
/// @param self KTextEditor__CodeCompletionModel*
/// @param callback void func(KTextEditor__CodeCompletionModel* self, libqt_list of QModelIndex* from, libqt_list of QModelIndex* to)
///
void k_texteditor__codecompletionmodel_on_change_persistent_index_list(void* self, void (*callback)(void*, libqt_list, libqt_list));
