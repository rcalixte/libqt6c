#pragma once
#ifndef EXTRAS_KTEXTEDITOR_LIBMAINWINDOW_H
#define EXTRAS_KTEXTEDITOR_LIBMAINWINDOW_H
...
///
/// @param self KTextEditor__MainWindow*
/// @param callback void* func(KTextEditor__MainWindow* self, const char* param1)
///
