#pragma once
#ifndef SRC_EXTRAS_KCONFIGWIDGETSQT6C_LIBKHAMBURGERMENU_H
#define SRC_EXTRAS_KCONFIGWIDGETSQT6C_LIBKHAMBURGERMENU_H
...
QMetaObject__Connection* k_hamburgermenu_connect(void* sender, void* signal, void* receiver, void* method);
...
QMetaObject__Connection* k_hamburgermenu_connect2(void* self, void* sender, const char* signal, const char* member);
...
bool k_hamburgermenu_disconnect(void* sender, void* signal, void* receiver, void* member);
...
bool k_hamburgermenu_disconnect2(void* param1);
...
bool k_hamburgermenu_move_to_thread2(void* self, void* thread, void* param2);
...
QMetaObject__Connection* k_hamburgermenu_connect5(void* sender, void* signal, void* receiver, void* method, int32_t typeVal);
...
/// @param member const char*
/// @param typeVal enum Qt__ConnectionType
QMetaObject__Connection* k_hamburgermenu_connect4(void* self, void* sender, const char* signal, const char* member, int32_t typeVal);
