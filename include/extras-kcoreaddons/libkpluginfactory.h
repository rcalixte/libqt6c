#pragma once
#ifndef SRC_EXTRAS_KCOREADDONS_QT6C_LIBKPLUGINFACTORY_H
#define SRC_EXTRAS_KCOREADDONS_QT6C_LIBKPLUGINFACTORY_H
...
/// @param args libqt_list of QVariant*
///
QObject* k_pluginfactory_super_create(void* self, const char* iface, void* parentWidget, void* parent, libqt_list args);
...
typedef enum {
    ...
    KPLUGINFACTORY_RESULTERRORREASON_INVALID_PLUGIN = 1,
    KPLUGINFACTORY_RESULTERRORREASON_INVALID_FACTORY = 2,
    KPLUGINFACTORY_RESULTERRORREASON_INVALID_KPLUGINFACTORY_INSTANTIATION = 3
} KPluginFactory__ResultErrorReason;
