...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
///
/// ``` QFileSystemWatcher* self, enum Qt__TimerId id ```
void q_filesystemwatcher_kill_timer2(void* self, int64_t id);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
///
/// ``` QFileSystemWatcher* self, QThread* thread, Disambiguated_t* param2 ```
...
int32_t q_filesystemwatcher_start_timer22(void* self, int interval, int64_t timerType);
