...
void q_pluginloader_kill_timer2(void* self, int64_t id);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QPluginLoader* self, void (*slot)(QPluginLoader*) ```
...
int32_t q_pluginloader_start_timer22(void* self, int interval, int64_t timerType);
...
/// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
///
/// ``` QPluginLoader* self, void (*slot)(QPluginLoader*, QObject*) ```
...
///
/// ``` QPluginLoader* self, void (*slot)(QPluginLoader*, const char*) ```
