#pragma once
#ifndef EXTRAS_KJOBWIDGETS_LIBKSTATUSBARJOBTRACKER_H
#define EXTRAS_KJOBWIDGETS_LIBKSTATUSBARJOBTRACKER_H
...
///
void k_statusbarjobtracker_set_object_name(void* self, const char* name);
