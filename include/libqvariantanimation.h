#pragma once
#ifndef SRC_QT6C_LIBQVARIANTANIMATION_H
#define SRC_QT6C_LIBQVARIANTANIMATION_H
...
///
libqt_list q_variantanimation_key_values(void* self);
...
///
libqt_list q_variantanimation_children(void* self);
