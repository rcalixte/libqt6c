...
func generate(srcName string, srcDirs []string, allowHeaderFn func(string) bool, clangBin, cflagsCombined, outDir string, matcher ClangMatcher, headerList *[]string, qtstructdefs, qttypedefs map[string]struct{}) {
