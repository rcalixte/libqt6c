...
func InsertTypedefs() {
	...
	KnownIncludes["Command"] = lookupResultInclude{"posix-restricted-qtermwidget", "KeyboardTranslator.h"}
	...
	// Qt 6 KIO
	KnownIncludes["PrivilegeOperationStatus"] = lookupResultInclude{"extras-kio", "global.h"}
	KnownIncludes["RulesStorage"] = lookupResultInclude{"extras-kio", "sslui.h"}
...
func ImportHeaderForClass(className string, excludeQsci bool) bool {
