...
```bash
sudo pkg install llvm qt6-base qt6-charts qt6-multimedia qt6-pdf qt6-svg qt6-webchannel qt6-webengine kf6-kcodecs kf6-kconfig kf6-kcoreaddons kf6-kcrash kf6-kguiaddons kf6-ki18n kf6-kitemviews kf6-kwidgetsaddons qscintilla2-qt6 qtermwidget zig
```
...
```bash
sudo apt install clang-format qt6-base-dev qt6-base-private-dev qt6-charts-dev qt6-multimedia-dev qt6-pdf-dev qt6-svg-dev qt6-webchannel-dev qt6-webengine-dev libkf6codecs-dev libkf6config-dev libkf6coreaddons-dev libkf6crash-dev libkf6guiaddons-dev libkf6i18n-dev libkf6itemviews-dev libkf6widgetsaddons-dev libqscintilla2-qt6-dev libqtermwidget-dev
```
...
```bash
sudo pacman -S clang qt6-base qt6-charts qt6-multimedia qt6-svg qt6-webchannel qt6-webengine kcodecs kconfig kcoreaddons kcrash kguiaddons ki18n kitemviews kwidgetsaddons qscintilla-qt6 qtermwidget zig
```
