...
<div align="center">
<img alt="libqt6c" src="assets/libqt6c-tools.png" />
</div>
...
While optional for the `lupdate-c` and `uic-c` programs, there is a hard system dependency for the `qrc-c` program:
