...
```bash
sudo pacman -S clang qt6-base qt6-charts qt6-multimedia qt6-svg qt6-webchannel qt6-webengine kcodecs kcolorscheme kcompletion kconfig kconfigwidgets kcoreaddons kcrash kguiaddons ki18n kitemviews kplotting ktextwidgets kwidgetsaddons qscintilla-qt6 qtermwidget sonnet zig
```
