...
```bash
sudo pkg install llvm qt6-base qt6-charts qt6-multimedia qt6-pdf qt6-svg qt6-webchannel qt6-webengine kf6-kcodecs kf6-kconfig kf6-kcoreaddons kf6-kcrash kf6-kguiaddons kf6-ki18n kf6-kitemviews kf6-sonnet kf6-kwidgetsaddons qscintilla2-qt6 qtermwidget zig
```
...
```bash
sudo pacman -S clang qt6-base qt6-charts qt6-multimedia qt6-svg qt6-webchannel qt6-webengine kcodecs kconfig kcoreaddons kcrash kguiaddons ki18n kitemviews kwidgetsaddons qscintilla-qt6 qtermwidget sonnet zig
```
